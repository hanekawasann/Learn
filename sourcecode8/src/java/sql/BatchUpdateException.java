...
public class BatchUpdateException extends SQLException {
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        if (tmp != null) { updateCounts = tmp.clone(); }
        if (tmp2 != null) { longUpdateCounts = tmp2.clone(); }
        if (updateCounts == null && longUpdateCounts != null) { updateCounts = copyUpdateCount(longUpdateCounts); }
        if (longUpdateCounts == null && updateCounts != null) { longUpdateCounts = copyUpdateCount(updateCounts); }
