...
final class DigitList implements Cloneable {
    ...
    final void set(boolean isNegative, double source, int maximumDigits, boolean fixedPoint) {
        ...
        set(isNegative, digitsString, hasBeenRoundedUp, allDecimalDigits, maximumDigits, fixedPoint);
    }
     ...
     */
    private void set(boolean isNegative, String s, boolean roundedUp, boolean allDecimalDigits, int maximumDigits,
        boolean fixedPoint) {
        ...
        round(fixedPoint ? (maximumDigits + decimalAt) : maximumDigits, roundedUp, allDecimalDigits);
    }
     ...
     */
    private final void round(int maximumDigits, boolean alreadyRounded, boolean allDecimalDigits) {
        // Eliminate digits beyond maximum digits to be displayed.
        // Round up if appropriate.
     ...
     */
    private boolean shouldRoundUp(int maximumDigits, boolean alreadyRounded, boolean allDecimalDigits) {
            ...
            switch (roundingMode) {
                ...
                case HALF_UP:
                    if (digits[maximumDigits] >= '5') {
                        ...
                        return (maximumDigits != (count - 1)) || (!alreadyRounded);
                ...
                case HALF_DOWN:
                    if (digits[maximumDigits] > '5') {
                        ...
                        if (maximumDigits == (count - 1)) {
                            ...
                            return !allDecimalDigits && !alreadyRounded;
                        }
