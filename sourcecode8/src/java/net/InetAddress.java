...
public class InetAddress implements java.io.Serializable {
     ...
     */
    static {
        preferIPv6Address = java.security.AccessController
            .doPrivileged(new GetBooleanAction("java.net.preferIPv6Addresses")).booleanValue();
    ...
    private static NameService createNSProvider(String provider) {
        ...
        if (provider.equals("default")) {
            ...
            try {
                nameService = java.security.AccessController
                    .doPrivileged(new java.security.PrivilegedExceptionAction<NameService>() {
                        public NameService run() {
                            Iterator<NameServiceDescriptor> itr = ServiceLoader.load(NameServiceDescriptor.class)
                                .iterator();
                            while (itr.hasNext()) {
                                NameServiceDescriptor nsd = itr.next();
                                if (providerName.
                                    equalsIgnoreCase(nsd.getType() + "," + nsd.getProviderName())) {
                                    try {
    ...
    private static InetAddress[] getAllByName0(String host, InetAddress reqAddr, boolean check)
        ...
        if (addresses == unknown_array) { throw new UnknownHostException(host); }
        ...
        try {
            ...
            synchronized (cacheLock) {
                ...
                if (cachedLocalHost != null) {
                    ...
                    { ret = cachedLocalHost; } else { cachedLocalHost = null; }
                }
    ...
    static InetAddressImpl loadImpl(String implName) {
        ...
        try {
            ...
            System.err.println(
                "Could not instantiate: java.net." + prefix + implName + ":\ncheck impl.prefix property " +
                    "in your properties file.");
