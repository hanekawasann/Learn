...
public class CompletableFuture<T> implements Future<T>, CompletionStage<T> {
    ...
    final void internalComplete(T v, Throwable ex) {
        if (result == null) {
            UNSAFE.compareAndSwapObject(this, RESULT, null, (ex == null) ? (v == null) ? NIL : v
                : new AltResult((ex instanceof CompletionException) ? ex : new CompletionException(ex)));
        }
    ...
    static final class WaitNode implements ForkJoinPool.ManagedBlocker {
        ...
        public boolean block() {
            if (isReleasable()) { return true; } else if (deadline == 0L) { LockSupport.park(this); } else if (nanos >
                0L) {
    ...
    private Object waitingGet(boolean interruptible) {
        ...
        for (Object r; ; ) {
            if ((r = result) != null) {
                ...
                if (rnd == 0) { rnd = ThreadLocalRandom.current().nextInt(); }
                if (rnd >= 0) { --spins; }
            } else if (q == null) { q = new WaitNode(interruptible, 0L, 0L); } else if (!queued) {
            ...
            for (; ; ) {          // restart on removeWaiter race
                for (WaitNode pred = null, q = waiters, s; q != null; q = s) {
                    ...
                    if (q.thread != null) { pred = q; } else if (pred != null) {
                        ...
                        { continue retry; }
                    } else if (!UNSAFE.compareAndSwapObject(this, WAITERS, q, s)) { continue retry; }
                }
                break;
            }
        }
    ...
    static void execAsync(Executor e, Async r) {
        if (e == ForkJoinPool.commonPool() && ForkJoinPool.getCommonPoolParallelism() <= 1) {
            new Thread(r).start();
        } else { e.execute(r); }
    }
    ...
    static final class ThenApply<T, U> extends Completion {
        ...
        ThenApply(CompletableFuture<? extends T> src, Function<? super T, ? extends U> fn, CompletableFuture<U> dst,
            Executor executor) {
            this.src = src;
            this.fn = fn;
            this.dst = dst;
        ...
        public final void run() {
            ...
            T t;
            Throwable ex;
            if ((dst = this.dst) != null && (fn = this.fn) != null && (a = this.src) != null &&
                (r = a.result) != null && compareAndSet(0, 1)) {
                if (r instanceof AltResult) {
                    ex = ((AltResult) r).ex;
                    t = null;
                } else {
                ...
                if (ex == null) {
                    try {
                        if (e != null) { execAsync(e, new AsyncApply<T, U>(t, fn, dst)); } else { u = fn.apply(t); }
                    } catch (Throwable rex) {
                        ex = rex;
                    }
                }
    ...
    static final class ThenAccept<T> extends Completion {
        ...
        ThenAccept(CompletableFuture<? extends T> src, Consumer<? super T> fn, CompletableFuture<?> dst,
            Executor executor) {
            this.src = src;
            this.fn = fn;
            this.dst = dst;
        ...
        public final void run() {
            ...
            if ((dst = this.dst) != null && (fn = this.fn) != null && (a = this.src) != null &&
                ...
                if (ex == null) {
                    try {
                        if (e != null) { execAsync(e, new AsyncAccept<T>(t, fn, dst)); } else { fn.accept(t); }
                    } catch (Throwable rex) {
                        ex = rex;
                    }
                }
    ...
    static final class ThenRun extends Completion {
        ...
        public final void run() {
            ...
            if ((dst = this.dst) != null && (fn = this.fn) != null && (a = this.src) != null &&
                (r = a.result) != null && compareAndSet(0, 1)) {
                if (r instanceof AltResult) { ex = ((AltResult) r).ex; } else { ex = null; }
                Executor e = executor;
                if (ex == null) {
                    try {
                        if (e != null) { execAsync(e, new AsyncRun(fn, dst)); } else { fn.run(); }
                    } catch (Throwable rex) {
                        ex = rex;
                    }
                }
    ...
    static final class ThenCombine<T, U, V> extends Completion {
        ...
        ThenCombine(CompletableFuture<? extends T> src, CompletableFuture<? extends U> snd,
            BiFunction<? super T, ? super U, ? extends V> fn, CompletableFuture<V> dst, Executor executor) {
            this.src = src;
            this.snd = snd;
            this.fn = fn;
            this.dst = dst;
        ...
        public final void run() {
            ...
            Throwable ex;
            if ((dst = this.dst) != null && (fn = this.fn) != null && (a = this.src) != null &&
                (r = a.result) != null && (b = this.snd) != null && (s = b.result) != null && compareAndSet(0, 1)) {
                if (r instanceof AltResult) {
                    ex = ((AltResult) r).ex;
                    t = null;
                } else {
                ...
                if (ex != null) { u = null; } else if (s instanceof AltResult) {
                    ex = ((AltResult) s).ex;
                    u = null;
                } else {
                    @SuppressWarnings("unchecked")
                ...
                if (ex == null) {
                    try {
                        if (e != null) { execAsync(e, new AsyncCombine<T, U, V>(t, u, fn, dst)); } else {
                            v = fn.apply(t, u);
                        }
                    } catch (Throwable rex) {
                        ex = rex;
                ...
                if (e == null || ex != null) { dst.internalComplete(v, ex); }
            }
        }
    ...
    static final class ThenAcceptBoth<T, U> extends Completion {
        ...
        ThenAcceptBoth(CompletableFuture<? extends T> src, CompletableFuture<? extends U> snd,
            BiConsumer<? super T, ? super U> fn, CompletableFuture<Void> dst, Executor executor) {
            this.src = src;
            this.snd = snd;
            this.fn = fn;
            this.dst = dst;
        ...
        public final void run() {
            ...
            if ((dst = this.dst) != null && (fn = this.fn) != null && (a = this.src) != null &&
                ...
                if (ex == null) {
                    try {
                        if (e != null) { execAsync(e, new AsyncAcceptBoth<T, U>(t, u, fn, dst)); } else {
                            fn.accept(t, u);
                        }
                    } catch (Throwable rex) {
                        ex = rex;
    ...
    static final class RunAfterBoth extends Completion {
        ...
        RunAfterBoth(CompletableFuture<?> src, CompletableFuture<?> snd, Runnable fn, CompletableFuture<Void> dst,
            Executor executor) {
            this.src = src;
            this.snd = snd;
            this.fn = fn;
    ...
    static final class AndCompletion extends Completion {
        ...
        public final void run() {
            ...
            Object r, s;
            Throwable ex;
            if ((dst = this.dst) != null && (a = this.src) != null && (r = a.result) != null &&
                (b = this.snd) != null && (s = b.result) != null && compareAndSet(0, 1)) {
                if (r instanceof AltResult) { ex = ((AltResult) r).ex; } else { ex = null; }
                if (ex == null && (s instanceof AltResult)) { ex = ((AltResult) s).ex; }
    ...
    static final class ApplyToEither<T, U> extends Completion {
        ...
        ApplyToEither(CompletableFuture<? extends T> src, CompletableFuture<? extends T> snd,
            Function<? super T, ? extends U> fn, CompletableFuture<U> dst, Executor executor) {
            this.src = src;
            this.snd = snd;
            this.fn = fn;
            this.dst = dst;
        ...
        public final void run() {
            ...
            T t;
            Throwable ex;
            if ((dst = this.dst) != null && (fn = this.fn) != null &&
                (((a = this.src) != null && (r = a.result) != null) ||
                    ((b = this.snd) != null && (r = b.result) != null)) && compareAndSet(0, 1)) {
                if (r instanceof AltResult) {
                    ex = ((AltResult) r).ex;
                    t = null;
                } else {
    ...
    static final class AcceptEither<T> extends Completion {
        ...
        AcceptEither(CompletableFuture<? extends T> src, CompletableFuture<? extends T> snd, Consumer<? super T> fn,
    ...
    static final class RunAfterEither extends Completion {
        ...
        RunAfterEither(CompletableFuture<?> src, CompletableFuture<?> snd, Runnable fn, CompletableFuture<Void> dst,
            Executor executor) {
            this.src = src;
            this.snd = snd;
            this.fn = fn;
    ...
    static final class ExceptionCompletion<T> extends Completion {
        ...
        ExceptionCompletion(CompletableFuture<? extends T> src, Function<? super Throwable, ? extends T> fn,
            CompletableFuture<T> dst) {
            this.src = src;
            this.fn = fn;
            this.dst = dst;
    ...
    static final class WhenCompleteCompletion<T> extends Completion {
        ...
        WhenCompleteCompletion(CompletableFuture<? extends T> src, BiConsumer<? super T, ? super Throwable> fn,
            CompletableFuture<T> dst, Executor executor) {
            this.src = src;
            this.fn = fn;
            this.dst = dst;
            this.executor = executor;
        ...
        public final void run() {
            ...
            if ((dst = this.dst) != null && (fn = this.fn) != null && (a = this.src) != null &&
                ...
                Throwable dx = null;
                try {
                    if (e != null) { execAsync(e, new AsyncWhenComplete<T>(t, ex, fn, dst)); } else {
                        fn.accept(t, ex);
                    }
                } catch (Throwable rex) {
                    dx = rex;
                }
                if (e == null || dx != null) { dst.internalComplete(t, ex != null ? ex : dx); }
            }
        }
    ...
    static final class HandleCompletion<T, U> extends Completion {
        ...
        HandleCompletion(CompletableFuture<? extends T> src, BiFunction<? super T, Throwable, ? extends U> fn,
        ...
        public final void run() {
            ...
            if ((dst = this.dst) != null && (fn = this.fn) != null && (a = this.src) != null &&
                ...
                Throwable dx = null;
                try {
                    if (e != null) { execAsync(e, new AsyncCombine<T, Throwable, U>(t, ex, fn, dst)); } else {
                        u = fn.apply(t, ex);
                    }
                } catch (Throwable rex) {
                    dx = rex;
                }
                if (e == null || dx != null) { dst.internalComplete(u, dx); }
            }
        }
    ...
    static final class ThenCompose<T, U> extends Completion {
        ...
        ThenCompose(CompletableFuture<? extends T> src, Function<? super T, ? extends CompletionStage<U>> fn,
            CompletableFuture<U> dst, Executor executor) {
            this.src = src;
            this.fn = fn;
            this.dst = dst;
        ...
        public final void run() {
            ...
            if ((dst = this.dst) != null && (fn = this.fn) != null && (a = this.src) != null &&
                ...
                if (ex == null) {
                    if ((e = executor) != null) { execAsync(e, new AsyncCompose<T, U>(t, fn, dst)); } else {
                        try {
                            CompletionStage<U> cs = fn.apply(t);
                            c = (cs == null) ? null : cs.toCompletableFuture();
                            if (c == null) { ex = new NullPointerException(); }
                        } catch (Throwable rex) {
                            ex = rex;
                        }
                    }
    ...
    private CompletableFuture<Void> doThenRun(Runnable action, Executor e) {
        ...
        if (r != null && (d == null || d.compareAndSet(0, 1))) {
            ...
            if (ex == null) {
                try {
                    if (e != null) { execAsync(e, new AsyncRun(action, dst)); } else { action.run(); }
                } catch (Throwable rex) {
                    ex = rex;
                }
            }
    ...
    private <U, V> CompletableFuture<V> doThenCombine(CompletableFuture<? extends U> other,
        BiFunction<? super T, ? super U, ? extends V> fn, Executor e) {
    ...
    private <U> CompletableFuture<Void> doThenAcceptBoth(CompletableFuture<? extends U> other,
        BiConsumer<? super T, ? super U> fn, Executor e) {
        if (other == null || fn == null) { throw new NullPointerException(); }
        CompletableFuture<Void> dst = new CompletableFuture<Void>();
        ...
        if (r != null && s != null && (d == null || d.compareAndSet(0, 1))) {
            ...
            if (ex == null) {
                try {
                    if (e != null) { execAsync(e, new AsyncAcceptBoth<T, U>(t, u, fn, dst)); } else { fn.accept(t, u); }
                } catch (Throwable rex) {
                    ex = rex;
                }
            }
    ...
    private <U> CompletableFuture<U> doApplyToEither(CompletableFuture<? extends T> other, Function<? super T, U> fn,
        Executor e) {
        if (other == null || fn == null) { throw new NullPointerException(); }
        CompletableFuture<U> dst = new CompletableFuture<U>();
    ...
    private CompletableFuture<Void> doAcceptEither(CompletableFuture<? extends T> other, Consumer<? super T> fn,
        Executor e) {
        if (other == null || fn == null) { throw new NullPointerException(); }
        CompletableFuture<Void> dst = new CompletableFuture<Void>();
    ...
    private <U> CompletableFuture<U> doThenCompose(Function<? super T, ? extends CompletionStage<U>> fn, Executor e) {
        if (fn == null) { throw new NullPointerException(); }
        ...
        if (r != null && (d == null || d.compareAndSet(0, 1))) {
            ...
            if (ex == null) {
                if (e != null) {
                    if (dst == null) { dst = new CompletableFuture<U>(); }
                    execAsync(e, new AsyncCompose<T, U>(t, fn, dst));
                } else {
                    try {
                        CompletionStage<U> cs = fn.apply(t);
                        if (cs == null || (dst = cs.toCompletableFuture()) == null) { ex = new NullPointerException(); }
                    } catch (Throwable rex) {
                        ex = rex;
                    }
                }
    ...
    private CompletableFuture<T> doWhenComplete(BiConsumer<? super T, ? super Throwable> fn, Executor e) {
        if (fn == null) { throw new NullPointerException(); }
        CompletableFuture<T> dst = new CompletableFuture<T>();
        WhenCompleteCompletion<T> d = null;
        Object r;
        if ((r = result) == null) {
            CompletionNode p = new CompletionNode(d = new WhenCompleteCompletion<T>(this, fn, dst, e));
            while ((r = result) == null) {
                if (UNSAFE.compareAndSwapObject(this, COMPLETIONS, p.next = completions, p)) { break; }
            }
        }
        if (r != null && (d == null || d.compareAndSet(0, 1))) {
            ...
            Throwable dx = null;
            try {
                if (e != null) { execAsync(e, new AsyncWhenComplete<T>(t, ex, fn, dst)); } else { fn.accept(t, ex); }
            } catch (Throwable rex) {
                dx = rex;
            }
            if (e == null || dx != null) { dst.internalComplete(t, ex != null ? ex : dx); }
    ...
    private <U> CompletableFuture<U> doHandle(BiFunction<? super T, Throwable, ? extends U> fn, Executor e) {
        if (fn == null) { throw new NullPointerException(); }
        CompletableFuture<U> dst = new CompletableFuture<U>();
        HandleCompletion<T, U> d = null;
        Object r;
        if ((r = result) == null) {
            CompletionNode p = new CompletionNode(d = new HandleCompletion<T, U>(this, fn, dst, e));
            while ((r = result) == null) {
                if (UNSAFE.compareAndSwapObject(this, COMPLETIONS, p.next = completions, p)) { break; }
            }
        }
    ...
    public static <U> CompletableFuture<U> supplyAsync(Supplier<U> supplier, Executor executor) {
        if (executor == null || supplier == null) { throw new NullPointerException(); }
        CompletableFuture<U> f = new CompletableFuture<U>();
    ...
    public static CompletableFuture<Void> runAsync(Runnable runnable, Executor executor) {
        if (executor == null || runnable == null) { throw new NullPointerException(); }
        CompletableFuture<Void> f = new CompletableFuture<Void>();
    ...
    public T get() throws InterruptedException, ExecutionException {
        Object r;
        Throwable ex, cause;
        if ((r = result) == null && (r = waitingGet(true)) == null) { throw new InterruptedException(); }
        if (!(r instanceof AltResult)) {
            @SuppressWarnings("unchecked")
            T tr = (T) r;
            return tr;
    ...
    public T getNow(T valueIfAbsent) {
        Object r;
        Throwable ex;
        if ((r = result) == null) { return valueIfAbsent; }
        if (!(r instanceof AltResult)) {
            @SuppressWarnings("unchecked")
            T tr = (T) r;
            return tr;
    ...
    public boolean complete(T value) {
        boolean triggered = result == null &&
            UNSAFE.compareAndSwapObject(this, RESULT, null, value == null ? NIL : value);
        postComplete();
        return triggered;
    }
    ...
    public <U, V> CompletableFuture<V> thenCombineAsync(CompletionStage<? extends U> other,
        BiFunction<? super T, ? super U, ? extends V> fn) {
        return doThenCombine(other.toCompletableFuture(), fn, ForkJoinPool.commonPool());
    }
    ...
    public <U> CompletableFuture<Void> thenAcceptBothAsync(CompletionStage<? extends U> other,
        BiConsumer<? super T, ? super U> action) {
        return doThenAcceptBoth(other.toCompletableFuture(), action, ForkJoinPool.commonPool());
    }
    ...
    public CompletableFuture<Void> runAfterBothAsync(CompletionStage<?> other, Runnable action) {
        return doRunAfterBoth(other.toCompletableFuture(), action, ForkJoinPool.commonPool());
    }
    ...
    public <U> CompletableFuture<U> applyToEitherAsync(CompletionStage<? extends T> other, Function<? super T, U> fn) {
        return doApplyToEither(other.toCompletableFuture(), fn, ForkJoinPool.commonPool());
    }
    ...
    public CompletableFuture<Void> acceptEitherAsync(CompletionStage<? extends T> other, Consumer<? super T> action) {
        return doAcceptEither(other.toCompletableFuture(), action, ForkJoinPool.commonPool());
    }
    ...
    public CompletableFuture<Void> runAfterEitherAsync(CompletionStage<?> other, Runnable action) {
        return doRunAfterEither(other.toCompletableFuture(), action, ForkJoinPool.commonPool());
    }
    ...
    public static CompletableFuture<Void> allOf(CompletableFuture<?>... cfs) {
        ...
        if (len > 1) { return allTree(cfs, 0, len - 1); } else {
            CompletableFuture<Void> dst = new CompletableFuture<Void>();
            CompletableFuture<?> f;
            if (len == 0) { dst.result = NIL; } else if ((f = cfs[0]) == null) {
                ...
                while ((r = f.result) == null) {
                    if (d == null) { d = new ThenPropagate(f, dst); } else if (p == null) {
    ...
    private static CompletableFuture<Void> allTree(CompletableFuture<?>[] cfs, int lo, int hi) {
        ...
        if ((fst = (lo == mid ? cfs[lo] : allTree(cfs, lo, mid))) == null ||
            (snd = (hi == mid + 1 ? cfs[hi] : allTree(cfs, mid + 1, hi))) == null) { throw new NullPointerException(); }
        CompletableFuture<Void> dst = new CompletableFuture<Void>();
        AndCompletion d = null;
        CompletionNode p = null, q = null;
        Object r = null, s = null;
        while ((r = fst.result) == null || (s = snd.result) == null) {
            if (d == null) { d = new AndCompletion(fst, snd, dst); } else if (p == null) {
                p = new CompletionNode(d);
            } else if (q == null) {
        ...
        if ((r != null || (r = fst.result) != null) && (s != null || (s = snd.result) != null) &&
    ...
    public static CompletableFuture<Object> anyOf(CompletableFuture<?>... cfs) {
        ...
        if (len > 1) { return anyTree(cfs, 0, len - 1); } else {
            CompletableFuture<Object> dst = new CompletableFuture<Object>();
            CompletableFuture<?> f;
            if (len == 0) {
                // skip
            } else if ((f = cfs[0]) == null) { throw new NullPointerException(); } else {
                ThenCopy<Object> d = null;
                CompletionNode p = null;
                Object r;
                while ((r = f.result) == null) {
                    if (d == null) { d = new ThenCopy<Object>(f, dst); } else if (p == null) {
                        p = new CompletionNode(d);
                    } else if (UNSAFE.compareAndSwapObject(f, COMPLETIONS, p.next = f.completions, p)) { break; }
                }
                if (r != null && (d == null || d.compareAndSet(0, 1))) {
    ...
    private static CompletableFuture<Object> anyTree(CompletableFuture<?>[] cfs, int lo, int hi) {
        ...
        if ((fst = (lo == mid ? cfs[lo] : anyTree(cfs, lo, mid))) == null ||
            (snd = (hi == mid + 1 ? cfs[hi] : anyTree(cfs, mid + 1, hi))) == null) { throw new NullPointerException(); }
        CompletableFuture<Object> dst = new CompletableFuture<Object>();
        OrCompletion d = null;
        CompletionNode p = null, q = null;
        Object r;
        while ((r = fst.result) == null && (r = snd.result) == null) {
            if (d == null) { d = new OrCompletion(fst, snd, dst); } else if (p == null) {
                p = new CompletionNode(d);
            } else if (q == null) {
                if (UNSAFE.compareAndSwapObject(fst, COMPLETIONS, p.next = fst.completions, p)) {
                    q = new CompletionNode(d);
        ...
        if ((r != null || (r = fst.result) != null || (r = snd.result) != null) &&
            (d == null || d.compareAndSet(0, 1))) {
            Throwable ex;
            Object t;
            if (r instanceof AltResult) {
    ...
    public boolean cancel(boolean mayInterruptIfRunning) {
        boolean cancelled = (result == null) &&
            UNSAFE.compareAndSwapObject(this, RESULT, null, new AltResult(new CancellationException()));
        postComplete();
    ...
    public String toString() {
        Object r = result;
        int count;
        return super.toString() + ((r == null) ? (((count = getNumberOfDependents()) == 0) ? "[Not completed]"
