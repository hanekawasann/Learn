...
public class Arrays {
    ...
    public static int deepHashCode(Object[] a) {
        ...
        for (Object element : a) {
            ...
            } else if (element instanceof boolean[]) { elementHash = hashCode((boolean[]) element); } else if (
                element != null) { elementHash = element.hashCode(); }
    ...
    static boolean deepEquals0(Object e1, Object e2) {
        ...
        } else if (e1 instanceof byte[] && e2 instanceof byte[]) { eq = equals((byte[]) e1, (byte[]) e2); } else if (
            e1 instanceof short[] && e2 instanceof short[]) {
            eq = equals((short[]) e1, (short[]) e2);
        } else if (e1 instanceof int[] && e2 instanceof int[]) { eq = equals((int[]) e1, (int[]) e2); } else if (
            e1 instanceof long[] && e2 instanceof long[]) {
            eq = equals((long[]) e1, (long[]) e2);
        } else if (e1 instanceof char[] && e2 instanceof char[]) { eq = equals((char[]) e1, (char[]) e2); } else if (
