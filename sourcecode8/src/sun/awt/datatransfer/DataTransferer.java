...
public abstract class DataTransferer {
    ...
    public Object translateBytes(byte[] bytes, DataFlavor flavor, long format, Transferable localeTransferable)
        ...
        if (isFileFormat(format)) {
            ...
            CharBuffer buffer = CharBuffer.wrap(translateBytesToString(bytes, format, localeTransferable));
            ...
            if (isFlavorCharsetTextType(flavor) && isTextFormat(format)) {
                bytes = translateBytesToString(bytes, format, localeTransferable)
            ...
            try (ByteArrayInputStream bais = new ByteArrayInputStream(
                bytes); ObjectInputStream ois = new ObjectInputStream(bais)) {
    ...
    public Object translateStream(InputStream str, DataFlavor flavor, long format, Transferable localeTransferable)
        ...
        if (isURIListFormat(format) && DataFlavor.javaFileListFlavor.equals(flavor)) {
            ...
            theObject = new StringReader(
                translateBytesToString(inputStreamToByteArray(str), format, localeTransferable));
            ...
            InputStream is = (InputStream) translateStreamToInputStream(str, DataFlavor.plainTextFlavor, format,
                localeTransferable);
     ...
     */
    private Object translateStreamToInputStream(InputStream str, DataFlavor flavor, long format,
