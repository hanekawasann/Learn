...
public abstract class CustomCursor extends Cursor {
    ...
    public CustomCursor(Image cursor, Point hotSpot, String name) throws IndexOutOfBoundsException {
        ...
        if (nativeSize.width != width || nativeSize.height != height) {
            cursor = cursor.getScaledInstance(nativeSize.width, nativeSize.height, Image.SCALE_DEFAULT);
    ...
    protected abstract void createNativeCursor(Image im, int[] pixels, int width, int height, int xHotSpot,
        int yHotSpot);
}
