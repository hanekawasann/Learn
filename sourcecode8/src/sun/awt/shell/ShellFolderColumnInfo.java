...
public class ShellFolderColumnInfo {
    ...
    public ShellFolderColumnInfo(String title, Integer width, Integer alignment, boolean visible, SortOrder sortOrder,
     ...
     */
    public ShellFolderColumnInfo(String title, int width, int alignment, boolean visible) {
