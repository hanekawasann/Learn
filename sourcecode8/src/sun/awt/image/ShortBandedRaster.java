...
public class ShortBandedRaster extends SunWritableRaster {
     ...
     */
    public ShortBandedRaster(SampleModel sampleModel, DataBuffer dataBuffer, Rectangle aRegion, Point origin,
    ...
    public WritableRaster createWritableChild(int x, int y, int width, int height, int x0, int y0, int bandList[]) {
        ...
        return new ShortBandedRaster(sm, dataBuffer, new Rectangle(x0, y0, width, height),
    ...
    public String toString() {
        return new String("ShortBandedRaster: width = " + width + " height = " + height + " #numBands " + numBands +
