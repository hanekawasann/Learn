...
public class ImageRepresentation extends ImageWatched implements ImageConsumer {
    ...
    private native boolean setICMpixels(int x, int y, int w, int h, int[] lut, byte[] pix, int off, int scansize,
        IntegerComponentRaster ict);

    private native boolean setDiffICM(int x, int y, int w, int h, int[] lut, int transPix, int numLut,
        IndexColorModel icm, byte[] pix, int off, int scansize, ByteComponentRaster bct, int chanOff);
