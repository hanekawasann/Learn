...
public class ShortComponentRaster extends SunWritableRaster {
     ...
     */
    public ShortComponentRaster(SampleModel sampleModel, DataBuffer dataBuffer, Rectangle aRegion, Point origin,
        ...
        if (sampleModel instanceof ComponentSampleModel) {
            ...
            throw new RasterFormatException(
                "ShortComponentRasters must have" + "ComponentSampleModel or SinglePixelPackedSampleModel");
        }
    ...
    public WritableRaster createWritableChild(int x, int y, int width, int height, int x0, int y0, int[] bandList) {
        ...
        return new ShortComponentRaster(sm, dataBuffer, new Rectangle(x0, y0, width, height),
    ...
    public String toString() {
        return new String(
            "ShortComponentRaster: width = " + width + " height = " + height + " #numDataElements " + numDataElements);
