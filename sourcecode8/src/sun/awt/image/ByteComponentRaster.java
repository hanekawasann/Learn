...
public class ByteComponentRaster extends SunWritableRaster {
     ...
     */
    public ByteComponentRaster(SampleModel sampleModel, DataBuffer dataBuffer, Rectangle aRegion, Point origin,
        ...
        if (sampleModel instanceof ComponentSampleModel) {
            ...
            for (int i = 0; i < getNumDataElements(); i++) {
                dataOffsets[i] += dbOffset + xOffset * pixelStride + yOffset * scanlineStride;
            }
            ...
            throw new RasterFormatException(
                "IntegerComponentRasters must " + "have ComponentSampleModel or SinglePixelPackedSampleModel");
        }
            ...
            if (numDataElements == 1) {
                ...
                if (pixelStride == bct.getPixelStride()) {
                    ...
                    for (int tmpY = 0; tmpY < height; tmpY++) {
                        System.arraycopy(bdata, srcOffset, data, dstOffset, width);
                        srcOffset += tss;
    ...
    public void setDataElements(int x, int y, int w, int h, Object obj) {
        ...
        if (numDataElements == 1) {
            ...
            for (ystart = 0; ystart < h; ystart++) {
                xoff = yoff;
                System.arraycopy(inData, srcOffset, data, dstOffset, w);
    ...
    public WritableRaster createWritableChild(int x, int y, int width, int height, int x0, int y0, int[] bandList) {
        ...
        return new ByteComponentRaster(sm, dataBuffer, new Rectangle(x0, y0, width, height),
    ...
    public String toString() {
        return new String(
            "ByteComponentRaster: width = " + width + " height = " + height + " #numDataElements " + numDataElements
