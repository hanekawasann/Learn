...
public final class AWTAccessor {
    ...
    public interface KeyboardFocusManagerAccessor {
         ...
         */
        int shouldNativelyFocusHeavyweight(Component heavyweight, Component descendant, boolean temporary,
         ...
         * synchronously.
         */
        boolean processSynchronousLightweightTransfer(Component heavyweight, Component descendant, boolean temporary,
    ...
    public interface EventQueueAccessor {
         ...
         */
        void invokeAndWait(Object source, Runnable r) throws InterruptedException, InvocationTargetException;
    ...
    public interface ScrollPaneAdjustableAccessor {
         ...
         */
        void setTypedValue(final ScrollPaneAdjustable adj, final int v, final int type);
    }
