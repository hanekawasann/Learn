...
abstract class InputMethodPopupMenu implements ActionListener {
    ...
    abstract void addMenuItem(Object targetMenu, String label, String command, String currentSelection);
    ...
    String getLocaleName(Locale locale) {
        ...
        if (localeName == null) {
            ...
            if (localeName == null || localeName.length() == 0) { localeName = localeString; }
        }
        return localeName;
    }
