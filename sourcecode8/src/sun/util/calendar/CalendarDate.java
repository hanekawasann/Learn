...
public abstract class CalendarDate implements Cloneable {
     ...
     * <code>null</code>.
     *
     * @throws NullPointerException     if the calendar system for this
    ...
    public boolean isSameDate(CalendarDate date) {
        return getDayOfWeek() == date.getDayOfWeek() && getMonth() == date.getMonth() && getYear() == date.getYear() &&
            getEra() == date.getEra();
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (getEra() == that.getEra() && year == that.year && month == that.month &&
            dayOfMonth == that.dayOfMonth && hours == that.hours && minutes == that.minutes &&
            seconds == that.seconds && millis == that.millis && zoneOffset == that.zoneOffset);
    }
