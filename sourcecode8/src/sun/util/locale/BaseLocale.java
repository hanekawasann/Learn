...
public final class BaseLocale {
    ...
    public boolean equals(Object obj) {
        ...
        return language == other.language && script == other.script && region == other.region &&
    ...
    private static final class Key implements Comparable<Key> {
        ...
        private Key(String language, String region) {
            assert language.intern() == language && region.intern() == region;
        ...
        @Override
        public boolean equals(Object obj) {
            return (this == obj) || (obj instanceof Key) && this.hash == ((Key) obj).hash &&
