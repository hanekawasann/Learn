...
public final class TimeZoneNameUtility {
    ...
    private static class TimeZoneNameArrayGetter
        ...
        @Override
        public String[] getObject(TimeZoneNameProvider timeZoneNameProvider, Locale locale, String requestID,
            Object... params) {
        ...
        private static String[] examineAliases(TimeZoneNameProvider tznp, Locale locale, String id,
    ...
    private static class TimeZoneNameGetter
        ...
        private static String examineAliases(TimeZoneNameProvider tznp, Locale locale, String requestID, String tzid,
            int style, Map<String, String> aliases) {
        ...
        private static String getName(TimeZoneNameProvider timeZoneNameProvider, Locale locale, String requestID,
            int style, String tzid) {
            String value = null;
            switch (requestID) {
                case "std":
