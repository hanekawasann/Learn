...
public class LocaleResources {
    ...
    int getCalendarData(String key) {
        ...
        if (data == null || ((caldata = (Integer) data.get()) == null)) {
            ...
            cache.put(cacheKey, new ResourceReference(cacheKey, (Object) caldata, referenceQueue));
        }
    ...
    public String getCurrencyName(String key) {
        ...
        if (olrb.containsKey(key)) {
            ...
            cache.put(cacheKey, new ResourceReference(cacheKey, currencyName, referenceQueue));
        }
    ...
    public String getLocaleName(String key) {
        ...
        if (olrb.containsKey(key)) {
            ...
            cache.put(cacheKey, new ResourceReference(cacheKey, localeName, referenceQueue));
        }
    ...
    String[] getTimeZoneNames(String key, int size) {
        ...
        if (data == null || ((names = (String[]) data.get()) == null)) {
            ...
            if (tznb.containsKey(key)) {
                ...
                cache.put(cacheKey, new ResourceReference(cacheKey, (Object) names, referenceQueue));
            }
        }
    ...
    Set<String> getZoneIDs() {
        ...
        if (data == null || ((zoneIDs = (Set<String>) data.get()) == null)) {
            ...
            zoneIDs = rb.keySet();
            cache.put(ZONE_IDS_CACHEKEY, new ResourceReference(ZONE_IDS_CACHEKEY, (Object) zoneIDs, referenceQueue));
        }
    ...
    private String getDateTimePattern(String prefix, String key, int styleIndex, String calendarType) {
        ...
        if (data == null || ((value = data.get()) == null)) {
            ...
            cache.put(cacheKey, new ResourceReference(cacheKey, value, referenceQueue));
        }
        if (value == NULLOBJECT) {
            assert prefix != null;
            return null;
