...
public final class LocaleServiceProviderPool {
    ...
    static final Class<LocaleServiceProvider>[] spiClasses = (Class<LocaleServiceProvider>[]) new Class<?>[] {
        java.text.spi.BreakIteratorProvider.class, java.text.spi.CollatorProvider.class,
        java.text.spi.DateFormatProvider.class, java.text.spi.DateFormatSymbolsProvider.class,
        java.text.spi.DecimalFormatSymbolsProvider.class, java.text.spi.NumberFormatProvider.class,
        java.util.spi.CurrencyNameProvider.class, java.util.spi.LocaleNameProvider.class,
        java.util.spi.TimeZoneNameProvider.class, java.util.spi.CalendarDataProvider.class };
    ...
    boolean hasProviders() {
        return providers.size() != 1 || (providers.get(LocaleProviderAdapter.Type.JRE) == null &&
     ...
     */
    public <P extends LocaleServiceProvider, S> S getLocalizedObject(LocalizedObjectGetter<P, S> getter, Locale locale,
        Object... params) {
    ...
    private <P extends LocaleServiceProvider, S> S getLocalizedObjectImpl(LocalizedObjectGetter<P, S> getter,
        Locale locale, boolean isObjectProvider, String key, Object... params) {
        if (locale == null) {
        ...
        if (!hasProviders()) {
            return getter
                .getObject((P) providers.get(LocaleProviderAdapter.defaultLocaleProviderAdapter), locale, key, params);
        }
    ...
    static Locale getLookupLocale(Locale locale) {
        ...
        if (locale.hasExtensions() && !locale.equals(JRELocaleConstants.JA_JP_JP) &&
