...
public abstract class SynthFileChooserUI extends BasicFileChooserUI implements SynthUI {
    ...
    public SynthContext getContext(JComponent c) {
        return new SynthContext(c, Region.FILE_CHOOSER, style, getComponentState(c));
    }
    ...
    public void update(Graphics g, JComponent c) {
        ...
        style.getPainter(context).paintFileChooserBackground(context, g, 0, 0, c.getWidth(), c.getHeight());
        paint(context, g);
    }
    ...
    private static boolean isGlobPattern(String fileName) {
        return ((File.separatorChar == '\\' && fileName.indexOf('*') >= 0) || (File.separatorChar == '/' &&
