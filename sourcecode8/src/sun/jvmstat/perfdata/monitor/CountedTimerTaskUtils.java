...
public class CountedTimerTaskUtils {
     ...
     */
    public static void reschedule(Timer timer, CountedTimerTask oldTask, CountedTimerTask newTask, int oldInterval,
        int newInterval) {
        ...
        if (DEBUG) {
            System.err.println(
                "computing timer delay: " + " oldInterval = " + oldInterval + " newInterval = " + newInterval +
                    " samples = " + oldTask.executionCount() + " expired = " + expired);
        }
