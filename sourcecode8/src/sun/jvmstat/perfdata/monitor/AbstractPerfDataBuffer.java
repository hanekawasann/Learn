...
public abstract class AbstractPerfDataBuffer {
    ...
    protected void createPerfDataBuffer(ByteBuffer bb, int lvmid) throws MonitorException {
        ...
        try {
            ...
            Constructor cons = implClass
                .getConstructor(new Class[] { Class.forName("java.nio.ByteBuffer"), Integer.TYPE });
            ...
            throw new IllegalArgumentException("Expected constructor missing in " + classname + ": " + e.getMessage(),
                e);

        } catch (IllegalAccessException e) {
            // from Constructor.newInstance()
            throw new IllegalArgumentException("Unexpected constructor access in " + classname + ": " + e.getMessage(),
                e);
