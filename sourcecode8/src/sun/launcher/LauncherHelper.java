...
public enum LauncherHelper {
     ...
     *    line entirely.
     */
    static void showSettings(boolean printToStderr, String optionFlag, long initialHeapSize, long maxHeapSize,
        ...
        switch (optStr) {
            case "vm":
                printVmSettings(initialHeapSize, maxHeapSize, stackSize, isServer);
                break;
            case "properties":
                printProperties();
                break;
     ...
     */
    private static void printVmSettings(long initialHeapSize, long maxHeapSize, long stackSize, boolean isServer) {
        ...
        if (maxHeapSize != 0L) {
            ...
            ostream.println(
                INDENT + "Max. Heap Size (Estimated): " + SizePrefix.scaleValue(Runtime.getRuntime().maxMemory()));
        }
    ...
    private enum SizePrefix {
        ...
        private static String scale(long v, SizePrefix prefix) {
            return BigDecimal.valueOf(v).divide(BigDecimal.valueOf(prefix.size), 2, RoundingMode.HALF_EVEN)
                .toPlainString() + prefix.abbrev;
        }
    ...
    static String getMainClassFromJar(String jarname) {
        ...
        try (JarFile jarFile = new JarFile(jarname)) {
             ...
             */
            if (mainAttrs.containsKey(new Attributes.Name(FXHelper.JAVAFX_APPLICATION_MARKER))) {
    ...
    public static Class<?> checkAndLoadMain(boolean printToStderr, int mode, String what) {
         ...
         */
        if (mainClass.equals(FXHelper.class) || FXHelper.doesExtendFXApplication(mainClass)) {
    ...
    static void validateMainClass(Class<?> mainClass) {
        ...
        try {
            ...
            abort(null, "java.launcher.cls.error4", mainClass.getName(), FXHelper.JAVAFX_APPLICATION_CLASS_NAME);
        ...
        if (!Modifier.isStatic(mod)) {
            abort(null, "java.launcher.cls.error2", "static", mainMethod.getDeclaringClass().getName());
        }
        if (mainMethod.getReturnType() != java.lang.Void.TYPE) {
            abort(null, "java.launcher.cls.error3", mainMethod.getDeclaringClass().getName());
        }
    }
    ...
    static final class FXHelper {
        ...
        private static void setFXLaunchParameters(String what, int mode) {
            ...
            try {
                 ...
                 */
                fxLauncherMethod = fxLauncherClass
                    .getMethod("launchApplication", String.class, String.class, String[].class);
        ...
        public static void main(String... args) throws Exception {
            ...
            fxLauncherMethod.invoke(null, new Object[] { fxLaunchName, fxLaunchMode, args });
        }
    }
}
