...
public class TypeVariableImpl<D extends GenericDeclaration> extends LazyReflectiveObjectGenerator
     ...
     * specified
     */
    public static <T extends GenericDeclaration> TypeVariableImpl<T> make(T decl, String name, FieldTypeSignature[] bs,
        GenericsFactory f) {
    ...
    public D getGenericDeclaration() {
        ...
        } else { throw new AssertionError("Unexpected kind of GenericDeclaration"); }
    ...
    public Annotation[] getAnnotations() {
        ...
        if (myIndex < 0) { throw new AssertionError("Index must be non-negative."); }
