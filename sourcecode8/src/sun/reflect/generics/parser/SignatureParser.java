...
public class SignatureParser {
    ...
    private void progress(int startingPosition) {
        if (index <= startingPosition) { throw error("Failure to make progress!"); }
    }
    ...
    private ClassSignature parseClassSignature() {
        ...
        return ClassSignature
            .make(parseZeroOrMoreFormalTypeParameters(), parseClassTypeSignature(), // Only rule for SuperclassSignature
    ...
    private FieldTypeSignature parseFieldTypeSignature(boolean allowArrays) {
        switch (current()) {
            ...
            case '[':
                if (allowArrays) { return parseArrayTypeSignature(); } else {
