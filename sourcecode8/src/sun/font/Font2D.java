...
public abstract class Font2D {
    ...
    private static final String[] boldItalicNames = { "bolditalic", "bold-italic", "bold italic", "boldoblique",
        "bold-oblique", "bold oblique", "demibold italic", "negreta cursiva", "demi oblique", };
    ...
    public FontStrike getStrike(Font font, AffineTransform devTx, int aa, int fm) {
        ...
        if (glyphTx.getTranslateX() != 0 || glyphTx.getTranslateY() != 0) {
            glyphTx
                .setTransform(glyphTx.getScaleX(), glyphTx.getShearY(), glyphTx.getShearX(), glyphTx.getScaleY(), 0.0,
                    0.0);
        }
    ...
    private FontStrike getStrike(FontStrikeDesc desc, boolean copy) {
        ...
        if (strike != null && desc.equals(strike.desc)) {
            ...
            if (txType == AffineTransform.TYPE_GENERAL_TRANSFORM ||
                (txType & AffineTransform.TYPE_GENERAL_ROTATION) != 0 && strikeCache.size() > 10) {
