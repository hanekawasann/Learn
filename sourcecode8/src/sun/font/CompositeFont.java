...
public final class CompositeFont extends Font2D {
    ...
    /* See isStdComposite() for when/how this is used */ boolean isStdComposite = true;

    public CompositeFont(String name, String[] compFileNames, String[] compNames, int metricsSlotCnt, int[] exclRanges,
        int[] maxIndexes, boolean defer, SunFontManager fm) {
        ...
        synchronized (fm) {
            ...
            if (components[slot] == null) {
                ...
                if (componentNames[slot] == null) {
                    ...
                    components[slot] = (PhysicalFont) fm
                        .findFont2D(componentNames[slot], style, FontManager.PHYSICAL_FALLBACK);
                }
            }
    ...
    public String toString() {
        String ls = (String) java.security.AccessController
