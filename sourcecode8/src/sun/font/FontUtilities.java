...
public final class FontUtilities {
    ...
    public static boolean isNonSimpleChar(char ch) {
        return isComplexCharCode(ch) ||
            (ch >= CharToGlyphMapper.HI_SURROGATE_START && ch <= CharToGlyphMapper.LO_SURROGATE_END);
    }
     ...
     * logical font name.
     */
    private static final String[][] nameMap = { { "sans", "sansserif" }, { "sans-serif", "sansserif" },
        { "serif", "serif" }, { "monospace", "monospaced" } };
    ...
    public static boolean textLayoutIsCompatible(Font font) {
        ...
        if (font2D instanceof TrueTypeFont) {
            ...
            return ttf.getDirectoryEntry(TrueTypeFont.GSUBTag) == null ||
