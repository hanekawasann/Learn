...
public class UnicodeSet implements UnicodeMatcher {
     ...
     * @throws java.lang.IllegalArgumentException if the pattern contains
     *                                            a syntax error.
     * @stable ICU 2.0
     */
     ...
     *
     * @param pattern a string specifying what characters are in the set
     * @throws java.lang.IllegalArgumentException if the pattern
     ...
     * @throws java.lang.IllegalArgumentException if the parse fails.
     */
    ...
    void applyPattern(RuleCharacterIterator chars, SymbolTable symbols, StringBuffer rebuiltPat, int options) {
        ...
        while (mode != 2 && !chars.atEnd()) {
            if (false) {
                // Debugging assertion
                if (!((lastItem == 0 && op == 0) || (lastItem == 1 && (op == 0 || op == '-')) ||
