...
final class UCharacterPropertyReader implements ICUBinary.Authenticate {
    ...
    public boolean isDataVersionAcceptable(byte version[]) {
        return version[0] == DATA_FORMAT_VERSION_[0] && version[2] == DATA_FORMAT_VERSION_[2] &&
     ...
     * @throws IOException throw if data file fails authentication
     */
    ...
    protected void read(UCharacterProperty ucharppty) throws IOException {
        ...
        ucharppty.m_unicodeVersion_ = VersionInfo
            .getInstance((int) m_unicodeVersion_[0], (int) m_unicodeVersion_[1], (int) m_unicodeVersion_[2],
                (int) m_unicodeVersion_[3]);
    }
     ...
     */
    private static final byte DATA_FORMAT_VERSION_[] = { (byte) 0x5, (byte) 0, (byte) Trie.INDEX_STAGE_1_SHIFT_,
