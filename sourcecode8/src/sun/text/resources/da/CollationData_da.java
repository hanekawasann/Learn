...
public class CollationData_da extends ListResourceBundle {
    ...
    protected final Object[][] getContents() {
        return new Object[][] { { "Rule", "& A;\u00C1;\u00C0;\u00C2,a;\u00E1;\u00E0;\u00E2"
            // A; A-acute; A-grave; A-circ, a; a-acute, a-grave, a-circ
            + "<B,b" + "<C;\u00c7,c;\u00e7" // c-cedill
            ...
            + "<F,f <G,g <H,h" + "<I;\u00CD,i;\u00ED" // i-acute
            + "<J,j <K,k <L,l <M,m <N,n" + "<O;\u00D3;\u00d4,o;\u00F3;\u00f4" // o-acute, o-circ
            + "<P,p <Q,q <R,r <S,s <T,t" + "<U,u <V,v <W,w <X,x" + "<Y;\u00DD;U\u0308,y;\u00FD;u\u0308"
            // y-acute, u-diaeresis
            + "<Z,z"
