...
public class ServiceDialog extends JDialog implements ActionListener {
     ...
     * tabs)
     */
    public ServiceDialog(GraphicsConfiguration gc, int x, int y, PrintService[] services, int defaultServiceIndex,
        DocFlavor flavor, PrintRequestAttributeSet attributes, Dialog dialog) {
     ...
     */
    public ServiceDialog(GraphicsConfiguration gc, int x, int y, PrintService[] services, int defaultServiceIndex,
        DocFlavor flavor, PrintRequestAttributeSet attributes, Frame frame) {
     ...
     */
    void initPrintDialog(int x, int y, PrintService[] services, int defaultServiceIndex, DocFlavor flavor,
     ...
     */
    public ServiceDialog(GraphicsConfiguration gc, int x, int y, PrintService ps, DocFlavor flavor,
    ...
    public static void showNoPrintService(GraphicsConfiguration gc) {
        ...
        JOptionPane.showMessageDialog(dlgFrame, getMsg("dialog.noprintermsg"));
        dlgFrame.dispose();
    }
    ...
    private class PrintServicePanel extends JPanel implements ActionListener, ItemListener, PopupMenuListener {
        ...
        public PrintServicePanel() {
            ...
            c.gridwidth = 1;
            addToGB(new JLabel(getMsg("label.info"), JLabel.TRAILING), this, gridbag, c);
            c.gridwidth = GridBagConstraints.RELATIVE;
            lblInfo = new JLabel();
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (source == btnProperties) {
                if (uiFactory != null) {
                    JDialog dialog = (JDialog) uiFactory
                        .getUI(ServiceUIFactory.MAIN_UIROLE, ServiceUIFactory.JDIALOG_UI);
                    ...
                    if (dialog != null) {
                        ...
                        try {
                            docPropertiesUI = (DocumentPropertiesUI) uiFactory
                                .getUI(DocumentPropertiesUI.DOCUMENTPROPERTIES_ROLE,
                                    DocumentPropertiesUI.DOCPROPERTIESCLASSNAME);
                        } catch (Exception ex) {
                        }
                        if (docPropertiesUI != null) {
                            PrinterJobWrapper wrapper = (PrinterJobWrapper) asCurrent.get(PrinterJobWrapper.class);
                            if (wrapper == null) {
                            ...
                            PrintRequestAttributeSet newAttrs = docPropertiesUI
                                .showDocumentProperties(job, ServiceDialog.this, psCurrent, asCurrent);
                            if (newAttrs != null) {
            ...
            if (e.getStateChange() == ItemEvent.SELECTED) {
                ...
                if ((index >= 0) && (index < services.length)) {
                    if (!services[index].equals(psCurrent)) {
                        ...
                        Destination dest = (Destination) asOriginal.get(Destination.class);
                        // to preserve the state of Print To File
                        if ((dest != null || isPrintToFileSelected()) &&
                            psCurrent.isAttributeCategorySupported(Destination.class)) {
        ...
        public void updateInfo() {
            ...
            boolean dstAllowed = filePermission ? allowedToPrintToFile() : false;
            ...
            cbPrintToFile.setSelected(dstSelected && dstAllowed && dstSupported);
            ...
            Attribute status = psCurrent.getAttribute(PrinterIsAcceptingJobs.class);
            if (status != null) {
    ...
    private class PrintRangePanel extends JPanel implements ActionListener, FocusListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            } else if (source == rbPages || source == tfRangeFrom || source == tfRangeTo) {
        ...
        public void updateInfo() {
            ...
            if (psCurrent.isAttributeCategorySupported(prCategory) || isAWT) {
                prSupported = true;
            }
            ...
            if (isAWT) {
                select = (SunPageSelection) asCurrent.get(SunPageSelection.class);
            }
    ...
    private class CopiesPanel extends JPanel implements ActionListener, ChangeListener {
        ...
        public void updateInfo() {
            ...
            CopiesSupported cs = (CopiesSupported) psCurrent.getSupportedAttributeValues(cpCategory, null, null);
            if (cs == null) {
    ...
    private class MarginsPanel extends JPanel implements ActionListener, FocusListener {
        ...
        private MediaPrintableArea validateMargins(float lm, float rm, float tm, float bm) {
            ...
            if (media != null) {
                ...
                Object values = psCurrent.getSupportedAttributeValues(mpaCategory, docFlavor, tmpASet);
            ...
            if (paw <= 0f || pah <= 0f || pax < 0f || pay < 0f || pax < mpaMax.getX(units) ||
                paw > mpaMax.getWidth(units) || pay < mpaMax.getY(units) || pah > mpaMax.getHeight(units)) {
                return null;
            } else {
    ...
    private class MediaPanel extends JPanel implements ItemListener {
        ...
        public void updateInfo() {
            ...
            if (psCurrent.isAttributeCategorySupported(mdCategory)) {
                ...
                Object values = psCurrent.getSupportedAttributeValues(mdCategory, docFlavor, asCurrent);
            ...
            if (mediaSupported) {
                ...
                if (medium == null || !psCurrent.isAttributeValueSupported(medium, docFlavor, asCurrent)) {
    ...
    private class OrientationPanel extends JPanel implements ActionListener {
        ...
        private IconRadioButton rbPortrait, rbLandscape, rbRevPortrait, rbRevLandscape;
        private MarginsPanel pnlMargins = null;
        ...
        public OrientationPanel() {
            ...
            ButtonGroup bg = new ButtonGroup();
            rbPortrait = new IconRadioButton("radiobutton.portrait", "orientPortrait.png", true, bg, this);
            rbPortrait.addActionListener(this);
            addToGB(rbPortrait, this, gridbag, c);
            rbLandscape = new IconRadioButton("radiobutton.landscape", "orientLandscape.png", false, bg, this);
            rbLandscape.addActionListener(this);
            addToGB(rbLandscape, this, gridbag, c);
            rbRevPortrait = new IconRadioButton("radiobutton.revportrait", "orientRevPortrait.png", false, bg, this);
            rbRevPortrait.addActionListener(this);
            addToGB(rbRevPortrait, this, gridbag, c);
            rbRevLandscape = new IconRadioButton("radiobutton.revlandscape", "orientRevLandscape.png", false, bg, this);
        ...
        public void updateInfo() {
            ...
            if (isAWT) {
                pSupported = true;
                lSupported = true;
            } else if (psCurrent.isAttributeCategorySupported(orCategory)) {
                Object values = psCurrent.getSupportedAttributeValues(orCategory, docFlavor, asCurrent);
            ...
            OrientationRequested or = (OrientationRequested) asCurrent.get(orCategory);
            if (or == null || !psCurrent.isAttributeValueSupported(or, docFlavor, asCurrent)) {
                ...
                if ((or != null) && !psCurrent.isAttributeValueSupported(or, docFlavor, asCurrent)) {
                    ...
                    Object values = psCurrent.getSupportedAttributeValues(orCategory, docFlavor, asCurrent);
                    if (values instanceof OrientationRequested[]) {
                        OrientationRequested[] orValues = (OrientationRequested[]) values;
    ...
    private class ChromaticityPanel extends JPanel implements ActionListener {
        ...
        public void updateInfo() {
            ...
            if (isAWT) {
                monoSupported = true;
                colorSupported = true;
            } else if (psCurrent.isAttributeCategorySupported(chCategory)) {
                Object values = psCurrent.getSupportedAttributeValues(chCategory, docFlavor, asCurrent);
    ...
    private class QualityPanel extends JPanel implements ActionListener {
        ...
        public void updateInfo() {
            ...
            if (isAWT) {
                ...
                highSupported = true;
            } else if (psCurrent.isAttributeCategorySupported(pqCategory)) {
                Object values = psCurrent.getSupportedAttributeValues(pqCategory, docFlavor, asCurrent);
    ...
    private class SidesPanel extends JPanel implements ActionListener {
        ...
        public SidesPanel() {
            ...
            ButtonGroup bg = new ButtonGroup();
            rbOneSide = new IconRadioButton("radiobutton.oneside", "oneside.png", true, bg, this);
            rbOneSide.addActionListener(this);
            addToGB(rbOneSide, this, gridbag, c);
            rbTumble = new IconRadioButton("radiobutton.tumble", "tumble.png", false, bg, this);
            rbTumble.addActionListener(this);
            addToGB(rbTumble, this, gridbag, c);
            rbDuplex = new IconRadioButton("radiobutton.duplex", "duplex.png", false, bg, this);
        ...
        public void updateInfo() {
            ...
            if (psCurrent.isAttributeCategorySupported(sdCategory)) {
                Object values = psCurrent.getSupportedAttributeValues(sdCategory, docFlavor, asCurrent);
    ...
    private class JobAttributesPanel extends JPanel implements ActionListener, ChangeListener, FocusListener {
        ...
        public JobAttributesPanel() {
            ...
            c.gridwidth = GridBagConstraints.REMAINDER;
            pnlTop.getAccessibleContext().setAccessibleName(getMsg("label.priority"));
            addToGB(pnlTop, this, gridbag, c);
            ...
            tfJobName.getAccessibleContext().setAccessibleName(getMsg("label.jobname"));
            ...
            tfUserName.getAccessibleContext().setAccessibleName(getMsg("label.username"));
    ...
    private class IconRadioButton extends JPanel {
        ...
        public IconRadioButton(String key, String img, boolean selected, ButtonGroup bg, ActionListener al) {
            ...
            Icon icon = (Icon) java.security.AccessController.doPrivileged(new java.security.PrivilegedAction() {
                public Object run() {
    ...
    private class ValidatingFileChooser extends JFileChooser {
        public void approveSelection() {
            ...
            if (exists) {
                int val;
                val = JOptionPane.showConfirmDialog(this, getMsg("dialog.overwrite"), getMsg("dialog.owtitle"),
            ...
            try {
                ...
                JOptionPane
                    .showMessageDialog(this, getMsg("dialog.writeerror") + " " + selected, getMsg("dialog.owtitle"),
            ...
            if ((selected.exists() && (!selected.isFile() || !selected.canWrite())) ||
                ((pFile != null) && (!pFile.exists() || (pFile.exists() && !pFile.canWrite())))) {
                JOptionPane
                    .showMessageDialog(this, getMsg("dialog.writeerror") + " " + selected, getMsg("dialog.owtitle"),
                        JOptionPane.WARNING_MESSAGE);
                return;
