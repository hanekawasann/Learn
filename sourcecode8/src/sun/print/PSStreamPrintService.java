...
public class PSStreamPrintService extends StreamPrintService implements SunPrinterJobService {
    ...
    private static final Class[] suppAttrCats = { Chromaticity.class, Copies.class, Fidelity.class, JobName.class,
        Media.class, MediaPrintableArea.class, OrientationRequested.class, PageRanges.class, RequestingUserName.class,
        SheetCollate.class, Sides.class, };

    private static int MAXCOPIES = 1000;

    private static final MediaSizeName mediaSizes[] = { MediaSizeName.NA_LETTER, MediaSizeName.TABLOID,
        MediaSizeName.LEDGER, MediaSizeName.NA_LEGAL, MediaSizeName.EXECUTIVE, MediaSizeName.ISO_A3,
        MediaSizeName.ISO_A4, MediaSizeName.ISO_A5, MediaSizeName.ISO_B4, MediaSizeName.ISO_B5, };
    ...
    public Object getDefaultAttributeValue(Class<? extends Attribute> category) {
        ...
        if (category == Copies.class) {
            ...
            return new MediaPrintableArea(margin, margin, iw, ih, MediaPrintableArea.INCH);
    ...
    public boolean isAttributeValueSupported(Attribute attr, DocFlavor flavor, AttributeSet attributes) {
        ...
        } else if (attr.getCategory() == Media.class && attr instanceof MediaSizeName) {
            return isSupportedMedia((MediaSizeName) attr);
        } else if (attr.getCategory() == OrientationRequested.class) {
            if (attr == OrientationRequested.REVERSE_PORTRAIT || (flavor != null) &&
    ...
    public boolean equals(Object obj) {
        return (obj == this ||
            (obj instanceof PSStreamPrintService && ((PSStreamPrintService) obj).getName().equals(getName())));
    }
