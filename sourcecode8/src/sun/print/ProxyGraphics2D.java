...
public class ProxyGraphics2D extends Graphics2D implements PrinterGraphics {
    ...
    public boolean drawImage(Image img, int x, int y, int width, int height, Color bgcolor, ImageObserver observer) {
        ...
        if (needToCopyBgColorImage(img)) {
            ...
            result = mGraphics.drawImage(img, x, y, width, height, bgcolor, observer);
        }
    ...
    public boolean drawImage(Image img, int dx1, int dy1, int dx2, int dy2, int sx1, int sy1, int sx2, int sy2,
        ...
        if (needToCopyBgColorImage(img)) {
            BufferedImage imageCopy = getBufferedImageCopy(img, bgcolor);
            result = mGraphics.drawImage(imageCopy, dx1, dy1, dx2, dy2, sy1, sy1, sx2, sy2, null);
        } else {
            result = mGraphics.drawImage(img, dx1, dy1, dx2, dy2, sy1, sy1, sx2, sy2, bgcolor, observer);
        }
    ...
    private boolean needToCopyBgColorImage(Image img) {
        ...
        return
            (transform.getType() & (AffineTransform.TYPE_GENERAL_ROTATION | AffineTransform.TYPE_GENERAL_TRANSFORM)) !=
                0;
    }
