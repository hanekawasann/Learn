...
public class MsgAppletViewer_sv extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        Object[][] temp = new Object[][] { { "textframe.button.dismiss", "St\u00E4ng" },
            { "appletviewer.tool.title", "Applet Viewer: {0}" }, { "appletviewer.menu.applet", "Applet" },
            { "appletviewer.menuitem.restart", "Starta om" }, { "appletviewer.menuitem.reload", "Ladda om" },
            { "appletviewer.menuitem.stop", "Stopp" }, { "appletviewer.menuitem.save", "Spara..." },
            { "appletviewer.menuitem.start", "Starta" }, { "appletviewer.menuitem.clone", "Klona..." },
            { "appletviewer.menuitem.tag", "Tagg..." }, { "appletviewer.menuitem.info", "Information..." },
            { "appletviewer.menuitem.edit", "Redigera" }, { "appletviewer.menuitem.encoding", "Teckenkodning" },
            { "appletviewer.menuitem.print", "Skriv ut..." }, { "appletviewer.menuitem.props", "Egenskaper..." },
            { "appletviewer.menuitem.close", "St\u00E4ng" }, { "appletviewer.menuitem.quit", "Avsluta" },
            { "appletviewer.label.hello", "Hej..." }, { "appletviewer.status.start", "startar applet..." },
            { "appletviewer.appletsave.filedialogtitle", "Serialisera applet till fil" },
            { "appletviewer.appletsave.err1", "serialiserar {0} till {1}" },
            { "appletviewer.appletsave.err2", "i appletSave: {0}" }, { "appletviewer.applettag", "Tagg visas" },
            ...
            { "appletviewer.appletencoding", "Teckenkodning: {0}" }, { "appletviewer.parse.warning.requiresname",
            "Varning: <param name=... value=...>-taggen kr\u00E4ver ett namnattribut." },
            { "appletviewer.parse.warning.paramoutside",
                "Varning: <param>-taggen finns utanf\u00F6r <applet> ... </applet>." },
            { "appletviewer.parse.warning.applet.requirescode",
                "Varning: <applet>-taggen kr\u00E4ver ett kodattribut." },
            { "appletviewer.parse.warning.applet.requiresheight",
                "Varning: <applet>-taggen kr\u00E4ver ett h\u00F6jdattribut." },
            { "appletviewer.parse.warning.applet.requireswidth",
                "Varning: <applet>-taggen kr\u00E4ver ett breddattribut." },
            { "appletviewer.parse.warning.object.requirescode",
                "Varning: <object>-taggen kr\u00E4ver ett kodattribut." },
            { "appletviewer.parse.warning.object.requiresheight",
                "Varning: <object>-taggen kr\u00E4ver ett h\u00F6jdattribut." },
            { "appletviewer.parse.warning.object.requireswidth",
                "Varning: <object>-taggen kr\u00E4ver ett breddattribut." },
            ...
            { "appletviewer.main.warning",
                "Varning: Inga appletar har startats. Kontrollera att indata inneh\u00E5ller <applet>-tagg." },
            { "appletviewer.main.warn.prop.overwrite",
                "Varning: Skriver tillf\u00E4lligt \u00F6ver systemegenskap enligt beg\u00E4ran fr\u00E5n anv\u00E4ndare: nyckel: {0} gammalt v\u00E4rde: {1} nytt v\u00E4rde: {2}" },
            { "appletviewer.main.warn.cantreadprops",
                "Varning: Kan inte l\u00E4sa egenskapsfil f\u00F6r AppletViewer: {0} Standardv\u00E4rden anv\u00E4nds." },
            ...
            { "appletclassloader.findclass.verbose.openstream",
                "\u00D6ppnar str\u00F6m till: {0} f\u00F6r h\u00E4mtning av {1}" },
            ...
            { "appletpanel.destroyed", "Applet raderad." }, { "appletpanel.loaded", "Applet laddad." },
            { "appletpanel.started", "Applet startad." }, { "appletpanel.inited", "Applet initierad." },
            { "appletpanel.stopped", "Applet stoppad." }, { "appletpanel.disposed", "Applet kasserad." },
            ...
            { "appletpanel.death", "avslutad" }, { "appletpanel.exception", "undantag: {0}." },
            { "appletpanel.exception2", "undantag: {0}: {1}." }, { "appletpanel.error", "fel: {0}." },
            ...
            { "appletpanel.notdisposed", "Ladda: applet har inte kasserats." }, { "appletpanel.bail", "Avbruten." },
            ...
            { "appletpanel.fileerror", "{0} fel vid laddning: {1}" }, { "appletpanel.badattribute.exception",
            "HTML-tolkning: felaktigt v\u00E4rde f\u00F6r bredd-/h\u00F6jdattribut" },
            { "appletillegalargumentexception.objectinputstream",
                "AppletObjectInputStream kr\u00E4ver laddare med icke-null" },
            ...
            { "appletprops.choice.unsignedapplet.no", "Nej" }, { "appletprops.choice.unsignedapplet.yes", "Ja" },
            { "appletprops.button.apply", "Anv\u00E4nd" }, { "appletprops.button.cancel", "Avbryt" },
            ...
            { "appletsecurityexception.checkconnect.networkhost1",
                "S\u00E4kerhetsundantag: Kunde inte ansluta till {0} med ursprung fr\u00E5n {1}." },
            { "appletsecurityexception.checkconnect.networkhost2",
                "S\u00E4kerhetsundantag: Kunde inte matcha IP f\u00F6r v\u00E4rd {0} eller f\u00F6r {1}. " },
            { "appletsecurityexception.checkconnect.networkhost3",
                "S\u00E4kerhetsundantag: Kunde inte matcha IP f\u00F6r v\u00E4rd {0}. Se egenskapen trustProxy." },
            { "appletsecurityexception.checkconnect", "S\u00E4kerhetsundantag: connect: {0}->{1}" },
            { "appletsecurityexception.checkpackageaccess",
                "S\u00E4kerhetsundantag: ingen \u00E5tkomst till paket: {0}" },
            { "appletsecurityexception.checkpackagedefinition",
                "S\u00E4kerhetsundantag: kan inte definiera paket: {0}" },
            ...
            { "appletsecurityexception.checksecurityaccess",
                "S\u00E4kerhetsundantag: s\u00E4kerhets\u00E5tg\u00E4rd: {0}" },
            { "appletsecurityexception.getsecuritycontext.unknown",
                "ok\u00E4nd typ av klassladdare. kan inte kontrollera getContext" },
            { "appletsecurityexception.checkread.unknown",
                "ok\u00E4nd typ av klassladdare. kan inte kontrollera kontroll\u00E4sning {0}" },
            { "appletsecurityexception.checkconnect.unknown",
                "ok\u00E4nd typ av klassladdare. kan inte kontrollera kontrollanslutning" }, };
