...
public class MsgAppletViewer_it extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        Object[][] temp = new Object[][] { { "textframe.button.dismiss", "Chiudi" },
            { "appletviewer.tool.title", "Visualizzatore applet: {0}" }, { "appletviewer.menu.applet", "Applet" },
            { "appletviewer.menuitem.restart", "Riavvia" }, { "appletviewer.menuitem.reload", "Ricarica" },
            { "appletviewer.menuitem.stop", "Arresta" }, { "appletviewer.menuitem.save", "Salva..." },
            { "appletviewer.menuitem.start", "Avvia" }, { "appletviewer.menuitem.clone", "Copia..." },
            { "appletviewer.menuitem.tag", "Tag..." }, { "appletviewer.menuitem.info", "Informazioni..." },
            { "appletviewer.menuitem.edit", "Modifica" }, { "appletviewer.menuitem.encoding", "Codifica caratteri" },
            { "appletviewer.menuitem.print", "Stampa..." }, { "appletviewer.menuitem.props", "Propriet\u00E0..." },
            { "appletviewer.menuitem.close", "Chiudi" }, { "appletviewer.menuitem.quit", "Esci" },
            { "appletviewer.label.hello", "Benvenuti..." }, { "appletviewer.status.start", "avvio applet in corso..." },
            { "appletviewer.appletsave.filedialogtitle", "Serializza applet in file" },
            { "appletviewer.appletsave.err1", "serializzazione di {0} in {1}" },
            { "appletviewer.appletsave.err2", "in appletSave: {0}" }, { "appletviewer.applettag", "Tag visualizzata" },
            ...
            { "appletviewer.main.warning",
                "Avvertenza: nessuna applet avviata. Assicurarsi che l'input contenga una tag <applet>." },
            { "appletviewer.main.warn.prop.overwrite",
                "Avvertenza: la propriet\u00E0 di sistema verr\u00E0 sovrascritta temporaneamente su richiesta dell''utente. Chiave {0}, valore precedente {1}, nuovo valore {2}." },
            { "appletviewer.main.warn.cantreadprops",
                "Avvertenza: impossibile leggere il file delle propriet\u00E0 AppletViewer {0}. Verranno utilizzate le impostazioni predefinite." },
            ...
            { "appletclassloader.getresource.verbose.found",
                "\u00C8 stata trovata la risorsa {0} come risorsa di sistema" },
            ...
            { "appletpanel.destroyed", "Applet rimossa." }, { "appletpanel.loaded", "Applet caricata." },
            { "appletpanel.started", "Applet avviata." }, { "appletpanel.inited", "Applet inizializzata." },
            { "appletpanel.stopped", "Applet arrestata." }, { "appletpanel.disposed", "Applet eliminata." },
            ...
            { "appletpanel.death", "terminato" }, { "appletpanel.exception", "eccezione: {0}" },
            { "appletpanel.exception2", "eccezione: {0}: {1}." }, { "appletpanel.error", "errore: {0}." },
            ...
            { "appletillegalargumentexception.objectinputstream",
                "AppletObjectInputStream richiede un loader non nullo" },
            ...
            { "appletprops.choice.unsignedapplet.no", "No" }, { "appletprops.choice.unsignedapplet.yes", "S\u00EC" },
            { "appletprops.button.apply", "Applica" }, { "appletprops.button.cancel", "Annulla" },
            ...
            { "appletsecurityexception.checkconnect.networkhost1",
                "Eccezione di sicurezza: impossibile connettersi a {0} con origine da {1}." },
            { "appletsecurityexception.checkconnect.networkhost2",
                "Eccezione di sicurezza: impossibile risolvere l''IP per l''host {0} o per {1}. " },
            { "appletsecurityexception.checkconnect.networkhost3",
                "Eccezione di sicurezza: impossibile non risolvere l''IP per l''host {0}. Vedere la propriet\u00E0 trustProxy." },
            { "appletsecurityexception.checkconnect", "Eccezione di sicurezza: connect: {0}->{1}" },
            { "appletsecurityexception.checkpackageaccess",
                "Eccezione di sicurezza: impossibile accedere al package {0}" },
            { "appletsecurityexception.checkpackagedefinition",
                "Eccezione di sicurezza: impossibile definire il package {0}" },
            ...
            { "appletsecurityexception.getsecuritycontext.unknown",
                "tipo di loader della classe sconosciuto. Impossibile verificare la presenza di getContext." },
            { "appletsecurityexception.checkread.unknown",
                "tipo di loader della classe sconosciuto. Impossibile verificare la presenza della lettura di controllo {0}." },
            { "appletsecurityexception.checkconnect.unknown",
                "tipo di loader della classe sconosciuto. Impossibile verificare la presenza della connessione di controllo." }, };
