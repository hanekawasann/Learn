...
public class MsgAppletViewer extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        Object[][] temp = new Object[][] { { "textframe.button.dismiss", "Dismiss" },
            { "appletviewer.tool.title", "Applet Viewer: {0}" }, { "appletviewer.menu.applet", "Applet" },
            { "appletviewer.menuitem.restart", "Restart" }, { "appletviewer.menuitem.reload", "Reload" },
            { "appletviewer.menuitem.stop", "Stop" }, { "appletviewer.menuitem.save", "Save..." },
            { "appletviewer.menuitem.start", "Start" }, { "appletviewer.menuitem.clone", "Clone..." },
            { "appletviewer.menuitem.tag", "Tag..." }, { "appletviewer.menuitem.info", "Info..." },
            { "appletviewer.menuitem.edit", "Edit" }, { "appletviewer.menuitem.encoding", "Character Encoding" },
            { "appletviewer.menuitem.print", "Print..." }, { "appletviewer.menuitem.props", "Properties..." },
            { "appletviewer.menuitem.close", "Close" }, { "appletviewer.menuitem.quit", "Quit" },
            { "appletviewer.label.hello", "Hello..." }, { "appletviewer.status.start", "starting applet..." },
            { "appletviewer.appletsave.filedialogtitle", "Serialize Applet into File" },
            { "appletviewer.appletsave.err1", "serializing an {0} to {1}" },
            { "appletviewer.appletsave.err2", "in appletSave: {0}" }, { "appletviewer.applettag", "Tag shown" },
            ...
            { "appletviewer.appletencoding", "Character Encoding: {0}" }, { "appletviewer.parse.warning.requiresname",
            ...
            { "appletviewer.parse.warning.appnotLongersupported",
                "Warning: <app> tag no longer supported, use <applet> instead:" }, { "appletviewer.usage",
            ...
            { "appletviewer.main.nosecmgr", "Warning: SecurityManager not installed!" }, { "appletviewer.main.warning",
            "Warning: No applets were started. Make sure the input contains an <applet> tag." },
            { "appletviewer.main.warn.prop.overwrite",
                "Warning: Temporarily overwriting system property at user''s request: key: {0} old value: {1} new value: {2}" },
            { "appletviewer.main.warn.cantreadprops",
                "Warning: Can''t read AppletViewer properties file: {0} Using defaults." },
            ...
            { "appletpanel.destroyed", "Applet destroyed." }, { "appletpanel.loaded", "Applet loaded." },
            { "appletpanel.started", "Applet started." }, { "appletpanel.inited", "Applet initialized." },
            { "appletpanel.stopped", "Applet stopped." }, { "appletpanel.disposed", "Applet disposed." },
            ...
            { "appletpanel.death", "killed" }, { "appletpanel.exception", "exception: {0}." },
            { "appletpanel.exception2", "exception: {0}: {1}." }, { "appletpanel.error", "error: {0}." },
            { "appletpanel.error2", "error: {0}: {1}." }, { "appletpanel.notloaded", "Init: applet not loaded." },
            ...
            { "appletprops.label.http.proxy", "Http proxy port:" }, { "appletprops.label.network", "Network access:" },
            ...
            { "appletprops.choice.unsignedapplet.no", "No" }, { "appletprops.choice.unsignedapplet.yes", "Yes" },
            { "appletprops.button.apply", "Apply" }, { "appletprops.button.cancel", "Cancel" },
            ...
            { "appletsecurityexception.checkconnect.networkhost1",
                "Security Exception: Couldn''t connect to {0} with origin from {1}." },
            { "appletsecurityexception.checkconnect.networkhost2",
                "Security Exception: Couldn''t resolve IP for host {0} or for {1}. " },
            { "appletsecurityexception.checkconnect.networkhost3",
                "Security Exception: Could not resolve IP for host {0}. See the trustProxy property." },
            ...
            { "appletsecurityexception.getsecuritycontext.unknown",
                "unknown class loader type. unable to check for getContext" },
            { "appletsecurityexception.checkread.unknown",
                "unknown class loader type. unable to check for checking read {0}" },
            { "appletsecurityexception.checkconnect.unknown",
                "unknown class loader type. unable to check for checking connect" }, };
