...
public class MsgAppletViewer_de extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        Object[][] temp = new Object[][] { { "textframe.button.dismiss", "Verwerfen" },
            { "appletviewer.tool.title", "Applet Viewer: {0}" }, { "appletviewer.menu.applet", "Applet" },
            { "appletviewer.menuitem.restart", "Neu starten" }, { "appletviewer.menuitem.reload", "Neu laden" },
            { "appletviewer.menuitem.stop", "Stoppen" }, { "appletviewer.menuitem.save", "Speichern..." },
            { "appletviewer.menuitem.start", "Starten..." }, { "appletviewer.menuitem.clone", "Clonen..." },
            { "appletviewer.menuitem.tag", "Tag..." }, { "appletviewer.menuitem.info", "Informationen..." },
            { "appletviewer.menuitem.edit", "Bearbeiten" }, { "appletviewer.menuitem.encoding", "Zeichencodierung" },
            { "appletviewer.menuitem.print", "Drucken..." }, { "appletviewer.menuitem.props", "Eigenschaften..." },
            { "appletviewer.menuitem.close", "Schlie\u00DFen" }, { "appletviewer.menuitem.quit", "Beenden" },
            { "appletviewer.label.hello", "Hallo..." }, { "appletviewer.status.start", "Applet wird gestartet..." },
            { "appletviewer.appletsave.filedialogtitle", "Applet in Datei serialisieren" },
            { "appletviewer.appletsave.err1", "{0} in {1} serialisieren" },
            { "appletviewer.appletsave.err2", "in appletSave: {0}" }, { "appletviewer.applettag", "Angezeigtes Tag" },
            ...
            { "appletviewer.appletencoding", "Zeichencodierung: {0}" }, { "appletviewer.parse.warning.requiresname",
            "Warnung: F\u00FCr <param name=... value=...>-Tag ist ein \"name\"-Attribut erforderlich." },
            { "appletviewer.parse.warning.paramoutside",
                "Warnung: <param>-Tag au\u00DFerhalb von <applet> ... </applet>." },
            { "appletviewer.parse.warning.applet.requirescode",
                "Warnung: F\u00FCr <applet>-Tag ist ein \"code\"-Attribut erforderlich." },
            { "appletviewer.parse.warning.applet.requiresheight",
                "Warnung: F\u00FCr <applet>-Tag ist ein \"height\"-Attribut erforderlich." },
            { "appletviewer.parse.warning.applet.requireswidth",
                "Warnung: F\u00FCr <applet>-Tag ist ein \"width\"-Attribut erforderlich." },
            { "appletviewer.parse.warning.object.requirescode",
                "Warnung: F\u00FCr <object>-Tag ist ein \"code\"-Attribut erforderlich." },
            { "appletviewer.parse.warning.object.requiresheight",
                "Warnung: F\u00FCr <object>-Tag ist ein \"height\"-Attribut erforderlich." },
            { "appletviewer.parse.warning.object.requireswidth",
                "Warnung: F\u00FCr <object>-Tag ist ein \"width\"-Attribut erforderlich." },
            { "appletviewer.parse.warning.embed.requirescode",
                "Warnung: F\u00FCr <embed>-Tag ist ein \"code\"-Attribut erforderlich." },
            { "appletviewer.parse.warning.embed.requiresheight",
                "Warnung: F\u00FCr <embed>-Tag ist ein \"height\"-Attribut erforderlich." },
            { "appletviewer.parse.warning.embed.requireswidth",
                "Warnung: F\u00FCr <embed>-Tag ist ein \"width\"-Attribut erforderlich." },
            { "appletviewer.parse.warning.appnotLongersupported",
                "Warnung: <app>-Tag wird nicht mehr unterst\u00FCtzt. Verwenden Sie stattdessen <applet>:" },
            { "appletviewer.usage",
                "Verwendung: appletviewer <Optionen> url(s)\n\nwobei die <Optionen> Folgendes umfassen:\n  -debug                  Applet Viewer im Java-Debugger starten\n  -encoding <Codierung>    Zeichencodierung f\u00FCr HTML-Dateien angeben\n  -J<Laufzeitkennzeichen>        Argument an den Java-Interpreter \u00FCbergeben\n\nDie Option \"-J\" ist nicht standardm\u00E4\u00DFig und kann ohne vorherige Ank\u00FCndigung ge\u00E4ndert werden." },
            ...
            { "appletviewer.main.warning",
                "Warnung: Es wurden keine Applets gestartet. Stellen Sie sicher, dass die Eingabe ein <applet>-Tag enth\u00E4lt." },
            { "appletviewer.main.warn.prop.overwrite",
                "Warnung: Systemeigenschaft wird tempor\u00E4r aufgrund von Benutzeranforderung \u00FCberschrieben: Schl\u00FCssel: {0} Alter Wert: {1} Neuer Wert: {2}" },
            { "appletviewer.main.warn.cantreadprops",
                "Warnung: AppletViewer-Eigenschaftendatei kann nicht gelesen werden: {0} Standardwerte werden verwendet." },
            ...
            { "appletpanel.destroyed", "Applet zerst\u00F6rt." }, { "appletpanel.loaded", "Applet geladen." },
            { "appletpanel.started", "Applet gestartet." }, { "appletpanel.inited", "Applet initialisiert." },
            { "appletpanel.stopped", "Applet gestoppt." }, { "appletpanel.disposed", "Applet verworfen." },
            ...
            { "appletpanel.death", "abgebrochen" }, { "appletpanel.exception", "Ausnahme: {0}." },
            { "appletpanel.exception2", "Ausnahme: {0}: {1}." }, { "appletpanel.error", "Fehler: {0}." },
            { "appletpanel.error2", "Fehler: {0}: {1}." }, { "appletpanel.notloaded", "Init.: Applet nicht geladen." },
            ...
            { "appletillegalargumentexception.objectinputstream",
                "AppletObjectInputStream erfordert Loader ungleich null" },
            { "appletprops.title", "AppletViewer-Eigenschaften" },
            { "appletprops.label.http.server", "HTTP-Proxyserver:" },
            { "appletprops.label.http.proxy", "HTTP-Proxyport:" }, { "appletprops.label.network", "Netzwerkzugriff:" },
            ...
            { "appletprops.choice.unsignedapplet.no", "Nein" }, { "appletprops.choice.unsignedapplet.yes", "Ja" },
            { "appletprops.button.apply", "Anwenden" }, { "appletprops.button.cancel", "Abbrechen" },
            ...
            { "appletsecurityexception.checkconnect.networkhost1",
                "Sicherheitsausnahme: Verbindung mit {0} mit Ursprung aus {1} konnte nicht hergestellt werden." },
            { "appletsecurityexception.checkconnect.networkhost2",
                "Sicherheitsausnahme: IP f\u00FCr Host {0} oder f\u00FCr {1} konnte nicht aufgel\u00F6st werden. " },
            { "appletsecurityexception.checkconnect.networkhost3",
                "Sicherheitsausnahme: IP f\u00FCr Host {0} konnte nicht aufgel\u00F6st werden. Siehe trustProxy-Eigenschaft." },
            { "appletsecurityexception.checkconnect", "Sicherheitsausnahme: Verbinden: {0}->{1}" },
            { "appletsecurityexception.checkpackageaccess",
                "Sicherheitsausnahme: Zugriff auf Package nicht m\u00F6glich: {0}" },
            { "appletsecurityexception.checkpackagedefinition",
                "Sicherheitsausnahme: Package kann nicht definiert werden: {0}" },
            ...
            { "appletsecurityexception.getsecuritycontext.unknown",
                "Unbekannter Class Loader-Typ. Pr\u00FCfen auf getContext nicht m\u00F6glich" },
            { "appletsecurityexception.checkread.unknown",
                "Unbekannter Class Loader-Typ. Pr\u00FCfen auf checkRead {0} nicht m\u00F6glich" },
            { "appletsecurityexception.checkconnect.unknown",
                "Unbekannter Class Loader-Typ. Pr\u00FCfen auf checkConnect nicht m\u00F6glich" }, };
