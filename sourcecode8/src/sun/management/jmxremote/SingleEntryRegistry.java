...
public class SingleEntryRegistry extends RegistryImpl {
    SingleEntryRegistry(int port, String name, Remote object) throws RemoteException {
        super(port);
        this.name = name;
        this.object = object;
    }

    SingleEntryRegistry(int port, RMIClientSocketFactory csf, RMIServerSocketFactory ssf, String name, Remote object)
    ...
    public Remote lookup(String name) throws NotBoundException {
        if (name.equals(this.name)) { return object; }
