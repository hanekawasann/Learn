...
public class LockInfoCompositeData extends LazyCompositeData {
    ...
    protected CompositeData getCompositeData() {
        ...
        // lockInfoItemNames!
        final Object[] lockInfoItemValues = { new String(lock.getClassName()),
            new Integer(lock.getIdentityHashCode()), };

        try {
            return new CompositeDataSupport(lockInfoCompositeType, lockInfoItemNames, lockInfoItemValues);
    ...
    private static final String[] lockInfoItemNames = { CLASS_NAME, IDENTITY_HASH_CODE, };
