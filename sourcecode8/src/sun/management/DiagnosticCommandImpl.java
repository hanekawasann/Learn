...
class DiagnosticCommandImpl extends NotificationEmitterSupport implements DiagnosticCommandMBean {
            ...
            if (info.getPermissionClass() != null) {
                    ...
                    if (permission == null) {
                        try {
                            ...
                            permission = (Permission) constructor
                                .newInstance(info.getPermissionName(), info.getPermissionAction());
                        } catch (InstantiationException | IllegalAccessException | IllegalArgumentException | InvocationTargetException | NoSuchMethodException | SecurityException ex) {
                            cause = ex;
                        }
                    }
                ...
                if (permission == null) {
                    InstantiationException iex = new InstantiationException(
                        "Unable to instantiate required permission");
                    iex.initCause(cause);
                }
            }
        }
    ...
    public MBeanInfo getMBeanInfo() {
            ...
            try {
                ...
                for (int i = 0; i < command.length; i++) {
                    ...
                    try {
                        ...
                        operations.add(new MBeanOperationInfo(w.name, w.info.getDescription(),
                            (w.info.getArgumentsInfo() == null || w.info.getArgumentsInfo().isEmpty()) ? null
                                : stringArgInfo, strClassName, MBeanOperationInfo.ACTION_INFO, commandDescriptor(w)));
        ...
        return new MBeanInfo(this.getClass().getName(), "Diagnostic Commands", null, // attributes
            null, // constructors
    ...
    public Object invoke(String actionName, Object[] params, String[] signature)
        ...
        if (w != null) {
            if (w.info.getArgumentsInfo().isEmpty() && (params == null || params.length == 0) &&
                (signature == null || signature.length == 0)) {
                return w.execute(null);
            } else if ((params != null && params.length == 1) &&
                (signature != null && signature.length == 1 && signature[0] != null &&
    ...
    private final static String notifName = "javax.management.Notification";

    private final static String[] diagFramNotifTypes = { "jmx.mbean.info.changed" };
    ...
    public MBeanNotificationInfo[] getNotificationInfo() {
        synchronized (this) {
            if (notifInfo == null) {
                ...
                notifInfo[0] = new MBeanNotificationInfo(diagFramNotifTypes, notifName,
    ...
    private void createDiagnosticFrameworkNotification() {
        ...
        Notification notif = new Notification("jmx.mbean.info.changed", on, getNextSeqNumber());
