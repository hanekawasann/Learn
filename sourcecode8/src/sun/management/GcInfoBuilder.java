...
public class GcInfoBuilder {
    ...
    GcInfo getLastGcInfo() {
        ...
        return getLastGcInfo0(gc, gcExtItemCount, values, gcExtItemTypes, usageBeforeGC, usageAfterGC);
    }
    ...
    synchronized CompositeType getGcInfoCompositeType() {
        if (gcInfoCompositeType != null) { return gcInfoCompositeType; }
        ...
        try {
            ...
            gict = new CompositeType(typeName, "CompositeType for GC info for " + gc.getName(), allItemNames,
                allItemDescs, allItemTypes);
    ...
    private native void fillGcAttributeInfo(GarbageCollectorMXBean gc, int numAttributes, String[] attributeNames,
        char[] types, String[] descriptions);
     ...
     */
    private native GcInfo getLastGcInfo0(GarbageCollectorMXBean gc, int numExtAtts, Object[] extAttValues,
        char[] extAttTypes, MemoryUsage[] before, MemoryUsage[] after);
}
