...
public class ManagementFactoryHelper {
    ...
    public static synchronized List<BufferPoolMXBean> getBufferPoolMXBeans() {
        if (bufferPools == null) {
            ...
            bufferPools.add(createBufferPoolMXBean(sun.misc.SharedSecrets.getJavaNioAccess().getDirectBufferPool()));
     ...
     */
    private static BufferPoolMXBean createBufferPoolMXBean(final sun.misc.JavaNioAccess.BufferPool pool) {
    ...
    final static String HOTSPOT_DIAGNOSTIC_COMMAND_MBEAN_NAME = "com.sun.management:type=DiagnosticCommand";
