...
public class JvmThreadInstanceEntryImpl implements JvmThreadInstanceEntryMBean, Serializable {
    ...
    public final static class ThreadStateMap {
        ...
        public static void checkOther(byte[] bitmap) {
            if (((bitmap[0] & mask0) == (byte) 0x00) && ((bitmap[1] & mask1) == (byte) 0x00)) {
        ...
        public static Byte[] getState(ThreadInfo info) {
            ...
            try {
                ...
                log.debug("getJvmThreadInstState",
                    "[State=" + state + ",isInNative=" + inNative + ",isSuspended=" + suspended + "]");
    ...
    public static String getJvmThreadInstIndexOid() throws SnmpStatusException {
        if (jvmThreadInstIndexOid == null) {
            ...
            final SnmpOidRecord record = table.resolveVarName("jvmThreadInstIndex");
