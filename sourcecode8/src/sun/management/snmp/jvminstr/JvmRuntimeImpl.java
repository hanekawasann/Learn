...
public class JvmRuntimeImpl implements JvmRuntimeMBean {
     ...
     * "
     */
    static final EnumJvmRTBootClassPathSupport JvmRTBootClassPathSupportSupported = new EnumJvmRTBootClassPathSupport(
        "supported");
    static final EnumJvmRTBootClassPathSupport JvmRTBootClassPathSupportUnSupported = new EnumJvmRTBootClassPathSupport(
        "unsupported");
    ...
    static String[] getBootClassPath(Object userData) {
        if (!getRuntimeMXBean().isBootClassPathSupported()) { return new String[0]; }
    ...
    public EnumJvmRTBootClassPathSupport getJvmRTBootClassPathSupport() throws SnmpStatusException {
        if (getRuntimeMXBean().isBootClassPathSupported()) { return JvmRTBootClassPathSupportSupported; } else {
