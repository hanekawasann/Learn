...
public class JvmCompilationImpl implements JvmCompilationMBean {
     ...
     * "
     */
    static final EnumJvmJITCompilerTimeMonitoring JvmJITCompilerTimeMonitoringSupported
        = new EnumJvmJITCompilerTimeMonitoring("supported");
    static final EnumJvmJITCompilerTimeMonitoring JvmJITCompilerTimeMonitoringUnsupported
    ...
    public EnumJvmJITCompilerTimeMonitoring getJvmJITCompilerTimeMonitoring() throws SnmpStatusException {
        ...
        } else { return JvmJITCompilerTimeMonitoringUnsupported; }
    }
