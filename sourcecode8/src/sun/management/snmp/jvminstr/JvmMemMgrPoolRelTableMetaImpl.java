...
public class JvmMemMgrPoolRelTableMetaImpl extends JvmMemMgrPoolRelTableMeta implements Serializable {
    ...
    private static class JvmMemMgrPoolRelTableCache extends SnmpTableCache {
        ...
        protected SnmpCachedData updateCachedDatas(Object userData) {
            ...
            final TreeMap<SnmpOid, Object> table = new TreeMap<>(SnmpCachedData.oidComparator);
        ...
        protected void updateTreeMap(TreeMap<SnmpOid, Object> table, Object userData, MemoryManagerMXBean mmm,
            SnmpOid mmIndex, Map<String, SnmpOid> poolIndexMap) {
        ...
        protected void updateTreeMap(TreeMap<SnmpOid, Object> table, Object userData, SnmpTableHandler mmHandler,
            SnmpTableHandler mpHandler, Map<String, SnmpOid> poolIndexMap) {
        ...
        protected void updateTreeMap(TreeMap<SnmpOid, Object> table, Object userData, SnmpCachedData mmHandler,
            SnmpTableHandler mpHandler, Map<String, SnmpOid> poolIndexMap) {
    ...
    public JvmMemMgrPoolRelTableMetaImpl(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib, objserv);
        this.cache = new JvmMemMgrPoolRelTableCache(this, ((JVM_MANAGEMENT_MIB_IMPL) myMib).
            validity());
    }
    ...
    protected SnmpTableHandler getHandler(Object userData) {
        ...
        if (userData instanceof Map) { m = Util.cast(userData); } else { m = null; }
