...
public class JvmRTClassPathTableMetaImpl extends JvmRTClassPathTableMeta {
    ...
    private static class JvmRTClassPathTableCache extends SnmpTableCache {
        ...
        JvmRTClassPathTableCache(JvmRTClassPathTableMetaImpl meta, long validity) {
            this.meta = meta;
        ...
        protected SnmpCachedData updateCachedDatas(Object userData) {
            ...
            final String[] path = JvmRuntimeImpl.getClassPath(userData);
     ...
     * in Java DMK.
     */
    public JvmRTClassPathTableMetaImpl(SnmpMib myMib, SnmpStandardObjectServer objserv) {
        super(myMib, objserv);
    ...
    protected SnmpTableHandler getHandler(Object userData) {
        ...
        if (m != null && handler != null) { m.put("JvmRTClassPathTable.handler", handler); }
