...
public class JvmMemPoolTableMeta extends SnmpMibTable implements Serializable {
     ...
     **/
    protected JvmMemPoolEntryMeta createJvmMemPoolEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib,
        MBeanServer server) {
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname, Object entry) throws SnmpStatusException {
        if (!(entry instanceof JvmMemPoolEntryMBean)) {
            throw new ClassCastException(
                "Entries for Table \"" + "JvmMemPoolTable" + "\" must implement the \"" + "JvmMemPoolEntryMBean" +
                    "\" interface.");
        }
