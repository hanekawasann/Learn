...
public class JvmRTBootClassPathTableMeta extends SnmpMibTable implements Serializable {
     ...
     **/
    protected JvmRTBootClassPathEntryMeta createJvmRTBootClassPathEntryMetaNode(String snmpEntryName, String tableName,
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname, Object entry) throws SnmpStatusException {
        if (!(entry instanceof JvmRTBootClassPathEntryMBean)) {
            throw new ClassCastException(
                "Entries for Table \"" + "JvmRTBootClassPathTable" + "\" must implement the \"" +
