...
public class JvmThreadInstanceTableMeta extends SnmpMibTable implements Serializable {
     ...
     **/
    protected JvmThreadInstanceEntryMeta createJvmThreadInstanceEntryMetaNode(String snmpEntryName, String tableName,
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname, Object entry) throws SnmpStatusException {
        if (!(entry instanceof JvmThreadInstanceEntryMBean)) {
            throw new ClassCastException(
                "Entries for Table \"" + "JvmThreadInstanceTable" + "\" must implement the \"" +
