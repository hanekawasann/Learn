...
public class JvmRTClassPathTableMeta extends SnmpMibTable implements Serializable {
     ...
     **/
    protected JvmRTClassPathEntryMeta createJvmRTClassPathEntryMetaNode(String snmpEntryName, String tableName,
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname, Object entry) throws SnmpStatusException {
        if (!(entry instanceof JvmRTClassPathEntryMBean)) {
            throw new ClassCastException("Entries for Table \"" + "JvmRTClassPathTable" + "\" must implement the \"" +
