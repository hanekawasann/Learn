...
public class JvmMemManagerTableMeta extends SnmpMibTable implements Serializable {
     ...
     **/
    protected JvmMemManagerEntryMeta createJvmMemManagerEntryMetaNode(String snmpEntryName, String tableName,
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname, Object entry) throws SnmpStatusException {
        if (!(entry instanceof JvmMemManagerEntryMBean)) {
            throw new ClassCastException(
                "Entries for Table \"" + "JvmMemManagerTable" + "\" must implement the \"" + "JvmMemManagerEntryMBean" +
                    "\" interface.");
        }
