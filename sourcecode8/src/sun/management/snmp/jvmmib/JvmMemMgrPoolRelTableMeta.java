...
public class JvmMemMgrPoolRelTableMeta extends SnmpMibTable implements Serializable {
     ...
     **/
    protected JvmMemMgrPoolRelEntryMeta createJvmMemMgrPoolRelEntryMetaNode(String snmpEntryName, String tableName,
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname, Object entry) throws SnmpStatusException {
        if (!(entry instanceof JvmMemMgrPoolRelEntryMBean)) {
            throw new ClassCastException("Entries for Table \"" + "JvmMemMgrPoolRelTable" + "\" must implement the \"" +
