...
public class FtpURLConnection extends URLConnection {
    ...
    public synchronized void connect() throws IOException {
        ...
        if (user == null) {
            ...
            password = java.security.AccessController
                .doPrivileged(new GetPropertyAction("ftp.protocol.user", "Java" + vers + "@"));
        }
        try {
    ...
    public void setRequestProperty(String key, String value) {
        ...
        if ("type".equals(key)) {
            if ("i".equalsIgnoreCase(value)) {
                ...
                throw new IllegalArgumentException("Value of '" + key + "' request property was '" + value +
