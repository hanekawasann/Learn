...
final class HttpsClient extends HttpClient implements HandshakeCompletedListener {
    ...
    private String getUserAgent() {
        String userAgent = java.security.AccessController
            .doPrivileged(new sun.security.action.GetPropertyAction("https.agent"));
    ...
    private static Proxy newHttpProxy(String proxyHost, int proxyPort) {
        ...
        try {
            saddr = java.security.AccessController
                .doPrivileged(new java.security.PrivilegedExceptionAction<InetSocketAddress>() {
    ...
    static HttpClient New(SSLSocketFactory sf, URL url, HostnameVerifier hv, HttpURLConnection httpuc)
        throws IOException {
    ...
    static HttpClient New(SSLSocketFactory sf, URL url, HostnameVerifier hv, String proxyHost, int proxyPort,
        ...
        return HttpsClient
            .New(sf, url, hv, (proxyHost == null ? null : HttpsClient.newHttpProxy(proxyHost, proxyPort)), useCache,
