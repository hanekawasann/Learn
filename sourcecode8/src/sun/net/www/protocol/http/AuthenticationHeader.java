...
public class AuthenticationHeader {
    ...
    static {
        authPref = java.security.AccessController
            .doPrivileged(new sun.security.action.GetPropertyAction("http.auth.preference"));
        ...
        if (authPref == null || (v = schemes.get(authPref)) == null) {
            ...
            if (v == null) {
                if ((v = schemes.get("digest")) == null) {
                    if (!NTLMAuthenticationProxy.supported || ((v = schemes.get("ntlm")) == null)) {
                        v = schemes.get("basic");
                    }
                }
            }
