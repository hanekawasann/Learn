...
public final class StringPrep {
    ...
    public StringPrep(InputStream inputStream) throws IOException {
        ...
        if (normUniVer.compareTo(sprepUniVer) <
            0 && /* the Unicode version of SPREP file must be less than the Unicode Vesion of the normalization data */
            normUniVer.compareTo(normCorrVer) <
                0 && /* the Unicode version of the NormalizationCorrections.txt file should be less than the Unicode Vesion of the normalization data */
    ...
    private StringBuffer normalize(StringBuffer src) {
         ...
         */
        return new StringBuffer(Normalizer.normalize(src.toString(), java.text.Normalizer.Form.NFKC,
    ...
    */
    ...
    public StringBuffer prepare(UCharacterIterator src, int options) throws ParseException {
        ...
        Values val = new Values();
        int direction = UCharacterDirection.CHAR_DIRECTION_COUNT, firstCharDir
            = UCharacterDirection.CHAR_DIRECTION_COUNT;
