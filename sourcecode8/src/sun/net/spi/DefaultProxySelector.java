...
public class DefaultProxySelector extends ProxySelector {
    ...
    final static String[][] props = {
         ...
         */
        { "http", "http.proxy", "proxy", "socksProxy" }, { "https", "https.proxy", "proxy", "socksProxy" },
        { "ftp", "ftp.proxy", "ftpProxy", "proxy", "socksProxy" }, { "gopher", "gopherProxy", "socksProxy" },
        { "socket", "socksProxy" } };
                ...
                for (i = 0; i < props.length; i++) {
                    if (props[i][0].equalsIgnoreCase(proto)) {
                        ...
                        if (phost == null || phost.length() == 0) {
                            ...
                            if (hasSystemProxies) {
                                String sproto;
                                if (proto.equalsIgnoreCase("socket")) { sproto = "socks"; } else { sproto = proto; }
                        ...
                        if (pport == 0) {
                            ...
                            { pport = defaultPort("socket"); } else { pport = defaultPort(proto); }
                        }
