...
class ExchangeImpl {
    ...
    long reqContentLen;
    long rspContentLen;
    /* raw streams which access the socket directly */ InputStream ris;
    OutputStream ros;
    Thread thread;
    /* close the underlying connection when this exchange finished */ boolean close;
    boolean closed;
    ...
    public void sendResponseHeaders(int rCode, long contentLen) throws IOException {
        ...
        if ((rCode >= 100 && rCode < 200) /* informational */ || (rCode == 204)           /* no content */ ||
