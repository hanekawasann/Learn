    ...
    */
    ...
    public ClassTab(VMPanel vmPanel) {
        ...
        loadedClassesMeter.plotter
            .createSequence(totalLoadedPlotterKey, Messages.TOTAL_LOADED, totalLoadedPlotterColor, true);
        setAccessibleName(loadedClassesMeter.plotter, Messages.CLASS_TAB_LOADED_CLASSES_PLOTTER_ACCESSIBLE_NAME);
