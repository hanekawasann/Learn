...
public class Plotter extends JComponent implements Accessible, ActionListener, PropertyChangeListener {
    ...
    static final String[] rangeNames = { Messages.ONE_MIN, Messages.FIVE_MIN, Messages.TEN_MIN, Messages.THIRTY_MIN,
        Messages.ONE_HOUR, Messages.TWO_HOURS, Messages.THREE_HOURS, Messages.SIX_HOURS, Messages.TWELVE_HOURS,
        Messages.ONE_DAY, Messages.SEVEN_DAYS, Messages.ONE_MONTH, Messages.THREE_MONTHS, Messages.SIX_MONTHS,
        Messages.ONE_YEAR, Messages.ALL };
    ...
    private void saveDataToFile(File file) {
        try {
            ...
            JOptionPane.showMessageDialog(this,
                Resources.format(Messages.FILE_CHOOSER_SAVED_FILE, file.getAbsolutePath(), file.length()));
            ...
            JOptionPane.showMessageDialog(this, Resources.format(Messages.FILE_CHOOSER_SAVE_FAILED_MESSAGE, path, msg),
                Messages.FILE_CHOOSER_SAVE_FAILED_TITLE, JOptionPane.ERROR_MESSAGE);
        }
    }
            ...
            if (file != null) {
                ...
                if (file.exists()) {
                    ...
                    int ret = JOptionPane.showOptionDialog(this,
                        ...
                        Messages.FILE_CHOOSER_FILE_EXISTS_TITLE, JOptionPane.OK_CANCEL_OPTION,
                ...
                for (Sequence seq : seqs) {
                    if (seq.isPlotted) {
                        ...
                        keyValueList += Resources
                            .format(Messages.PLOTTER_ACCESSIBLE_NAME_KEY_AND_VALUE, seq.key, value);
                    }
                }
                name += "\n" + keyValueList + ".";
            } else {
