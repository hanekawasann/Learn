...
public class ProxyClient implements JConsoleContext {
            ...
            if (!Proxy.isProxyClass(stub.getClass())) {
                ...
                if (handler.getClass() != RemoteObjectInvocationHandler.class) {
                    throw new SecurityException(
                        "Expecting a dynamic proxy instance with a " + RemoteObjectInvocationHandler.class.getName() +
                            " invocation handler!");
                } else {
                    stub = (Remote) handler;
                }
    ...
    public static class Snapshot {
        ...
        public static SnapshotMBeanServerConnection newSnapshot(MBeanServerConnection mbsc) {
            ...
            return (SnapshotMBeanServerConnection) Proxy
                .newProxyInstance(Snapshot.class.getClassLoader(), new Class[] { SnapshotMBeanServerConnection.class },
                    ih);
        }
    }
    ...
    static class SnapshotInvocationHandler implements InvocationHandler {
        ...
        private Object getAttribute(ObjectName objName, String attrName)
            throws MBeanException, InstanceNotFoundException, AttributeNotFoundException, ReflectionException,
            IOException {
