...
public class AboutDialog extends InternalDialog {
    ...
    public AboutDialog(JConsole jConsole) {
        ...
        setAccessibleName(mastheadLabel, Messages.HELP_ABOUT_DIALOG_MASTHEAD_ACCESSIBLE_NAME);
        ...
        JEditorPane helpLink = new JEditorPane("text/html", "<html><font color=#" + colorStr + ">" +
            Resources.format(Messages.HELP_ABOUT_DIALOG_JCONSOLE_VERSION, jConsoleVersion) + "<p>" +
            Resources.format(Messages.HELP_ABOUT_DIALOG_JAVA_VERSION, (vmName + ", " + vmVersion)) + "<p>" + urlStr +
            "</html>");
