...
class SummaryTab extends Tab {
    ...
    public SummaryTab(VMPanel vmPanel) {
        ...
        headerDateTimeFormat = Formatter.getDateTimeFormat(Messages.SUMMARY_TAB_HEADER_DATE_TIME_FORMAT);
    }
            ...
            protected void done() {
                try {
                    ...
                    if (result != null) {
                        ...
                        if (overviewPanel != null && result.upTime > 0L && result.processCpuTime >= 0L) {
        ...
        try {
            ...
            {  // VM info
                ...
                append(Messages.VIRTUAL_MACHINE,
                    Resources.format(Messages.SUMMARY_TAB_VM_VERSION, rmBean.getVmName(), rmBean.getVmVersion()));
                ...
                if (cmpMBean != null) {
                    ...
                    append(Messages.TOTAL_COMPILE_TIME,
                        cmpMBean.isCompilationTimeMonitoringSupported() ? formatTime(cmpMBean.getTotalCompilationTime())
            ...
            {  // Memory
                ...
                append(Messages.SUMMARY_TAB_PENDING_FINALIZATION_LABEL, Messages.SUMMARY_TAB_PENDING_FINALIZATION_VALUE,
                ...
                for (GarbageCollectorMXBean garbageCollectorMBean : garbageCollectors) {
                    ...
                    append(Messages.GARBAGE_COLLECTOR, Resources.format(Messages.GC_INFO, gcName, gcCount,
                        (gcTime >= 0) ? formatTime(gcTime) : Messages.UNAVAILABLE), 4);
                }
                append(endTable);
            }
            ...
            {  // Operating System info
                ...
                if (sunOSMBean != null) {
                    ...
                    String[] kbStrings2 = formatKByteStrings(sunOSMBean.getTotalPhysicalMemorySize(),
            ...
            {  // VM arguments and paths
                ...
                append(Messages.BOOT_CLASS_PATH,
                    rmBean.isBootClassPathSupported() ? rmBean.getBootClassPath() : Messages.UNAVAILABLE, 4);
                append(endTable);
            }
        } catch (IOException e) {
            if (JConsole.isDebug()) {
    ...
    private void append(String label, String value, int columnPerRow) {
        if (columnPerRow == 4 && pathSeparator != null) {
            value = value.replace(pathSeparator, "<b></b>" + pathSeparator);
        }
        ...
        public void updateCPUInfo(Result result) {
            if (prevUpTime > 0L && result.upTime > prevUpTime) {
                ...
                getInfoLabel().setText(
                    Resources.format(Messages.CPU_USAGE_FORMAT, String.format("%." + CPU_DECIMALS + "f", cpuUsage)));
            }
