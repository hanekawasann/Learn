...
public class XTree extends JTree {
    ...
    private static class MBeanInfoNodesSwingWorker extends SwingWorker<Object[], Void> {
        ...
        // Call on EDT
        private void addMBeanInfoNodes(DefaultTreeModel tree, DefaultMutableTreeNode node, XMBean mbean,
            MBeanInfo mbeanInfo, Boolean isBroadcaster) {
            ...
            if (ai != null && ai.length > 0) {
                ...
                XNodeInfo attributesUO = new XNodeInfo(Type.ATTRIBUTES, mbean, Messages.ATTRIBUTES, null);
                ...
                for (MBeanAttributeInfo mbai : ai) {
                    ...
                    XNodeInfo attributeUO = new XNodeInfo(Type.ATTRIBUTE, new Object[] { mbean, mbai }, mbai.getName(),
                        null);
            ...
            if (oi != null && oi.length > 0) {
                ...
                XNodeInfo operationsUO = new XNodeInfo(Type.OPERATIONS, mbean, Messages.OPERATIONS, null);
                ...
                for (MBeanOperationInfo mboi : oi) {
                    ...
                    XNodeInfo operationUO = new XNodeInfo(Type.OPERATION, new Object[] { mbean, mboi }, mboi.getName(),
                        toolTipText);
            ...
            if (isBroadcaster != null && isBroadcaster.booleanValue()) {
                ...
                XNodeInfo notificationsUO = new XNodeInfo(Type.NOTIFICATIONS, mbean, Messages.NOTIFICATIONS, null);
    ...
    // Utility classes
    //
    private static class ComparableDefaultMutableTreeNode extends DefaultMutableTreeNode
    ...
    private static class Dn implements Comparable<Dn> {
        ...
        public Dn(ObjectName mbean) {
            ...
            if (isTreeView()) {
                // Tree view
                Map<String, String> map = extractKeyValuePairs(keyPropertyList, mbean);
                for (Map.Entry<String, String> entry : map.entrySet()) {
