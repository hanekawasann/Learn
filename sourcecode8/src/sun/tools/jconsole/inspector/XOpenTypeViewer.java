...
public class XOpenTypeViewer extends JPanel implements ActionListener {
    ...
    private static final String compositeNavigationSingle = Messages.MBEANS_TAB_COMPOSITE_NAVIGATION_SINGLE;
    private static final String tabularNavigationSingle = Messages.MBEANS_TAB_TABULAR_NAVIGATION_SINGLE;
            ...
            if (col == 1) {
                ...
                if (value != null) {
                    if (isClickableElement(value)) {
                        return Messages.DOUBLE_CLICK_TO_VISUALIZE + ". " + value.toString();
    ...
    static class XCompositeData extends XOpenTypeData {
        protected final String[] columnNames = { Messages.NAME, Messages.VALUE };
    ...
    static class XArrayData extends XCompositeData implements XViewedArrayData {
        ...
        public void viewed(XOpenTypeViewer viewer) throws Exception {
            if (size == 0) { throw new Exception(Messages.EMPTY_ARRAY); }
            if (dimension > 1) { throw new Exception(Messages.DIMENSION_IS_NOT_SUPPORTED_COLON + dimension); }
            super.viewed(viewer);
        }
        ...
        public String toString() {
            if (dimension > 1) {
                return Messages.DIMENSION_IS_NOT_SUPPORTED_COLON + dimension;
            } else {
    ...
    void setOpenType(XOpenTypeData data) {
        ...
        if (!(data instanceof XViewedTabularData)) {
            ...
            if (hasMoreThanOneElement) {
                tabularLabel.setText(Resources.format(Messages.MBEANS_TAB_TABULAR_NAVIGATION_MULTIPLE,
        ...
        if (!(data instanceof XViewedArrayData)) {
            ...
            if (hasMoreThanOneElement) {
                compositeLabel.setText(Resources.format(Messages.MBEANS_TAB_COMPOSITE_NAVIGATION_MULTIPLE,
