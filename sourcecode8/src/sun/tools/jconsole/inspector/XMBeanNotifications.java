...
public class XMBeanNotifications extends JTable implements NotificationListener {
    ...
    private final static String[] columnNames = { Messages.TIME_STAMP, Messages.TYPE, Messages.USER_DATA,
        Messages.SEQ_NUM, Messages.MESSAGE, Messages.EVENT, Messages.SOURCE };
    ...
    public synchronized TableCellRenderer getCellRenderer(int row, int column) {
        ...
        if (cell != null) {
            toolTip = Messages.DOUBLE_CLICK_TO_EXPAND_FORWARD_SLASH_COLLAPSE + ". " + cell.toString();
        } else {
