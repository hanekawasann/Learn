...
public final class SheetDialog {
    ...
    static JOptionPane showOptionDialog(final VMPanel vmPanel, Object message, int optionType, int messageType,
        ...
        final SheetOptionPane optionPane = new SheetOptionPane(message, messageType, optionType, icon, options,
            initialValue);

        optionPane.setComponentOrientation(vmPanel.getComponentOrientation());
        optionPane.addPropertyChangeListener(new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent event) {
                if (event.getPropertyName().equals(VALUE_PROPERTY) && event.getNewValue() != null &&
            ...
            message = new JLabel((String) message) {
                public Dimension getPreferredSize() {
                    ...
                    if (v != null) {
                        ...
                        SwingUtilities
                            .layoutCompoundLabel(this, fm, text, null, getVerticalAlignment(), getHorizontalAlignment(),
    ...
    static class SheetOptionPane extends JOptionPane {
        SheetOptionPane(Object message, int messageType, int optionType, Icon icon, Object[] options,
            Object initialValue) {
        ...
        private static Composite comp = AlphaComposite.getInstance(AlphaComposite.SRC_OVER, 0.8F);
