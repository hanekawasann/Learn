...
public class ConnectDialog extends InternalDialog
    ...
    public ConnectDialog(JConsole jConsole) {
        ...
        LabeledComponent lc;
        lc = new LabeledComponent(Messages.USERNAME_COLON_, Resources.getMnemonicInt(Messages.USERNAME_COLON_),
            userNameTF);
        ...
        lc = new LabeledComponent(Messages.PASSWORD_COLON_, Resources.getMnemonicInt(Messages.PASSWORD_COLON_),
            passwordTF);
    ...
    public void setConnectionParameters(String url, String host, int port, String userName, String password,
        String msg) {
    ...
    public void refresh() {
        if (vmModel != null) {
            ...
            localTableScrollPane.setVerticalScrollBarPolicy(
                (dim.height < 100) ? JScrollPane.VERTICAL_SCROLLBAR_NEVER : JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
    ...
    private static class ManagedVmTableModel extends AbstractTableModel {
        private static String[] columnNames = { Messages.COLUMN_NAME, Messages.COLUMN_PID, };
    ...
    private static class Padder extends JPanel {
        ...
        private static Rectangle getTextRectangle(AbstractButton button) {
            ...
            SwingUtilities.layoutCompoundLabel(button, g.getFontMetrics(), text, icon, button.getVerticalAlignment(),
                button.getHorizontalAlignment(), button.getVerticalTextPosition(), button.getHorizontalTextPosition(),
                paintViewR, paintIconR, paintTextR, button.getIconTextGap());
