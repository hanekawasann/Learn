...
public class BatchEnvironment extends Environment implements ErrorConsumer {
     ...
     * Factory
     */
    static BatchEnvironment create(OutputStream out, String srcPathString, String classPathString,
        String sysClassPathString, String extDirsString) {
    ...
    *--------------------------*/
                ...
                if (srcfile == null) {
                    ...
                    if (bc.getSource() != null) {
                        ...
                        if ((srcfile != null) && srcfile.exists()) {
                            ...
                            bc.loadNested(this);
                            if (tracing) {
                                dtExit("loadDefinition: EXIT " + c.getName() + ", status " + c.getStatus());
                            }
                            return;
                        }
                    }
            ...
            case CS_SOURCE: {
                ...
                if (c.getClassDefinition() != null) {
                    ...
                    if (srcfile == null) {
                        ...
                        c.setDefinition(null, CS_NOTFOUND);
                        if (tracing) {
                            dtExit("loadDefinition: SOURCE NOT FOUND " + c.getName() + ", status " + c.getStatus());
                        }
                        return;
                    }
                }
     ...
     * Create a new class.
     */
    public ClassDefinition makeClassDefinition(Environment toplevelEnv, long where, IdentifierToken name, String doc,
        ...
        ClassDefinition sourceClass = new SourceClass(toplevelEnv, where, c, doc, modifiers, superClass, interfaces,
    ...
    public String errorString(String err, Object arg1, Object arg2, Object arg3) {
        ...
        if (err.startsWith("warn.")) { key = "javac.err." + err.substring(5); } else { key = "javac.err." + err; }

        return Main.getText(key, arg1 != null ? arg1.toString() : null, arg2 != null ? arg2.toString() : null,
    ...
    public void pushError(String errorFileName, int line, String message, String referenceText,
        String referenceTextPointer) {
    ...
    public void flushErrors() {
        ...
        try {
            ...
            InputStreamReader reader = (getCharacterEncoding() != null ? new InputStreamReader(in,
                getCharacterEncoding()) : new InputStreamReader(in));
