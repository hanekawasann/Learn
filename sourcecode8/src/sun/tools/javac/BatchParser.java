...
public class BatchParser extends Parser {
     ...
     * Define class
     */
    public ClassDefinition beginClass(long where, String doc, int mod, IdentifierToken t, IdentifierToken sup,
        ...
        sourceClass = (SourceClass) toplevelEnv
            .makeClassDefinition(toplevelEnv, where, t, doc, mod, sup, interfaces, outerClass);
     ...
     * Define a method
     */
    public void defineField(long where, ClassDefinition c, String doc, int mod, Type t, IdentifierToken name,
        ...
        if (nm.equals(idInit)) {
            ...
            Identifier retname = !rt.isType(TC_CLASS) ? idStar /*no match*/ : rt.getClassName();
