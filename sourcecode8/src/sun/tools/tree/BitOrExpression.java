...
public class BitOrExpression extends BinaryBitExpression {
     ...
     */
    Expression simplify() {
        if (left.equals(false) || left.equals(0)) { return right; }
        if (right.equals(false) || right.equals(0)) { return left; }
        if (left.equals(true)) { return new CommaExpression(where, right, left).simplify(); }
        if (right.equals(true)) { return new CommaExpression(where, left, right).simplify(); }
        return this;
    }
