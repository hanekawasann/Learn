    ...
    public Arguments(String[] args) throws IllegalArgumentException {
        ...
        if (specialOption != null) {
            ...
            if (optionFormat == null) {
                throw new IllegalArgumentException("Unknown option: -" + specialOption);
            }
        }
        ...
        try {
            ...
            IllegalArgumentException iae = new IllegalArgumentException("Malformed VM Identifier: " + vmIdString);
            iae.initCause(e);
            throw iae;
        }
    }
