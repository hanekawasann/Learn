...
public class ISO2022_JP extends Charset implements HistoricallyNamedCharset {
    ...
    public boolean contains(Charset cs) {
        return ((cs instanceof JIS_X_0201) || (cs instanceof US_ASCII) || (cs instanceof JIS_X_0208) ||
                ...
                while (sp < sl) {
                    ...
                    switch (currentState) {
                        ...
                        case JISX0208_1983:
                            ...
                            if (c == UNMAPPABLE_DECODING) { return CoderResult.unmappableForLength(inputSize); }
                            da[dp++] = c;
                            break;
                        case JISX0212_1990:
                            if (sp + inputSize + 1 > sl) { return CoderResult.UNDERFLOW; }
    ...
    static class Encoder extends CharsetEncoder {
        ...
        Encoder(Charset cs, DoubleByte.Encoder enc0208, DoubleByte.Encoder enc0212, boolean doSBKANA) {
        ...
        public boolean canEncode(char c) {
            return ((c <= '\u007F') || (c >= 0xFF61 && c <= 0xFF9F) || (c == '\u00A5') || (c == '\u203E') ||
                enc0208.canEncode(c) || (enc0212 != null && enc0212.canEncode(c)));
        }
            ...
            try {
                while (sp < sl) {
                    ...
                    if (c <= '\u007F') {
                        ...
                        } else if (enc0212 != null && (index = enc0212.encodeChar(c)) != UNMAPPABLE_ENCODING) {
