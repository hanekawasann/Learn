...
public class MSISO2022JP extends ISO2022_JP {
    ...
    public boolean contains(Charset cs) {
        return super.contains(cs) || (cs instanceof MSISO2022JP);
    }
    ...
    private static class CoderHolder {
        final static DoubleByte.Decoder DEC0208 = (DoubleByte.Decoder) new JIS_X_0208_MS932().newDecoder();
        final static DoubleByte.Encoder ENC0208 = (DoubleByte.Encoder) new JIS_X_0208_MS932().newEncoder();
    }
}
