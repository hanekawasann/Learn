...
public class EUC_JP extends Charset implements HistoricallyNamedCharset {
    ...
    public boolean contains(Charset cs) {
        return ((cs.name().equals("US-ASCII")) || (cs instanceof JIS_X_0201) || (cs instanceof JIS_X_0208) ||
            (cs instanceof JIS_X_0212) || (cs instanceof EUC_JP));
    }
    ...
    static class Decoder extends CharsetDecoder implements DelegatableDecoder {
        ...
        final static SingleByte.Decoder DEC0201 = (SingleByte.Decoder) new JIS_X_0201().newDecoder();

        final static DoubleByte.Decoder DEC0208 = (DoubleByte.Decoder) new JIS_X_0208().newDecoder();

        final static DoubleByte.Decoder DEC0212 = (DoubleByte.Decoder) new JIS_X_0212().newDecoder();
        ...
        protected Decoder(Charset cs, float avgCpb, float maxCpb, SingleByte.Decoder dec0201,
            DoubleByte.Decoder dec0208, DoubleByte.Decoder dec0212) {
        ...
        protected char decodeDouble(int byte1, int byte2) {
            if (byte1 == 0x8e) {
                if (byte2 < 0x80) { return UNMAPPABLE_DECODING; }
        ...
        public CoderResult decodeLoop(ByteBuffer src, CharBuffer dst) {
            if (src.hasArray() && dst.hasArray()) { return decodeArrayLoop(src, dst); } else {
    ...
    static class Encoder extends CharsetEncoder {
        ...
        final static SingleByte.Encoder ENC0201 = (SingleByte.Encoder) new JIS_X_0201().newEncoder();

        final static DoubleByte.Encoder ENC0208 = (DoubleByte.Encoder) new JIS_X_0208().newEncoder();

        final static DoubleByte.Encoder ENC0212 = (DoubleByte.Encoder) new JIS_X_0212().newEncoder();
        ...
        protected Encoder(Charset cs, float avgBpc, float maxBpc, SingleByte.Encoder enc0201,
            DoubleByte.Encoder enc0208, DoubleByte.Encoder enc0212) {
        ...
        public boolean canEncode(char c) {
            ...
            return encodeSingle(c, encodedBytes) != 0 || encodeDouble(c) != UNMAPPABLE_ENCODING;
        }
        ...
        protected int encodeDouble(char ch) {
            ...
            if (b != UNMAPPABLE_ENCODING) { return b + 0x8080; }
            if (enc0212 != null) {
                b = enc0212.encodeChar(ch);
                if (b != UNMAPPABLE_ENCODING) { b += 0x8F8080; }
            }
            return b;
        }
        ...
        protected CoderResult encodeLoop(CharBuffer src, ByteBuffer dst) {
            if (src.hasArray() && dst.hasArray()) { return encodeArrayLoop(src, dst); } else {
