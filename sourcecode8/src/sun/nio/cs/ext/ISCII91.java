...
public class ISCII91 extends Charset implements HistoricallyNamedCharset {
    ...
    private static final char[] directMapTable = { '\u0000', // ascii character
        '\u0001', // ascii character
        '\u0002', // ascii character
        '\u0003', // ascii character
        '\u0004', // ascii character
    ...
    private static final byte[] encoderMappingTable = { NO_CHAR, NO_CHAR, //0900 <reserved>
    ...
    private static class Encoder extends CharsetEncoder {
        ...
        public boolean canEncode(char ch) {
            ...
            return ((ch >= '\u0900' && ch <= '\u097f' && encoderMappingTable[2 * (ch - '\u0900')] != NO_CHAR) ||
                (ch == '\u200d') || (ch == '\u200c') || (ch <= '\u007f'));
        }
