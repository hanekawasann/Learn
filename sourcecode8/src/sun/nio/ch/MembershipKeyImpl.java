...
class MembershipKeyImpl extends MembershipKey {
    ...
    static class Type4 extends MembershipKeyImpl {
        ...
        Type4(MulticastChannel ch, InetAddress group, NetworkInterface interf, InetAddress source, int groupAddress,
    ...
    static class Type6 extends MembershipKeyImpl {
        ...
        Type6(MulticastChannel ch, InetAddress group, NetworkInterface interf, InetAddress source, byte[] groupAddress,
            int index, byte[] sourceAddress) {
            super(ch, group, interf, source);
            this.groupAddress = groupAddress;
            this.index = index;
            this.sourceAddress = sourceAddress;
    ...
    public MembershipKey block(InetAddress toBlock) throws IOException {
        if (source != null) { throw new IllegalStateException("key is source-specific"); }
        ...
        synchronized (stateLock) {
            ...
            if (blockedSet == null) { blockedSet = new HashSet<InetAddress>(); }
