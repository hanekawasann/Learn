...
final class SessionManager {
    ...
    synchronized Session getOpSession() throws PKCS11Exception {
        ...
        if (maxSessions == Integer.MAX_VALUE || activeSessions < maxSessions) {
            session = openSession();
            return ensureValid(session);
        }
    ...
    synchronized Session killSession(Session session) {
        ...
        if (debug != null) {
            ...
            System.out.println("Killing session (" + location + ") active: " + activeSessions);
        }
    ...
    private Session openSession() throws PKCS11Exception {
        ...
        long id = token.p11.C_OpenSession(token.provider.slotID, openSessionFlags, null, null);
    ...
    private static final class Pool {
        ...
        void release(Session session) {
            ...
            if (debug != null) {
                System.out.println("Closing " + i + " idle sessions, active: " + mgr.activeSessions);
            }
