...
public final class ECKeyPairGenerator extends KeyPairGeneratorSpi {
    ...
    public void initialize(AlgorithmParameterSpec params, SecureRandom random)
        ...
        if (params instanceof ECParameterSpec) {
            this.params = ECUtil.getECParameterSpec(null, (ECParameterSpec) params);
            if (this.params == null) {
    ...
    public KeyPair generateKeyPair() {
        ...
        try {
            ...
            ECPoint w = ECUtil.decodePoint(getEncodedBytes(handles[1]), ((ECParameterSpec) params).getCurve());
     ...
     */
    private static native long[] generateECKeyPair(int keySize, byte[] encodedParams, byte[] seed)
