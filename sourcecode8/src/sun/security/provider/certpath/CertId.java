...
public class CertId {
    ...
    public CertId(X500Principal issuerName, PublicKey issuerKey, SerialNumber serialNumber) throws IOException {
        ...
        if (debug) {
            ...
            System.out.println("issuerNameHash is " + encoder.encodeBuffer(issuerNameHash));
            System.out.println("issuerKeyHash is " + encoder.encodeBuffer(issuerKeyHash));
    ...
    public boolean equals(Object other) {
        ...
        if (hashAlgId.equals(that.getHashAlgorithm()) && Arrays.equals(issuerNameHash, that.getIssuerNameHash()) &&
