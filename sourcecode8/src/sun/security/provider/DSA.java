...
abstract class DSA extends SignatureSpi {
     ...
     * @throws InvalidKeyException if the key is not a valid DSA private
     *                             key.
     */
     ...
     * @throws InvalidKeyException if the key is not a valid DSA public
     *                             key.
     */
     ...
     * Encoding Rules.
     * @throws SignatureException if the signature object was not
