...
public class X509Factory extends CertificateFactorySpi {
    ...
    public Certificate engineGenerateCertificate(InputStream is) throws CertificateException {
        ...
        try {
            ...
            throw (CertificateException) new CertificateException("Could not parse certificate: " + ioe.toString())
                .initCause(ioe);
        }
    }
     ...
     * @throws CertificateException on parsing errors.
     */
    public Collection<? extends java.security.cert.Certificate> engineGenerateCertificates(InputStream is)
