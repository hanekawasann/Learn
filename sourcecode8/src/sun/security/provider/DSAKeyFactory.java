        ...
        try {
            ...
            if (key instanceof java.security.interfaces.DSAPublicKey) {
                ...
                if (dsaPubKeySpec.isAssignableFrom(keySpec)) {
                    ...
                    return keySpec
                        .cast(new DSAPublicKeySpec(dsaPubKey.getY(), params.getP(), params.getQ(), params.getG()));
                ...
                if (dsaPrivKeySpec.isAssignableFrom(keySpec)) {
                    ...
                    return keySpec
                        .cast(new DSAPrivateKeySpec(dsaPrivKey.getX(), params.getP(), params.getQ(), params.getG()));
