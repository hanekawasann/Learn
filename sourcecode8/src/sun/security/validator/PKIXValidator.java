...
public final class PKIXValidator extends Validator {
     ...
     */
    private final static boolean checkTLSRevocation = AccessController
        .doPrivileged(new GetBooleanAction("com.sun.net.ssl.checkRevocation"));
        ...
        if (TRY_VALIDATOR) {
            ...
            if (plugin) {
                ...
                if (chain.length > 1) {
                    ...
                    try {
                        pkixParameters
                            .setTrustAnchors(Collections.singleton(new TrustAnchor(chain[chain.length - 1], null)));
    ...
    private X509Certificate[] doBuild(X509Certificate[] chain, Collection<X509Certificate> otherCerts,
