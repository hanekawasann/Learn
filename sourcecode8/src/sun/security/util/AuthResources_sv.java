...
public class AuthResources_sv extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        { "Invalid.NTSid.value", "Ogiltigt NTSid-v\u00E4rde" }, { "NTSid.name", "NTSid: {0}" },
        { "NTSidDomainPrincipal.name", "NTSidDomainPrincipal: {0}" },
        { "NTSidGroupPrincipal.name", "NTSidGroupPrincipal: {0}" },
        { "NTSidPrimaryGroupPrincipal.name", "NTSidPrimaryGroupPrincipal: {0}" },
        { "NTSidUserPrincipal.name", "NTSidUserPrincipal: {0}" }, { "NTUserPrincipal.name", "NTUserPrincipal: {0}" },
        ...
        { "Keystore.alias.", "Nyckellageralias: " }, { "Keystore.password.", "Nyckellagerl\u00F6senord: " },
        ...
        { ".error.parsing.", ": tolkningsfel " }, { "COLON", ": " },
        { ".error.adding.Permission.", ": fel vid till\u00E4gg av beh\u00F6righet " }, { "SPACE", " " },
        { ".error.adding.Entry.", ": fel vid till\u00E4gg av post " }, { "LPARAM", "(" }, { "RPARAM", ")" },
        ...
        { "only.Principal.based.grant.entries.permitted", "endast identitetshavarbaserade poster till\u00E5ts" },
        ...
        { "expected.read.end.of.file", "f\u00F6rv\u00E4ntade ';', l\u00E4ste filslut" }, { "line.", "rad " },
        { ".expected.", ": f\u00F6rv\u00E4ntade '" }, { ".found.", "', hittade '" }, { "QUOTE", "'" },

        // SolarisPrincipals
        { "SolarisNumericGroupPrincipal.Primary.Group.", "SolarisNumericGroupPrincipal [prim\u00E4r grupp]: " },
        { "SolarisNumericGroupPrincipal.Supplementary.Group.", "SolarisNumericGroupPrincipal [till\u00E4ggsgrupp]: " },
