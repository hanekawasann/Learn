...
public class AuthResources_de extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        { "Invalid.NTSid.value", "Ung\u00FCltiger NTSid-Wert" }, { "NTSid.name", "NTSid: {0}" },
        ...
        { "Keystore.alias.", "Keystore-Alias: " }, { "Keystore.password.", "Keystore-Kennwort: " },
        ...
        { ".error.parsing.", ": Parsefehler " }, { "COLON", ": " },
        { ".error.adding.Permission.", ": Fehler beim Hinzuf\u00FCgen der Berechtigung " }, { "SPACE", " " },
        { ".error.adding.Entry.", ": Fehler beim Hinzuf\u00FCgen des Eintrags " }, { "LPARAM", "(" }, { "RPARAM", ")" },
        ...
        { "expected.read.end.of.file", "\";\" erwartet, Dateiende gelesen" }, { "line.", "Zeile " },
        { ".expected.", ": erwartet: \"" }, { ".found.", "\", gefunden: \"" }, { "QUOTE", "'" },

        // SolarisPrincipals
        { "SolarisNumericGroupPrincipal.Primary.Group.", "SolarisNumericGroupPrincipal [Prim\u00E4rgruppe]: " },
        { "SolarisNumericGroupPrincipal.Supplementary.Group.", "SolarisNumericGroupPrincipal [Zusatzgruppe]: " },
