...
public class DisabledAlgorithmConstraints implements AlgorithmConstraints {
    ...
    private final static Map<String, String[]> disabledAlgorithmsMap = new HashMap<>();
    private final static Map<String, KeySizeConstraints> keySizeConstraintsMap = new HashMap<>();
