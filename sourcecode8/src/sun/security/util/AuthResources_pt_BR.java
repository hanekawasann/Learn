...
public class AuthResources_pt_BR extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        { "Invalid.NTSid.value", "Valor de NTSid inv\u00E1lido" }, { "NTSid.name", "NTSid: {0}" },
        ...
        { ".error.parsing.", ": erro de parsing " }, { "COLON", ": " },
        { ".error.adding.Permission.", ": erro ao adicionar a Permiss\u00E3o " }, { "SPACE", " " },
        { ".error.adding.Entry.", ": erro ao adicionar a Entrada " }, { "LPARAM", "(" }, { "RPARAM", ")" },
        ...
        { "expected.expect.read.end.of.file.", "esperado {0}, ler fim do arquivo" },
        { "expected.read.end.of.file", "esperado ';', fim de arquivo lido" }, { "line.", "linha " },
        { ".expected.", ": esperado '" }, { ".found.", "', encontrado '" }, { "QUOTE", "'" },

        // SolarisPrincipals
        { "SolarisNumericGroupPrincipal.Primary.Group.", "SolarisNumericGroupPrincipal [Grupo Principal]: " },
        { "SolarisNumericGroupPrincipal.Supplementary.Group.", "SolarisNumericGroupPrincipal [Grupo Complementar]: " },
