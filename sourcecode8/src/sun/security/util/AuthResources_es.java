...
public class AuthResources_es extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        { "Invalid.NTSid.value", "Valor de NTSid no v\u00E1lido" }, { "NTSid.name", "NTSid: {0}" },
        ...
        { ".error.parsing.", ": error de an\u00E1lisis " }, { "COLON", ": " },
        { ".error.adding.Permission.", ": error al agregar el permiso " }, { "SPACE", " " },
        { ".error.adding.Entry.", ": error al agregar la entrada " }, { "LPARAM", "(" }, { "RPARAM", ")" },
        ...
        { "expected.permission.entry", "se esperaba un permiso de entrada" }, { "number.", "n\u00FAmero " },
        ...
        { "line.", "l\u00EDnea " }, { ".expected.", ": se esperaba '" }, { ".found.", "', se ha encontrado '" },
        { "QUOTE", "'" },

        // SolarisPrincipals
        { "SolarisNumericGroupPrincipal.Primary.Group.", "SolarisNumericGroupPrincipal [Grupo Principal]: " },
        { "SolarisNumericGroupPrincipal.Supplementary.Group.", "SolarisNumericGroupPrincipal [Grupo Adicional]: " },
