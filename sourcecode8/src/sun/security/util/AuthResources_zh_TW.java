...
public class AuthResources_zh_TW extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        { "Invalid.NTSid.value", "\u7121\u6548 NTSid \u503C" }, { "NTSid.name", "NTSid: {0}" },
        ...
        { ".error.parsing.", ": \u5256\u6790\u932F\u8AA4 " }, { "COLON", ": " },
        { ".error.adding.Permission.", ": \u65B0\u589E\u6B0A\u9650\u932F\u8AA4 " }, { "SPACE", " " },
        { ".error.adding.Entry.", ": \u65B0\u589E\u8F38\u5165\u932F\u8AA4 " }, { "LPARAM", "(" }, { "RPARAM", ")" },
        ...
        { "expected.expect.read.end.of.file.", "\u9810\u671F\u70BA {0}, \u8B80\u53D6\u6A94\u6848\u7D50\u5C3E" },
        { "expected.read.end.of.file", "\u9810\u671F\u7684 ';'\uFF0C\u8B80\u53D6\u6A94\u6848\u7D50\u5C3E" },
        { "line.", "\u884C " }, { ".expected.", ": \u9810\u671F '" }, { ".found.", "'\uFF0C\u767C\u73FE '" },
        { "QUOTE", "'" },

        // SolarisPrincipals
        { "SolarisNumericGroupPrincipal.Primary.Group.", "SolarisNumericGroupPrincipal [\u4E3B\u7FA4\u7D44]: " },
