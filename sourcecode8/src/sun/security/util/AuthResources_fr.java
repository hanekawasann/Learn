...
public class AuthResources_fr extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        { "Invalid.NTSid.value", "Valeur de NTSid non valide" }, { "NTSid.name", "NTSid : {0}" },
        ...
        { "username.", "nom utilisateur : " }, { "password.", "mot de passe : " },
        ...
        { ".error.parsing.", ": erreur d'analyse " }, { "COLON", ": " },
        { ".error.adding.Permission.", ": erreur d'ajout de droit " }, { "SPACE", " " },
        { ".error.adding.Entry.", ": erreur d'ajout d'entr\u00E9e " }, { "LPARAM", "(" }, { "RPARAM", ")" },
        ...
        { "expected.expect.read.end.of.file.", "attendu {0}, lecture de fin de fichier" },
        { "expected.read.end.of.file", "attendu ';', lecture de fin de fichier" }, { "line.", "ligne " },
        { ".expected.", ": attendu '" }, { ".found.", "', trouv\u00E9 '" }, { "QUOTE", "'" },

        // SolarisPrincipals
        { "SolarisNumericGroupPrincipal.Primary.Group.", "SolarisNumericGroupPrincipal [groupe principal] : " },
