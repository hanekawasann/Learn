...
public class OwnerImpl implements Owner {
     ...
     * @throws NotOwnerException if the caller principal is not on
     ...
     * @throws NotOwnerException  if the caller principal is not on
     *                            the owners list of the Acl.
     * @throws LastOwnerException if there is only one owner left in the group, then
    ...
    public synchronized boolean deleteOwner(Principal caller, Principal owner)
        ...
        if (e.hasMoreElements()) { return ownerGroup.removeMember(owner); } else { throw new LastOwnerException(); }
