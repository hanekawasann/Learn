...
public class Resources_it extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = { { "NEWLINE", "\n" },
        ...
        // keytool: Help part
        { ".OPTION.", " [OPTION]..." }, { "Options.", "Opzioni:" }, { "Use.keytool.help.for.all.available.commands",
        ...
        { "Generated.keyAlgName.secret.key", "Generata chiave segreta {0}" }, //-genseckey
        { "Generated.keysize.bit.keyAlgName.secret.key", "Generata chiave segreta {1} a {0} bit" }, //-genseckey
        ...
        //-importcert
        { "Imports.a.password", "Importa una password" }, //-importpass
        ...
        { "verified.by.s.in.s", "Verificato da %s in %s" }, { "warning.not.verified.make.sure.keystore.is.correct",
