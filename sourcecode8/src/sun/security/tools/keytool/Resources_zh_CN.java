...
public class Resources_zh_CN extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = { { "NEWLINE", "\n" },
        ...
        { "Generates.a.secret.key", "\u751F\u6210\u5BC6\u94A5" }, //-genseckey
        { "Generates.certificate.from.a.certificate.request",
            "\u6839\u636E\u8BC1\u4E66\u8BF7\u6C42\u751F\u6210\u8BC1\u4E66" }, //-gencert
        { "Generates.CRL", "\u751F\u6210 CRL" }, //-gencrl
        { "Generated.keyAlgName.secret.key", "\u5DF2\u751F\u6210{0}\u5BC6\u94A5" }, //-genseckey
        { "Generated.keysize.bit.keyAlgName.secret.key", "\u5DF2\u751F\u6210 {0} \u4F4D{1}\u5BC6\u94A5" }, //-genseckey
        { "Imports.entries.from.a.JDK.1.1.x.style.identity.database",
            "\u4ECE JDK 1.1.x \u6837\u5F0F\u7684\u8EAB\u4EFD\u6570\u636E\u5E93\u5BFC\u5165\u6761\u76EE" }, //-identitydb
        { "Imports.a.certificate.or.a.certificate.chain", "\u5BFC\u5165\u8BC1\u4E66\u6216\u8BC1\u4E66\u94FE" },
        //-importcert
        { "Imports.a.password", "\u5BFC\u5165\u53E3\u4EE4" }, //-importpass
        ...
        { "Your.keystore.contains.keyStore.size.entries",
            "\u60A8\u7684\u5BC6\u94A5\u5E93\u5305\u542B {0,number,integer} \u4E2A\u6761\u76EE" },
        { "Failed.to.parse.input", "\u65E0\u6CD5\u89E3\u6790\u8F93\u5165" }, { "Empty.input", "\u7A7A\u8F93\u5165" },
        ...
        { "Do.you.still.want.to.add.it.to.your.own.keystore.no.",
            "\u662F\u5426\u4ECD\u8981\u5C06\u5B83\u6DFB\u52A0\u5230\u81EA\u5DF1\u7684\u5BC6\u94A5\u5E93? [\u5426]:  " },
        { "Trust.this.certificate.no.", "\u662F\u5426\u4FE1\u4EFB\u6B64\u8BC1\u4E66? [\u5426]:  " }, { "YES", "YES" },
        ...
        { "Install.reply.anyway.no.", "\u662F\u5426\u4ECD\u8981\u5B89\u88C5\u56DE\u590D? [\u5426]:  " }, { "NO", "NO" },
