...
public class Resources_de extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = { { "NEWLINE", "\n" },
        { "STAR", "*******************************************" },
        { "STARNN", "*******************************************\n\n" },
        ...
        { "Generated.keyAlgName.secret.key", "{0} Secret Key generiert" }, //-genseckey
        { "Generated.keysize.bit.keyAlgName.secret.key", "{0}-Bit {1} Secret Key generiert" }, //-genseckey
        ...
        //-importcert
        { "Imports.a.password", "Importiert ein Kennwort" }, //-importpass
        ...
        { "verified.by.s.in.s", "Gepr\u00FCft von %s in %s" }, { "warning.not.verified.make.sure.keystore.is.correct",
