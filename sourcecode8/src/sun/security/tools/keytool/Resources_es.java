...
public class Resources_es extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = { { "NEWLINE", "\n" },
        ...
        // keytool: Help part
        { ".OPTION.", " [OPTION]..." }, { "Options.", "Opciones:" }, { "Use.keytool.help.for.all.available.commands",
        ...
        { "Generated.keyAlgName.secret.key", "Clave secreta {0} generada" }, //-genseckey
        { "Generated.keysize.bit.keyAlgName.secret.key", "Clave secreta {1} de {0} bits generada" }, //-genseckey
        ...
        //-importcert
        { "Imports.a.password", "Importa una contrase\u00F1a" }, //-importpass
        ...
        { "verified.by.s.in.s", "Verificado por %s en %s" }, { "warning.not.verified.make.sure.keystore.is.correct",
