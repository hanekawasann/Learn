...
public class Resources_pt_BR extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = { { "NEWLINE", "\n" },
        ...
        { "Generated.keyAlgName.secret.key", "Chave secreta {0} gerada" }, //-genseckey
        { "Generated.keysize.bit.keyAlgName.secret.key", "Chave secreta {1} de {0} bits gerada" }, //-genseckey
        ...
        //-importcert
        { "Imports.a.password", "Importa uma senha" }, //-importpass
        ...
        { "Failed.to.parse.input", "Falha durante o parsing da entrada" }, { "Empty.input", "Entrada vazia" },
        ...
        { "Re.enter.new.prompt.", "Informe novamente a nova {0}: " }, { "Re.enter.passpword.", "Redigite a senha: " },
        ...
        { "verified.by.s.in.s", "Verificado por %s em %s" }, { "warning.not.verified.make.sure.keystore.is.correct",
