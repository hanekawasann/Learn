...
public class Resources_sv extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = { { "NEWLINE", "\n" },
        ...
        // keytool: Help part
        { ".OPTION.", " [OPTION]..." }, { "Options.", "Alternativ:" }, { "Use.keytool.help.for.all.available.commands",
        ...
        { "Generated.keyAlgName.secret.key", "Genererade {0} hemlig nyckel" }, //-genseckey
        { "Generated.keysize.bit.keyAlgName.secret.key", "Genererade {0}-bitars {1} hemlig nyckel" }, //-genseckey
        ...
        //-importcert
        { "Imports.a.password", "Importerar ett l\u00F6senord" }, //-importpass
        ...
        { "Re.enter.new.prompt.", "Ange nytt {0} igen: " }, { "Re.enter.passpword.", "Ange l\u00F6senord igen: " },
        ...
        { "verified.by.s.in.s", "Verifierad av %s i %s" }, { "warning.not.verified.make.sure.keystore.is.correct",
