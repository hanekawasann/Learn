...
public class Resources extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = { { "NEWLINE", "\n" },
        ...
        { "Generated.keyAlgName.secret.key", "Generated {0} secret key" }, //-genseckey
        { "Generated.keysize.bit.keyAlgName.secret.key", "Generated {0}-bit {1} secret key" }, //-genseckey
        ...
        //-importcert
        { "Imports.a.password", "Imports a password" }, //-importpass
        ...
        { "Re.enter.new.prompt.", "Re-enter new {0}: " }, { "Re.enter.passpword.", "Re-enter password: " },
        ...
        { "verified.by.s.in.s", "Verified by %s in %s" }, { "warning.not.verified.make.sure.keystore.is.correct",
