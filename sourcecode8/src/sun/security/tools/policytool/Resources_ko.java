...
public class Resources_ko extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = { { "NEWLINE", "\n" },
        ...
        { "New", "\uC0C8\uB85C \uB9CC\uB4E4\uAE30(&N)" }, { "Open", "\uC5F4\uAE30(&O)..." },
        { "Save", "\uC800\uC7A5(&S)" }, { "Save.As", "\uB2E4\uB978 \uC774\uB984\uC73C\uB85C \uC800\uC7A5(&A)..." },
        { "View.Warning.Log", "\uACBD\uACE0 \uB85C\uADF8 \uBCF4\uAE30(&W)" }, { "Exit", "\uC885\uB8CC(&X)" },
        { "Add.Policy.Entry", "\uC815\uCC45 \uD56D\uBAA9 \uCD94\uAC00(&A)" },
        { "Edit.Policy.Entry", "\uC815\uCC45 \uD56D\uBAA9 \uD3B8\uC9D1(&E)" },
        { "Remove.Policy.Entry", "\uC815\uCC45 \uD56D\uBAA9 \uC81C\uAC70(&R)" }, { "Edit", "\uD3B8\uC9D1(&E)" },
        { "Retain", "\uC720\uC9C0" },
        ...
        { "Remove.Public.Key.Alias", "\uACF5\uC6A9 \uD0A4 \uBCC4\uCE6D \uC81C\uAC70" }, { "File", "\uD30C\uC77C(&F)" },
        { "KeyStore", "\uD0A4 \uC800\uC7A5\uC18C(&K)" }, { "Policy.File.", "\uC815\uCC45 \uD30C\uC77C:" },
        ...
        { "Cancel", "\uCDE8\uC18C" }, { "CodeBase.", "CodeBase(&C)" }, { "SignedBy.", "SignedBy(&S):" },
        { "Add.Principal", "\uC8FC\uCCB4 \uCD94\uAC00(&A)" }, { "Edit.Principal", "\uC8FC\uCCB4 \uD3B8\uC9D1(&E)" },
        { "Remove.Principal", "\uC8FC\uCCB4 \uC81C\uAC70(&R)" }, { "Principals.", "\uC8FC\uCCB4(&P):" },
        { ".Add.Permission", "  \uAD8C\uD55C \uCD94\uAC00(&D)" },
        { ".Edit.Permission", "  \uAD8C\uD55C \uD3B8\uC9D1(&I)" },
        { "Remove.Permission", "\uAD8C\uD55C \uC81C\uAC70(&M)" }, { "Done", "\uC644\uB8CC" },
        ...
        { "Yes", "\uC608(&Y)" }, { "No", "\uC544\uB2C8\uC624(&N)" }, { "Policy.Entry", "\uC815\uCC45 \uD56D\uBAA9" },
        ...
        { "property.name", "\uC18D\uC131 \uC774\uB984" }, { "provider.name", "\uC81C\uACF5\uC790 \uC774\uB984" },
        { "url", "URL" }, { "method.list", "\uBA54\uC18C\uB4DC \uBAA9\uB85D" },
        { "request.headers.list", "\uC694\uCCAD \uD5E4\uB354 \uBAA9\uB85D" },
        { "Principal.List", "\uC8FC\uCCB4 \uBAA9\uB85D" }, { "Permission.List", "\uAD8C\uD55C \uBAA9\uB85D" },
        { "Code.Base", "\uCF54\uB4DC \uBCA0\uC774\uC2A4" }, { "KeyStore.U.R.L.", "\uD0A4 \uC800\uC7A5\uC18C URL:" },
