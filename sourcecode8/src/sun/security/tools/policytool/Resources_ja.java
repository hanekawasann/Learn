...
public class Resources_ja extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = { { "NEWLINE", "\n" },
        ...
        { "New", "\u65B0\u898F(&N)" }, { "Open", "\u958B\u304F(&O)..." }, { "Save", "\u4FDD\u5B58(&S)" },
        { "Save.As", "\u5225\u540D\u4FDD\u5B58(&A)..." },
        { "View.Warning.Log", "\u8B66\u544A\u30ED\u30B0\u306E\u8868\u793A(&W)" }, { "Exit", "\u7D42\u4E86(&X)" },
        ...
        { "Remove.Permission", "\u30A2\u30AF\u30BB\u30B9\u6A29\u306E\u524A\u9664(&M)" }, { "Done", "\u5B8C\u4E86" },
        ...
        { "provider.name", "\u30D7\u30ED\u30D0\u30A4\u30C0\u540D" }, { "url", "URL" },
        { "method.list", "\u30E1\u30BD\u30C3\u30C9\u30FB\u30EA\u30B9\u30C8" }, { "request.headers.list",
        "\u30EA\u30AF\u30A8\u30B9\u30C8\u30FB\u30D8\u30C3\u30C0\u30FC\u30FB\u30EA\u30B9\u30C8" },
