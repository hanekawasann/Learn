...
public class PolicyTool {
    ...
    // for i18n
    static final java.util.ResourceBundle rb = java.util.ResourceBundle
        .getBundle("sun.security.tools.policytool.Resources");
            ...
            while (perms.hasMoreElements()) {
                ...
                try {
                    ...
                    MessageFormat form = new MessageFormat(
                        getMessage("Warning.Invalid.argument.s.for.constructor.arg"));
                    Object[] source = { pe.permission };
                    warnings.addElement(form.format(source));
                }
...
class ToolWindow extends JFrame {
    ...
    private void initWindow() {
        ...
        try {
            ...
            // display the error
            MessageFormat form = new MessageFormat(
                PolicyTool.getMessage("Could.not.open.policy.file.policyFile.e.toString."));
    ...
    private void addMenuItem(JMenu menu, String key, ActionListener actionListener, String accelerator) {
        ...
        if (accelerator != null && !accelerator.isEmpty()) {
            ...
            if (accelerator.length() == 1) {
                keyStroke = KeyStroke
                    .getKeyStroke(KeyEvent.getExtendedKeyCodeForChar(accelerator.charAt(0)), shortCutModifier);
            } else {
     ...
     */
    void addNewComponent(Container container, JComponent component, int index, int gridx, int gridy, int gridwidth,
...
class ToolDialog extends JDialog {
    ...
    void displayPolicyEntryDialog(boolean edit) {
        ...
        tw.addNewComponent(this, scrollPane, PE_PRIN_LIST, 1, 3, 3, 1, 0.0, prinList.getVisibleRowCount(),
            GridBagConstraints.BOTH, ToolWindow.BOTTOM_PADDING);
        ...
        tw.addNewComponent(this, scrollPane, PE_PERM_LIST, 0, 5, 3, 1, 0.0, permList.getVisibleRowCount(),
            GridBagConstraints.BOTH, ToolWindow.BOTTOM_PADDING);
        ...
        tw.addNewComponent(panel, okButton, PE_DONE_BUTTON, 0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.VERTICAL,
        ...
        tw.addNewComponent(panel, cancelButton, PE_CANCEL_BUTTON, 1, 0, 1, 1, 0.0, 0.0, GridBagConstraints.VERTICAL,
            ToolWindow.LR_PADDING);
    ...
    void keyStoreDialog(int mode) {
        ...
        if (mode == EDIT_KEYSTORE) {
            ...
            tw.addNewComponent(this, tf, KSD_NAME_TEXTFIELD, 1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.BOTH,
            ...
            tw.addNewComponent(this, tf, KSD_TYPE_TEXTFIELD, 1, 1, 1, 1, 1.0, 0.0, GridBagConstraints.BOTH,
                ToolWindow.BOTTOM_PADDING);
            ...
            tw.addNewComponent(this, tf, KSD_PROVIDER_TEXTFIELD, 1, 2, 1, 1, 1.0, 0.0, GridBagConstraints.BOTH,
                ToolWindow.BOTTOM_PADDING);
            ...
            tw.addNewComponent(this, tf, KSD_PWD_URL_TEXTFIELD, 1, 3, 1, 1, 1.0, 0.0, GridBagConstraints.BOTH,
                ToolWindow.BOTTOM_PADDING);
    ...
    void displayPrincipalDialog(boolean editPolicyEntry, boolean edit) {
        ...
        // description label
        JLabel label = (edit ? new JLabel(PolicyTool.getMessage(".Edit.Principal."))
        ...
        tw.addNewComponent(newTD, tf, PRD_PRIN_TEXTFIELD, 1, 1, 1, 1, 1.0, 0.0, GridBagConstraints.BOTH,
            ToolWindow.LR_PADDING);
        ...
        tw.addNewComponent(newTD, label, PRD_NAME_LABEL, 0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.BOTH,
            ToolWindow.LR_PADDING);
        tw.addNewComponent(newTD, tf, PRD_NAME_TEXTFIELD, 1, 2, 1, 1, 1.0, 0.0, GridBagConstraints.BOTH,
            ToolWindow.LR_PADDING);
    ...
    void displayPermissionDialog(boolean editPolicyEntry, boolean edit) {
        ...
        // description label
        JLabel label = (edit ? new JLabel(PolicyTool.getMessage(".Edit.Permission."))
        ...
        tw.addNewComponent(newTD, choice, PD_PERM_CHOICE, 0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.BOTH,
        ...
        tw.addNewComponent(newTD, tf, PD_PERM_TEXTFIELD, 1, 1, 1, 1, 1.0, 0.0, GridBagConstraints.BOTH,
            ToolWindow.LR_BOTTOM_PADDING);
        ...
        tw.addNewComponent(newTD, choice, PD_NAME_CHOICE, 0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.BOTH,
            ToolWindow.LR_BOTTOM_PADDING);
        tw.addNewComponent(newTD, tf, PD_NAME_TEXTFIELD, 1, 2, 1, 1, 1.0, 0.0, GridBagConstraints.BOTH,
            ToolWindow.LR_BOTTOM_PADDING);
        ...
        tw.addNewComponent(newTD, choice, PD_ACTIONS_CHOICE, 0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.BOTH,
            ToolWindow.LR_BOTTOM_PADDING);
        tw.addNewComponent(newTD, tf, PD_ACTIONS_TEXTFIELD, 1, 3, 1, 1, 1.0, 0.0, GridBagConstraints.BOTH,
            ToolWindow.LR_BOTTOM_PADDING);
        ...
        tf.setPreferredSize(new Dimension(tf.getPreferredSize().width, TEXTFIELD_HEIGHT));
        tf.getAccessibleContext().setAccessibleName(PolicyTool.getMessage("Signed.By."));
        tw.addNewComponent(newTD, tf, PD_SIGNEDBY_TEXTFIELD, 1, 4, 1, 1, 1.0, 0.0, GridBagConstraints.BOTH,
            ToolWindow.LR_BOTTOM_PADDING);
    ...
    PolicyParser.PermissionEntry getPermFromDialog() {
        ...
        if (permission.equals(FILE_PERM_CLASS) && name.lastIndexOf("\\\\") > 0) {
            char result = tw.displayYesNoDialog(this, PolicyTool.getMessage("Warning"), PolicyTool.getMessage(
                "Warning.File.name.may.include.escaped.backslash.characters.It.is.not.necessary.to.escape.backslash.characters.the.tool.escapes"),
                PolicyTool.getMessage("Retain"), PolicyTool.getMessage("Edit"));
            if (result != 'Y') {
    ...
    void displayConfirmRemovePolicyEntry() {
        ...
        tw.addNewComponent(this, label, CRPE_LABEL1, 0, 0, 2, 1, 0.0, 0.0, GridBagConstraints.BOTH,
            ToolWindow.BOTTOM_PADDING);
    ...
    void displayUserSave(int select) {
        ...
        if (tool.modified == true) {
            ...
            tw.addNewComponent(panel, cancelButton, USC_CANCEL_BUTTON, 2, 0, 1, 1, 0.0, 0.0,
                GridBagConstraints.VERTICAL, ToolWindow.LR_BOTTOM_PADDING);
        ...
        if (PolicyTool.collator.compare(e.getActionCommand(), ToolWindow.QUIT) == 0) {
            ...
            if (filename == null || filename.length() == 0) {
                ...
                try {
                    ...
                    // display status
                    MessageFormat form = new MessageFormat(
                        PolicyTool.getMessage("Policy.successfully.written.to.filename"));
                    Object[] source = { filename };
                    tw.displayStatusDialog(null, form.format(source));
                } catch (FileNotFoundException fnfe) {
                    if (filename == null || filename.equals("")) {
...
class PermissionMenuListener implements ItemListener {
    ...
    public void itemStateChanged(ItemEvent e) {
        ...
        JComboBox perms = (JComboBox) td.getComponent(ToolDialog.PD_PERM_CHOICE);
        JComboBox names = (JComboBox) td.getComponent(ToolDialog.PD_NAME_CHOICE);
        JComboBox actions = (JComboBox) td.getComponent(ToolDialog.PD_ACTIONS_CHOICE);
...
class PermissionNameMenuListener implements ItemListener {
    ...
    public void itemStateChanged(ItemEvent e) {
        ...
        if (((String) e.getItem()).indexOf(ToolDialog.PERM_NAME) != -1) { return; }
...
class PermissionActionsMenuListener implements ItemListener {
    ...
    public void itemStateChanged(ItemEvent e) {
        ...
        if (((String) e.getItem()).indexOf(ToolDialog.PERM_ACTIONS) != -1) { return; }
    ...
    public AuthPerm() {
        super("AuthPermission", "javax.security.auth.AuthPermission",
            new String[] { "doAs", "doAsPrivileged", "getSubject", "getSubjectFromDomainCombiner", "setReadOnly",
                ...
                "destroyCredential", "createLoginContext.<" + PolicyTool.getMessage("name") + ">",
                "getLoginConfiguration", "setLoginConfiguration",
                "createLoginConfiguration.<" + PolicyTool.getMessage("configuration.type") + ">",
...
class URLPerm extends Perm {
    public URLPerm() {
        super("URLPermission", "java.net.URLPermission", new String[] { "<" + PolicyTool.getMessage("url") + ">", },
            new String[] {
    ...
    public RuntimePerm() {
        super("RuntimePermission", "java.lang.RuntimePermission",
            new String[] { "createClassLoader", "getClassLoader", "setContextClassLoader",
                ...
                "getenv.<" + PolicyTool.getMessage("environment.variable.name") + ">", "exitVM", "shutdownHooks",
                "setFactory", "setIO", "modifyThread", "stopThread", "modifyThreadGroup", "getProtectionDomain",
                "readFileDescriptor", "writeFileDescriptor",
                "loadLibrary.<" + PolicyTool.getMessage("library.name") + ">",
                "accessClassInPackage.<" + PolicyTool.getMessage("package.name") + ">",
                "defineClassInPackage.<" + PolicyTool.getMessage("package.name") + ">", "accessDeclaredMembers",
    ...
    public SecurityPerm() {
        super("SecurityPermission", "java.security.SecurityPermission",
            new String[] { "createAccessControlContext", "getDomainCombiner", "getPolicy", "setPolicy",
                "createPolicy.<" + PolicyTool.getMessage("policy.type") + ">",
                "getProperty.<" + PolicyTool.getMessage("property.name") + ">",
                "setProperty.<" + PolicyTool.getMessage("property.name") + ">",
                "insertProvider.<" + PolicyTool.getMessage("provider.name") + ">",
                "removeProvider.<" + PolicyTool.getMessage("provider.name") + ">",
                //"setSystemScope",
                ...
                //"printIdentity",
                "clearProviderProperties.<" + PolicyTool.getMessage("provider.name") + ">",
                "putProviderProperty.<" + PolicyTool.getMessage("provider.name") + ">",
                "removeProviderProperty.<" + PolicyTool.getMessage("provider.name") + ">",
                //"getSignerPrivateKey",
                //"setSignerKeyPair"
            }, null);
    }
