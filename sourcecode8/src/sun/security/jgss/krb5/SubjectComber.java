...
class SubjectComber {
    ...
    static <T> T find(Subject subject, String serverPrincipal, String clientPrincipal, Class<T> credClass) {
        ...
        return credClass.cast(findAux(subject, serverPrincipal, clientPrincipal, credClass, true));
    }
    ...
    private static <T> Object findAux(Subject subject, String serverPrincipal, String clientPrincipal,
        Class<T> credClass, boolean oneOnly) {
        ...
        if (subject == null) {
            ...
            if (credClass == KeyTab.class) {
                Iterator<KeyTab> iterator = subject.getPrivateCredentials(KeyTab.class).iterator();
                ...
                synchronized (pcs) {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        if (obj instanceof KerberosTicket) {
                            ...
                            if (DEBUG) {
                                System.out.println(
                                    "Found ticket for " + ticket.getClient() + " to go to " + ticket.getServer() +
                            ...
                            if (!ticket.isCurrent()) {
                                ...
                                if (!subject.isReadOnly()) {
                                    ...
                                    try {
                                        ...
                                        if (DEBUG) {
                                            System.out
                                                .println("Removed and destroyed " + "the expired Ticket \n" + ticket);
