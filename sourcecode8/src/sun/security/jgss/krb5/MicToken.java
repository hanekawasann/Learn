...
class MicToken extends MessageToken {
    ...
    public MicToken(Krb5Context context, byte[] tokenBytes, int tokenOffset, int tokenLen, MessageProp prop)
        throws GSSException {
        super(Krb5Token.MIC_ID, context, tokenBytes, tokenOffset, tokenLen, prop);
    }
