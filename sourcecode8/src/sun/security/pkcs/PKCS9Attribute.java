...
public class PKCS9Attribute implements DerEncoder {
    ...
    static {   // static initializer for PKCS9_OIDS
        ...
        PKCS9_OIDS[PKCS9_OIDS.length - 2] = ObjectIdentifier
            .newInternal(new int[] { 1, 2, 840, 113549, 1, 9, 16, 2, 12 });
        PKCS9_OIDS[PKCS9_OIDS.length - 1] = ObjectIdentifier
            .newInternal(new int[] { 1, 2, 840, 113549, 1, 9, 16, 2, 14 });
     ...
     */
    private static final Byte[][] PKCS9_VALUE_TAGS = { null, { new Byte(DerValue.tag_IA5String) },   // EMailAddress
        { new Byte(DerValue.tag_IA5String),   // UnstructuredName
            new Byte(DerValue.tag_PrintableString) }, { new Byte(DerValue.tag_ObjectId) },    // ContentType
        ...
        { new Byte(DerValue.tag_PrintableString), new Byte(DerValue.tag_T61String) },   // ChallengePassword
        ...
        null, null, null, { new Byte(DerValue.tag_Sequence) },    // extensionRequest
     ...
     *
     * @throws IllegalArgumentException if the <code>value</code> has the wrong type.
     */
     ...
     *
     * @throws IllegalArgumentException if the <code>name</code> is not recognized or the
    ...
    private void init(ObjectIdentifier oid, Object value) throws IllegalArgumentException {
        ...
        if (!clazz.isInstance(value)) {
            throw new IllegalArgumentException(
                "Wrong value class " + " for attribute " + oid + " constructing PKCS9Attribute; was " +
                    value.getClass().toString() + ", should be " + clazz.toString());
        }
        this.value = value;
    }
