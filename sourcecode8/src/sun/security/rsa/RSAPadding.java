...
public final class RSAPadding {
    ...
    private RSAPadding(int type, int paddedSize, SecureRandom random, OAEPParameterSpec spec)
        throws InvalidKeyException, InvalidAlgorithmParameterException {
        this.type = type;
            ...
            case PAD_OAEP_MGF1:
                ...
                if (maxDataSize <= 0) {
                    throw new InvalidKeyException(
                        "Key is too short for encryption using OAEPPadding" + " with " + mdName + " and MGF1" +
                            mgfMdName);
                }
                break;
            default:
    ...
    private byte[] unpadV15(byte[] padded) throws BadPaddingException {
        ...
        while (k < padded.length) {
            ...
            if ((type == PAD_BLOCKTYPE_1) && (b != 0xff) && p == 0 && bpe == null) {
     ...
     */
    private void mgf1(byte[] seed, int seedOfs, int seedLen, byte[] out, int outOfs, int maskLen)
