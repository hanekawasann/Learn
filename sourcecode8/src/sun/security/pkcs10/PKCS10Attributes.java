...
public class PKCS10Attributes implements DerEncoder {
    ...
    private Hashtable<String, PKCS10Attribute> map = new Hashtable<String, PKCS10Attribute>(3);
    ...
    public PKCS10Attributes(DerInputStream in) throws IOException {
        ...
        if (attrs == null) { throw new IOException("Illegal encoding of attributes"); }
        for (int i = 0; i < attrs.length; i++) {
    ...
    public void derEncode(OutputStream out) throws IOException {
        ...
        PKCS10Attribute[] attribs = allAttrs.toArray(new PKCS10Attribute[map.size()]);
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PKCS10Attributes)) { return false; }
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (!thisAttr.equals(otherAttr)) { return false; }
        }
        return true;
    }
