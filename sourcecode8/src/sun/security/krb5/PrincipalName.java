...
public class PrincipalName implements Cloneable {
    ...
    public PrincipalName(String[] nameParts, int type) throws IllegalArgumentException, RealmException {
     ...
     */
    public static PrincipalName parse(DerInputStream data, byte explicitTag, boolean optional, Realm realm)
            ...
            case KRB_NT_SRV_HST:
                if (nameParts.length >= 2) {
                    ...
                    try {
                        ...
                        if (canonicalized.toLowerCase(Locale.ENGLISH)
    ...
    public static PrincipalName tgsService(String r1, String r2) throws KrbException {
        return new PrincipalName(PrincipalName.KRB_NT_SRV_INST, new String[] { PrincipalName.TGS_DEFAULT_SRV_NAME, r1 },
            new Realm(r2));
    }
    ...
    static String mapHostToRealm(String name) {
        ...
        try {
            ...
            if ((result = c.get("domain_realm", name)) != null) { return result; } else {
