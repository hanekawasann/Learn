...
abstract class KrbAppMessage {
    ...
    void check(KerberosTime packetTimestamp, Integer packetUsec, Integer packetSeqNumber, HostAddress packetSAddress,
        ...
        boolean timestampRequired, boolean seqNumberRequired, PrincipalName packetPrincipal) throws KrbApErrException {
        ...
        if (packetTimestamp != null) {
            if (packetUsec != null) {
                packetTimestamp = packetTimestamp.withMicroSeconds(packetUsec.intValue());
            }
