...
*/
    ...
    /** used by KrbTgsReq **/
    KrbApReq(APOptions apOptions, Ticket ticket, EncryptionKey key, PrincipalName cname, Checksum cksum,
        ...
        init(apOptions, ticket, key, cname, cksum, ctime, subKey, seqNumber, authorizationData,
    ...
    private void init(APOptions options, Credentials tgs_creds, Checksum cksum, EncryptionKey subKey,
        ...
        init(options, tgs_creds.ticket, tgs_creds.key, tgs_creds.client, cksum, ctime, subKey, seqNumber,
            authorizationData, usage);
    }

    private void init(APOptions apOptions, Ticket ticket, EncryptionKey key, PrincipalName cname, Checksum cksum,
        KerberosTime ctime, EncryptionKey subKey, SeqNumber seqNumber, AuthorizationData authorizationData, int usage)
        throws Asn1Exception, IOException, KdcErrException, KrbCryptoException {
    ...
    private void authenticate(Krb5AcceptCredential cred, InetAddress initiator) throws KrbException, IOException {
        ...
        if (!authenticator.ctime.inClockSkew()) { throw new KrbApErrException(Krb5.KRB_AP_ERR_SKEW); }
        ...
        AuthTimeWithHash time = new AuthTimeWithHash(authenticator.cname.toString(), apReqMessg.ticket.sname.toString(),
            authenticator.ctime.getSeconds(), authenticator.cusec, new String(h));
    ...
    private void createMessage(APOptions apOptions, Ticket ticket, EncryptionKey key, PrincipalName cname,
        ...
        authenticator = new Authenticator(cname, cksum, ctime.getMicroSeconds(), ctime, subKey, seqno,
            authorizationData);
