...
public class KRBSafeBody {
    ...
    public KRBSafeBody(byte[] new_userData, KerberosTime new_timestamp, Integer new_usec, Integer new_seqNumber,
        HostAddress new_sAddress, HostAddress new_rAddress) {
    ...
    public KRBSafeBody(DerValue encoding) throws Asn1Exception, IOException {
        ...
        if (encoding.getData().available() > 0) { rAddress = HostAddress.parse(encoding.getData(), (byte) 0x05, true); }
    ...
    public byte[] asn1Encode() throws Asn1Exception, IOException {
        ...
        if (rAddress != null) { temp = new DerOutputStream(); }
     ...
     */
    public static KRBSafeBody parse(DerInputStream data, byte explicitTag, boolean optional)
