...
public class PAData {
    ...
    public Object clone() {
        ...
        if (pADataValue != null) {
            ...
            System.arraycopy(pADataValue, 0, new_pAData.pADataValue, 0, pADataValue.length);
        }
        return new_pAData;
    }
                ...
                if (pADataValue != null) {
                    try {
                        ...
                        while (der.data.available() > 0) {
                            ...
                            sb.append("\t PA-ETYPE-INFO etype = ").append(info.getEType()).append(", salt = ")
                                .append(info.getSalt()).append('\n');
                        }
                ...
                if (pADataValue != null) {
                    try {
                        ...
                        while (der.data.available() > 0) {
                            ...
                            sb.append("\t PA-ETYPE-INFO2 etype = ").append(info2.getEType()).append(", salt = ")
                                .append(info2.getSalt()).append(", s2kparams = ");
                            ...
                            if (s2kparams == null) {
                                ...
                                sb.append(new sun.misc.HexDumpEncoder().encodeBuffer(s2kparams));
                            }
                        }
                    } catch (IOException | Asn1Exception e) {
                        sb.append("\t <Unparseable PA-ETYPE-INFO>\n");
