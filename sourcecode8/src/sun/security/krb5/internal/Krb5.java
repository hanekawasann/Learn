...
public class Krb5 {
    ...
    public static final boolean DEBUG = java.security.AccessController
        .doPrivileged(new sun.security.action.GetBooleanAction("sun.security.krb5.debug"));
    public static final sun.misc.HexDumpEncoder hexDumper = new sun.misc.HexDumpEncoder();
    ...
    static {
        ...
        errMsgList.put(KRB_AP_ERR_NOREALM,
            "Realm name not available"); //used in setDefaultCreds() in sun.security.krb5.Credentials
