...
public class EncTicketPart {
    ...
    public EncTicketPart(TicketFlags new_flags, EncryptionKey new_key, PrincipalName new_cname,
        TransitedEncoding new_transited, KerberosTime new_authtime, KerberosTime new_starttime,
        KerberosTime new_endtime, KerberosTime new_renewTill, HostAddresses new_caddr,
    ...
    private void init(DerValue encoding) throws Asn1Exception, IOException, RealmException {
        ...
        if (((encoding.getTag() & (byte) 0x1F) != (byte) 0x03) || (encoding.isApplication() != true) ||
    ...
    public byte[] asn1Encode() throws Asn1Exception, IOException {
        ...
        bytes.write(DerValue.createTag(DerValue.TAG_CONTEXT, true, (byte) 0x02), cname.getRealm().asn1Encode());
