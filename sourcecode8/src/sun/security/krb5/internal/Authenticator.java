...
public class Authenticator {
    ...
    public Authenticator(PrincipalName new_cname, Checksum new_cksum, int new_cusec, KerberosTime new_ctime,
        EncryptionKey new_subKey, Integer new_seqNumber, AuthorizationData new_authorizationData) {
    ...
    private void init(DerValue encoding) throws Asn1Exception, IOException, KrbApErrException, RealmException {
        ...
        if (((encoding.getTag() & (byte) 0x1F) != (byte) 0x02) || (encoding.isApplication() != true) ||
    ...
    public byte[] asn1Encode() throws Asn1Exception, IOException {
        ...
        v.addElement(
            new DerValue(DerValue.createTag(DerValue.TAG_CONTEXT, true, (byte) 0x01), cname.getRealm().asn1Encode()));
        ...
        if (subKey != null) {
            v.addElement(
                new DerValue(DerValue.createTag(DerValue.TAG_CONTEXT, true, (byte) 0x06), subKey.asn1Encode()));
        }
        if (seqNumber != null) {
            temp = new DerOutputStream();
