...
public class KDCOptions extends KerberosFlags {
    ...
    private static final String[] names = { "RESERVED",         //0
        "FORWARDABLE",      //1;
        "FORWARDED",        //2;
        "PROXIABLE",        //3;
        "PROXY",            //4;
        ...
        "UNUSED10",         //10;
        "UNUSED11",         //11;
        null, null, "CNAME_IN_ADDL_TKT",//14;
        null, null, null, null, null, null, null, null, null, null, null, null, "RENEWABLE_OK",     //27;
        "ENC_TKT_IN_SKEY",  //28;
        null, "RENEW",            //30;
        "VALIDATE",         //31;
    };
    ...
    public static KDCOptions parse(DerInputStream data, byte explicitTag, boolean optional)
