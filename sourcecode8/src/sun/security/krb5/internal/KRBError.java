...
public class KRBError implements java.io.Serializable {
    ...
    public KRBError(APOptions new_apOptions, KerberosTime new_cTime, Integer new_cuSec, KerberosTime new_sTime,
        Integer new_suSec, int new_errorCode, PrincipalName new_cname, PrincipalName new_sname, String new_eText,
        byte[] new_eData) throws IOException, Asn1Exception {
        pvno = Krb5.PVNO;
    ...
    public KRBError(APOptions new_apOptions, KerberosTime new_cTime, Integer new_cuSec, KerberosTime new_sTime,
        Integer new_suSec, int new_errorCode, PrincipalName new_cname, PrincipalName new_sname, String new_eText,
        byte[] new_eData, Checksum new_eCksum) throws IOException, Asn1Exception {
        pvno = Krb5.PVNO;
        msgType = Krb5.KRB_ERROR;
        cTime = new_cTime;
        cuSec = new_cuSec;
    ...
    public boolean equals(Object obj) {
        ...
        return pvno == other.pvno && msgType == other.msgType && isEqual(cTime, other.cTime) &&
            ...
            errorCode == other.errorCode && isEqual(cname, other.cname) && isEqual(sname, other.sname) &&
            isEqual(eText, other.eText) && java.util.Arrays.equals(eData, other.eData) && isEqual(eCksum, other.eCksum);
    }
