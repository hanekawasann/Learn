...
public class EncKrbCredPart {
    ...
    public EncKrbCredPart(KrbCredInfo[] new_ticketInfo, KerberosTime new_timeStamp, Integer new_usec, Integer new_nonce,
        HostAddress new_sAddress, HostAddresses new_rAddress) throws IOException {
    ...
    public EncKrbCredPart(byte[] data) throws Asn1Exception, IOException, RealmException {
        init(new DerValue(data));
    }

    public EncKrbCredPart(DerValue encoding) throws Asn1Exception, IOException, RealmException {
        init(encoding);
    }
    ...
    private void init(DerValue encoding) throws Asn1Exception, IOException, RealmException {
        ...
        sAddress = null;
        rAddress = null;
        if (((encoding.getTag() & (byte) 0x1F) != (byte) 0x1D) || (encoding.isApplication() != true) ||
