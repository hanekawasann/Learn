...
public class PAForUserEnc {
    ...
    public PAForUserEnc(DerValue encoding, EncryptionKey key) throws Asn1Exception, KrbException, IOException {
        ...
        if ((der.getTag() & 0x1F) == 0x01) {
            try {
                ...
                name = new PrincipalName(tmpName.getNameType(), tmpName.getNameStrings(), realm);
            } catch (RealmException re) {
    ...
    public byte[] asn1Encode() throws Asn1Exception, IOException {
        ...
        try {
            Checksum cks = new Checksum(Checksum.CKSUMTYPE_HMAC_MD5_ARCFOUR, getS4UByteArray(), key,
