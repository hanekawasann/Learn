...
public final class KerberosString {
     ...
     * GeneralString.
     */
    public static final boolean MSNAME = AccessController
        .doPrivileged(new GetBooleanAction("sun.security.krb5.msinterop.kstring"));
    ...
    public DerValue toDerValue() throws IOException {
        ...
        // only called once.
        return new DerValue(DerValue.tag_GeneralString, s.getBytes(MSNAME ? "UTF8" : "ASCII"));
    }
}
