...
public class X509CertInfo implements CertAttrSet<String> {
    ...
    private Object getX500Name(String name, boolean getIssuer) throws IOException {
        if (name.equalsIgnoreCase(X509CertInfo.DN_NAME)) {
            ...
            return getIssuer ? issuer.asX500Principal() : subject.asX500Principal();
        } else {
    ...
    private void parse(DerValue val) throws CertificateParsingException, IOException {
        ...
        if ((version.compare(CertificateVersion.V1) == 0) && subject.isEmpty()) {
     ...
     */
    private void verifyCert(X500Name subject, CertificateExtensions extensions)
