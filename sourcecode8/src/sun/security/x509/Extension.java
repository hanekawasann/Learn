...
public class Extension implements java.security.cert.Extension {
     ...
     */
    public static Extension newExtension(ObjectIdentifier extensionId, boolean critical, byte[] rawExtensionValue)
        throws IOException {
    ...
    public void encode(DerOutputStream out) throws IOException {
        ...
        if (extensionId == null) { throw new IOException("Null OID to encode for the extension!"); }
        if (extensionValue == null) { throw new IOException("No value to encode for the extension!"); }

        DerOutputStream dos = new DerOutputStream();

        dos.putOID(extensionId);
        if (critical) { dos.putBoolean(critical); }
    ...
    public boolean equals(Object other) {
        ...
        if (critical != otherExt.critical) { return false; }
        if (!extensionId.equals((Object) otherExt.extensionId)) { return false; }
