...
public class HandshakeOutStream extends OutputStream {
    ...
    HandshakeOutStream(ProtocolVersion protocolVersion, ProtocolVersion helloVersion, HandshakeHash handshakeHash,
    ...
    private void checkOverflow(int length, int overflow) {
        if (length >= overflow) {
            ...
            throw new RuntimeException(
                "Field length overflow, the field length (" + length + ") should be less than " + overflow);
        }
    }
}
