...
final class RSAClientKeyExchange extends HandshakeMessage {
     ...
     */
    RSAClientKeyExchange(ProtocolVersion protocolVersion, ProtocolVersion maxVersion, SecureRandom generator,
        ...
        try {
            String s = ((protocolVersion.v >= ProtocolVersion.TLS12.v) ? "SunTls12RsaPremasterSecret"
     ...
     */
    RSAClientKeyExchange(ProtocolVersion currentVersion, ProtocolVersion maxVersion, SecureRandom generator,
        HandshakeInStream input, int messageSize, PrivateKey privateKey) throws IOException {
        ...
        preMaster = polishPreMasterSecretKey(currentVersion, maxVersion, generator, encoded, failover);
    }
     ...
     */
    private SecretKey polishPreMasterSecretKey(ProtocolVersion currentVersion, ProtocolVersion clientHelloVersion,
        SecureRandom generator, byte[] encoded, Exception failoverException) {
        ...
        if (failoverException == null && encoded != null) {
            ...
            if (clientHelloVersion.major != encoded[0] || clientHelloVersion.minor != encoded[1]) {
                ...
                if (clientHelloVersion.v <= ProtocolVersion.TLS10.v && currentVersion.major == encoded[0] &&
            ...
            return generatePreMasterSecret(clientHelloVersion, encoded, generator);
        }
    ...
    private static SecretKey generatePreMasterSecret(ProtocolVersion version, byte[] encodedSecret,
        ...
        try {
            String s = ((version.v >= ProtocolVersion.TLS12.v) ? "SunTls12RsaPremasterSecret"
                : "SunTlsRsaPremasterSecret");
            KeyGenerator kg = JsseJce.getKeyGenerator(s);
            kg.init(new TlsRsaPremasterSecretParameterSpec(version.major, version.minor, encodedSecret), generator);
