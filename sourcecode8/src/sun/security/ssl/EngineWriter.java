...
final class EngineWriter {
     ...
     * other writeRecord.
     */
    synchronized void writeRecord(EngineOutputRecord outputRecord, Authenticator authenticator, CipherBox writeCipher)
        throws IOException {
    ...
    synchronized HandshakeStatus writeRecord(EngineOutputRecord outputRecord, EngineArgs ea,
        Authenticator authenticator, CipherBox writeCipher) throws IOException {
