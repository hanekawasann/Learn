...
interface Record {
     ...
     */
    static final int headerPlusMaxIVSize = headerSize        // header
        + maxIVLength;      // iv
     ...
     */
    static final int maxRecordSize = headerPlusMaxIVSize   // header + iv
        + maxDataSize           // data
        + maxPadding            // padding
        + trailerSize;          // MAC or AEAD tag

    static final boolean enableCBCProtection = Debug.getBooleanProperty("jsse.enableCBCProtection", true);

    /*
     * For CBC protection in SSL3/TLS1, we break some plaintext into two
     * packets.  Max application data size for the second packet.
     */
    static final int maxDataSizeMinusOneByteRecord = maxDataSize       // max data size
     ...
     */
    static final int maxLargeRecordSize = maxRecordSize   // Max size with a conforming implementation
     ...
     */
    static final int maxAlertRecordSize = headerPlusMaxIVSize   // header + iv
        + 2                     // alert
        + maxPadding            // padding
        + trailerSize;          // MAC
