...
abstract class Handshaker {
    ...
    static final boolean rejectClientInitiatedRenego = Debug
        .getBooleanProperty("jdk.tls.rejectClientInitiatedRenegotiation", false);
    ...
    void calculateConnectionKeys(SecretKey masterKey) {
        ...
        TlsKeyMaterialParameterSpec spec = new TlsKeyMaterialParameterSpec(masterKey, protocolVersion.major,
            ...
            expandedKeySize, ivSize, hashSize, prfHashAlg, prfHashLength, prfBlockSize);
