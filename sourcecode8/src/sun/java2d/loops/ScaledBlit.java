...
public class ScaledBlit extends GraphicsPrimitive {
    ...
    public native void Scale(SurfaceData src, SurfaceData dst, Composite comp, Region clip, int sx1, int sy1, int sx2,
    ...
    private static class TraceScaledBlit extends ScaledBlit {
        ...
        public void Scale(SurfaceData src, SurfaceData dst, Composite comp, Region clip, int sx1, int sy1, int sx2,
            int sy2, double dx1, double dy1, double dx2, double dy2) {
