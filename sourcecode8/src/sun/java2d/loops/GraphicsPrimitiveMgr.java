...
public final class GraphicsPrimitiveMgr {
    ...
    private static native void initIDs(Class GP, Class ST, Class CT, Class SG2D, Class Color, Class AT, Class XORComp,
        Class AlphaComp, Class Path2D, Class Path2DFloat, Class SHints);

    private static native void registerNativeLoops();

    static {
        initIDs(GraphicsPrimitive.class, SurfaceType.class, CompositeType.class, SunGraphics2D.class,
            java.awt.Color.class, java.awt.geom.AffineTransform.class, XORComposite.class,
            java.awt.AlphaComposite.class, java.awt.geom.Path2D.class, java.awt.geom.Path2D.Float.class,
    ...
    public synchronized static GraphicsPrimitive locate(int primTypeID, SurfaceType srctype, CompositeType comptype,
        SurfaceType dsttype) {
        /*
        ...
        */
        GraphicsPrimitive prim = locatePrim(primTypeID, srctype, comptype, dsttype);
    ...
    public synchronized static GraphicsPrimitive locatePrim(int primTypeID, SurfaceType srctype, CompositeType comptype,
        SurfaceType dsttype) {
        /*
          System.out.println("Looking for:");
          System.out.println("    method: "+signature);
        ...
        for (int j = 0; j < prims.length; j++) {
            ...
            if (p instanceof GraphicsPrimitiveProxy) {
                ...
                if (!r.getSignature().equals(p.getSignature()) || r.getUniqueID() != p.getUniqueID()) {
                    ...
                    throw new RuntimeException("Primitive " + p + " returns wrong signature for " + r.getClass());
                }
