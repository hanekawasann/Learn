...
public class DrawPolygons extends GraphicsPrimitive {
     ...
     */
    public native void DrawPolygons(SunGraphics2D sg2d, SurfaceData sData, int xPoints[], int yPoints[], int nPoints[],
    ...
    public GraphicsPrimitive makePrimitive(SurfaceType srctype, CompositeType comptype, SurfaceType dsttype) {
        ...
        throw new InternalError("DrawPolygons not implemented for " + srctype + " with " + comptype);
    }
