...
public class DrawParallelogram extends GraphicsPrimitive {
     ...
     */
    public native void DrawParallelogram(SunGraphics2D sg, SurfaceData dest, double x, double y, double dx1, double dy1,
    ...
    public GraphicsPrimitive makePrimitive(SurfaceType srctype, CompositeType comptype, SurfaceType dsttype) {
        ...
        throw new InternalError("DrawParallelogram not implemented for " + srctype + " with " + comptype);
    }
    ...
    private static class TraceDrawParallelogram extends DrawParallelogram {
        ...
        public void DrawParallelogram(SunGraphics2D sg2d, SurfaceData dest, double x, double y, double dx1, double dy1,
            double dx2, double dy2, double lw1, double lw2) {
