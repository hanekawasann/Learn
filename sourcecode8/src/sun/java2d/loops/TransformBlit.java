...
public class TransformBlit extends GraphicsPrimitive {
    ...
    public native void Transform(SurfaceData src, SurfaceData dst, Composite comp, Region clip, AffineTransform at,
    ...
    private static class TraceTransformBlit extends TransformBlit {
        ...
        public void Transform(SurfaceData src, SurfaceData dst, Composite comp, Region clip, AffineTransform at,
            int hint, int srcx, int srcy, int dstx, int dsty, int width, int height) {
