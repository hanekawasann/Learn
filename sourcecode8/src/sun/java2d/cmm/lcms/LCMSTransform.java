...
public class LCMSTransform implements ColorTransform {
    ...
    private synchronized void doTransform(LCMSImageLayout in, LCMSImageLayout out) {
        ...
        if (ID == 0L || inFormatter != in.pixelType || isInIntPacked != in.isIntPacked ||
            ...
            ID = LCMS
                .createTransform(lcmsProfiles, renderType, inFormatter, isInIntPacked, outFormatter, isOutIntPacked,
                    disposerReferent);
        }
