...
public class Region {
    ...
    public static final Region WHOLE_REGION = new ImmutableRegion(Integer.MIN_VALUE, Integer.MIN_VALUE,
    ...
    public Region getTranslatedRegion(int dx, int dy) {
        ...
        int thix = hix + dx;
        int thiy = hiy + dy;
        if ((tlox > lox) != (dx > 0) || (tloy > loy) != (dy > 0) || (thix > hix) != (dx > 0) ||
            (thiy > hiy) != (dy > 0)) {
    ...
    public Region getIntersectionXYXY(int lox, int loy, int hix, int hiy) {
        ...
        Region ret = new Region((lox < this.lox) ? this.lox : lox, (loy < this.loy) ? this.loy : loy,
            (hix > this.hix) ? this.hix : hix, (hiy > this.hiy) ? this.hiy : hiy);
        if (bands != null) {
    ...
    public Region getIntersection(Region r) {
        ...
        Region ret = new Region((r.lox < this.lox) ? this.lox : r.lox, (r.loy < this.loy) ? this.loy : r.loy,
            (r.hix > this.hix) ? this.hix : r.hix, (r.hiy > this.hiy) ? this.hiy : r.hiy);
        if (!ret.isEmpty()) {
    ...
    public Region getBoundsIntersectionXYXY(int lox, int loy, int hix, int hiy) {
        ...
        return new Region((lox < this.lox) ? this.lox : lox, (loy < this.loy) ? this.loy : loy,
            (hix > this.hix) ? this.hix : hix, (hiy > this.hiy) ? this.hiy : hiy);
    }
    ...
    public Region getBoundsIntersection(Region r) {
        ...
        return new Region((r.lox < this.lox) ? this.lox : r.lox, (r.loy < this.loy) ? this.loy : r.loy,
            (r.hix > this.hix) ? this.hix : r.hix, (r.hiy > this.hiy) ? this.hiy : r.hiy);
    }
    ...
    private void appendSpan(int box[]) {
        ...
        if (endIndex == 0 || spanloy >= bands[curYrow + 1]) {
            ...
            bands[endIndex++] = 0;
        } else if (spanloy == bands[curYrow] && spanhiy == bands[curYrow + 1] && spanlox >= bands[endIndex - 1]) {
