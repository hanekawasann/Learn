...
class OGLMaskBlit extends BufferedMaskBlit {
    ...
    static void register() {
        GraphicsPrimitive[] primitives = { new OGLMaskBlit(IntArgb, SrcOver), new OGLMaskBlit(IntArgbPre, SrcOver),
            new OGLMaskBlit(IntRgb, SrcOver), new OGLMaskBlit(IntRgb, SrcNoEa), new OGLMaskBlit(IntBgr, SrcOver),
    ...
    protected void validateContext(SurfaceData dstData, Composite comp, Region clip) {
        ...
        OGLContext.validateContext(oglDst, oglDst, clip, comp, null, null, null, OGLContext.NO_CONTEXT_FLAGS);
    }
}
