...
class OGLTextRenderer extends BufferedTextPipe {
    ...
    @Override
    protected native void drawGlyphList(int numGlyphs, boolean usePositions, boolean subPixPos, boolean rgbOrder,
    ...
    protected void validateContext(SunGraphics2D sg2d, Composite comp) {
        ...
        OGLContext.validateContext(oglDst, oglDst, sg2d.getCompClip(), comp, null, sg2d.paint, sg2d,
