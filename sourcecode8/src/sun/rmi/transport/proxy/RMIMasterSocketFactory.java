...
public class RMIMasterSocketFactory extends RMISocketFactory {
    ...
    private static String getLogLevel() {
        return java.security.AccessController
            .doPrivileged(new sun.security.action.GetPropertyAction("sun.rmi.transport.proxy.logLevel"));
    }
    ...
    private static long getConnectTimeout() {
        return java.security.AccessController
            .doPrivileged(new GetLongAction("sun.rmi.transport.proxy.connectTimeout", 15000))
            .longValue(); // default: 15 seconds
    }

    /** whether to fallback to HTTP on general connect failures */
    private static final boolean eagerHttpFallback = java.security.AccessController
        .doPrivileged(new GetBooleanAction("sun.rmi.transport.proxy.eagerHttpFallback")).booleanValue();
    ...
    public RMIMasterSocketFactory() {
        ...
        try {
            String proxyHost;
            proxyHost = java.security.AccessController.doPrivileged(new GetPropertyAction("http.proxyHost"));

            if (proxyHost == null) {
                proxyHost = java.security.AccessController.doPrivileged(new GetPropertyAction("proxyHost"));
            }

            boolean disable = java.security.AccessController
                .doPrivileged(new GetPropertyAction("java.rmi.server.disableHttp", "true")).equalsIgnoreCase("true");
        ...
        try {
            synchronized (connector) {
                ...
                Thread t = java.security.AccessController
                    .doPrivileged(new NewThreadAction(connector, "AsyncConnector", true));
                t.start();
