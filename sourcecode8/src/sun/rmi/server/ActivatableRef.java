...
public class ActivatableRef implements RemoteRef {
            ...
            if (retries > 1) {
                ...
                synchronized (this) {
                    if (localRef.remoteEquals(ref) || ref == null) {
                        ...
                        if (newRef.remoteEquals(localRef) && exception instanceof NoSuchObjectException &&
                            force == false) {
                            /*
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        try {
            Class<?> refClass = Class.forName(RemoteRef.packagePrefix + "." + className);
    ...
    public boolean remoteEquals(RemoteRef ref) {
        if (ref instanceof ActivatableRef) { return id.equals(((ActivatableRef) ref).id); }
        return false;
    }
}
