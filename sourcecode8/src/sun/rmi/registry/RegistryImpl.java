 ...
 */
public class RegistryImpl extends java.rmi.server.RemoteServer implements Registry {
     ...
     * @throws NotBound        If name is not currently bound.
     */
    ...
    public static void checkAccess(String op) throws AccessException {
        ...
        try {
            ...
            try {
                clientHost = java.security.AccessController
            ...
            if (allowedAccessCache.get(clientHost) == null) {
                ...
                try {
                    ...
                    throw new AccessException(
                        "Registry." + op + " disallowed; origin " + clientHost + " is non-local host");
                }
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            System.err.println(MessageFormat.format(getTextResource("rmiregistry.port.badnumber"), args[0]));
    ...
    private static AccessControlContext getAccessControlContext(int port) {
        ...
        PermissionCollection perms = AccessController
         ...
         */
        ProtectionDomain pd = new ProtectionDomain(new CodeSource(null, (java.security.cert.Certificate[]) null),
            perms);
