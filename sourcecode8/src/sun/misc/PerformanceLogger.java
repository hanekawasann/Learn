...
public class PerformanceLogger {
    ...
    static {
        String perfLoggingProp = java.security.AccessController
            .doPrivileged(new sun.security.action.GetPropertyAction("sun.perflog"));
        if (perfLoggingProp != null) {
            perfLoggingOn = true;

            // Check if we should use nanoTime
            String perfNanoProp = java.security.AccessController
                .doPrivileged(new sun.security.action.GetPropertyAction("sun.perflog.nano"));
                    ...
                    java.security.AccessController.doPrivileged(new java.security.PrivilegedAction<Void>() {
                        public Void run() {
                            try {
                                ...
                                System.out.println(e + ": Creating logfile " + logFileName + ".  Log to console");
                            }
                            return null;
                        }
                    });
