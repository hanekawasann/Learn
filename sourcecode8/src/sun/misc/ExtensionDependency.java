...
public class ExtensionDependency {
            ...
            if (value != null) {
                ...
                while (st.hasMoreTokens()) {
                    ...
                    if (attr.getValue(extName) == null) {
                        debug("The jar file " + jar.getName() + " appers to depend on " + extensionName +
                            " but does not define the " + extName + " attribute in its manifest ");
     ...
     */
    protected synchronized boolean checkExtension(final String extensionName, final Attributes attr)
    ...
    protected boolean installExtension(ExtensionInfo reqInfo, ExtensionInfo instInfo)
        ...
        synchronized (providers) {
            ...
            Vector<ExtensionInstallationProvider> tmp = (Vector<ExtensionInstallationProvider>) providers.clone();
            currentProviders = tmp;
        }
        for (Enumeration<ExtensionInstallationProvider> e = currentProviders.elements(); e.hasMoreElements(); ) {
            ...
            if (eip != null) {
                ...
                if (eip.installExtension(reqInfo, instInfo)) {
                    ...
                    Launcher.ExtClassLoader cl = (Launcher.ExtClassLoader) Launcher.getLauncher().getClassLoader()
                        .getParent();
    ...
    private static File[] getExtDirs() {
        String s = java.security.AccessController
            .doPrivileged(new sun.security.action.GetPropertyAction("java.ext.dirs"));
