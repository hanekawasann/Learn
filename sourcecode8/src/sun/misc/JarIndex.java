...
public class JarIndex {
     ...
     */
    private static final boolean metaInfFilenames = "true"
        .equals(System.getProperty("sun.misc.JarIndex.metaInfFilenames"));
        ...
        for (int i = 0; i < files.length; i++) {
            ...
            while (entries.hasMoreElements()) {
                ...
                if (fileName.equals("META-INF/") || fileName.equals(INDEX_NAME) ||
                    fileName.equals(JarFile.MANIFEST_NAME)) { continue; }
