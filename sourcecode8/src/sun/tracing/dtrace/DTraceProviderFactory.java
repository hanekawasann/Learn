...
public final class DTraceProviderFactory extends ProviderFactory {
     ...
     */
    public Map<Class<? extends Provider>, Provider> createProviders(Set<Class<? extends Provider>> providers,
        String moduleName) {
        HashMap<Class<? extends Provider>, Provider> map = new HashMap<Class<? extends Provider>, Provider>();
    ...
    public static boolean isSupported() {
        try {
            ...
            if (security != null) {
                Permission perm = new RuntimePermission("com.sun.tracing.dtrace.createProvider");
