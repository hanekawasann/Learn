...
public class CharToByteGB18030 extends CharToByteConverter {
    ...
    public boolean canConvert(char c) {
        ...
        if ((c >= 0xd800 && c <= 0xdfff) || (c >= 0xfffe)) { return false; } else { return true; }
    }
        ...
        while (charOff < inEnd) {
            ...
            if (inputChar >= '\uD800' && inputChar <= '\uDBFF') {
                ...
                if (inputChar >= '\uDC00' && inputChar <= '\uDFFF') {
                    inputSize = 2;
                    charOff++;
                    linearDiffValue = (previousChar - 0xD800) * 0x400 + (inputChar - 0xDC00) + 0x2E248;
            ...
            // Not part of a surrogate
                ...
                if (inputChar >= 0xE000 && inputChar < 0xF900) { linearDiffValue += 0x82BD; } else if (inputChar >=
                    0xF900) { linearDiffValue += 0x93A9; }

                if (hiByte > 0x80) { currentState = GB18030_DOUBLE_BYTE; } else { currentState = GB18030_FOUR_BYTE; }
            ...
            if (currentState == GB18030_SINGLE_BYTE) { continue; }
