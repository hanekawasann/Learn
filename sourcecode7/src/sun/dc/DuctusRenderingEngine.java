...
public class DuctusRenderingEngine extends RenderingEngine {
     ...
     */
    @Override
    public void strokeTo(Shape src, AffineTransform transform, BasicStroke bs, boolean thin, boolean normalize,
        boolean antialias, PathConsumer2D sr) {
                ...
                case PathIterator.SEG_QUADTO:
                    ...
                    if (point[2] < UPPER_BND && point[2] > LOWER_BND && point[3] < UPPER_BND && point[3] > LOWER_BND) {
                        if (skip) {
                            ...
                            if (point[0] < UPPER_BND && point[0] > LOWER_BND && point[1] < UPPER_BND &&
                                point[1] > LOWER_BND) {
                ...
                case PathIterator.SEG_CUBICTO:
                    ...
                    if (point[4] < UPPER_BND && point[4] > LOWER_BND && point[5] < UPPER_BND && point[5] > LOWER_BND) {
                        if (skip) {
                            ...
                            if (point[0] < UPPER_BND && point[0] > LOWER_BND && point[1] < UPPER_BND &&
                                point[1] > LOWER_BND && point[2] < UPPER_BND && point[2] > LOWER_BND &&
            ...
            while (!pi.isDone()) {
                ...
                switch (type) {
                    ...
                    case PathIterator.SEG_QUADTO:
                         ...
                         */
                        if (point[2] < UPPER_BND && point[2] > LOWER_BND && point[3] < UPPER_BND &&
                            point[3] > LOWER_BND) {
                            if (skip) {
                    ...
                    case PathIterator.SEG_CUBICTO:
                        ...
                        if (point[4] < UPPER_BND && point[4] > LOWER_BND && point[5] < UPPER_BND &&
                            point[5] > LOWER_BND) {
                            if (skip) {
