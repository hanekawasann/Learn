...
public class JarSignerResources extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        { "This.jar.contains.signed.entries.that.s.not.signed.by.alias.in.this.keystore.",
            "This jar contains signed entries that's not signed by alias in this keystore." }, { "s", "s" },
        ...
        "jar is unsigned. (signatures missing or not parsable)" }, { "jar.verified.", "jar verified." },
        { "jarsigner.", "jarsigner: " }, { "signature.filename.must.consist.of.the.following.characters.A.Z.0.9.or.",
        ...
        { "entry.was.signed.on", "entry was signed on {0}" }, { "Warning.", "Warning: " },
