...
public class JarSigner {
    ...
    void verifyJar(String jarName) throws Exception {
        ...
        try {
            ...
            if (!anySigned) {
                ...
                if (hasUnsignedEntry || hasExpiredCert || hasExpiringCert || badKeyUsage || badExtendedKeyUsage ||
                    badNetscapeCertType || notYetValidCert || chainNotValidated || aliasNotInStore ||
                    notSignedByAlias) {
     ...
     */
    String printCert(String tab, Certificate c, boolean checkValidityPeriod, long now, boolean checkUsage) {
    ...
    void signJar(String jarName, String alias, String[] args) throws Exception {
        ...
        try {
            ...
            try {
                block = sf
                    .generateBlock(privateKey, sigalg, certChain, externalSF, tsaUrl, tsaCert, signingMechanism, args,
                        zipFile);
            ...
            if (verbose != null) {
                ...
                if (tsaCert != null) {
                    ...
                    System.out.println(rb.getString("TSA.certificate.") + printCert("", tsaCert, false, 0, false));
                }
        ...
        if (hasExpiredCert || hasExpiringCert || notYetValidCert || badKeyUsage || badExtendedKeyUsage ||
     ...
     */
    private synchronized String[] getDigests(ZipEntry ze, ZipFile zf, MessageDigest[] digests, BASE64Encoder encoder)
        throws IOException {
     ...
     * attributes
     */
    private Attributes getDigestAttributes(ZipEntry ze, ZipFile zf, MessageDigest[] digests, BASE64Encoder encoder)
        throws IOException {
     ...
     * otherwise.
     */
    private boolean updateDigests(ZipEntry ze, ZipFile zf, MessageDigest[] digests, BASE64Encoder encoder, Manifest mf)
        throws IOException {
...
class SignatureFile {
    ...
    public Block generateBlock(PrivateKey privateKey, String sigalg, X509Certificate[] certChain, boolean externalSF,
        String tsaUrl, X509Certificate tsaCert, ContentSigner signingMechanism, String[] args, ZipFile zipFile)
        throws NoSuchAlgorithmException, InvalidKeyException, IOException, SignatureException, CertificateException {
        return new Block(this, privateKey, sigalg, certChain, externalSF, tsaUrl, tsaCert, signingMechanism, args,
            zipFile);
    }
    ...
    public static class Block {
        ...
        Block(SignatureFile sfg, PrivateKey privateKey, String sigalg, X509Certificate[] certChain, boolean externalSF,
            ...
            ContentSignerParameters params = new JarSignerParameters(args, tsaUri, tsaCert, signature,
...
class JarSignerParameters implements ContentSignerParameters {
     ...
     * Create a new object.
     */
    JarSignerParameters(String[] args, URI tsa, X509Certificate tsaCertificate, byte[] signature,
