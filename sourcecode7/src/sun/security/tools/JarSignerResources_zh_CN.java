...
public class JarSignerResources_zh_CN extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        { "jarsigner.error.", "jarsigner \u9519\u8BEF: " }, { "Illegal.option.", "\u975E\u6CD5\u9009\u9879: " },
        ...
        { "s", "s" }, { "m", "m" }, { "k", "k" }, { "i", "i" }, { ".and.d.more.", "(%d \u53CA\u4EE5\u4E0A)" },
        ...
        { "jar.verified.", "jar \u5DF2\u9A8C\u8BC1\u3002" }, { "jarsigner.", "jarsigner: " },
        { "signature.filename.must.consist.of.the.following.characters.A.Z.0.9.or.",
            "\u7B7E\u540D\u6587\u4EF6\u540D\u5FC5\u987B\u5305\u542B\u4EE5\u4E0B\u5B57\u7B26: A-Z, 0-9, _ \u6216 -" },
        { "unable.to.open.jar.file.", "\u65E0\u6CD5\u6253\u5F00 jar \u6587\u4EF6: " },
        { "unable.to.create.", "\u65E0\u6CD5\u521B\u5EFA: " }, { ".adding.", "   \u6B63\u5728\u6DFB\u52A0: " },
        { ".updating.", " \u6B63\u5728\u66F4\u65B0: " }, { ".signing.", "  \u6B63\u5728\u7B7E\u540D: " },
        ...
        { "TSA.location.", "TSA \u4F4D\u7F6E: " }, { "TSA.certificate.", "TSA \u8BC1\u4E66: " },
