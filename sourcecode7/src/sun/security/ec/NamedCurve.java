...
public final class NamedCurve extends ECParameterSpec {
    ...
    private NamedCurve(String name, ObjectIdentifier oid, EllipticCurve curve, ECPoint g, BigInteger n, int h)
        throws IOException {
        super(curve, g, n, h);
        this.name = name;
        this.oid = oid;
    ...
    static {
        ...
        add("sect131r1", "1.3.132.0.22", B, "080000000000000000000000000000010D", "07A11B09A76B562144418FF3FF8C2570B8",
            ...
            "078C6E7EA38C001F73C8134B1B4EF9E150", "0400000000000000023123953A9464B54D", 2);
        ...
        add("sect131r2", "1.3.132.0.23", B, "080000000000000000000000000000010D", "03E5A88919D7CAFCBF415F07C2176573B2",
            ...
            "0648F06D867940A5366D9E265DE9EB240F", "0400000000000000016954A233049BA98F", 2);
