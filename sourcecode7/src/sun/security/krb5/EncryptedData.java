...
public class EncryptedData implements Cloneable {
    ...
    public static final int ETYPE_ARCFOUR_HMAC = 23;     // 1
    // NOTE: the exportable RC4-HMAC is not supported;
    // it is no longer a usable encryption type
    public static final int ETYPE_ARCFOUR_HMAC_EXP = 24; // 1
    ...
    public static final int ETYPE_AES128_CTS_HMAC_SHA1_96 = 17; // 16      0           16
    public static final int ETYPE_AES256_CTS_HMAC_SHA1_96 = 18; // 16      0           16
    ...
    public Object clone() {
        ...
        if (cipher != null) {
            ...
            System.arraycopy(cipher, 0, new_encryptedData.cipher, 0, cipher.length);
        }
    ...
    */
    ...
    public byte[] decrypt(EncryptionKey key, int usage) throws KdcErrException, KrbApErrException, KrbCryptoException {
        if (eType != key.getEType()) {
            throw new KrbCryptoException("EncryptedData is encrypted using keytype " + EType.toString(eType) +
                " but decryption key is of type " + EType.toString(key.getEType()));
        }
