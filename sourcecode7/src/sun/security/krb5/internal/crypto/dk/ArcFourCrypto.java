...
public class ArcFourCrypto extends DkCrypto {
     ...
     */
    public byte[] encryptSeq(byte[] baseKey, int usage, byte[] checksum, byte[] plaintext, int start, int len)
     ...
     */
    public byte[] decryptSeq(byte[] baseKey, int usage, byte[] checksum, byte[] ciphertext, int start, int len)
        throws GeneralSecurityException, KrbCryptoException {
     ...
     */
    public byte[] encryptRaw(byte[] baseKey, int usage, byte[] seqNum, byte[] plaintext, int start, int len)
        throws GeneralSecurityException, KrbCryptoException {
    ...
    public byte[] decrypt(byte[] baseKey, int usage, byte[] ivec, byte[] ciphertext, int start, int len)
        ...
        if (debug) {
            ...
            traceOutput("message Hmac", ciphertext, 0, hashSize);
        }
