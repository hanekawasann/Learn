...
public class KeyTabEntry implements KeyTabConstants {
    ...
    public KeyTabEntry(PrincipalName new_service, Realm new_realm, KerberosTime new_time, int new_keyVersion,
        int new_keyType, byte[] new_keyblock) {
        service = new_service;
        realm = new_realm;
        timestamp = new_time;
    ...
    public EncryptionKey getKey() {
        EncryptionKey key = new EncryptionKey(keyblock, keyType, new Integer(keyVersion));
        return key;
    }
    ...
    public int entryLength() {
        ...
        int size = principalComponentSize + realmSize + realmLen + totalPrincipalLength + principalTypeSize +
            timestampSize + keyVersionSize + keyTypeSize + keySize + keyblock.length;
