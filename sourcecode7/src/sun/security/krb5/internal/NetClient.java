...
public abstract class NetClient {
    public static NetClient getInstance(String protocol, String hostname, int port, int timeout) throws IOException {
...
class UDPClient extends NetClient {
    ...
    @Override
    public void send(byte[] data) throws IOException {
        DatagramPacket dgPacketOut = new DatagramPacket(data, data.length, iaddr, iport);
    ...
    public byte[] receive() throws IOException {
        ...
        System.arraycopy(dgPacketIn.getData(), 0, data, 0, dgPacketIn.getLength());
        return data;
    }
