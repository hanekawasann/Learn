...
public class EncKDCRepPart {
    ...
    public EncKDCRepPart(EncryptionKey new_key, LastReq new_lastReq, int new_nonce, KerberosTime new_keyExpiration,
     ...
     * @throws RealmException if an error occurs while decoding an Realm object.
     */
