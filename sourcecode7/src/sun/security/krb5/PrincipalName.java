...
public class PrincipalName implements Cloneable {
    ...
    public boolean equals(Object o) {
        if (o instanceof PrincipalName) { return equals((PrincipalName) o); } else { return false; }
    }
    ...
    public boolean equals(PrincipalName other) {
        ...
        if ((nameRealm != null && other.nameRealm == null) || (nameRealm == null && other.nameRealm != null)) {
            return false;
        }
    ...
    boolean equalsWithoutRealm(PrincipalName other) {
        ...
        if (nameType != KRB_NT_UNKNOWN && other.nameType != KRB_NT_UNKNOWN && nameType != other.nameType) {
            return false;
        }

        if ((nameStrings != null && other.nameStrings == null) || (nameStrings == null && other.nameStrings != null)) {
            return false;
        }

        if (nameStrings != null && other.nameStrings != null) {
            if (nameStrings.length != other.nameStrings.length) { return false; }
            for (int i = 0; i < nameStrings.length; i++) {
                if (!nameStrings[i].equals(other.nameStrings[i])) { return false; }
            }
        }
     ...
     * @throws Asn1Exception            if there is an ASN1 encoding error
    ...
    public static PrincipalName parse(DerInputStream data, byte explicitTag, boolean optional)
        ...
        if (explicitTag != (der.getTag() & (byte) 0x1F)) { throw new Asn1Exception(Krb5.ASN1_BAD_ID); } else {
            DerValue subDer = der.getData().getDerValue();
    ...
    public PrincipalName(String name, int type) throws RealmException {
        ...
        if (realmString != null) { tempRealm = new Realm(realmString); }
            ...
            case KRB_NT_SRV_HST:
                if (nameParts.length >= 2) {
                    ...
                    try {
                        ...
                        if (canonicalized.toLowerCase().startsWith(hostName.toLowerCase() + ".")) {
    ...
    static String mapHostToRealm(String name) {
        ...
        try {
            ...
            if ((result = c.getDefault(name, "domain_realm")) != null) { return result; } else {
