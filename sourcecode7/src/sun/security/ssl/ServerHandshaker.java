                    ...
                    case K_KRB5_EXPORT:
                        preMasterSecret = this.clientKeyExchange(
                            new KerberosClientKeyExchange(protocolVersion, clientRequestedVersion,
                                sslContext.getSecureRandom(), input, kerberosKeys));
                        break;
                    case K_DHE_RSA:
                    case K_DHE_DSS:
                    case K_DH_ANON:
            ...
            case K_DHE_RSA:
                ...
                if (protocolVersion.v >= ProtocolVersion.TLS12.v) {
                    preferableSignatureAlgorithm = SignatureAndHashAlgorithm
                        .getPreferableAlgorithm(supportedSignAlgs, "RSA");
    ...
    private boolean setupKerberosKeys() {
        ...
        try {
            ...
            if (kerberosKeys != null && kerberosKeys.length > 0) {
                ...
                String serverPrincipal = Krb5Helper.getServerPrincipalName(kerberosKeys[0]);
