...
final class ClientHandshaker extends Handshaker {
    ...
    private void serverHello(ServerHello mesg) throws IOException {
        ...
        for (HelloExtension ext : mesg.extensions.list()) {
            ...
            if ((type != ExtensionType.EXT_ELLIPTIC_CURVES) && (type != ExtensionType.EXT_EC_POINT_FORMATS) &&
    ...
    private void serverHelloDone(ServerHelloDone mesg) throws IOException {
        ...
        switch (keyExchange) {
            ...
            case K_KRB5_EXPORT:
                ...
                KerberosClientKeyExchange kerberosMsg = new KerberosClientKeyExchange(hostname, isLoopbackSE(),
                    getAccSE(), protocolVersion, sslContext.getSecureRandom());
            ...
            try {
                ...
                if (protocolVersion.v >= ProtocolVersion.TLS12.v) {
                    preferableSignatureAlgorithm = SignatureAndHashAlgorithm
                        .getPreferableAlgorithm(peerSupportedSignAlgs, signingKey.getAlgorithm());
    ...
    HandshakeMessage getKickstartMessage() throws SSLException {
        ...
        if (enableSNIExtension) {
            ...
            // we only allow FQDN
            if (hostname != null && hostname.indexOf('.') > 0 && !IPAddressUtil.isIPv4LiteralAddress(hostname) &&
