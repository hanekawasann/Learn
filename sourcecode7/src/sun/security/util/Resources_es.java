...
public class Resources_es extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        { "Generates.a.certificate.request", "Genera una solicitud de certificado" }, //-certreq
        { "Changes.an.entry.s.alias", "Cambia un alias de entrada" }, //-changealias
        { "Deletes.an.entry", "Suprime una entrada" }, //-delete
        { "Exports.certificate", "Exporta el certificado" }, //-exportcert
        { "Generates.a.key.pair", "Genera un par de claves" }, //-genkeypair
        // translation of "secret" key should be different to "private" key.
        { "Generates.a.secret.key", "Genera un clave secreta" }, //-genseckey
        ...
        { "Clones.a.key.entry", "Clona una entrada de clave" }, //-keyclone
        { "Changes.the.key.password.of.an.entry", "Cambia la contrase\u00F1a de clave de una entrada" }, //-keypasswd
        { "Lists.entries.in.a.keystore", "Enumera las entradas de un almac\u00E9n de claves" }, //-list
        { "Prints.the.content.of.a.certificate", "Imprime el contenido de un certificado" }, //-printcert
        { "Prints.the.content.of.a.certificate.request", "Imprime el contenido de una solicitud de certificado" },
        //-printcertreq
        { "Prints.the.content.of.a.CRL.file", "Imprime el contenido de un archivo CRL" }, //-printcrl
        { "Generates.a.self.signed.certificate", "Genera un certificado autofirmado" }, //-selfcert
        { "Changes.the.store.password.of.a.keystore",
            "Cambia la contrase\u00F1a de almac\u00E9n de un almac\u00E9n de claves" }, //-storepasswd
        // keytool: help: options
        { "alias.name.of.the.entry.to.process", "nombre de alias de la entrada que se va a procesar" }, //-alias
        { "destination.alias", "alias de destino" }, //-destalias
        { "destination.key.password", "contrase\u00F1a de clave de destino" }, //-destkeypass
        { "destination.keystore.name", "nombre de almac\u00E9n de claves de destino" }, //-destkeystore
        ...
        //-destprovidername
        { "destination.keystore.password", "contrase\u00F1a de almac\u00E9n de claves de destino" }, //-deststorepass
        { "destination.keystore.type", "tipo de almac\u00E9n de claves de destino" }, //-deststoretype
        { "distinguished.name", "nombre distintivo" }, //-dname
        { "X.509.extension", "extensi\u00F3n X.509" }, //-ext
        { "output.file.name", "nombre de archivo de salida" }, //-file and -outfile
        { "input.file.name", "nombre de archivo de entrada" }, //-file and -infile
        { "key.algorithm.name", "nombre de algoritmo de clave" }, //-keyalg
        { "key.password", "contrase\u00F1a de clave" }, //-keypass
        { "key.bit.size", "tama\u00F1o de bit de clave" }, //-keysize
        { "keystore.name", "nombre de almac\u00E9n de claves" }, //-keystore
        { "new.password", "nueva contrase\u00F1a" }, //-new
        { "do.not.prompt", "no solicitar" }, //-noprompt
        { "password.through.protected.mechanism", "contrase\u00F1a a trav\u00E9s de mecanismo protegido" }, //-protected
        { "provider.argument", "argumento del proveedor" }, //-providerarg
        { "provider.class.name", "nombre de clase del proveedor" }, //-providerclass
        { "provider.name", "nombre del proveedor" }, //-providername
        { "provider.classpath", "classpath de proveedor" }, //-providerpath
        { "output.in.RFC.style", "salida en estilo RFC" }, //-rfc
        { "signature.algorithm.name", "nombre de algoritmo de firma" }, //-sigalg
        { "source.alias", "alias de origen" }, //-srcalias
        { "source.key.password", "contrase\u00F1a de clave de origen" }, //-srckeypass
        { "source.keystore.name", "nombre de almac\u00E9n de claves de origen" }, //-srckeystore
        ...
        //-srcprovidername
        { "source.keystore.password", "contrase\u00F1a de almac\u00E9n de claves de origen" }, //-srcstorepass
        { "source.keystore.type", "tipo de almac\u00E9n de claves de origen" }, //-srcstoretype
        { "SSL.server.host.and.port", "puerto y host del servidor SSL" }, //-sslserver
        { "signed.jar.file", "archivo jar firmado" }, //=jarfile
        { "certificate.validity.start.date.time", "fecha/hora de inicio de validez del certificado" }, //-startdate
        { "keystore.password", "contrase\u00F1a de almac\u00E9n de claves" }, //-storepass
        { "keystore.type", "tipo de almac\u00E9n de claves" }, //-storetype
        { "trust.certificates.from.cacerts", "certificados de protecci\u00F3n de cacerts" }, //-trustcacerts
        { "verbose.output", "salida detallada" }, //-v
        { "validity.number.of.days", "n\u00FAmero de validez de d\u00EDas" }, //-validity
        { "Serial.ID.of.cert.to.revoke", "identificador de serie del certificado que se va a revocar" }, //-id
        // keytool: Running part
        { "keytool.error.", "error de herramienta de claves: " }, { "Illegal.option.", "Opci\u00F3n no permitida:  " },
        ...
        { "Must.specify.alias", "Se debe especificar un alias" }, { "Keystore.password.must.be.at.least.6.characters",
        ...
        { "Failed.to.parse.input", "Fallo al analizar la entrada" }, { "Empty.input", "Entrada vac\u00EDa" },
        ...
        { "Trust.this.certificate.no.", "\u00BFConfiar en este certificado? [no]:  " }, { "YES", "S\u00ED" },
        { "New.prompt.", "Nuevo {0}: " }, { "Passwords.must.differ", "Las contrase\u00F1as deben ser distintas" },
        ...
        { ".RETURN.if.same.as.for.otherAlias.", "\t(INTRO si es el mismo que para <{0}>)" }, { ".PATTERN.printX509Cert",
        ...
        { "Is.name.correct.", "\u00BFEs correcto {0}?" }, { "no", "no" }, { "yes", "s\u00ED" }, { "y", "s" },
        { ".defaultValue.", "  [{0}]:  " }, { "Alias.alias.has.no.key", "El alias <{0}> no tiene clave" },
        ...
        { "Signer.d.", "#%d de Firmante:" }, { "Timestamp.", "Registro de Hora:" }, { "Signature.", "Firma:" },
        { "CRLs.", "CRL:" }, { "Certificate.owner.", "Propietario del Certificado: " },
        ...
        { "Install.reply.anyway.no.", "\u00BFInstalar respuesta de todos modos? [no]:  " }, { "NO", "No" },
        ...
        { "n", "n" }, { "Wrong.answer.try.again", "Respuesta incorrecta, vuelva a intentarlo" },
        ...
        { "Extensions.", "Extensiones: " }, { ".Empty.value.", "(Valor vac\u00EDo)" },
        ...
        { ".file.file.policy.file.location", "  [-file <archivo>]    ubicaci\u00F3n del archivo de normas" },
        { "New", "Nuevo" }, { "Open", "Abrir" }, { "Save", "Guardar" }, { "Save.As", "Guardar como" },
        { "View.Warning.Log", "Ver Log de Advertencias" }, { "Exit", "Salir" },
        { "Add.Policy.Entry", "Agregar Entrada de Pol\u00EDtica" },
        { "Edit.Policy.Entry", "Editar Entrada de Pol\u00EDtica" },
        { "Remove.Policy.Entry", "Eliminar Entrada de Pol\u00EDtica" }, { "Edit", "Editar" }, { "Retain", "Mantener" },
        ...
        { "Remove.Public.Key.Alias", "Eliminar Alias de Clave P\u00FAblico" }, { "File", "Archivo" },
        { "KeyStore", "Almac\u00E9n de Claves" }, { "Policy.File.", "Archivo de Pol\u00EDtica:" },
        ...
        { "Error", "Error" }, { "OK", "Aceptar" }, { "Status", "Estado" }, { "Warning", "Advertencia" },
        { "Permission.", "Permiso:                                                       " },
        { "Principal.Type.", "Tipo de Principal:" }, { "Principal.Name.", "Nombre de Principal:" },
        { "Target.Name.", "Nombre de Destino:                                                    " },
        { "Actions.", "Acciones:                                                             " },
        { "OK.to.overwrite.existing.file.filename.", "\u00BFSobrescribir el archivo existente {0}?" },
        { "Cancel", "Cancelar" }, { "CodeBase.", "CodeBase:" }, { "SignedBy.", "SignedBy:" },
        { "Add.Principal", "Agregar Principal" }, { "Edit.Principal", "Editar Principal" },
        { "Remove.Principal", "Eliminar Principal" }, { "Principals.", "Principales:" },
        { ".Add.Permission", "  Agregar Permiso" }, { ".Edit.Permission", "  Editar Permiso" },
        { "Remove.Permission", "Eliminar Permiso" }, { "Done", "Listo" },
        { "KeyStore.URL.", "URL de Almac\u00E9n de Claves:" }, { "KeyStore.Type.", "Tipo de Almac\u00E9n de Claves:" },
        { "KeyStore.Provider.", "Proveedor de Almac\u00E9n de Claves:" },
        { "KeyStore.Password.URL.", "URL de Contrase\u00F1a de Almac\u00E9n de Claves:" },
        { "Principals", "Principales" }, { ".Edit.Principal.", "  Editar Principal:" },
        { ".Add.New.Principal.", "  Agregar Nuevo Principal:" }, { "Permissions", "Permisos" },
        { ".Edit.Permission.", "  Editar Permiso:" }, { ".Add.New.Permission.", "  Agregar Permiso Nuevo:" },
        { "Signed.By.", "Firmado Por:" }, { "Cannot.Specify.Principal.with.a.Wildcard.Class.without.a.Wildcard.Name",
        "No se puede especificar un principal con una clase de comod\u00EDn sin un nombre de comod\u00EDn" },
        { "Cannot.Specify.Principal.without.a.Name", "No se puede especificar el principal sin un nombre" },
        { "Permission.and.Target.Name.must.have.a.value", "Permiso y Nombre de Destino deben tener un valor" },
        { "Remove.this.Policy.Entry.", "\u00BFEliminar esta entrada de pol\u00EDtica?" },
        { "Overwrite.File", "Sobrescribir Archivo" },
        { "Policy.successfully.written.to.filename", "Pol\u00EDtica escrita correctamente en {0}" },
        { "null.filename", "nombre de archivo nulo" }, { "Save.changes.", "\u00BFGuardar los cambios?" },
        { "Yes", "S\u00ED" }, { "No", "No" }, { "Policy.Entry", "Entrada de Pol\u00EDtica" },
        { "Save.Changes", "Guardar Cambios" },
        { "No.Policy.Entry.selected", "No se ha seleccionado la entrada de pol\u00EDtica" },
        { "Unable.to.open.KeyStore.ex.toString.", "No se ha podido abrir el almac\u00E9n de claves: {0}" },
        { "No.principal.selected", "No se ha seleccionado un principal" },
        { "No.permission.selected", "No se ha seleccionado un permiso" }, { "name", "nombre" },
        { "configuration.type", "tipo de configuraci\u00F3n" },
        { "environment.variable.name", "nombre de variable de entorno" }, { "library.name", "nombre de la biblioteca" },
        { "package.name", "nombre del paquete" }, { "policy.type", "tipo de pol\u00EDtica" },
        { "property.name", "nombre de la propiedad" }, { "Principal.List", "Lista de Principales" },
        { "Permission.List", "Lista de Permisos" }, { "Code.Base", "Base de C\u00F3digo" },
        ...
        { "substitution.value.prefix.unsupported", "valor de sustituci\u00F3n, {0}, no soportado" }, { "LPARAM", "(" },
        { "RPARAM", ")" }, { "type.can.t.be.null", "el tipo no puede ser nulo" },
        ...
        { "expected.permission.entry", "se esperaba una entrada de permiso" }, { "number.", "n\u00FAmero " },
        ...
        { "PKCS11.Token.providerName.Password.", "Contrase\u00F1a del Elemento PKCS11 [{0}]: " },
