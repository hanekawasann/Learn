...
public final class SecurityConstants {
     ...
     */
    private static class FakeAWTPermissionFactory implements PermissionFactory<FakeAWTPermission> {
        @Override
    ...
    // java.lang.SecurityManager
    public static final SocketPermission LOCAL_LISTEN_PERMISSION = new SocketPermission("localhost:1024-",
