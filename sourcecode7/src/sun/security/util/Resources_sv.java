...
public class Resources_sv extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        { ".OPTION.", " [Alternativ]..." }, { "Options.", "Alternativ:" },
        ...
        { "Commands.", "Kommandon:" }, { "Use.keytool.command.name.help.for.usage.of.command.name",
        "L\u00E4s \"Hj\u00E4lp - Nyckelverktyg - command_name\" om anv\u00E4ndning av command_name" },
        // keytool: help: commands
        { "Generates.a.certificate.request", "Genererar certifikatbeg\u00E4ran" }, //-certreq
        { "Changes.an.entry.s.alias", "\u00C4ndrar postalias" }, //-changealias
        { "Deletes.an.entry", "Tar bort post" }, //-delete
        { "Exports.certificate", "Exporterar certifikat" }, //-exportcert
        { "Generates.a.key.pair", "Genererar nyckelpar" }, //-genkeypair
        // translation of "secret" key should be different to "private" key.
        { "Generates.a.secret.key", "Genererar hemlig nyckel" }, //-genseckey
        ...
        { "Clones.a.key.entry", "Klonar en nyckelpost" }, //-keyclone
        { "Changes.the.key.password.of.an.entry", "\u00C4ndrar nyckell\u00F6senordet f\u00F6r en post" }, //-keypasswd
        { "Lists.entries.in.a.keystore", "Visar lista \u00F6ver poster i nyckellager" }, //-list
        { "Prints.the.content.of.a.certificate", "Skriver ut inneh\u00E5llet i ett certifikat" }, //-printcert
        { "Prints.the.content.of.a.certificate.request", "Skriver ut inneh\u00E5llet i en certifikatbeg\u00E4ran" },
        //-printcertreq
        { "Prints.the.content.of.a.CRL.file", "Skriver ut inneh\u00E5llet i en CRL-fil" }, //-printcrl
        { "Generates.a.self.signed.certificate", "Genererar ett sj\u00E4lvsignerat certifikat" }, //-selfcert
        { "Changes.the.store.password.of.a.keystore", "\u00C4ndrar lagerl\u00F6senordet f\u00F6r ett nyckellager" },
        //-storepasswd
        // keytool: help: options
        { "alias.name.of.the.entry.to.process", "aliasnamn f\u00F6r post som ska bearbetas" }, //-alias
        { "destination.alias", "destinationsalias" }, //-destalias
        { "destination.key.password", "l\u00F6senord f\u00F6r destinationsnyckel" }, //-destkeypass
        { "destination.keystore.name", "namn p\u00E5 destinationsnyckellager" }, //-destkeystore
        ...
        //-destprovidername
        { "destination.keystore.password", "l\u00F6senord f\u00F6r destinationsnyckellager" }, //-deststorepass
        { "destination.keystore.type", "typ av destinationsnyckellager" }, //-deststoretype
        { "distinguished.name", "unikt namn" }, //-dname
        { "X.509.extension", "X.509-till\u00E4gg" }, //-ext
        { "output.file.name", "namn p\u00E5 utdatafil" }, //-file and -outfile
        { "input.file.name", "namn p\u00E5 indatafil" }, //-file and -infile
        { "key.algorithm.name", "namn p\u00E5 nyckelalgoritm" }, //-keyalg
        { "key.password", "nyckell\u00F6senord" }, //-keypass
        { "key.bit.size", "nyckelbitstorlek" }, //-keysize
        { "keystore.name", "namn p\u00E5 nyckellager" }, //-keystore
        { "new.password", "nytt l\u00F6senord" }, //-new
        { "do.not.prompt", "fr\u00E5ga inte" }, //-noprompt
        { "password.through.protected.mechanism", "l\u00F6senord med skyddad mekanism" }, //-protected
        { "provider.argument", "leverant\u00F6rsargument" }, //-providerarg
        { "provider.class.name", "namn p\u00E5 leverant\u00F6rsklass" }, //-providerclass
        { "provider.name", "leverant\u00F6rsnamn" }, //-providername
        { "provider.classpath", "leverant\u00F6rsklass\u00F6kv\u00E4g" }, //-providerpath
        { "output.in.RFC.style", "utdata i RFC-format" }, //-rfc
        { "signature.algorithm.name", "namn p\u00E5 signaturalgoritm" }, //-sigalg
        { "source.alias", "k\u00E4llalias" }, //-srcalias
        { "source.key.password", "l\u00F6senord f\u00F6r k\u00E4llnyckel" }, //-srckeypass
        { "source.keystore.name", "namn p\u00E5 k\u00E4llnyckellager" }, //-srckeystore
        { "source.keystore.password.protected", "skyddat l\u00F6senord f\u00F6r k\u00E4llnyckellager" }, //-srcprotected
        { "source.keystore.provider.name", "leverant\u00F6rsnamn f\u00F6r k\u00E4llnyckellager" }, //-srcprovidername
        { "source.keystore.password", "l\u00F6senord f\u00F6r k\u00E4llnyckellager" }, //-srcstorepass
        { "source.keystore.type", "typ av k\u00E4llnyckellager" }, //-srcstoretype
        { "SSL.server.host.and.port", "SSL-serverv\u00E4rd och -port" }, //-sslserver
        { "signed.jar.file", "signerad jar-fil" }, //=jarfile
        { "certificate.validity.start.date.time", "startdatum/-tid f\u00F6r certifikatets giltighet" }, //-startdate
        { "keystore.password", "l\u00F6senord f\u00F6r nyckellager" }, //-storepass
        { "keystore.type", "nyckellagertyp" }, //-storetype
        { "trust.certificates.from.cacerts", "tillf\u00F6rlitliga certifikat fr\u00E5n cacerts" }, //-trustcacerts
        { "verbose.output", "utf\u00F6rliga utdata" }, //-v
        { "validity.number.of.days", "antal dagar f\u00F6r giltighet" }, //-validity
        { "Serial.ID.of.cert.to.revoke", "Seriellt ID f\u00F6r certifikat som ska \u00E5terkallas" }, //-id
        // keytool: Running part
        { "keytool.error.", "nyckelverktygsfel: " }, { "Illegal.option.", "Otill\u00E5tet alternativ:  " },
        { "Illegal.value.", "Otill\u00E5tet v\u00E4rde: " },
        { "Unknown.password.type.", "Ok\u00E4nd l\u00F6senordstyp: " },
        { "Cannot.find.environment.variable.", "Kan inte hitta milj\u00F6variabel: " },
        ...
        { "Please.specify.srckeystore", "Ange -srckeystore" }, { "Must.not.specify.both.v.and.rfc.with.list.command",
        ...
        { "Must.specify.alias", "Du m\u00E5ste ange alias" }, { "Keystore.password.must.be.at.least.6.characters",
        ...
        { "alias.has.no.public.key.certificate.", "{0} saknar offentlig nyckel (certifikat)" },
        ...
        { "Keystore.type.", "Nyckellagertyp: " }, { "Keystore.provider.", "Nyckellagerleverant\u00F6r: " },
        ...
        { "Failed.to.parse.input", "Kunde inte tolka indata" }, { "Empty.input", "Inga indata" },
        ...
        { "Trust.this.certificate.no.", "Litar du p\u00E5 det h\u00E4r certifikatet? [nej]:  " }, { "YES", "Ja" },
        { "New.prompt.", "Nytt {0}: " }, { "Passwords.must.differ", "L\u00F6senorden m\u00E5ste vara olika" },
        ...
        { "What.is.the.two.letter.country.code.for.this.unit.",
            "Vilken \u00E4r den tv\u00E5st\u00E4lliga landskoden?" }, { "Is.name.correct.", "\u00C4r {0} korrekt?" },
        { "no", "nej" }, { "yes", "ja" }, { "y", "j" }, { ".defaultValue.", "  [{0}]:  " },
        ...
        { ".WARNING.WARNING.WARNING.", "*****************  Varning Varning Varning  *****************" },
        { "Signer.d.", "Signerare #%d:" }, { "Timestamp.", "Tidsst\u00E4mpel:" }, { "Signature.", "Underskrift:" },
        { "CRLs.", "CRL:er:" }, { "Certificate.owner.", "Certifikat\u00E4gare: " },
        ...
        { "Install.reply.anyway.no.", "Vill du installera svaret \u00E4nd\u00E5? [nej]:  " }, { "NO", "Nej" },
        ...
        { "Failed.to.establish.chain.from.reply", "Kunde inte uppr\u00E4tta kedja fr\u00E5n svaret" }, { "n", "n" },
        ...
        { "Extensions.", "Till\u00E4gg: " }, { ".Empty.value.", "(Tomt v\u00E4rde)" },
        ...
        { "Warning.Invalid.argument.s.for.constructor.arg", "Varning! Ogiltiga argument f\u00F6r konstruktor: {0}" },
        ...
        { ".file.file.policy.file.location", "  [-file <fil>]    policyfilens plats" }, { "New", "Nytt" },
        { "Open", "\u00D6ppna" }, { "Save", "Spara" }, { "Save.As", "Spara som" },
        { "View.Warning.Log", "Visa varningslogg" }, { "Exit", "Avsluta" },
        { "Add.Policy.Entry", "L\u00E4gg till policypost" }, { "Edit.Policy.Entry", "Redigera policypost" },
        { "Remove.Policy.Entry", "Ta bort policypost" }, { "Edit", "Redigera" }, { "Retain", "Beh\u00E5ll" },
        ...
        { "Remove.Public.Key.Alias", "Ta bort offentligt nyckelalias" }, { "File", "Fil" },
        { "KeyStore", "Nyckellager" }, { "Policy.File.", "Policyfil:" },
        { "Could.not.open.policy.file.policyFile.e.toString.", "Kan inte \u00F6ppna policyfilen: {0}: {1}" },
        ...
        { "Error", "Fel" }, { "OK", "OK" }, { "Status", "Status" }, { "Warning", "Varning" },
        { "Permission.", "Beh\u00F6righet:                                                       " },
        { "Principal.Type.", "Identitetshavaretyp:" }, { "Principal.Name.", "Identitetshavare:" },
        { "Target.Name.", "M\u00E5l:                                                    " },
        { "Actions.", "Funktioner:                                                             " },
        { "OK.to.overwrite.existing.file.filename.", "Ska den befintliga filen {0} skrivas \u00F6ver?" },
        { "Cancel", "Avbryt" }, { "CodeBase.", "Kodbas:" }, { "SignedBy.", "Signerad av:" },
        { "Add.Principal", "L\u00E4gg till identitetshavare" }, { "Edit.Principal", "Redigera identitetshavare" },
        { "Remove.Principal", "Ta bort identitetshavare" }, { "Principals.", "Identitetshavare:" },
        { ".Add.Permission", "  L\u00E4gg till beh\u00F6righet" }, { ".Edit.Permission", "  Redigera beh\u00F6righet" },
        { "Remove.Permission", "Ta bort beh\u00F6righet" }, { "Done", "Utf\u00F6rd" },
        { "KeyStore.URL.", "URL f\u00F6r nyckellager:" }, { "KeyStore.Type.", "Nyckellagertyp:" },
        { "KeyStore.Provider.", "Nyckellagerleverant\u00F6r:" },
        { "KeyStore.Password.URL.", "URL f\u00F6r l\u00F6senord till nyckellager:" },
        { "Principals", "Identitetshavare" }, { ".Edit.Principal.", "  Redigera identitetshavare:" },
        { ".Add.New.Principal.", "  L\u00E4gg till ny identitetshavare:" }, { "Permissions", "Beh\u00F6righet" },
        { ".Edit.Permission.", "  Redigera beh\u00F6righet:" },
        { ".Add.New.Permission.", "  L\u00E4gg till ny beh\u00F6righet:" }, { "Signed.By.", "Signerad av:" },
        { "Cannot.Specify.Principal.with.a.Wildcard.Class.without.a.Wildcard.Name",
            "Kan inte specificera identitetshavare med jokerteckenklass utan jokerteckennamn" },
        { "Cannot.Specify.Principal.without.a.Name", "Kan inte specificera identitetshavare utan namn" },
        ...
        { "Policy.successfully.written.to.filename", "Policy har skrivits till {0}" },
        { "null.filename", "nullfilnamn" }, { "Save.changes.", "Vill du spara \u00E4ndringarna?" }, { "Yes", "Ja" },
        { "No", "Nej" }, { "Policy.Entry", "Policyfel" }, { "Save.Changes", "Spara \u00E4ndringar" },
        { "No.Policy.Entry.selected", "Ingen policypost har valts" },
        { "Unable.to.open.KeyStore.ex.toString.", "Kan inte \u00F6ppna nyckellagret: {0}" },
        { "No.principal.selected", "Ingen identitetshavare har valts" },
        { "No.permission.selected", "Ingen beh\u00F6righet har valts" }, { "name", "namn" },
        { "configuration.type", "konfigurationstyp" },
        { "environment.variable.name", "variabelnamn f\u00F6r milj\u00F6" }, { "library.name", "biblioteksnamn" },
        { "package.name", "paketnamn" }, { "policy.type", "policytyp" }, { "property.name", "egenskapsnamn" },
        { "Principal.List", "Lista \u00F6ver identitetshavare" }, { "Permission.List", "Beh\u00F6righetslista" },
        { "Code.Base", "Kodbas" }, { "KeyStore.U.R.L.", "URL f\u00F6r nyckellager:" },
        ...
        { "invalid.null.Class.provided", "ogiltig null-klass" }, { "Subject.", "Innehavare:\n" },
        { ".Principal.", "\tIdentitetshavare: " }, { ".Public.Credential.", "\tOffentlig inloggning: " },
        ...
        { "null.subject.logout.called.before.login", "null-innehavare - utloggning anropades f\u00F6re inloggning" },
        ...
        { "LPARAM", "(" }, { "RPARAM", ")" }, { "type.can.t.be.null", "typen kan inte vara null" },
        ...
        { "expected.permission.entry", "f\u00F6rv\u00E4ntade beh\u00F6righetspost" }, { "number.", "antal " },
        ...
        { "PKCS11.Token.providerName.Password.", "PKCS11-tecken [{0}] L\u00F6senord: " },

        /* --- DEPRECATED --- */
        // javax.security.auth.Policy
        { "unable.to.instantiate.Subject.based.policy", "den innehavarbaserade policyn kan inte skapas" } };
