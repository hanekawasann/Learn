...
public class Resources_fr extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        { ".OPTION.", " [Option]..." }, { "Options.", "Options :" }, { "Use.keytool.help.for.all.available.commands",
        ...
        { "Commands.", "Commandes :" }, { "Use.keytool.command.name.help.for.usage.of.command.name",
        "Utiliser \"keytool -command_name -help\" pour la syntaxe de command_name" },
        // keytool: help: commands
        { "Generates.a.certificate.request", "G\u00E9n\u00E8re une demande de certificat" }, //-certreq
        { "Changes.an.entry.s.alias", "Modifie l'alias d'une entr\u00E9e" }, //-changealias
        { "Deletes.an.entry", "Supprime une entr\u00E9e" }, //-delete
        { "Exports.certificate", "Exporte le certificat" }, //-exportcert
        { "Generates.a.key.pair", "G\u00E9n\u00E8re une paire de cl\u00E9s" }, //-genkeypair
        // translation of "secret" key should be different to "private" key.
        { "Generates.a.secret.key", "G\u00E9n\u00E8re une cl\u00E9 secr\u00E8te" }, //-genseckey
        ...
        { "Imports.entries.from.a.JDK.1.1.x.style.identity.database",
            "Importe les entr\u00E9es \u00E0 partir d'une base de donn\u00E9es d'identit\u00E9s de type JDK 1.1.x" },
        //-identitydb
        { "Imports.a.certificate.or.a.certificate.chain", "Importe un certificat ou une cha\u00EEne de certificat" },
        //-importcert
        { "Imports.one.or.all.entries.from.another.keystore",
            "Importe une entr\u00E9e ou la totalit\u00E9 des entr\u00E9es depuis un autre fichier de cl\u00E9s" },
        //-importkeystore
        { "Clones.a.key.entry", "Clone une entr\u00E9e de cl\u00E9" }, //-keyclone
        { "Changes.the.key.password.of.an.entry", "Modifie le mot de passe de cl\u00E9 d'une entr\u00E9e" },
        //-keypasswd
        { "Lists.entries.in.a.keystore", "R\u00E9pertorie les entr\u00E9es d'un fichier de cl\u00E9s" }, //-list
        { "Prints.the.content.of.a.certificate", "Imprime le contenu d'un certificat" }, //-printcert
        ...
        { "Generates.a.self.signed.certificate", "G\u00E9n\u00E8re un certificat auto-sign\u00E9" }, //-selfcert
        { "Changes.the.store.password.of.a.keystore", "Modifie le mot de passe de banque d'un fichier de cl\u00E9s" },
        //-storepasswd
        // keytool: help: options
        { "alias.name.of.the.entry.to.process", "nom d'alias de l'entr\u00E9e \u00E0 traiter" }, //-alias
        { "destination.alias", "alias de destination" }, //-destalias
        { "destination.key.password", "mot de passe de la cl\u00E9 de destination" }, //-destkeypass
        { "destination.keystore.name", "nom du fichier de cl\u00E9s de destination" }, //-destkeystore
        ...
        //-destprovidername
        { "destination.keystore.password", "mot de passe du fichier de cl\u00E9s de destination" }, //-deststorepass
        { "destination.keystore.type", "type du fichier de cl\u00E9s de destination" }, //-deststoretype
        { "distinguished.name", "nom distinctif" }, //-dname
        { "X.509.extension", "extension X.509" }, //-ext
        { "output.file.name", "nom du fichier de sortie" }, //-file and -outfile
        { "input.file.name", "nom du fichier d'entr\u00E9e" }, //-file and -infile
        { "key.algorithm.name", "nom de l'algorithme de cl\u00E9" }, //-keyalg
        { "key.password", "mot de passe de la cl\u00E9" }, //-keypass
        { "key.bit.size", "taille en bits de la cl\u00E9" }, //-keysize
        { "keystore.name", "nom du fichier de cl\u00E9s" }, //-keystore
        { "new.password", "nouveau mot de passe" }, //-new
        { "do.not.prompt", "ne pas inviter" }, //-noprompt
        { "password.through.protected.mechanism", "mot de passe via m\u00E9canisme prot\u00E9g\u00E9" }, //-protected
        { "provider.argument", "argument du fournisseur" }, //-providerarg
        { "provider.class.name", "nom de la classe de fournisseur" }, //-providerclass
        { "provider.name", "nom du fournisseur" }, //-providername
        { "provider.classpath", "variable d'environnement CLASSPATH du fournisseur" }, //-providerpath
        { "output.in.RFC.style", "sortie au style RFC" }, //-rfc
        { "signature.algorithm.name", "nom de l'algorithme de signature" }, //-sigalg
        { "source.alias", "alias source" }, //-srcalias
        { "source.key.password", "mot de passe de la cl\u00E9 source" }, //-srckeypass
        { "source.keystore.name", "nom du fichier de cl\u00E9s source" }, //-srckeystore
        { "source.keystore.password.protected", "mot de passe du fichier de cl\u00E9s source prot\u00E9g\u00E9" },
        //-srcprotected
        { "source.keystore.provider.name", "nom du fournisseur du fichier de cl\u00E9s source" }, //-srcprovidername
        { "source.keystore.password", "mot de passe du fichier de cl\u00E9s source" }, //-srcstorepass
        { "source.keystore.type", "type du fichier de cl\u00E9s source" }, //-srcstoretype
        { "SSL.server.host.and.port", "Port et h\u00F4te du serveur SSL" }, //-sslserver
        { "signed.jar.file", "fichier JAR sign\u00E9" }, //=jarfile
        { "certificate.validity.start.date.time", "date/heure de d\u00E9but de validit\u00E9 du certificat" },
        //-startdate
        { "keystore.password", "mot de passe du fichier de cl\u00E9s" }, //-storepass
        { "keystore.type", "type du fichier de cl\u00E9s" }, //-storetype
        { "trust.certificates.from.cacerts", "certificats s\u00E9curis\u00E9s issus de certificats CA" },
        //-trustcacerts
        { "verbose.output", "sortie en mode verbose" }, //-v
        { "validity.number.of.days", "nombre de jours de validit\u00E9" }, //-validity
        { "Serial.ID.of.cert.to.revoke", "ID de s\u00E9rie du certificat \u00E0 r\u00E9voquer" }, //-id
        // keytool: Running part
        { "keytool.error.", "erreur keytool : " }, { "Illegal.option.", "Option non admise :  " },
        { "Illegal.value.", "Valeur non admise : " }, { "Unknown.password.type.", "Type de mot de passe inconnu : " },
        ...
        { "Entry.for.alias.alias.successfully.imported.",
            "L''entr\u00E9e de l''alias {0} a \u00E9t\u00E9 import\u00E9e." }, { "Entry.for.alias.alias.not.imported.",
        ...
        { "Empty.input", "Entr\u00E9e vide" }, { "Not.X.509.certificate", "Pas un certificat X.509" },
        ...
        { "Trust.this.certificate.no.", "Faire confiance \u00E0 ce certificat ? [non] :  " }, { "YES", "Oui" },
        { "New.prompt.", "Nouveau {0} : " }, { "Passwords.must.differ", "Les mots de passe doivent diff\u00E9rer" },
        ...
        { "Enter.alias.name.", "Indiquez le nom d'alias :  " }, { ".RETURN.if.same.as.for.otherAlias.",
        "\t(appuyez sur Entr\u00E9e si le r\u00E9sultat est identique \u00E0 <{0}>)" }, { ".PATTERN.printX509Cert",
        ...
        { "Is.name.correct.", "Est-ce {0} ?" }, { "no", "non" }, { "yes", "oui" }, { "y", "o" },
        { ".defaultValue.", "  [{0}]:  " },
        ...
        { "Signer.d.", "Signataire n\u00B0%d :" }, { "Timestamp.", "Horodatage :" }, { "Signature.", "Signature :" },
        ...
        { "Install.reply.anyway.no.", "Installer la r\u00E9ponse quand m\u00EAme ? [non] :  " }, { "NO", "Non" },
        ...
        { "Failed.to.establish.chain.from.reply",
            "Impossible de cr\u00E9er une cha\u00EEne \u00E0 partir de la r\u00E9ponse" }, { "n", "n" },
        ...
        { "Extensions.", "Extensions\u00A0: " }, { ".Empty.value.", "(Valeur vide)" },
        ...
        { ".file.file.policy.file.location", "  [-file <file>]    emplacement du fichier de r\u00E8gles" },
        { "New", "Nouveau" }, { "Open", "Ouvrir" }, { "Save", "Enregistrer" }, { "Save.As", "Enregistrer sous" },
        { "View.Warning.Log", "Afficher le journal des avertissements" }, { "Exit", "Quitter" },
        { "Add.Policy.Entry", "Ajouter une r\u00E8gle" }, { "Edit.Policy.Entry", "Modifier une r\u00E8gle" },
        { "Remove.Policy.Entry", "Enlever une r\u00E8gle" }, { "Edit", "Modifier" }, { "Retain", "Conserver" },
        ...
        { "Remove.Public.Key.Alias", "Enlever un alias de cl\u00E9 publique" }, { "File", "Fichier" },
        { "KeyStore", "Fichier de cl\u00E9s" }, { "Policy.File.", "Fichier de r\u00E8gles :" },
        { "Could.not.open.policy.file.policyFile.e.toString.",
            "Impossible d''ouvrir le fichier de r\u00E8gles\u00A0: {0}: {1}" }, { "Policy.Tool", "Policy Tool" },
        ...
        { "Error", "Erreur" }, { "OK", "OK" }, { "Status", "Statut" }, { "Warning", "Avertissement" },
        { "Permission.", "Droit :                                                       " },
        { "Principal.Type.", "Type de principal :" }, { "Principal.Name.", "Nom de principal :" },
        { "Target.Name.", "Nom de cible :                                                    " },
        { "Actions.", "Actions :                                                             " },
        { "OK.to.overwrite.existing.file.filename.", "Remplacer le fichier existant {0} ?" }, { "Cancel", "Annuler" },
        { "CodeBase.", "Base de code :" }, { "SignedBy.", "Sign\u00E9 par :" },
        { "Add.Principal", "Ajouter un principal" }, { "Edit.Principal", "Modifier un principal" },
        { "Remove.Principal", "Enlever un principal" }, { "Principals.", "Principaux :" },
        { ".Add.Permission", "  Ajouter un droit" }, { ".Edit.Permission", "  Modifier un droit" },
        { "Remove.Permission", "Enlever un droit" }, { "Done", "Termin\u00E9" },
        { "KeyStore.URL.", "URL du fichier de cl\u00E9s :" }, { "KeyStore.Type.", "Type du fichier de cl\u00E9s :" },
        { "KeyStore.Provider.", "Fournisseur du fichier de cl\u00E9s :" },
        { "KeyStore.Password.URL.", "URL du mot de passe du fichier de cl\u00E9s :" }, { "Principals", "Principaux" },
        { ".Edit.Principal.", "  Modifier un principal :" }, { ".Add.New.Principal.", "  Ajouter un principal :" },
        { "Permissions", "Droits" }, { ".Edit.Permission.", "  Modifier un droit :" },
        { ".Add.New.Permission.", "  Ajouter un droit :" }, { "Signed.By.", "Sign\u00E9 par :" },
        { "Cannot.Specify.Principal.with.a.Wildcard.Class.without.a.Wildcard.Name",
            "Impossible de sp\u00E9cifier un principal avec une classe g\u00E9n\u00E9rique sans nom g\u00E9n\u00E9rique" },
        { "Cannot.Specify.Principal.without.a.Name", "Impossible de sp\u00E9cifier un principal sans nom" },
        { "Permission.and.Target.Name.must.have.a.value", "Le droit et le nom de cible doivent avoir une valeur" },
        { "Remove.this.Policy.Entry.", "Enlever cette r\u00E8gle ?" }, { "Overwrite.File", "Remplacer le fichier" },
        { "Policy.successfully.written.to.filename", "R\u00E8gle \u00E9crite dans {0}" },
        { "null.filename", "nom de fichier NULL" }, { "Save.changes.", "Enregistrer les modifications ?" },
        { "Yes", "Oui" }, { "No", "Non" }, { "Policy.Entry", "R\u00E8gle" },
        { "Save.Changes", "Enregistrer les modifications" },
        { "No.Policy.Entry.selected", "Aucune r\u00E8gle s\u00E9lectionn\u00E9e" },
        { "Unable.to.open.KeyStore.ex.toString.", "Impossible d''ouvrir le fichier de cl\u00E9s d''acc\u00E8s : {0}" },
        { "No.principal.selected", "Aucun principal s\u00E9lectionn\u00E9" },
        { "No.permission.selected", "Aucun droit s\u00E9lectionn\u00E9" }, { "name", "nom" },
        { "configuration.type", "type de configuration" },
        { "environment.variable.name", "Nom de variable d'environnement" },
        { "library.name", "nom de biblioth\u00E8que" }, { "package.name", "nom de package" },
        { "policy.type", "type de r\u00E8gle" }, { "property.name", "nom de propri\u00E9t\u00E9" },
        { "Principal.List", "Liste de principaux" }, { "Permission.List", "Liste de droits" },
        { "Code.Base", "Base de code" }, { "KeyStore.U.R.L.", "URL du fichier de cl\u00E9s :" },
        ...
        { "invalid.null.Class.provided", "classe NULL fournie non valide" }, { "Subject.", "Objet :\n" },
        { ".Principal.", "\tPrincipal : " },
        ...
        { "LPARAM", "(" }, { "RPARAM", ")" }, { "type.can.t.be.null", "le type ne peut \u00EAtre NULL" },
        ...
        { "expected.permission.entry", "entr\u00E9e de droit attendue" }, { "number.", "nombre " },
        { "expected.expect.read.end.of.file.", "attendu [{0}], lu [fin de fichier]" },
        { "expected.read.end.of.file.", "attendu [;], lu [fin de fichier]" }, { "line.number.msg", "ligne {0} : {1}" },
