...
public class AuthResources extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        { "NTNumericCredential.name", "NTNumericCredential: {0}" }, { "Invalid.NTSid.value", "Invalid NTSid value" },
        { "NTSid.name", "NTSid: {0}" }, { "NTSidDomainPrincipal.name", "NTSidDomainPrincipal: {0}" },
        ...
        { "Keystore.alias.", "Keystore alias: " }, { "Keystore.password.", "Keystore password: " },
        ...
        { ".error.parsing.", ": error parsing " }, { "COLON", ": " },
        { ".error.adding.Permission.", ": error adding Permission " }, { "SPACE", " " },
        { ".error.adding.Entry.", ": error adding Entry " }, { "LPARAM", "(" }, { "RPARAM", ")" },
        ...
        { "expected.read.end.of.file", "expected ';', read end of file" }, { "line.", "line " },
        { ".expected.", ": expected '" }, { ".found.", "', found '" }, { "QUOTE", "'" },
