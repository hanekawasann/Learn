...
public class Resources_zh_TW extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        { "Generates.a.certificate.request", "\u7522\u751F\u6191\u8B49\u8981\u6C42" }, //-certreq
        { "Changes.an.entry.s.alias", "\u8B8A\u66F4\u9805\u76EE\u7684\u5225\u540D" }, //-changealias
        { "Deletes.an.entry", "\u522A\u9664\u9805\u76EE" }, //-delete
        { "Exports.certificate", "\u532F\u51FA\u6191\u8B49" }, //-exportcert
        { "Generates.a.key.pair", "\u7522\u751F\u91D1\u9470\u7D44" }, //-genkeypair
        // translation of "secret" key should be different to "private" key.
        { "Generates.a.secret.key", "\u7522\u751F\u79D8\u5BC6\u91D1\u9470" }, //-genseckey
        ...
        { "Imports.one.or.all.entries.from.another.keystore",
            "\u5F9E\u5176\u4ED6\u91D1\u9470\u5132\u5B58\u5EAB\u532F\u5165\u4E00\u500B\u6216\u5168\u90E8\u9805\u76EE" },
        //-importkeystore
        { "Clones.a.key.entry", "\u8907\u88FD\u91D1\u9470\u9805\u76EE" }, //-keyclone
        { "Changes.the.key.password.of.an.entry", "\u8B8A\u66F4\u9805\u76EE\u7684\u91D1\u9470\u5BC6\u78BC" },
        //-keypasswd
        { "Lists.entries.in.a.keystore", "\u5217\u793A\u91D1\u9470\u5132\u5B58\u5EAB\u4E2D\u7684\u9805\u76EE" }, //-list
        { "Prints.the.content.of.a.certificate", "\u5217\u5370\u6191\u8B49\u7684\u5167\u5BB9" }, //-printcert
        { "Prints.the.content.of.a.certificate.request", "\u5217\u5370\u6191\u8B49\u8981\u6C42\u7684\u5167\u5BB9" },
        //-printcertreq
        { "Prints.the.content.of.a.CRL.file", "\u5217\u5370 CRL \u6A94\u6848\u7684\u5167\u5BB9" }, //-printcrl
        { "Generates.a.self.signed.certificate", "\u7522\u751F\u81EA\u884C\u7C3D\u7F72\u7684\u6191\u8B49" }, //-selfcert
        { "Changes.the.store.password.of.a.keystore",
            "\u8B8A\u66F4\u91D1\u9470\u5132\u5B58\u5EAB\u7684\u5132\u5B58\u5BC6\u78BC" }, //-storepasswd
        // keytool: help: options
        { "alias.name.of.the.entry.to.process", "\u8981\u8655\u7406\u9805\u76EE\u7684\u5225\u540D\u540D\u7A31" },
        //-alias
        { "destination.alias", "\u76EE\u7684\u5730\u5225\u540D" }, //-destalias
        { "destination.key.password", "\u76EE\u7684\u5730\u91D1\u9470\u5BC6\u78BC" }, //-destkeypass
        { "destination.keystore.name", "\u76EE\u7684\u5730\u91D1\u9470\u5132\u5B58\u5EAB\u540D\u7A31" }, //-destkeystore
        ...
        //-deststoretype
        { "distinguished.name", "\u8FA8\u5225\u540D\u7A31" }, //-dname
        { "X.509.extension", "X.509 \u64F4\u5145\u5957\u4EF6" }, //-ext
        { "output.file.name", "\u8F38\u51FA\u6A94\u6848\u540D\u7A31" }, //-file and -outfile
        { "input.file.name", "\u8F38\u5165\u6A94\u6848\u540D\u7A31" }, //-file and -infile
        { "key.algorithm.name", "\u91D1\u9470\u6F14\u7B97\u6CD5\u540D\u7A31" }, //-keyalg
        { "key.password", "\u91D1\u9470\u5BC6\u78BC" }, //-keypass
        { "key.bit.size", "\u91D1\u9470\u4F4D\u5143\u5927\u5C0F" }, //-keysize
        { "keystore.name", "\u91D1\u9470\u5132\u5B58\u5EAB\u540D\u7A31" }, //-keystore
        { "new.password", "\u65B0\u5BC6\u78BC" }, //-new
        { "do.not.prompt", "\u4E0D\u8981\u63D0\u793A" }, //-noprompt
        { "password.through.protected.mechanism", "\u7D93\u7531\u4FDD\u8B77\u6A5F\u5236\u7684\u5BC6\u78BC" },
        //-protected
        { "provider.argument", "\u63D0\u4F9B\u8005\u5F15\u6578" }, //-providerarg
        { "provider.class.name", "\u63D0\u4F9B\u8005\u985E\u5225\u540D\u7A31" }, //-providerclass
        { "provider.name", "\u63D0\u4F9B\u8005\u540D\u7A31" }, //-providername
        { "provider.classpath", "\u63D0\u4F9B\u8005\u985E\u5225\u8DEF\u5F91" }, //-providerpath
        { "output.in.RFC.style", "\u4EE5 RFC \u6A23\u5F0F\u8F38\u51FA" }, //-rfc
        { "signature.algorithm.name", "\u7C3D\u7AE0\u6F14\u7B97\u6CD5\u540D\u7A31" }, //-sigalg
        { "source.alias", "\u4F86\u6E90\u5225\u540D" }, //-srcalias
        { "source.key.password", "\u4F86\u6E90\u91D1\u9470\u5BC6\u78BC" }, //-srckeypass
        { "source.keystore.name", "\u4F86\u6E90\u91D1\u9470\u5132\u5B58\u5EAB\u540D\u7A31" }, //-srckeystore
        { "source.keystore.password.protected", "\u4F86\u6E90\u91D1\u9470\u5132\u5B58\u5EAB\u5BC6\u78BC\u4FDD\u8B77" },
        //-srcprotected
        { "source.keystore.provider.name", "\u4F86\u6E90\u91D1\u9470\u5132\u5B58\u5EAB\u63D0\u4F9B\u8005\u540D\u7A31" },
        //-srcprovidername
        { "source.keystore.password", "\u4F86\u6E90\u91D1\u9470\u5132\u5B58\u5EAB\u5BC6\u78BC" }, //-srcstorepass
        { "source.keystore.type", "\u4F86\u6E90\u91D1\u9470\u5132\u5B58\u5EAB\u985E\u578B" }, //-srcstoretype
        { "SSL.server.host.and.port", "SSL \u4F3A\u670D\u5668\u4E3B\u6A5F\u8207\u9023\u63A5\u57E0" }, //-sslserver
        { "signed.jar.file", "\u7C3D\u7F72\u7684 jar \u6A94\u6848" }, //=jarfile
        { "certificate.validity.start.date.time",
            "\u6191\u8B49\u6709\u6548\u6027\u958B\u59CB\u65E5\u671F/\u6642\u9593" }, //-startdate
        { "keystore.password", "\u91D1\u9470\u5132\u5B58\u5EAB\u5BC6\u78BC" }, //-storepass
        { "keystore.type", "\u91D1\u9470\u5132\u5B58\u5EAB\u985E\u578B" }, //-storetype
        { "trust.certificates.from.cacerts", "\u4F86\u81EA cacerts \u7684\u4FE1\u4EFB\u6191\u8B49" }, //-trustcacerts
        { "verbose.output", "\u8A73\u7D30\u8CC7\u8A0A\u8F38\u51FA" }, //-v
        { "validity.number.of.days", "\u6709\u6548\u6027\u65E5\u6578" }, //-validity
        { "Serial.ID.of.cert.to.revoke", "\u8981\u64A4\u92B7\u6191\u8B49\u7684\u5E8F\u5217 ID" }, //-id
        // keytool: Running part
        { "keytool.error.", "\u91D1\u9470\u5DE5\u5177\u932F\u8AA4: " },
        { "Illegal.option.", "\u7121\u6548\u7684\u9078\u9805:" }, { "Illegal.value.", "\u7121\u6548\u503C: " },
        ...
        { "Your.keystore.contains.keyStore.size.entries",
            "\u60A8\u7684\u91D1\u9470\u5132\u5B58\u5EAB\u5305\u542B {0,number,integer} \u9805\u76EE" },
        { "Failed.to.parse.input", "\u7121\u6CD5\u5256\u6790\u8F38\u5165" }, { "Empty.input", "\u7A7A\u8F38\u5165" },
        ...
        { "Trust.this.certificate.no.", "\u4FE1\u4EFB\u9019\u500B\u6191\u8B49\uFF1F [\u5426]:  " }, { "YES", "\u662F" },
        { "New.prompt.", "\u65B0 {0}: " },
        ...
        { "What.is.the.two.letter.country.code.for.this.unit.",
            "\u6B64\u55AE\u4F4D\u7684\u5169\u500B\u5B57\u6BCD\u570B\u5225\u4EE3\u78BC\u70BA\u4F55\uFF1F" },
        { "Is.name.correct.", "{0} \u6B63\u78BA\u55CE\uFF1F" }, { "no", "\u5426" }, { "yes", "\u662F" }, { "y", "y" },
        { ".defaultValue.", "  [{0}]:  " }, { "Alias.alias.has.no.key", "\u5225\u540D <{0}> \u6C92\u6709\u91D1\u9470" },
        { "Alias.alias.references.an.entry.type.that.is.not.a.private.key.entry.The.keyclone.command.only.supports.cloning.of.private.key",
            "\u5225\u540D <{0}> \u6240\u53C3\u7167\u7684\u9805\u76EE\u4E0D\u662F\u79C1\u5BC6\u91D1\u9470\u985E\u578B\u3002-keyclone \u547D\u4EE4\u50C5\u652F\u63F4\u79C1\u5BC6\u91D1\u9470\u9805\u76EE\u7684\u8907\u88FD" },

        { ".WARNING.WARNING.WARNING.", "*****************  \u8B66\u544A \u8B66\u544A \u8B66\u544A  *****************" },
        { "Signer.d.", "\u7C3D\u7F72\u8005 #%d:" }, { "Timestamp.", "\u6642\u6233:" },
        { "Signature.", "\u7C3D\u7AE0:" }, { "CRLs.", "CRL:" },
        ...
        { "NO", "\u5426" }, { "Public.keys.in.reply.and.keystore.don.t.match",
        "\u56DE\u8986\u6642\u7684\u516C\u958B\u91D1\u9470\u8207\u91D1\u9470\u5132\u5B58\u5EAB\u4E0D\u7B26" },
        ...
        { "Extensions.", "\u64F4\u5145\u5957\u4EF6: " }, { ".Empty.value.", "(\u7A7A\u767D\u503C)" },
        ...
        { ".file.file.policy.file.location", "  [-file <file>]    \u539F\u5247\u6A94\u6848\u4F4D\u7F6E" },
        { "New", "\u65B0\u589E" }, { "Open", "\u958B\u555F" }, { "Save", "\u5132\u5B58" },
        { "Save.As", "\u53E6\u5B58\u65B0\u6A94" }, { "View.Warning.Log", "\u6AA2\u8996\u8B66\u544A\u8A18\u9304" },
        { "Exit", "\u7D50\u675F" }, { "Add.Policy.Entry", "\u65B0\u589E\u539F\u5247\u9805\u76EE" },
        { "Edit.Policy.Entry", "\u7DE8\u8F2F\u539F\u5247\u9805\u76EE" },
        { "Remove.Policy.Entry", "\u79FB\u9664\u539F\u5247\u9805\u76EE" }, { "Edit", "\u7DE8\u8F2F" },
        { "Retain", "\u4FDD\u7559" },
        ...
        { "Remove.Public.Key.Alias", "\u79FB\u9664\u516C\u958B\u91D1\u9470\u5225\u540D" }, { "File", "\u6A94\u6848" },
        { "KeyStore", "\u91D1\u9470\u5132\u5B58\u5EAB" }, { "Policy.File.", "\u539F\u5247\u6A94\u6848: " },
        { "Could.not.open.policy.file.policyFile.e.toString.",
            "\u7121\u6CD5\u958B\u555F\u539F\u5247\u6A94\u6848: {0}: {1}" },
        { "Policy.Tool", "\u539F\u5247\u5DE5\u5177" },
        { "Errors.have.occurred.while.opening.the.policy.configuration.View.the.Warning.Log.for.more.information.",
            "\u958B\u555F\u539F\u5247\u8A18\u7F6E\u6642\u767C\u751F\u932F\u8AA4\u3002\u8ACB\u6AA2\u8996\u8B66\u544A\u8A18\u9304\u4EE5\u53D6\u5F97\u66F4\u591A\u7684\u8CC7\u8A0A" },
        { "Error", "\u932F\u8AA4" }, { "OK", "\u78BA\u5B9A" }, { "Status", "\u72C0\u614B" },
        { "Warning", "\u8B66\u544A" },
        { "Permission.", "\u6B0A\u9650:                                                       " },
        { "Principal.Type.", "Principal \u985E\u578B: " }, { "Principal.Name.", "Principal \u540D\u7A31: " },
        { "Target.Name.", "\u76EE\u6A19\u540D\u7A31:                                                    " },
        { "Actions.", "\u52D5\u4F5C:                                                             " },
        { "OK.to.overwrite.existing.file.filename.",
            "\u78BA\u8A8D\u8986\u5BEB\u73FE\u5B58\u7684\u6A94\u6848 {0}\uFF1F" }, { "Cancel", "\u53D6\u6D88" },
        { "CodeBase.", "CodeBase:" }, { "SignedBy.", "SignedBy:" }, { "Add.Principal", "\u65B0\u589E Principal" },
        { "Edit.Principal", "\u7DE8\u8F2F Principal" }, { "Remove.Principal", "\u79FB\u9664 Principal" },
        { "Principals.", "Principal:" }, { ".Add.Permission", "  \u65B0\u589E\u6B0A\u9650" },
        { ".Edit.Permission", "  \u7DE8\u8F2F\u6B0A\u9650" }, { "Remove.Permission", "\u79FB\u9664\u6B0A\u9650" },
        { "Done", "\u5B8C\u6210" }, { "KeyStore.URL.", "\u91D1\u9470\u5132\u5B58\u5EAB URL: " },
        { "KeyStore.Type.", "\u91D1\u9470\u5132\u5B58\u5EAB\u985E\u578B:" },
        { "KeyStore.Provider.", "\u91D1\u9470\u5132\u5B58\u5EAB\u63D0\u4F9B\u8005:" },
        { "KeyStore.Password.URL.", "\u91D1\u9470\u5132\u5B58\u5EAB\u5BC6\u78BC URL: " }, { "Principals", "Principal" },
        { ".Edit.Principal.", "  \u7DE8\u8F2F Principal: " }, { ".Add.New.Principal.", "  \u65B0\u589E Principal: " },
        { "Permissions", "\u6B0A\u9650" }, { ".Edit.Permission.", "  \u7DE8\u8F2F\u6B0A\u9650:" },
        { ".Add.New.Permission.", "  \u65B0\u589E\u6B0A\u9650:" }, { "Signed.By.", "\u7C3D\u7F72\u4EBA: " },
        ...
        { "Overwrite.File", "\u8986\u5BEB\u6A94\u6848" },
        { "Policy.successfully.written.to.filename", "\u539F\u5247\u6210\u529F\u5BEB\u5165\u81F3 {0}" },
        { "null.filename", "\u7A7A\u503C\u6A94\u540D" }, { "Save.changes.", "\u5132\u5B58\u8B8A\u66F4\uFF1F" },
        { "Yes", "\u662F" }, { "No", "\u5426" }, { "Policy.Entry", "\u539F\u5247\u9805\u76EE" },
        { "Save.Changes", "\u5132\u5B58\u8B8A\u66F4" },
        { "No.Policy.Entry.selected", "\u6C92\u6709\u9078\u53D6\u539F\u5247\u9805\u76EE" },
        { "Unable.to.open.KeyStore.ex.toString.", "\u7121\u6CD5\u958B\u555F\u91D1\u9470\u5132\u5B58\u5EAB: {0}" },
        { "No.principal.selected", "\u672A\u9078\u53D6 Principal" },
        { "No.permission.selected", "\u6C92\u6709\u9078\u53D6\u6B0A\u9650" }, { "name", "\u540D\u7A31" },
        { "configuration.type", "\u7D44\u614B\u985E\u578B" },
        { "environment.variable.name", "\u74B0\u5883\u8B8A\u6578\u540D\u7A31" },
        { "library.name", "\u7A0B\u5F0F\u5EAB\u540D\u7A31" },
        { "package.name", "\u5957\u88DD\u7A0B\u5F0F\u540D\u7A31" }, { "policy.type", "\u539F\u5247\u985E\u578B" },
        { "property.name", "\u5C6C\u6027\u540D\u7A31" }, { "Principal.List", "Principal \u6E05\u55AE" },
        { "Permission.List", "\u6B0A\u9650\u6E05\u55AE" }, { "Code.Base", "\u4EE3\u78BC\u57FA\u6E96" },
        ...
        { "No.LoginModules.configured.for.name", "\u7121\u91DD\u5C0D {0} \u914D\u7F6E\u7684 LoginModules" },
        ...
        { "LPARAM", "(" }, { "RPARAM", ")" }, { "type.can.t.be.null", "\u8F38\u5165\u4E0D\u80FD\u70BA\u7A7A\u503C" },
        ...
        { "expected.permission.entry", "\u9810\u671F\u7684\u6B0A\u9650\u9805\u76EE" }, { "number.", "\u865F\u78BC " },
