...
public class Debug {
    ...
    static {
        args = java.security.AccessController
            .doPrivileged(new sun.security.action.GetPropertyAction("java.security.debug"));

        String args2 = java.security.AccessController
            .doPrivileged(new sun.security.action.GetPropertyAction("java.security.auth.debug"));
    ...
    public static boolean isOn(String option) {
        if (args == null) { return false; } else {
            if (args.indexOf("all") != -1) { return true; } else { return (args.indexOf(option) != -1); }
        }
    }
