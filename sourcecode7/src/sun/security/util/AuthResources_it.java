...
public class AuthResources_it extends java.util.ListResourceBundle {
    ...
    private static final Object[][] contents = {
        ...
        { "Invalid.NTSid.value", "Valore NTSid non valido" }, { "NTSid.name", "NTSid: {0}" },
        ...
        { "Keystore.alias.", "Alias keystore: " }, { "Keystore.password.", "Password keystore: " },
        ...
        { ".error.parsing.", ": errore durante l'analisi " }, { "COLON", ": " },
        { ".error.adding.Permission.", ": errore durante l'aggiunta dell'autorizzazione " }, { "SPACE", " " },
        { ".error.adding.Entry.", ": errore durante l'aggiunta della voce " }, { "LPARAM", "(" }, { "RPARAM", ")" },
