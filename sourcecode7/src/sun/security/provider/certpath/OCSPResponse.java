...
public final class OCSPResponse {
    ...
    private static final ObjectIdentifier OCSP_NONCE_EXTENSION_OID = ObjectIdentifier
     ...
     */
    OCSPResponse(byte[] bytes, Date dateCheckedAgainst, X509Certificate responderCert)
     ...
     */
    private boolean verifyResponse(byte[] responseData, X509Certificate cert, AlgorithmId sigAlgId, byte[] signBytes)
