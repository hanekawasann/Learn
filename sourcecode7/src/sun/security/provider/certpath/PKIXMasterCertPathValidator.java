...
class PKIXMasterCertPathValidator {
     ...
     * @throws CertPathValidatorException Exception thrown if cert
        ...
        for (int i = 0; i < cpSize; i++) {
            ...
            for (int j = 0; j < certPathCheckers.size(); j++) {
                ...
                try {
                     ...
                     */
                    CertPathValidatorException currentCause = new CertPathValidatorException(cpve.getMessage(),
                        cpve.getCause(), cpOriginal, cpSize - (i + 1), cpve.getReason());
            ...
            if (!unresolvedCritExts.isEmpty()) {
                throw new CertPathValidatorException("unrecognized " + "critical extension(s)", null, cpOriginal,
                    cpSize - (i + 1), PKIXReason.UNRECOGNIZED_CRIT_EXT);
            }
     ...
     */
    private static boolean isRevocationCheck(PKIXCertPathChecker checker, int index,
