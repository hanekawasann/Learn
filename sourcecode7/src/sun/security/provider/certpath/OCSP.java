...
public final class OCSP {
    ...
    public static RevocationStatus check(X509Certificate cert, X509Certificate issuerCert)
        ...
        OCSPResponse ocspResponse = check(Collections.singletonList(certId), responderURI, issuerCert, null);
    ...
    public static RevocationStatus check(X509Certificate cert, X509Certificate issuerCert, URI responderURI,
        ...
        OCSPResponse ocspResponse = check(Collections.singletonList(certId), responderURI, responderCert, date);
        return (RevocationStatus) ocspResponse.getSingleResponse(certId);
    }
     ...
     *                                    encoding the OCSP Request or validating the OCSP Response
     */
    static OCSPResponse check(List<CertId> certIds, URI responderURI, X509Certificate responderCert, Date date)
        throws IOException, CertPathValidatorException {
