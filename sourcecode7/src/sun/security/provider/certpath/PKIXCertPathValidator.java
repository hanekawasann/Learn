...
public class PKIXCertPathValidator extends CertPathValidatorSpi {
     ...
     * @return the result
     * @throws CertPathValidatorException         Exception thrown if cert path
     *                                            does not validate.
    ...
    public CertPathValidatorResult engineValidate(CertPath cp, CertPathParameters param)
        ...
        for (TrustAnchor anchor : anchors) {
            ...
            if (trustedCert != null) {
                ...
                if (debug != null) {
                    debug.println("anchor.getTrustedCert()." + "getSubjectX500Principal() = " +
            ...
            try {
                PolicyNodeImpl rootNode = new PolicyNodeImpl(null, PolicyChecker.ANY_POLICY, null, false,
        ...
        throw new CertPathValidatorException("Path does not chain with any of the trust anchors", null, null, -1,
    ...
    private void populateVariables(PKIXParameters pkixParam) {
        ...
        if (pkixParam.isRevocationEnabled()) {
            ...
            ocspEnabled = AccessController
                .doPrivileged(new GetBooleanSecurityPropertyAction(OCSPChecker.OCSP_ENABLE_PROP));
     ...
     */
    private PolicyNode doValidate(TrustAnchor anchor, CertPath cpOriginal, ArrayList<X509Certificate> certList,
        PKIXParameters pkixParam, PolicyNodeImpl rootNode) throws CertPathValidatorException {
        ...
        PolicyChecker policyChecker = new PolicyChecker(pkixParam.getInitialPolicies(), certPathLen,
            pkixParam.isExplicitPolicyRequired(), pkixParam.isPolicyMappingInhibited(),
            pkixParam.isAnyPolicyInhibited(), pkixParam.getPolicyQualifiersRejected(), rootNode);
