...
public class GSSNameImpl implements GSSName {
    ...
    GSSNameImpl(GSSManagerImpl gssManager, Object appName, Oid appNameType, Oid mech) throws GSSException {
        ...
        if (appName == null) { throw new GSSExceptionImpl(GSSException.BAD_NAME, "Cannot import null name"); }
    ...
    private void importName(GSSManagerImpl gssManager, Object appName) throws GSSException {
        ...
        pos += oidLen;
        int mechPortionLen = (((0xFF & bytes[pos++]) << 24) | ((0xFF & bytes[pos++]) << 16) |
    ...
    public boolean equals(Object another) {
        ...
        try {
            ...
            if (another instanceof GSSName) { return equals((GSSName) another); }
     ...
     * @throws GSSException with major codes NAME_NOT_MN, BAD_NAME,
     *                      BAD_NAME, FAILURE.
     */
    ...
    private static String getNameTypeStr(Oid nameTypeOid) {
        ...
        if (nameTypeOid.equals(GSSUtil.NT_GSS_KRB5_PRINCIPAL)) { return "NT_GSS_KRB5_PRINCIPAL"; } else {
            return "Unknown";
        }
    }
}
