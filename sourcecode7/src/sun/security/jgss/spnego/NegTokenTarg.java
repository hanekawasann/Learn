...
public class NegTokenTarg extends SpNegoToken {
    ...
    final byte[] encode() throws GSSException {
        try {
            ...
            targToken.write(DerValue.createTag(DerValue.TAG_CONTEXT, true, (byte) 0x00), result);
            ...
            if (supportedMech != null) {
                ...
                mech.write(mechType);
                targToken.write(DerValue.createTag(DerValue.TAG_CONTEXT, true, (byte) 0x01), mech);
            }
            ...
            if (responseToken != null) {
                ...
                targToken.write(DerValue.createTag(DerValue.TAG_CONTEXT, true, (byte) 0x02), rspToken);
            }
            ...
            if (mechListMIC != null) {
                ...
                targToken.write(DerValue.createTag(DerValue.TAG_CONTEXT, true, (byte) 0x03), mic);
                ...
                if (responseToken != null) {
                    ...
                    DerOutputStream rspToken = new DerOutputStream();
                    rspToken.putOctetString(responseToken);
                    targToken.write(DerValue.createTag(DerValue.TAG_CONTEXT, true, (byte) 0x03), rspToken);
                }
            }
        ...
        try {
            ...
            while (tmp1.data.available() > 0) {
                ...
                if (tmp2.isContextSpecific((byte) 0x00)) {
                    ...
                    if (DEBUG) {
                        System.out.println(
                            "SpNegoToken NegTokenTarg: negotiated" + " result = " + getNegoResultString(negResult));
                    }
                    ...
                    if (!GSSUtil.useMSInterop()) {
                        ...
                        if (DEBUG) {
                            System.out.println(
                                "SpNegoToken NegTokenTarg: " + "MechListMIC Token = " + getHexBytes(mechListMIC));
                        }
                    }
                }
            }
