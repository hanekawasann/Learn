...
class GSSContextImpl implements ExtendedGSSContext {
    ...
    public boolean isEstablished() {
        if (mechCtxt == null) { return false; } else { return (currentState == READY); }
    }

    public int getWrapSizeLimit(int qop, boolean confReq, int maxTokenSize) throws GSSException {
        if (mechCtxt != null) { return mechCtxt.getWrapSizeLimit(qop, confReq, maxTokenSize); } else {
    ...
    public void verifyMIC(InputStream tokStream, InputStream msgStream, MessageProp msgProp) throws GSSException {
        if (mechCtxt != null) { mechCtxt.verifyMIC(tokStream, msgStream, msgProp); } else {
            throw new GSSExceptionImpl(GSSException.NO_CONTEXT, "No mechanism context yet!");
        }
    }
    ...
    public void requestMutualAuth(boolean state) throws GSSException {
        if (mechCtxt == null && initiator) { reqMutualAuthState = state; }
    }

    public void requestReplayDet(boolean state) throws GSSException {
        if (mechCtxt == null && initiator) { reqReplayDetState = state; }
    }

    public void requestSequenceDet(boolean state) throws GSSException {
        if (mechCtxt == null && initiator) { reqSequenceDetState = state; }
    }

    public void requestCredDeleg(boolean state) throws GSSException {
        if (mechCtxt == null && initiator) { reqCredDelegState = state; }
    }

    public void requestAnonymity(boolean state) throws GSSException {
        if (mechCtxt == null && initiator) { reqAnonState = state; }
    }

    public void requestConf(boolean state) throws GSSException {
        if (mechCtxt == null && initiator) { reqConfState = state; }
    }

    public void requestInteg(boolean state) throws GSSException {
        if (mechCtxt == null && initiator) { reqIntegState = state; }
    }

    public void requestLifetime(int lifetime) throws GSSException {
        if (mechCtxt == null && initiator) { reqLifetime = lifetime; }
    }

    public void setChannelBinding(ChannelBinding channelBindings) throws GSSException {

        if (mechCtxt == null) { this.channelBindings = channelBindings; }

    }

    public boolean getCredDelegState() {
        if (mechCtxt != null) { return mechCtxt.getCredDelegState(); } else { return reqCredDelegState; }
    }
    ...
    public boolean getReplayDetState() {
        if (mechCtxt != null) { return mechCtxt.getReplayDetState(); } else { return reqReplayDetState; }
    }

    public boolean getSequenceDetState() {
        if (mechCtxt != null) { return mechCtxt.getSequenceDetState(); } else { return reqSequenceDetState; }
    }

    public boolean getAnonymityState() {
        if (mechCtxt != null) { return mechCtxt.getAnonymityState(); } else { return reqAnonState; }
    }

    public boolean isTransferable() throws GSSException {
        if (mechCtxt != null) { return mechCtxt.isTransferable(); } else { return false; }
    }

    public boolean isProtReady() {
        if (mechCtxt != null) { return mechCtxt.isProtReady(); } else { return false; }
    }

    public boolean getConfState() {
        if (mechCtxt != null) { return mechCtxt.getConfState(); } else { return reqConfState; }
    }

    public boolean getIntegState() {
        if (mechCtxt != null) { return mechCtxt.getIntegState(); } else { return reqIntegState; }
    }

    public int getLifetime() {
        if (mechCtxt != null) { return mechCtxt.getLifetime(); } else { return reqLifetime; }
    }
    ...
    public GSSCredential getDelegCred() throws GSSException {
        ...
        if (mechCtxt == null) { throw new GSSExceptionImpl(GSSException.NO_CONTEXT, "No mechanism context yet!"); }
    ...
    public void requestDelegPolicy(boolean state) throws GSSException {
        if (mechCtxt == null && initiator) { reqDelegPolicyState = state; }
    }

    @Override
    public boolean getDelegPolicyState() {
        if (mechCtxt != null) { return mechCtxt.getDelegPolicyState(); } else { return reqDelegPolicyState; }
    }
}
