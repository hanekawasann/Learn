...
public class GSSNameElement implements GSSNameSpi {
    ...
    private static Oid getNativeNameType(Oid nameType, GSSLibStub stub) {
        if (GSSUtil.NT_GSS_KRB5_PRINCIPAL.equals(nameType)) {
            ...
            try {
                ...
                if (ge.getMajor() == GSSException.BAD_MECH && GSSUtil.isSpNegoMech(stub.getMech())) {
    ...
    public byte[] export() throws GSSException {
        ...
        int pos = 0;
        if ((nameVal[pos++] != 0x04) || (nameVal[pos++] != 0x01)) { throw new GSSException(GSSException.BAD_NAME); }
        ...
        pos += mechOidLen;
        int mechPortionLen = (((0xFF & nameVal[pos++]) << 24) | ((0xFF & nameVal[pos++]) << 16) |
            ((0xFF & nameVal[pos++]) << 8) | (0xFF & nameVal[pos++]));
