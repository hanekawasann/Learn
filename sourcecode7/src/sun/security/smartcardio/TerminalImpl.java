...
final class TerminalImpl extends CardTerminal {
            ...
            if (card.isValid()) {
                ...
                if (protocol.equals("*") || protocol.equalsIgnoreCase(cardProto)) {
                    ...
                    throw new CardException(
                        "Cannot connect using " + protocol + ", connection already established using " + cardProto);
                }
            } else {
                card = null;
            }
    ...
    public boolean isCardPresent() throws CardException {
        try {
            int[] status = SCardGetStatusChange(contextId, 0, new int[] { SCARD_STATE_UNAWARE }, new String[] { name });
