...
public class DistributionPoint {
    ...
    private static final String[] REASON_STRINGS = { null, "key compromise", "CA compromise", "affiliation changed",
        "superseded", "cessation of operation", "certificate hold", "privilege withdrawn", "AA compromise", };
    ...
    public DistributionPoint(DerValue val) throws IOException {
        ...
        while ((val.data != null) && (val.data.available() != 0)) {
            ...
            } else if (opt.isContextSpecific(TAG_REASONS) && !opt.isConstructed()) {
                if (reasonFlags != null) {
            ...
            } else if (opt.isContextSpecific(TAG_ISSUER) && opt.isConstructed()) {
                if (crlIssuer != null) {
    ...
    public boolean equals(Object obj) {
        ...
        boolean equal = equals(this.fullName, other.fullName) && equals(this.relativeName, other.relativeName) &&
            equals(this.crlIssuer, other.crlIssuer) && Arrays.equals(this.reasonFlags, other.reasonFlags);
        return equal;
    }
