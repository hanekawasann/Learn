...
public class GeneralSubtree {
    ...
    public GeneralSubtree(DerValue val) throws IOException {
        ...
        while (val.data.available() != 0) {
            ...
            } else { throw new IOException("Invalid encoding of GeneralSubtree."); }
        }
    }
    ...
    public boolean equals(Object other) {
        if (!(other instanceof GeneralSubtree)) { return false; }
        ...
        if (this.name == null) {
            ...
            if (!((this.name).equals(otherGS.name))) { return false; }
        }
        if (this.minimum != otherGS.minimum) { return false; }
        if (this.maximum != otherGS.maximum) { return false; }
        return true;
    }
