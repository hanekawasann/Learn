...
public class OIDName implements GeneralNameInterface {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof OIDName)) { return false; }
    ...
    public int constrains(GeneralNameInterface inputName) throws UnsupportedOperationException {
        int constraintType;
        if (inputName == null) { constraintType = NAME_DIFF_TYPE; } else if (inputName.getType() != NAME_OID) {
            constraintType = NAME_DIFF_TYPE;
        } else if (this.equals((OIDName) inputName)) { constraintType = NAME_MATCH; } else
