...
public class X509CRLEntryImpl extends X509CRLEntry {
    ...
    public byte[] getEncoded() throws CRLException {
        if (revokedCert == null) { this.encode(new DerOutputStream()); }
    ...
    private void parse(DerValue derVal) throws CRLException, IOException {
        ...
        if (derVal.data.available() == 0) { throw new CRLException("No data encoded for RevokedCertificates"); }
        ...
        } else { throw new CRLException("Invalid encoding for revocation date"); }
    ...
    public Map<String, java.security.cert.Extension> getExtensions() {
        ...
        HashMap<String, java.security.cert.Extension> map = new HashMap<String, java.security.cert.Extension>(
            exts.size());
