...
public class URIName implements GeneralNameInterface {
    ...
    public URIName(String name) throws IOException {
        try {
            ...
            throw (IOException) new IOException("invalid URI name:" + name).initCause(use);
        }
                ...
                try {
                    ...
                    try {
                        ...
                        throw new IOException(
                            "invalid URI name (host " + "portion is not a valid DNS name, IPv4 address," +
    ...
    public int constrains(GeneralNameInterface inputName) throws UnsupportedOperationException {
        ...
        if (inputName == null) {
            ...
            if (otherHost.equalsIgnoreCase(host)) {
                ...
                if ((hostDNS == null) || !(otherHostObject instanceof DNSName)) {
                    ...
                    if ((!thisDomain && !otherDomain) &&
                        ((constraintType == NAME_WIDENS) || (constraintType == NAME_NARROWS))) {
                        constraintType = NAME_SAME_TYPE;
                    }
                    ...
                    // not a domain.
                    if ((thisDomain != otherDomain) && (constraintType == NAME_MATCH)) {
                        if (thisDomain) {
