...
public class X509CertInfo implements CertAttrSet<String> {
    ...
    public X509CertInfo(byte[] cert) throws CertificateParsingException {
        try {
            ...
            CertificateParsingException parseException = new CertificateParsingException(e.toString());
     ...
     *
     * @throws CertificateEncodingException on encoding information errors.
     */
    ...
    public String toString() {
        ...
        if (subject == null || pubKey == null || interval == null || issuer == null || algId == null ||
            serialNum == null) {
     ...
     *
     * @throws CertificateException on invalid attributes.
     * @throws IOException          on other errors.
        ...
        switch (attr) {
            ...
            case (ATTR_EXTENSIONS):
                if (suffix == null) {
                    ...
                    if (extensions != null) { extensions.delete(suffix); }
                }
                break;
        }
    }
        ...
        switch (attr) { // frequently used attributes first
            ...
            case (ATTR_ISSUER_ID):
                if (suffix == null) {
                    ...
                    if (issuerUniqueId == null) { return null; } else { return (issuerUniqueId.get(suffix)); }
                }
            case (ATTR_SUBJECT_ID):
                if (suffix == null) {
                    return (subjectUniqueId);
                } else {
                    if (subjectUniqueId == null) { return null; } else { return (subjectUniqueId.get(suffix)); }
                }
        }
        return null;
    }
    ...
    private void parse(DerValue val) throws CertificateParsingException, IOException {
        ...
        if ((version.compare(CertificateVersion.V1) == 0) && subjectDN.isEmpty()) {
     ...
     */
    private void verifyCert(CertificateSubjectName subject, CertificateExtensions extensions)
        ...
        if (subjectDN.isEmpty()) {
            ...
            try {
                subjectAltNameExt = (SubjectAlternativeNameExtension) extensions
                ...
                throw new CertificateParsingException(
                    "X.509 Certificate is " + "incomplete: subject field is empty, and " +
            ...
            if (names == null || names.isEmpty()) {
                ...
                throw new CertificateParsingException(
                    "X.509 Certificate is " + "incomplete: SubjectAlternativeName extension MUST " +
     ...
     *
     * @throws CertificateException on invalid data.
