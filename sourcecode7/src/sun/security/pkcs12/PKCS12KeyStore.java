...
public final class PKCS12KeyStore extends KeyStoreSpi {
    ...
    public synchronized void engineSetKeyEntry(String alias, byte[] key, Certificate[] chain) throws KeyStoreException {
        ...
        try {
            ...
            KeyStoreException ke = new KeyStoreException(
                "Private key is not" + " stored as PKCS#8 EncryptedPrivateKeyInfo: " + ioe);
            ke.initCause(ioe);
            throw ke;
        }
        ...
        for (Enumeration<String> e = entries.keys(); e.hasMoreElements(); ) {
            ...
            for (int i = 0; i < chainLen; i++) {
                ...
                if (i == 0) {
                    ...
                    bagAttrs = getBagAttributes(cert.getSubjectX500Principal().getName(), null);
                }
                if (bagAttrs != null) {
