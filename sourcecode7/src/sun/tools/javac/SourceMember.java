...
public class SourceMember extends MemberDefinition implements Constants {
     ...
     */
    public SourceMember(long where, ClassDefinition clazz, String doc, int modifiers, Type type, Identifier name,
        Vector argNames, IdentifierToken exp[], Node value) {
    ...
    public SourceMember(MemberDefinition f, ClassDefinition c, Environment env) {
        this(f.getWhere(), c, f.getDocumentation(), f.getModifiers() | M_ABSTRACT, f.getType(), f.getName(), null,
    ...
    public ClassDeclaration getDefiningClassDeclaration() {
        if (abstractSource == null) { return super.getDefiningClassDeclaration(); } else {
