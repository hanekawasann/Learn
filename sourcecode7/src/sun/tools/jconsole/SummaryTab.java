...
class SummaryTab extends Tab {
    ...
    public SummaryTab(VMPanel vmPanel) {
        ...
        headerDateTimeFormat = getDateTimeFormat("SummaryTab.headerDateTimeFormat");
    }
        ...
        try {
            ...
            {  // Memory
                ...
                append("SummaryTab.pendingFinalization.label",
                    getText("SummaryTab.pendingFinalization.value", memoryBean.getObjectPendingFinalizationCount()));
                append(endTable);
                ...
                for (GarbageCollectorMXBean garbageCollectorMBean : garbageCollectors) {
                    ...
                    append("Garbage collector",
                        getText("GcInfo", gcName, gcCount, (gcTime >= 0) ? formatTime(gcTime) : getText("Unavailable")),
                        4);
                }
                append(endTable);
            }
            ...
            {  // VM arguments and paths
                ...
                append("Boot class path",
                    rmBean.isBootClassPathSupported() ? rmBean.getBootClassPath() : getText("Unavailable"), 4);
                append(endTable);
            }
        } catch (IOException e) {
            if (JConsole.isDebug()) {
