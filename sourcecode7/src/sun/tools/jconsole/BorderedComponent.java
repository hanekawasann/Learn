    ...
    public BorderedComponent(String text, JComponent comp, boolean collapsible) {
        ...
        if (text != null) {
            ...
            if (collapsible) {
                ...
                String toolTip = getText("BorderedComponent.moreOrLessButton.toolTip");
    ...
    public void actionPerformed(ActionEvent ev) {
        if (collapsed) {
            ...
            if (valueLabelStr != null) {
                if (label == null) {
                    label = new JLabel(Resources.getText("Current value", valueLabelStr));
                }
                add(label);
            }
    ...
    public void doLayout() {
        ...
        if (collapsed) {
            if (label != null) {
                ...
                label.setBounds(i.left, i.top + (d.height - i.top - i.bottom - p.height) / 2, p.width, p.height);
            }
        } else {
            if (comp != null) {
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
            ...
            switch (justification) {
                case LEFT:
                    ...
                    break;
                case RIGHT:
                    compLoc.x = (grooveRect.x + grooveRect.width - (labelDim.width + TEXT_INSET_H + insets.right));
                    break;
            }
            ...
            if (border != null) {
                if (grooveRect.y > compLoc.y - ascent) {
                    ...
                    clipRect.setBounds(saveClip);
                    if (computeIntersection(clipRect, compLoc.x - 1, compLoc.y + ascent + descent, labelDim.width + 2,
