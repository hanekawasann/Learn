...
public class CreateMBeanDialog extends InternalDialog implements ActionListener {
    ...
    public CreateMBeanDialog(JConsole jConsole) {
        ...
        setAccessibleDescription(this, getText("Hotspot MBeans.dialog.accessibleDescription"));
        ...
        centerPanel.add(new LabeledComponent(Resources.
            getText("Manage Hotspot MBeans " + "in: "), connections));
        ...
        buttonPanel.add(createMBeanButton = new JButton(Resources.getText("Create")));
        buttonPanel.add(unregisterMBeanButton = new JButton(Resources.getText("Unregister")));
        buttonPanel.add(cancelButton = new JButton(Resources.getText("Cancel")));
                ...
                public void run() {
                    try {
                        ...
                        statusBar.setText(Resources.
                            getText("Error: MBeans already " + "exist"));
                    } catch (InstanceNotFoundException e) {
                        statusBar.setText(Resources.
                            getText("Error: MBeans do not " + "exist"));
                    } catch (Exception e) {
