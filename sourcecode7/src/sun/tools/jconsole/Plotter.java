...
public class Plotter extends JComponent implements Accessible, ActionListener, PropertyChangeListener {
    ...
    static final String[] rangeNames = { Resources.getText(" 1 min"), Resources.getText(" 5 min"),
        Resources.getText("10 min"), Resources.getText("30 min"), Resources.getText(" 1 hour"),
        Resources.getText(" 2 hours"), Resources.getText(" 3 hours"), Resources.getText(" 6 hours"),
        Resources.getText("12 hours"), Resources.getText(" 1 day"), Resources.getText(" 7 days"),
        Resources.getText(" 1 month"), Resources.getText(" 3 months"), Resources.getText(" 6 months"),
        Resources.getText(" 1 year"), Resources.getText("All") };

    static final int[] rangeValues = { 1, 5, 10, 30, 1 * 60, 2 * 60, 3 * 60, 6 * 60, 12 * 60, 1 * 24 * 60, 7 * 24 * 60,
        1 * 31 * 24 * 60, 3 * 31 * 24 * 60, 6 * 31 * 24 * 60, 366 * 24 * 60, -1 };
    ...
    private void saveDataToFile(File file) {
        try {
            ...
            out.close();
            JOptionPane
                .showMessageDialog(this, getText("FileChooser.savedFile", file.getAbsolutePath(), file.length()));
            ...
            JOptionPane.showMessageDialog(this, getText("FileChooser.saveFailed.message", path, msg),
                getText("FileChooser.saveFailed.title"), JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        if (border == null) {
            ...
            // over and over.
            border = new BevelBorder(BevelBorder.LOWERED, getBackground().brighter().brighter(),
                getBackground().brighter(), getBackground().darker().darker(), getBackground().darker());
        }
    ...
    private static synchronized Stroke getDashedStroke() {
        if (dashedStroke == null) {
            dashedStroke = new BasicStroke(1.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f,
        ...
        public void approveSelection() {
            ...
            if (file != null) {
                ...
                if (file.exists()) {
                    ...
                    int ret = JOptionPane
                        .showOptionDialog(this, getText("FileChooser.fileExists.message", file.getName()),
                            getText("FileChooser.fileExists.title"), JOptionPane.OK_CANCEL_OPTION,
                    ...
                    if (seq.isPlotted) {
                        ...
                        if (seq.size > 0) {
                            if (unit == Unit.BYTES) {
                                ...
                                value = getFormattedValue(seq.value(seq.size - 1), false) +
                                    ((unit == Unit.PERCENT) ? "%" : "");
                            }
                        }
