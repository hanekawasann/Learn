...
public class XOpenTypeViewer extends JPanel implements ActionListener {
    ...
    private static final String compositeNavigationSingle = Resources.getText("MBeansTab.compositeNavigationSingle");
    private static final String tabularNavigationSingle = Resources.getText("MBeansTab.tabularNavigationSingle");
    ...
    class XOpenTypeDataListener extends MouseAdapter {
        ...
        private XOpenTypeData getSelectedViewedOpenType() {
            ...
            if (elem instanceof XOpenTypeData) { return (XOpenTypeData) elem; } else { return null; }
        }
    }
    ...
    static abstract class XOpenTypeData extends JTable {
            ...
            if (col == 1) {
                ...
                if (value != null) {
                    if (isClickableElement(value)) {
                        return Resources.getText("Double click to visualize") + ". " + value.toString();
        ...
        protected void updateColumnWidth() {
            if (!init) {
                ...
                if (col2Width == -1) {
                    ...
                    if (col1Width < getPreferredScrollableViewportSize().getWidth()) {
                        col1Width = (int) getPreferredScrollableViewportSize().getWidth();
                    }
                ...
                if (col1Width + col2Width < getPreferredScrollableViewportSize().getWidth()) {
        ...
        protected void emptyTable() {
            invalidate();
            while (getModel().getRowCount() > 0) { ((DefaultTableModel) getModel()).removeRow(0); }
            validate();
        }
    ...
    static class XTabularData extends XCompositeData implements XViewedTabularData {
        ...
        public XTabularData(XOpenTypeData parent, TabularData tabular) {
            ...
            if (size > 0) {
                ...
                List<CompositeData> data = new ArrayList<CompositeData>((Collection<CompositeData>) tabular.values());
        ...
        public void renderKey(String key, Component comp) {
            ...
            for (Object k : type.getIndexNames()) {
                if (key.equals(k)) { comp.setFont(italicFont); }
            }
        }
        ...
        public boolean canDecrement() {
            if (currentIndex == 0) { return false; } else { return true; }
        }

        public boolean canIncrement() {
            if (size == 0 || currentIndex == size - 1) { return false; } else { return true; }
        }
    ...
    static class XCompositeData extends XOpenTypeData {
        protected final String[] columnNames = { Resources.getText("Name"), Resources.getText("Value") };
        ...
        public String toString() {
            return composite == null ? "" : composite.getCompositeType().getTypeName();
        }
    ...
    static class XArrayData extends XCompositeData implements XViewedArrayData {
        ...
        public void viewed(XOpenTypeViewer viewer) throws Exception {
            if (size == 0) { throw new Exception(Resources.getText("Empty array")); }
            if (dimension > 1) {
                throw new Exception(Resources.getText("Dimension is not " + "supported:") + dimension);
            }
            super.viewed(viewer);
        }
        ...
        private void load() {
            ...
            for (int i = 0; i < size; i++) {
                rowData[0] = isTabularType ? new XTabularData(this, (TabularData) Array.get(val, i))
                    : Array.get(val, i);
        ...
        public String toString() {
            if (dimension > 1) {
                return Resources.getText("Dimension is not supported:") + dimension;
            } else {
    ...
    public static Component loadOpenType(Object value) {
        ...
        if (isViewableValue(value)) {
            XOpenTypeViewer open = new XOpenTypeViewer(value);
            comp = open;
        }
        return comp;
    }
    ...
    void setOpenType(XOpenTypeData data) {
        ...
        if (!(data instanceof XViewedTabularData)) {
            ...
            boolean hasMoreThanOneElement = tabular.canIncrement() || tabular.canDecrement();
            if (hasMoreThanOneElement) {
                tabularLabel.setText(Resources.getText("MBeansTab.tabularNavigationMultiple",
        ...
        if (!(data instanceof XViewedArrayData)) {
            ...
            boolean hasMoreThanOneElement = array.canIncrement() || array.canDecrement();
            if (hasMoreThanOneElement) {
                compositeLabel.setText(Resources.getText("MBeansTab.compositeNavigationMultiple",
    ...
    private void setupDisplay(XOpenTypeData data) {
        ...
        container = new JScrollPane(data, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
        ...
        Dimension d = new Dimension((int) container.getPreferredSize().
            getWidth() + 20, (int) container.getPreferredSize().
            getHeight() + 20);
        setPreferredSize(d);
    }
}
