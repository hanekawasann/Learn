...
public abstract class XOperations extends JPanel implements ActionListener {
    ...
    public final static String OPERATION_INVOCATION_EVENT = "jam.xoperations.invoke.result";
    ...
    public void loadOperations(XMBean mbean, MBeanInfo mbeanInfo) {
        ...
        for (int i = 0; i < operations.length; i++) {
            ...
            if (returnType == null) {
                ...
                if (JConsole.isDebug()) {
                    System.err.println(
                        "WARNING: The operation's return type " + "shouldn't be \"null\". Check how the " +
            ...
            if (methodLabel.getText().length() > 20) {
                methodLabel.setText(methodLabel.getText().
                    substring(methodLabel.getText().
                        lastIndexOf(".") + 1, methodLabel.getText().length()));
            }
            ...
            protected void done() {
                try {
                    ...
                    if (entryIf.getReturnType() != null && !entryIf.getReturnType().equals(Void.TYPE.getName()) &&
                        ...
                        new ThreadDialog(button, Resources.getText("Method successfully invoked"),
                            Resources.getText("Info"), JOptionPane.INFORMATION_MESSAGE).run();
                    }
                } catch (Throwable t) {
                    ...
                    new ThreadDialog(button,
                        Resources.getText("Problem invoking") + " " + button.getText() + " : " + t.toString(),
                        Resources.getText("Error"), JOptionPane.ERROR_MESSAGE).run();
                }
            }
        }.execute();
    }
