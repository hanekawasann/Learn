...
class ThreadTab extends Tab implements ActionListener, DocumentListener, ListSelectionListener {
    ...
    */
    ...
    public ThreadTab(VMPanel vmPanel) {
        ...
        threadMeter = new PlotterPanel(Resources.getText("Number of Threads"), Plotter.Unit.NONE, true);
        ...
        setAccessibleName(threadMeter.plotter, getText("ThreadTab.threadPlotter.accessibleName"));

        plotterPanel.add(threadMeter);

        timeComboBox = new TimeComboBox(threadMeter.plotter);
        controlPanel
            .add(new LabeledComponent(Resources.getText("Time Range:"), getMnemonicInt("Time Range:"), timeComboBox));
        ...
        setAccessibleName(textArea, getText("ThreadTab.threadInfo.accessibleName"));
                    ...
                    try {
                        ...
                        if (ti != null) {
                            if (ti.getLockName() == null) {
                                sb.append(Resources
                                    .getText("Name State", ti.getThreadName(), ti.getThreadState().toString()));
                            } else if (ti.getLockOwnerName() == null) {
                                sb.append(Resources
                                    .getText("Name State LockName", ti.getThreadName(), ti.getThreadState().toString(),
                                        ti.getLockName()));
                            } else {
                                sb.append(Resources.getText("Name State LockName LockOwner", ti.getThreadName(),
                                    ti.getThreadState().toString(), ti.getLockName(), ti.getLockOwnerName()));
                            }
                            sb.append(Resources
                                .getText("BlockedCount WaitedCount", ti.getBlockedCount(), ti.getWaitedCount()));
