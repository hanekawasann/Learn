...
public class AboutDialog extends InternalDialog {
    ...
    private Icon mastheadIcon = new MastheadIcon(getText("Help.AboutDialog.masthead.title"));
    ...
    public AboutDialog(JConsole jConsole) {
        ...
        JEditorPane helpLink = new JEditorPane("text/html",
            "<html><font color=#" + colorStr + ">" + getText("Help.AboutDialog.jConsoleVersion", jConsoleVersion) +
                "<p>" + getText("Help.AboutDialog.javaVersion", (vmName + ", " + vmVersion)) + "<p>" +
                getText("Help.AboutDialog.userGuideLink", urlStr) + "</html>");
