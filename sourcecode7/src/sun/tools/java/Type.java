...
public class Type implements Constants {
    ...
    public boolean isVoidArray() {
        ...
        Type type = this;
        while (type.isType(TC_ARRAY)) { type = type.getElementType(); }
    ...
    public static Identifier mangleInnerType(Identifier className) {
        ...
        Identifier mname = Identifier.lookup(className.getFlatName().toString().
     ...
     *
     * @throws CompilerError invalid type signature.
     */
