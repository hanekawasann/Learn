...
public class IdentifierExpression extends Expression {
    ...
    public Vset checkValue(Environment env, Context ctx, Vset vset, Hashtable exp) {
        ...
        if (bind(env, ctx)) {
            ...
            if (implementation != null) { vset = implementation.checkValue(env, ctx, vset, exp); }
        }
        return vset;
    }
    ...
    public FieldUpdater getAssigner(Environment env, Context ctx) {
        if (implementation != null) { return implementation.getAssigner(env, ctx); }
        return null;
    }
    ...
    public FieldUpdater getUpdater(Environment env, Context ctx) {
        if (implementation != null) { return implementation.getUpdater(env, ctx); }
        return null;
    }
    ...
    *-------------------------------------------------------*/
    ...
    void codeLoad(Environment env, Context ctx, Assembler asm) {
        asm.add(where, opc_iload + type.getTypeCodeOffset(), new Integer(((LocalMember) field).number));
    }
