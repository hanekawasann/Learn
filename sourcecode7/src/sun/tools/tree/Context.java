...
public class Context implements Constants {
    ...
    private MemberDefinition getFieldCommon(Environment env, Identifier name, boolean apparentOnly)
    ...
    private MemberDefinition getClassCommon(Environment env, Identifier name, boolean apparentOnly)
    ...
    public Expression findOuterLink(Environment env, long where, MemberDefinition f) {
        ...
        ClassDefinition reqc = f.isStatic() ? null
            : !f.isConstructor() ? fc : fc.isTopLevel() ? null : fc.getOuterClass();
        if (reqc == null) {
            return null;
        }
    ...
    public Expression findOuterLink(Environment env, long where, ClassDefinition reqc, MemberDefinition f,
