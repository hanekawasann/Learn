...
public final class UCharacter {
     ...
     * @throws IllegalArgumentException thrown when argument characters do
    ...
    private static final int getProperty(int ch) {
        ...
        if (ch <= UTF16.LEAD_SURROGATE_MAX_VALUE) {
            ...
            return PROPERTY_TRIE_DATA_[(PROPERTY_TRIE_INDEX_[(0x2800 >> 5) + (ch >> 5)] << 2) + (ch & 0x1f)];
        }
        // for optimization
        if (ch <= UTF16.CODEPOINT_MAX_VALUE) {
            ...
            return PROPERTY_.m_trie_.getSurrogateValue(UTF16.getLeadSurrogate(ch), (char) (ch & 0x3ff));
        }
