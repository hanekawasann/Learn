...
public final class UTF16 {
     ...
     * <code>bounds32()</code>.
     * @throws IndexOutOfBoundsException thrown if offset16 is out of
     *                                   bounds.
     * @stable ICU 2.1
     */
     ...
     * offset16. The boundaries of that codepoint are the same as in
     * <code>bounds32()</code>.
     * @throws IndexOutOfBoundsException thrown if offset16 is not within
    ...
    public static int charAt(char source[], int start, int limit, int offset16) {
        ...
        if (single <= LEAD_SURROGATE_MAX_VALUE) {
            ...
            if (isLeadSurrogate(lead)) { return UCharacterProperty.getRawSupplementary(lead, single); }
        }
        return single; // return unmatched surrogate
    }
     ...
     * @throws IllegalArgumentException thrown if char32 is a invalid
     *                                  codepoint.
     * @stable ICU 2.1
     */
     ...
     * @throws IllegalArgumentException thrown when char32 does not lie
     ...
     * @throws IndexOutOfBoundsException if the new offset16 is out of
