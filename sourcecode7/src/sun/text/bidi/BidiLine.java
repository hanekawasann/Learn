...
public final class BidiLine {
    ...
    static void setTrailingWSStart(BidiBase bidiBase) {
        ...
        */
        ...
        while (start > 0 && (BidiBase.DirPropFlagNC(dirProps[start - 1]) & BidiBase.MASK_WS) != 0) {
            --start;
        }
    ...
    public static Bidi setLine(Bidi bidi, BidiBase paraBidi, Bidi newBidi, BidiBase newBidiBase, int start, int limit) {
        int length;
