...
public final class TimeZoneNames_zh_TW extends TimeZoneNamesBundle {
    ...
    protected final Object[][] getContents() {
        ...
        String BRT[] = new String[] { "\u5df4\u897f\u5229\u4e9e\u6642\u9593", "BRT",
            "\u5df4\u897f\u5229\u4e9e\u590f\u4ee4\u6642\u9593", "BRST" };
        String BTT[] = new String[] { "\u4e0d\u4e39\u6642\u9593", "BTT", "\u4e0d\u4e39\u590f\u4ee4\u6642\u9593",
            "BTST" };
        String CAT[] = new String[] { "\u4e2d\u975e\u6642\u9593", "CAT", "\u4e2d\u975e\u590f\u4ee4\u6642\u9593",
            "CAST" };
        String CET[] = new String[] { "\u4e2d\u6b50\u6642\u9593", "CET", "\u4e2d\u6b50\u590f\u4ee4\u6642\u9593",
            "CEST" };
        ...
        String CIT[] = new String[] { "\u4e2d\u5370\u5ea6\u5c3c\u897f\u4e9e\u6642\u9593", "CIT",
            "\u4e2d\u5370\u5ea6\u5c3c\u897f\u4e9e\u590f\u4ee4\u6642\u9593", "CIST" };
        String CLT[] = new String[] { "\u667a\u5229\u6642\u9593", "CLT", "\u667a\u5229\u590f\u4ee4\u6642\u9593",
            "CLST" };
        ...
        String DUBLIN[] = new String[] { "\u683c\u6797\u5a01\u6cbb\u5e73\u5747\u6642\u9593", "GMT",
            "\u611b\u723e\u862d\u590f\u4ee4\u6642\u9593", "IST" };
        String EAT[] = new String[] { "\u6771\u975e\u6642\u9593", "EAT", "\u6771\u975e\u590f\u4ee4\u6642\u9593",
            "EAST" };
        String EASTER[] = new String[] { "\u5fa9\u6d3b\u5cf6\u6642\u9593", "EAST",
            "\u5fa9\u6d3b\u5cf6\u590f\u4ee4\u6642\u9593", "EASST" };
        String EET[] = new String[] { "\u6771\u6b50\u6642\u9593", "EET", "\u6771\u6b50\u590f\u4ee4\u6642\u9593",
            "EEST" };
        String EGT[] = new String[] { "\u6771\u683c\u6797\u5cf6\u6642\u9593", "EGT",
            "\u6771\u683c\u6797\u5cf6\u590f\u4ee4\u6642\u9593", "EGST" };
        String EST[] = new String[] { "\u6771\u65b9\u6a19\u6e96\u6642\u9593", "EST",
            "\u6771\u65b9\u65e5\u5149\u7bc0\u7d04\u6642\u9593", "EDT" };
        String EST_NSW[] = new String[] { "\u6771\u65b9\u6a19\u6e96\u6642\u9593 (\u65b0\u5357\u5a01\u723e\u65af)",
            "EST", "\u6771\u65b9\u590f\u4ee4\u6642\u9593 (\u65b0\u5357\u5a01\u723e\u65af)", "EST" };
        ...
        String HKT[] = new String[] { "\u9999\u6e2f\u6642\u9593", "HKT", "\u9999\u6e2f\u590f\u4ee4\u6642\u9593",
            "HKST" };
        ...
        String WART[] = new String[] { "\u897f\u963f\u6839\u5ef7\u6642\u9593", "WART",
            "\u897f\u963f\u6839\u5ef7\u590f\u4ee4\u6642\u9593", "WARST" };
        String WAT[] = new String[] { "\u897f\u975e\u6642\u9593", "WAT", "\u897f\u975e\u590f\u4ee4\u6642\u9593",
            "WAST" };
        String WET[] = new String[] { "\u897f\u6b50\u6642\u9593", "WET", "\u897f\u6b50\u590f\u4ee4\u6642\u9593",
            "WEST" };
        ...
        return new Object[][] { { "America/Los_Angeles", PST }, { "PST", PST }, { "America/Denver", MST },
            ...
            { "America/Bogota", new String[] { "\u54e5\u502b\u6bd4\u4e9e\u6642\u9593", "COT",
                "\u54e5\u502b\u6bd4\u4e9e\u590f\u4ee4\u6642\u9593", "COST" } }, { "America/Boise", MST },
            ...
            new String[] { "\u59d4\u5167\u745e\u62c9\u6642\u9593", "VET",
                "\u59d4\u5167\u745e\u62c9\u590f\u4ee4\u6642\u9593", "VEST" } }, { "America/Catamarca", AGT },
            { "America/Cayenne", new String[] { "\u6cd5\u5c6c\u572d\u4e9e\u90a3\u6642\u9593", "GFT",
                "\u6cd5\u5c6c\u572d\u4e9e\u90a3\u590f\u4ee4\u6642\u9593", "GFST" } }, { "America/Cayman", EST },
            ...
            { "America/Godthab", new String[] { "\u897f\u683c\u6797\u862d\u5cf6\u6642\u9593", "WGT",
                "\u897f\u683c\u6797\u862d\u5cf6\u590f\u4ee4\u6642\u9593", "WGST" } }, { "America/Goose_Bay", AST },
            ...
            new String[] { "\u70cf\u62c9\u572d\u6642\u9593", "UYT", "\u70cf\u62c9\u572d\u590f\u4ee4\u6642\u9593",
                "UYST" } }, { "America/Monterrey", CST }, { "America/Montreal", EST }, { "America/Montserrat", AST },
            ...
            new String[] { "\u5915\u6b50\u74e6 (Syowa) \u6642\u9593", "SYOT",
                "\u5915\u6b50\u74e6 (Syowa) \u590f\u4ee4\u6642\u9593", "SYOST" } }, { "Antarctica/Vostok",
            new String[] { "\u4f5b\u65af\u6258 (Vostok) \u6642\u9593", "VOST",
                "\u4f5b\u65af\u6258 (Vostok) \u590f\u4ee4\u6642\u9593", "VOSST" } }, { "Arctic/Longyearbyen", CET },
            { "Asia/Aden", ARAST }, { "Asia/Almaty",
            new String[] { "Alma-Ata \u6642\u9593", "ALMT", "Alma-Ata \u590f\u4ee4\u6642\u9593", "ALMST" } },
            { "Asia/Amman", EET }, { "Asia/Anadyr", new String[] { "\u963f\u90a3\u5e95\u6cb3\u6642\u9593", "ANAT",
            "\u963f\u90a3\u5e95\u6cb3\u590f\u4ee4\u6642\u9593", "ANAST" } },
            { "Asia/Aqtau", new String[] { "Aqtau \u6642\u9593", "AQTT", "Aqtau \u590f\u4ee4\u6642\u9593", "AQTST" } },
            { "Asia/Aqtobe",
            ...
            { "Asia/Baku", new String[] { "\u4e9e\u585e\u62dc\u7136\u6642\u9593", "AZT",
                "\u4e9e\u585e\u62dc\u7136\u590f\u4ee4\u6642\u9593", "AZST" } }, { "Asia/Bangkok", ICT },
            ...
            new String[] { "\u5de7\u5df4\u5c71 (Choibalsan) \u6642\u9593", "CHOT",
                "\u5de7\u5df4\u5c71 (Choibalsan) \u590f\u4ee4\u6642\u9593", "CHOST" } }, { "Asia/Chongqing", CTT },
            ...
            new String[] { "\u5854\u5409\u514b\u6642\u9593", "TJT", "\u5854\u5409\u514b\u590f\u4ee4\u6642\u9593",
                "TJST" } }, { "Asia/Gaza", EET }, { "Asia/Harbin", CTT }, { "Asia/Ho_Chi_Minh", ICT },
            { "Asia/Hong_Kong", HKT }, { "Asia/Hovd",
            ...
            new String[] { "\u6771\u5370\u5ea6\u5c3c\u897f\u4e9e\u6642\u9593", "EIT",
                "\u6771\u5370\u5ea6\u5c3c\u897f\u4e9e\u590f\u65e5\u6642\u9593", "EIST" } }, { "Asia/Kabul",
            new String[] { "\u963f\u5bcc\u6c57\u6642\u9593", "AFT", "\u963f\u5bcc\u6c57\u590f\u4ee4\u6642\u9593",
                "AFST" } }, { "Asia/Kamchatka", new String[] { "Petropavlovsk-Kamchatski \u6642\u9593", "PETT",
            "Petropavlovsk-Kamchatski \u590f\u4ee4\u6642\u9593", "PETST" } }, { "Asia/Karachi", PKT },
            ...
            { "Asia/Omsk", new String[] { "\u6b50\u59c6\u65af\u514b (Omsk) \u6642\u9593", "OMST",
                "\u6b50\u59c6\u65af\u514b (Omsk) \u590f\u4ee4\u6642\u9593", "OMSST" } }, { "Asia/Phnom_Penh", ICT },
            ...
            { "Asia/Taipei",
                new String[] { "\u53f0\u7063\u6a19\u6e96\u6642\u9593", "TST", "\u53f0\u7063\u590f\u4ee4\u6642\u9593",
                    "TDT" } }, { "Asia/Tel_Aviv", ISRAEL }, { "Asia/Tashkent", UZT }, { "Asia/Tbilisi",
            ...
            new String[] { "\u798f\u514b\u862d\u7fa4\u5cf6\u6642\u9593", "FKT",
                "\u798f\u514b\u862d\u7fa4\u5cf6\u590f\u4ee4\u6642\u9593", "FKST" } }, { "Australia/ACT", EST_NSW },
            ...
            new String[] { "\u4f0f\u723e\u52a0\u683c\u52d2\u6642\u9593", "VOLT",
                "\u4f0f\u723e\u52a0\u683c\u52d2\u590f\u4ee4\u6642\u9593", "VOLST" } }, { "Europe/Warsaw", CET },
            ...
            new String[] { "\u5370\u5ea6\u6d0b\u5730\u5340\u6642\u9593", "IOT",
                "\u5370\u5ea6\u6d0b\u5730\u5340\u590f\u4ee4\u6642\u9593", "IOST" } }, { "Indian/Christmas",
            new String[] { "\u8056\u8a95\u5cf6\u6642\u9593", "CXT", "\u8056\u8a95\u5cf6\u590f\u4ee4\u6642\u9593",
                "CXST" } }, { "Indian/Cocos", new String[] { "\u53ef\u53ef\u65af\u7fa4\u5cf6\u6642\u9593", "CCT",
            "\u53ef\u53ef\u65af\u7fa4\u5cf6\u590f\u4ee4\u6642\u9593", "CCST" } }, { "Indian/Comoro", EAT },
            { "Indian/Kerguelen",
                new String[] { "\u6cd5\u570b\u5357\u534a\u7403\u53ca\u5357\u6975\u5c6c\u5730\u6642\u9593", "TFT",
                    "\u6cd5\u570b\u5357\u534a\u7403\u53ca\u5357\u6975\u5c6c\u5730\u590f\u4ee4\u6642\u9593", "TFST" } },
            { "Indian/Mahe", new String[] { "\u585e\u5e2d\u723e\u7fa4\u5cf6\u6642\u9593", "SCT",
                "\u585e\u5e2d\u723e\u7fa4\u5cf6\u590f\u4ee4\u6642\u9593", "SCST" } }, { "Indian/Maldives",
            new String[] { "\u99ac\u723e\u5730\u592b\u6642\u9593", "MVT",
                "\u99ac\u723e\u5730\u592b\u590f\u4ee4\u6642\u9593", "MVST" } }, { "Indian/Mauritius",
            new String[] { "\u6469\u91cc\u897f\u65af\u6642\u9593", "MUT",
                "\u6469\u91cc\u897f\u65af\u590f\u4ee4\u6642\u9593", "MUST" } }, { "Indian/Mayotte", EAT },
            { "Indian/Reunion", new String[] { "\u7559\u5c3c\u65fa\u5cf6\u6642\u9593", "RET",
                "\u7559\u5c3c\u65fa\u5cf6\u590f\u4ee4\u6642\u9593", "REST" } }, { "Israel", ISRAEL },
            { "Jamaica", EST }, { "Japan", JST }, { "Kwajalein", MHT }, { "Libya", EET }, { "MET",
            new String[] { "\u4e2d\u6b50\u6642\u9593", "MET", "\u4e2d\u6b50\u590f\u4ee4\u6642\u9593", "MEST" } },
            ...
            new String[] { "\u74e6\u5974\u963f\u5716\u6642\u9593", "VUT",
                "\u74e6\u5974\u963f\u5716\u590f\u4ee4\u6642\u9593", "VUST" } }, { "Pacific/Enderbury",
            new String[] { "\u83f2\u5c3c\u514b\u65af\u7fa4\u5cf6\u6642\u9593", "PHOT",
                "\u83f2\u5c3c\u514b\u65af\u7fa4\u5cf6\u590f\u4ee4\u6642\u9593", "PHOST" } }, { "Pacific/Fakaofo",
            new String[] { "\u6258\u514b\u52de\u7fa4\u5cf6\u6642\u9593", "TKT",
                "\u6258\u514b\u52de\u7fa4\u5cf6\u590f\u4ee4\u6642\u9593", "TKST" } }, { "Pacific/Fiji",
            new String[] { "\u6590\u6fdf\u6642\u9593", "FJT", "\u6590\u6fdf\u590f\u4ee4\u6642\u9593", "FJST" } },
            { "Pacific/Funafuti",
                new String[] { "\u5410\u9b6f\u74e6\u6642\u9593", "TVT", "\u5410\u9b6f\u74e6\u590f\u4ee4\u6642\u9593",
                    "TVST" } }, { "Pacific/Galapagos", new String[] { "\u52a0\u62c9\u5df4\u54e5\u6642\u9593", "GALT",
            "\u52a0\u62c9\u5df4\u54e5\u590f\u4ee4\u6642\u9593", "GALST" } }, { "Pacific/Gambier", GAMBIER },
            ...
            new String[] { "\u99ac\u514b\u85a9\u65af\u6642\u9593", "MART",
                "\u99ac\u514b\u85a9\u65af\u590f\u4ee4\u6642\u9593", "MARST" } }, { "Pacific/Midway", SAMOA },
            { "Pacific/Nauru",
            ...
            { "Pacific/Port_Moresby", new String[] { "\u5df4\u5e03\u4e9e\u65b0\u5e7e\u5167\u4e9e\u6642\u9593", "PGT",
                "\u5df4\u5e03\u4e9e\u65b0\u5e7e\u5167\u4e9e\u590f\u4ee4\u6642\u9593", "PGST" } }, { "Pacific/Rarotonga",
            new String[] { "\u5eab\u514b\u7fa4\u5cf6\u6642\u9593", "CKT",
                "\u5eab\u514b\u7fa4\u5cf6\u590f\u4ee4\u6642\u9593", "CKHST" } }, { "Pacific/Saipan", ChST },
            { "Pacific/Samoa", SAMOA }, { "Pacific/Tahiti",
            new String[] { "\u5927\u6eaa\u5730\u5cf6\u6642\u9593", "TAHT",
                "\u5927\u6eaa\u5730\u5cf6\u590f\u4ee4\u6642\u9593", "TAHST" } }, { "Pacific/Tarawa",
            new String[] { "\u5409\u4f2f\u7279\u7fa4\u5cf6\u6642\u9593", "GILT",
                "\u5409\u4f2f\u7279\u7fa4\u5cf6\u590f\u4ee4\u6642\u9593", "GILST" } }, { "Pacific/Tongatapu",
