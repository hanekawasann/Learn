...
public final class TimeZoneNames_es extends TimeZoneNamesBundle {
    ...
    protected final Object[][] getContents() {
        String ACT[] = new String[] { "Hora de Acre", "ACT", "Hora de verano de Acre", "ACST" };
        ...
        String ARMT[] = new String[] { "Hora de Armenia", "AMT", "Hora de verano de Armenia", "AMST" };
        ...
        String BRT[] = new String[] { "Hora de Brasil", "BRT", "Hora de verano de Brasil", "BRST" };
        ...
        String CHAST[] = new String[] { "Hora est\u00e1ndar de Chatham", "CHAST", "Hora de verano de Chatham",
            "CHADT" };
        String CHUT[] = new String[] { "Chuuk Time", "CHUT", "Chuuk Summer Time", "CHUST" };
        String CIT[] = new String[] { "Hora de Indonesia Central", "CIT", "Hora de verano de Indonesia Central",
            "CIST" };
        String CLT[] = new String[] { "Hora de Chile", "CLT", "Hora de verano de Chile", "CLST" };
        ...
        String IRT[] = new String[] { "Hora est\u00e1ndar de Ir\u00e1n", "IRST", "Hora de verano de Ir\u00e1n",
            "IRDT" };
        ...
        String JST[] = new String[] { "Hora est\u00e1ndar de Jap\u00f3n", "JST", "Hora de verano de Jap\u00f3n",
            "JDT" };
        ...
        String MHT[] = new String[] { "Hora de las Islas Marshall", "MHT", "Hora de verano de las Islas Marshall",
            "MHST" };
        String MSK[] = new String[] { "Hora est\u00e1ndar de Mosc\u00fa", "MSK", "Hora de verano de Mosc\u00fa",
            "MSD" };
        String MST[] = new String[] { "Hora est\u00e1ndar de las Rocosas", "MST", "Hora de verano de las Rocosas",
            "MDT" };
        String MYT[] = new String[] { "Hora de Malasia", "MYT", "Hora de verano de Malasia", "MYST" };
        ...
        String NPT[] = new String[] { "Hora de Nepal", "NPT", "Hora de verano de Nepal", "NPST" };
        ...
        String NZST[] = new String[] { "Hora est\u00e1ndar de Nueva Zelanda", "NZST", "Hora de verano de Nueva Zelanda",
            "NZDT" };
        String PITCAIRN[] = new String[] { "Hora est\u00e1ndar de Pitcairn", "PST", "Hora de verano de Pitcairn",
            "PDT" };
        ...
        String PST[] = new String[] { "Hora est\u00e1ndar del Pac\u00edfico", "PST", "Hora de verano del Pac\u00edfico",
            "PDT" };
        String RST[] = new String[] { "Hora est\u00e1ndar Oriental", "EST", "Hora de verano Central", "CDT" };
        String SAST[] = new String[] { "Hora est\u00e1ndar de Sud\u00e1frica", "SAST",
            "Hora de verano de Sud\u00e1frica", "SAST" };
        String SBT[] = new String[] { "Hora de las Islas Solomon", "SBT", "Hora de verano de las Islas Solomon",
            "SBST" };
        ...
        String TMT[] = new String[] { "Hora de Turkmenist\u00e1n", "TMT", "Hora de verano de Turkmenist\u00e1n",
            "TMST" };
        ...
        String WET[] = new String[] { "Hora de Europa Occidental", "WET", "Hora de verano de Europa Occidental",
            "WEST" };
        ...
        return new Object[][] { { "America/Los_Angeles", PST }, { "PST", PST }, { "America/Denver", MST },
            ...
            new String[] { "Hora de Choibalsan", "CHOT", "Hora de verano de Choibalsan", "CHOST" } },
            { "Asia/Chongqing", CTT }, { "Asia/Chungking", CTT }, { "Asia/Colombo", IST }, { "Asia/Dacca", BDT },
            { "Asia/Dhaka", BDT },
            { "Asia/Dili", new String[] { "Hora de Timor Leste", "TLT", "Hora de verano de Timor Leste", "TLST" } },
            ...
            new String[] { "Hora de Indonesia Oriental", "EIT", "Hora de verano de Indonesia Oriental", "EIST" } },
            { "Asia/Kabul",
            ...
            new String[] { "Hora de Cabo Verde", "CVT", "Hora de verano de Cabo Verde", "CVST" } },
            ...
            new String[] { "Hora est\u00e1ndar de Georgia del Sur", "GST", "Hora de verano de Georgia del Sur",
            ...
            new String[] { "Hora est\u00e1ndar de Australia Central y Occidental", "CWST",
                "Hora de verano de Australia Central y Occidental", "CWST" } }, { "Australia/Hobart", TASMANIA },
            ...
            new String[] { "Hora de Volgogrado", "VOLT", "Hora de verano de Volgogrado", "VOLST" } },
            ...
            new String[] { "Hora del Territorio del Oc\u00e9ano \u00cdndico", "IOT",
                "Hora de verano del Territorio del Oc\u00e9ano \u00cdndico", "IOST" } }, { "Indian/Christmas",
            ...
            new String[] { "Hora de Marquesas", "MART", "Hora de verano de Marquesas", "MARST" } },
            ...
            new String[] { "Hora de Tahit\u00ed", "TAHT", "Hora de verano de Tahit\u00ed", "TAHST" } },
            { "Pacific/Tarawa",
