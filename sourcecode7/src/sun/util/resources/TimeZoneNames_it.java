...
public final class TimeZoneNames_it extends TimeZoneNamesBundle {
    ...
    protected final Object[][] getContents() {
        String ACT[] = new String[] { "Ora di Acre", "ACT", "Ora estiva di Acre", "ACST" };
        ...
        String AKST[] = new String[] { "Ora solare dell'Alaska", "AKST", "Ora legale dell'Alaska", "AKDT" };
        ...
        String ARMT[] = new String[] { "Ora dell'Armenia", "AMT", "Ora estiva dell'Armenia", "AMST" };
        ...
        String BRT[] = new String[] { "Ora del Brasile", "BRT", "Ora estiva del Brasile", "BRST" };
        String BTT[] = new String[] { "Ora del Bhutan", "BTT", "Ora estiva del Bhutan", "BTST" };
        ...
        String CIT[] = new String[] { "Ora dell'Indonesia centrale", "CIT", "Ora estiva dell'Indonesia centrale",
            "CIST" };
        String CLT[] = new String[] { "Ora del Cile", "CLT", "Ora estiva del Cile", "CLST" };
        String CST[] = new String[] { "Ora solare USA centrale", "CST", "Ora legale USA centrale", "CDT" };
        String CTT[] = new String[] { "Ora solare della Cina", "CST", "Ora legale della Cina", "CDT" };
        String CUBA[] = new String[] { "Ora solare Cuba", "CST", "Ora legale Cuba", "CDT" };
        ...
        String EASTER[] = new String[] { "Ora dell'Isola di Pasqua", "EAST", "Ora estiva dell'Isola di Pasqua",
            "EASST" };
        ...
        String GAMBIER[] = new String[] { "Ora di Gambier", "GAMT", "Ora estiva di Gambier", "GAMST" };
        ...
        String GST[] = new String[] { "Ora solare del golfo", "GST", "Ora legale del golfo", "GDT" };
        String HAST[] = new String[] { "Ora solare delle Isole Hawaii-Aleutine", "HAST",
            "Ora solare delle Isole Hawaii-Aleutine", "HADT" };
        String HKT[] = new String[] { "Ora di Hong Kong", "HKT", "Ora estiva di Hong Kong", "HKST" };
        ...
        String IRT[] = new String[] { "Ora solare Iran", "IRST", "Ora legale Iran", "IRDT" };
        String ISRAEL[] = new String[] { "Ora standard di Israele", "IST", "Ora legale di Israele", "IDT" };
        String IST[] = new String[] { "Ora solare dell'India", "IST", "Ora legale dell'India", "IDT" };
        String JST[] = new String[] { "Ora solare del Giappone", "JST", "Ora legale del Giappone", "JDT" };
        String KST[] = new String[] { "Ora solare della Corea", "KST", "Ora legale della Corea", "KDT" };
        ...
        String MSK[] = new String[] { "Ora standard di Mosca", "MSK", "Ora legale di Mosca", "MSD" };
        ...
        String NPT[] = new String[] { "Ora del Nepal", "NPT", "Ora estiva del Nepal", "NPST" };
        ...
        String PKT[] = new String[] { "Ora del Pakistan", "PKT", "Ora estiva del Pakistan", "PKST" };
        ...
        String RST[] = new String[] { "Ora solare USA orientale", "EST", "Ora legale USA centrale", "CDT" };
        ...
        String SGT[] = new String[] { "Ora di Singapore", "SGT", "Ora estiva di Singapore", "SGST" };
        ...
        String WET[] = new String[] { "Ora dell'Europa occidentale", "WET", "Ora estiva dell'Europa occidentale",
            "WEST" };
        String WIT[] = new String[] { "Ora dell'Indonesia occidentale", "WIT", "Ora estiva dell'Indonesia occidentale",
            "WIST" };
        String WST_AUS[] = new String[] { "Ora solare dell'Australia occidentale", "WST",
            "Ora estiva dell'Australia occidentale", "WST" };
        String SAMOA[] = new String[] { "Ora standard di Samoa", "SST", "Ora legale di Samoa", "SDT" };
        String WST_SAMOA[] = new String[] { "Ora di Samoa", "WST", "Ora estiva di Samoa", "WSST" };
        ...
        return new Object[][] { { "America/Los_Angeles", PST }, { "PST", PST }, { "America/Denver", MST },
            ...
            { "Asia/Dhaka", BDT },
            { "Asia/Dili", new String[] { "Ora di Timor Leste", "TLT", "Ora estiva di Timor Leste", "TLST" } },
            ...
            new String[] { "Ora dell'Indonesia orientale", "EIT", "Ora estiva dell'Indonesia orientale", "EIST" } },
            { "Asia/Kabul", new String[] { "Ora dell'Afghanistan", "AFT", "Ora estiva dell'Afghanistan", "AFST" } },
            { "Asia/Kamchatka",
                new String[] { "Ora di Petropavlovsk-Kamchatski", "PETT", "Ora estiva di Petropavlovsk-Kamchatski",
            ...
            { "Asia/Yekaterinburg",
                new String[] { "Ora di Ekaterinburg", "YEKT", "Ora estiva di Ekaterinburg", "YEKST" } },
            { "Asia/Yerevan", ARMT },
            ...
            { "Atlantic/Faroe", WET }, { "Atlantic/Faeroe", WET }, { "Atlantic/Jan_Mayen", CET },
            ...
            new String[] { "Ora solare Australia centrorientale", "CWST", "Ora estiva Australia centrorientale",
                "CWST" } }, { "Australia/Hobart", TASMANIA }, { "Australia/LHI", LORD_HOWE },
            ...
            { "Europe/Volgograd", new String[] { "Ora di Volgograd", "VOLT", "Ora estiva di Volgograd", "VOLST" } },
            ...
            new String[] { "Ora del Terr. Britannico dell'Oceano Indiano", "IOT",
                "Ora estiva del Terr. Britannico dell'Oceano Indiano", "IOST" } }, { "Indian/Christmas",
            ...
            { "Pacific/Galapagos",
                new String[] { "Ora delle Galapagos", "GALT", "Ora estiva delle Galapagos", "GALST" } },
            ...
            { "Pacific/Wallis",
                new String[] { "Ora di Wallis e Futuna", "WFT", "Ora estiva di Wallis e Futuna", "WFST" } },
