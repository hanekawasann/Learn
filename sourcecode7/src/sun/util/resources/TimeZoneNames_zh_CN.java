...
public final class TimeZoneNames_zh_CN extends TimeZoneNamesBundle {
    ...
    protected final Object[][] getContents() {
        ...
        String MSK[] = new String[] { "\u83ab\u65af\u79d1\u6807\u51c6\u65f6\u95f4", "MSK",
            "\u83ab\u65af\u79d1\u590f\u4ee4\u65f6", "MSD" };
        String MST[] = new String[] { "Mountain \u6807\u51c6\u65f6\u95f4", "MST", "Mountain \u590f\u4ee4\u65f6",
            "MDT" };
        ...
        String PST[] = new String[] { "\u592a\u5e73\u6d0b\u6807\u51c6\u65f6\u95f4", "PST",
            "\u592a\u5e73\u6d0b\u590f\u4ee4\u65f6", "PDT" };
        String RST[] = new String[] { "\u4e1c\u90e8\u6807\u51c6\u65f6\u95f4", "EST", "\u4e2d\u592e\u590f\u4ee4\u65f6",
            "CDT" };
        ...
        String WIT[] = new String[] { "\u897f\u5370\u5ea6\u5c3c\u897f\u4e9a\u65f6\u95f4", "WIT",
            "\u897f\u5370\u5ea6\u5c3c\u897f\u4e9a\u590f\u4ee4\u65f6", "WIST" };
        String WST_AUS[] = new String[] { "\u897f\u90e8\u6807\u51c6\u65f6\u95f4\uff08\u6fb3\u5927\u5229\u4e9a\uff09",
            "WST", "\u897f\u90e8\u590f\u4ee4\u65f6\uff08\u6fb3\u5927\u5229\u4e9a\uff09", "WST" };
        ...
        String ChST[] = new String[] { "Chamorro \u6807\u51c6\u65f6\u95f4", "ChST", "Chamorro \u590f\u4ee4\u65f6",
            "ChDT" };
        String VICTORIA[] = new String[] { "\u4e1c\u90e8\u6807\u51c6\u65f6\u95f4\uff08\u7ef4\u591a\u5229\u4e9a\uff09",
            "EST", "\u4e1c\u90e8\u590f\u4ee4\u65f6\uff08\u7ef4\u591a\u5229\u4e9a\uff09", "EST" };
        ...
        return new Object[][] { { "America/Los_Angeles", PST }, { "PST", PST }, { "America/Denver", MST },
            ...
            { "America/Bogota", new String[] { "\u54e5\u4f26\u6bd4\u4e9a\u65f6\u95f4", "COT",
                "\u54e5\u4f26\u6bd4\u4e9a\u590f\u4ee4\u65f6", "COST" } }, { "America/Boise", MST },
            ...
            new String[] { "\u6cd5\u5c5e\u572d\u4e9a\u90a3\u65f6\u95f4", "GFT",
                "\u6cd5\u5c5e\u572d\u4e9a\u90a3\u590f\u4ee4\u65f6", "GFST" } }, { "America/Cayman", EST },
            ...
            { "America/Godthab", new String[] { "\u897f\u683c\u6797\u5170\u5c9b\u65f6\u95f4", "WGT",
                "\u897f\u683c\u6797\u5170\u5c9b\u590f\u4ee4\u65f6", "WGST" } }, { "America/Goose_Bay", AST },
            ...
            new String[] { "\u7f57\u745f\u62c9\u65f6\u95f4", "ROTT", "\u7f57\u745f\u62c9\u590f\u4ee4\u65f6",
                "ROTST" } }, { "Antarctica/South_Pole", NZST },
            { "Antarctica/Syowa", new String[] { "Syowa \u65f6\u95f4", "SYOT", "Syowa \u590f\u4ee4\u65f6", "SYOST" } },
            { "Antarctica/Vostok", new String[] { "\u83ab\u65af\u6258\u514b\u65f6\u95f4", "VOST",
                "\u83ab\u65af\u6258\u514b\u590f\u4ee4\u65f6", "VOSST" } }, { "Arctic/Longyearbyen", CET },
            { "Asia/Aden", ARAST },
            { "Asia/Almaty", new String[] { "Alma-Ata \u65f6\u95f4", "ALMT", "Alma-Ata \u590f\u4ee4\u65f6", "ALMST" } },
            { "Asia/Amman", EET }, { "Asia/Anadyr",
            new String[] { "\u963f\u90a3\u5e95\u6cb3\u65f6\u95f4", "ANAT", "\u963f\u90a3\u5e95\u6cb3\u590f\u4ee4\u65f6",
                "ANAST" } },
            { "Asia/Aqtau", new String[] { "Aqtau \u65f6\u95f4", "AQTT", "Aqtau \u590f\u4ee4\u65f6", "AQTST" } },
            { "Asia/Aqtobe", new String[] { "Aqtobe \u65f6\u95f4", "AQTT", "Aqtobe \u590f\u4ee4\u65f6", "AQTST" } },
            { "Asia/Ashgabat", TMT }, { "Asia/Ashkhabad", TMT }, { "Asia/Baghdad", ARAST }, { "Asia/Bahrain", ARAST },
            { "Asia/Baku", new String[] { "\u4e9a\u585e\u62dc\u7136\u65f6\u95f4", "AZT",
                "\u4e9a\u585e\u62dc\u7136\u590f\u4ee4\u65f6", "AZST" } }, { "Asia/Bangkok", ICT },
            { "Asia/Beirut", EET }, { "Asia/Bishkek",
            new String[] { "\u5409\u5c14\u5409\u65af\u65af\u5766\u65f6\u95f4", "KGT",
                "\u5409\u5c14\u5409\u65af\u65af\u5766\u590f\u4ee4\u65f6", "KGST" } }, { "Asia/Brunei",
            ...
            new String[] { "\u5854\u5409\u514b\u65af\u5766\u65f6\u95f4", "TJT",
                "\u5854\u5409\u514b\u65af\u5766\u590f\u4ee4\u65f6", "TJST" } }, { "Asia/Gaza", EET },
            { "Asia/Harbin", CTT }, { "Asia/Ho_Chi_Minh", ICT }, { "Asia/Hong_Kong", HKT }, { "Asia/Hovd",
            new String[] { "\u79d1\u5e03\u591a\u65f6\u95f4", "HOVT", "\u79d1\u5e03\u591a\u590f\u4ee4\u65f6",
                "HOVST" } }, { "Asia/Irkutsk", new String[] { "\u4f0a\u5c14\u5e93\u6b21\u514b\u65f6\u95f4", "IRKT",
            "\u4f0a\u5c14\u5e93\u6b21\u514b\u590f\u4ee4\u65f6", "IRKST" } }, { "Asia/Istanbul", EET },
            { "Asia/Jakarta", WIT }, { "Asia/Jayapura",
            new String[] { "\u4e1c\u5370\u5ea6\u5c3c\u897f\u4e9a\u65f6\u95f4", "EIT",
                "\u4e1c\u5370\u5ea6\u5c3c\u897f\u4e9a\u590f\u4ee4\u65f6", "EIST" } }, { "Asia/Kabul",
            ...
            new String[] { "\u5357\u4e54\u6cbb\u4e9a\u6807\u51c6\u65f6\u95f4", "GST",
                "\u5357\u4e54\u6cbb\u4e9a\u590f\u4ee4\u65f6", "GDT" } }, { "Atlantic/St_Helena", GMT },
            { "Atlantic/Stanley", new String[] { "\u798f\u514b\u5170\u7fa4\u5c9b\u65f6\u95f4", "FKT",
                "\u798f\u514b\u5170\u7fa4\u5c9b\u590f\u4ee4\u65f6", "FKST" } }, { "Australia/ACT", EST_NSW },
            ...
            new String[] { "\u4f0f\u5c14\u52a0\u683c\u52d2\u65f6\u95f4", "VOLT",
                "\u4f0f\u5c14\u52a0\u683c\u52d2\u590f\u4ee4\u65f6", "VOLST" } }, { "Europe/Warsaw", CET },
            ...
            new String[] { "\u5370\u5ea6\u6d0b\u5730\u5e26\u65f6\u95f4", "IOT",
                "\u5370\u5ea6\u6d0b\u5730\u5e26\u590f\u4ee4\u65f6", "IOST" } }, { "Indian/Christmas",
            new String[] { "\u5723\u8bde\u5c9b\u65f6\u95f4", "CXT", "\u5723\u8bde\u5c9b\u590f\u4ee4\u65f6", "CXST" } },
            { "Indian/Cocos", new String[] { "\u53ef\u53ef\u65af\u7fa4\u5c9b\u65f6\u95f4", "CCT",
                "\u53ef\u53ef\u65af\u7fa4\u5c9b\u590f\u4ee4\u65f6", "CCST" } }, { "Indian/Comoro", EAT },
            { "Indian/Kerguelen", new String[] { "\u6cd5\u5c5e\u5357\u6781\u65f6\u95f4", "TFT",
                "\u6cd5\u5c5e\u5357\u6781\u590f\u4ee4\u65f6", "TFST" } }, { "Indian/Mahe",
            new String[] { "\u585e\u5e2d\u5c14\u7fa4\u5c9b\u65f6\u95f4", "SCT",
                "\u585e\u5e2d\u5c14\u7fa4\u5c9b\u590f\u4ee4\u65f6", "SCST" } }, { "Indian/Maldives",
            new String[] { "\u9a6c\u5c14\u4ee3\u592b\u65f6\u95f4", "MVT", "\u9a6c\u5c14\u4ee3\u592b\u590f\u4ee4\u65f6",
                "MVST" } }, { "Indian/Mauritius",
            new String[] { "\u6469\u91cc\u897f\u65af\u65f6\u95f4", "MUT", "\u6469\u91cc\u897f\u65af\u590f\u4ee4\u65f6",
                "MUST" } }, { "Indian/Mayotte", EAT }, { "Indian/Reunion",
            new String[] { "\u7559\u5c3c\u65fa\u5c9b\u65f6\u95f4", "RET", "\u7559\u5c3c\u65fa\u5c9b\u590f\u4ee4\u65f6",
                "REST" } }, { "Israel", ISRAEL }, { "Jamaica", EST }, { "Japan", JST }, { "Kwajalein", MHT },
            { "Libya", EET },
            { "MET", new String[] { "\u4e2d\u6b27\u65f6\u95f4", "MET", "\u4e2d\u6b27\u590f\u4ee4\u65f6", "MEST" } },
