...
public final class TimeZoneNames_fr extends TimeZoneNamesBundle {
    ...
    protected final Object[][] getContents() {
        ...
        String ARAST[] = new String[] { "Heure normale d'Arabie", "AST", "Heure avanc\u00e9e d'Arabie", "ADT" };
        ...
        String CET[] = new String[] { "Heure d'Europe centrale", "CET", "Heure d'\u00e9t\u00e9 d'Europe centrale",
            "CEST" };
        String CHAST[] = new String[] { "Heure standard de Chatham", "CHAST", "Heure avanc\u00e9e de Chatham",
            "CHADT" };
        ...
        String CST[] = new String[] { "Heure normale du Centre", "CST", "Heure avanc\u00e9e du Centre", "CDT" };
        String CTT[] = new String[] { "Heure normale de Chine", "CST", "Heure avanc\u00e9e de Chine", "CDT" };
        ...
        String GMT[] = new String[] { "Heure de Greenwich", "GMT", "Heure de Greenwich", "GMT" };
        String GMTBST[] = new String[] { "Heure du m\u00e9ridien de Greenwich", "GMT",
            "Heure d'\u00e9t\u00e9 britannique", "BST" };
        String GST[] = new String[] { "Heure normale du Golfe", "GST", "Heure avanc\u00e9e du Golfe", "GDT" };
        ...
        String ISRAEL[] = new String[] { "Heure standard d'Isra\u00ebl", "IST", "Heure avanc\u00e9e d'Isra\u00ebl",
            "IDT" };
        String IST[] = new String[] { "Heure normale d'Inde", "IST", "Heure avanc\u00e9e d'Inde", "IDT" };
        String JST[] = new String[] { "Heure normale du Japon", "JST", "Heure avanc\u00e9e du Japon", "JDT" };
        ...
        String NST[] = new String[] { "Heure normale de Terre-Neuve", "NST", "Heure avanc\u00e9e de Terre-Neuve",
            "NDT" };
        ...
        String RST[] = new String[] { "Heure normale de l'Est", "EST", "Heure avanc\u00e9e du Centre", "CDT" };
        ...
        String SAMOA[] = new String[] { "Heure standard de Samoa", "SST", "Heure avanc\u00e9e de Samoa", "SDT" };
        ...
        String UTC[] = new String[] { "Temps universel coordonn\u00e9", "UTC", "Temps universel coordonn\u00e9",
            "UTC" };
        ...
        return new Object[][] { { "America/Los_Angeles", PST }, { "PST", PST }, { "America/Denver", MST },
            ...
            { "America/Bogota",
                new String[] { "Heure de Colombie", "COT", "Heure d'\u00e9t\u00e9 de Colombie", "COST" } },
            ...
            new String[] { "Heure de Guyane fran\u00e7aise", "GFT", "Heure d'\u00e9t\u00e9 de Guyane fran\u00e7aise",
                "GFST" } }, { "America/Cayman", EST }, { "America/Chihuahua", MST }, { "America/Coral_Harbour", EST },
            ...
            { "America/Knox_IN", CST }, { "America/La_Paz",
            new String[] { "Heure de Bolivie", "BOT", "Heure d'\u00e9t\u00e9 de Bolivie", "BOST" } }, { "America/Lima",
            ...
            new String[] { "Heure normale de Saint-Pierre et Miquelon", "PMST",
                "Heure avanc\u00e9e de Saint-Pierre et Miquelon", "PMDT" } }, { "America/Moncton", AST },
            { "America/Montevideo",
            ...
            new String[] { "Heure de Davis", "DAVT", "Heure d'\u00e9t\u00e9 de Davis", "DAVST" } },
            { "Antarctica/DumontDUrville",
                new String[] { "Heure de Dumont-d'Urville", "DDUT", "Heure d'\u00e9t\u00e9 de Dumont-d'Urville",
                    "DDUST" } }, { "Antarctica/Macquarie",
            new String[] { "Macquarie Island Time", "MIST", "Macquarie Island Summer Time", "MIST" } },
            { "Antarctica/Mawson",
                new String[] { "Heure de Mawson", "MAWT", "Heure d'\u00e9t\u00e9 de Mawson", "MAWST" } },
            { "Antarctica/McMurdo", NZST }, { "Antarctica/Palmer", CLT }, { "Antarctica/Rothera",
            new String[] { "Heure de Rothera", "ROTT", "Heure d'\u00e9t\u00e9 de Rothera", "ROTST" } },
            { "Antarctica/South_Pole", NZST }, { "Antarctica/Syowa",
            new String[] { "Heure de Syowa", "SYOT", "Heure d'\u00e9t\u00e9 de Syowa", "SYOST" } },
            { "Antarctica/Vostok",
                new String[] { "Heure de Vostok", "VOST", "Heure d'\u00e9t\u00e9 de Vostok", "VOSST" } },
            ...
            { "Asia/Baku", new String[] { "Heure d'Azerba\u00efdjan", "AZT", "Heure d'\u00e9t\u00e9 d'Azerba\u00efdjan",
                "AZST" } }, { "Asia/Bangkok", ICT }, { "Asia/Beirut", EET }, { "Asia/Bishkek",
            ...
            new String[] { "Heure d'Indon\u00e9sie orientale", "EIT",
                "Heure d'\u00e9t\u00e9 d'Indon\u00e9sie orientale", "EIST" } }, { "Asia/Kabul",
            ...
            { "Asia/Kamchatka", new String[] { "Heure de Petropavlovsk-Kamchatski", "PETT",
                "Heure d'\u00e9t\u00e9 de Petropavlovsk-Kamchatski", "PETST" } }, { "Asia/Karachi", PKT },
            { "Asia/Kashgar", CTT }, { "Asia/Kathmandu", NPT }, { "Asia/Katmandu", NPT }, { "Asia/Kolkata", IST },
            { "Asia/Krasnoyarsk",
                new String[] { "Heure de Krasno\u00efarsk", "KRAT", "Heure d'\u00e9t\u00e9 de Krasno\u00efarsk",
                    "KRAST" } }, { "Asia/Kuala_Lumpur", MYT }, { "Asia/Kuching", MYT }, { "Asia/Kuwait", ARAST },
            { "Asia/Macao", CTT }, { "Asia/Macau", CTT }, { "Asia/Magadan",
            new String[] { "Heure de Magadan", "MAGT", "Heure d'\u00e9t\u00e9 de Magadan", "MAGST" } },
            ...
            { "Asia/Yerevan", ARMT }, { "Atlantic/Azores",
            ...
            new String[] { "Heure normale de G\u00e9orgie du Sud", "GST", "Heure avanc\u00e9e de G\u00e9orgie du Sud",
                "GDT" } }, { "Atlantic/St_Helena", GMT }, { "Atlantic/Stanley",
            new String[] { "Heure des \u00eeles Falkland", "FKT", "Heure d'\u00e9t\u00e9 des \u00eeles Falkland",
                "FKST" } }, { "Australia/ACT", EST_NSW }, { "Australia/Adelaide", ADELAIDE },
            ...
            new String[] { "Heure des Terres australes antartiques fran\u00e7aises", "TFT",
                "Heure d'\u00e9t\u00e9 des Terres australes antartiques fran\u00e7aises", "TFST" } }, { "Indian/Mahe",
            ...
            { "Indian/Mauritius",
                new String[] { "Heure de Maurice", "MUT", "Heure d'\u00e9t\u00e9 de Maurice", "MUST" } },
            ...
            new String[] { "Heure de l'Europe centrale", "MET", "Heure d'\u00e9t\u00e9 de l'Europe centrale",
                "MEST" } }, { "Mexico/BajaNorte", PST }, { "Mexico/BajaSur", MST }, { "Mexico/General", CST },
            ...
            { "Pacific/Chuuk", CHUT }, { "Pacific/Easter", EASTER },
            ...
            { "Pacific/Enderbury", new String[] { "Heure de l'\u00cele de Phoenix", "PHOT",
                "Heure d'\u00e9t\u00e9 de l'\u00cele de Phoenix", "PHOST" } }, { "Pacific/Fakaofo",
            new String[] { "Heure de Tokelau", "TKT", "Heure d'\u00e9t\u00e9 de Tokelau", "TKST" } },
            { "Pacific/Fiji", new String[] { "Heure de Fidji", "FJT", "Heure d'\u00e9t\u00e9 de Fidji", "FJST" } },
            { "Pacific/Funafuti",
                new String[] { "Heure de Tuvalu", "TVT", "Heure d'\u00e9t\u00e9 de Tuvalu", "TVST" } },
            { "Pacific/Galapagos",
            ...
            new String[] { "Heure de l'\u00cele de Line", "LINT", "Heure d'\u00e9t\u00e9 de l'\u00cele de Line",
                "LINST" } }, { "Pacific/Kosrae",
            new String[] { "Heure de Kusaie", "KOST", "Heure d'\u00e9t\u00e9 de Kusaie", "KOSST" } },
            ...
            { "Pacific/Norfolk",
                new String[] { "Heure de Norfolk", "NFT", "Heure d'\u00e9t\u00e9 de Norfolk", "NFST" } },
            { "Pacific/Noumea", new String[] { "Heure de Nouvelle-Cal\u00e9donie", "NCT",
                "Heure d'\u00e9t\u00e9 de Nouvelle-Cal\u00e9donie", "NCST" } }, { "Pacific/Pago_Pago", SAMOA },
            ...
            { "Pacific/Port_Moresby", new String[] { "Heure de Papouasie-Nouvelle-Guin\u00e9e", "PGT",
                "Heure d'\u00e9t\u00e9 de de Papouasie-Nouvelle-Guin\u00e9e", "PGST" } }, { "Pacific/Rarotonga",
            new String[] { "Heure des \u00celes Cook", "CKT", "Heure d'\u00e9t\u00e9 des \u00celes Cook", "CKHST" } },
            { "Pacific/Saipan", ChST }, { "Pacific/Samoa", SAMOA }, { "Pacific/Tahiti",
            new String[] { "Heure de Tahiti", "TAHT", "Heure d'\u00e9t\u00e9 de Tahiti", "TAHST" } },
            { "Pacific/Tarawa",
            ...
            { "Pacific/Wallis",
                new String[] { "Heure de Wallis et Futuna", "WFT", "Heure d'\u00e9t\u00e9 de Wallis et Futuna",
                    "WFST" } }, { "Pacific/Yap", CHUT }, { "Poland", CET }, { "PRC", CTT }, { "PST8PDT", PST },
