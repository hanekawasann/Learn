...
public final class TimeZoneNames_de extends TimeZoneNamesBundle {
    ...
    protected final Object[][] getContents() {
        String ACT[] = new String[] { "Acre Normalzeit", "ACT", "Acre Sommerzeit", "ACST" };
        ...
        String ARMT[] = new String[] { "Armenische Zeit", "AMT", "Armenische Sommerzeit", "AMST" };
        String AST[] = new String[] { "Atlantik Normalzeit", "AST", "Atlantik Sommerzeit", "ADT" };
        String BDT[] = new String[] { "Bangladesch Zeit", "BDT", "Bangladesch Sommerzeit", "BDST" };
        ...
        String BTT[] = new String[] { "Bhutanische Zeit", "BTT", "Bhutanische Sommerzeit", "BTST" };
        String CAT[] = new String[] { "Zentralafrikanische Zeit", "CAT", "Zentralafrikanische Sommerzeit", "CAST" };
        String CET[] = new String[] { "Mitteleurop\u00e4ische Zeit", "MEZ", "Mitteleurop\u00e4ische Sommerzeit",
            "MESZ" };
        ...
        String CIT[] = new String[] { "Zentralindonesische Zeit", "CIT", "Zentralindonesische Sommerzeit", "CIST" };
        String CLT[] = new String[] { "Chilenische Zeit", "CLT", "Chilenische Sommerzeit", "CLST" };
        String CST[] = new String[] { "Zentrale Normalzeit", "CST", "Zentrale Sommerzeit", "CDT" };
        ...
        String DUBLIN[] = new String[] { "Greenwich Zeit", "GMT", "Irische Sommerzeit", "IST" };
        ...
        String GAMBIER[] = new String[] { "Gambier Zeit", "GAMT", "Gambier Sommerzeit", "GAMST" };
        String GMT[] = new String[] { "Greenwich Zeit", "GMT", "Greenwich Zeit", "GMT" };
        String GMTBST[] = new String[] { "Greenwich Zeit", "GMT", "Britische Sommerzeit", "BST" };
        ...
        String HKT[] = new String[] { "Hongkong Zeit", "HKT", "Hongkong Sommerzeit", "HKST" };
        String HST[] = new String[] { "Hawaii Normalzeit", "HST", "Hawaii Sommerzeit", "HDT" };
        String ICT[] = new String[] { "Indochina Zeit", "ICT", "Indochina Sommerzeit", "ICST" };
        ...
        String MYT[] = new String[] { "Malaysische Zeit", "MYT", "Malaysische Sommerzeit", "MYST" };
        ...
        String RST[] = new String[] { "\u00d6stliche Normalzeit", "EST", "Zentrale Sommerzeit", "CDT" };
        ...
        String SGT[] = new String[] { "Singapur Zeit", "SGT", "Singapur Sommerzeit", "SGST" };
        ...
        String WIT[] = new String[] { "Westindonesische Zeit", "WIT", "Westindonesische Sommerzeit", "WIST" };
        String WST_AUS[] = new String[] { "Westliche Normalzeit (Australien)", "WST",
            "Westliche Sommerzeit (Australien)", "WST" };
        String SAMOA[] = new String[] { "Samoa Normalzeit", "SST", "Samoa Sommerzeit", "SDT" };
        String WST_SAMOA[] = new String[] { "West Samoa Zeit", "WST", "West Samoa Sommerzeit", "WSST" };
        ...
        String UZT[] = new String[] { "Usbekistan Zeit", "UZT", "Usbekistan Sommerzeit", "UZST" };
        ...
        return new Object[][] { { "America/Los_Angeles", PST }, { "PST", PST }, { "America/Denver", MST },
            ...
            new String[] { "Ecuadorianische Zeit", "ECT", "Ecuadorianische Sommerzeit", "ECST" } },
            ...
            { "Asia/Dhaka", BDT },
            { "Asia/Dili", new String[] { "Timor-Leste Normalzeit", "TLT", "Timor-Leste Sommerzeit", "TLST" } },
            ...
            new String[] { "Falkland Inseln Zeit", "FKT", "Falkland Inseln Sommerzeit", "FKST" } },
            ...
            new String[] { "Zentral-Westliche Normalzeit (Australien)", "CWST",
                "Zentral-Westliche Sommerzeit (Australien)", "CWST" } }, { "Australia/Hobart", TASMANIA },
            ...
            { "Europe/Volgograd", new String[] { "Wolgograder Zeit", "VOLT", "Wolgograder Sommerzeit", "VOLST" } },
            ...
            new String[] { "Zentraleurop\u00e4ische Zeit", "MET", "Zentraleurop\u00e4ische Sommerzeit", "MEST" } },
            ...
            { "Pacific/Enderbury",
                new String[] { "Phoenix Inseln Zeit", "PHOT", "Phoenix Inseln Sommerzeit", "PHOST" } },
            ...
            { "Pacific/Rarotonga", new String[] { "Cook-Inseln Zeit", "CKT", "Cook-Inseln Sommerzeit", "CKHST" } },
            ...
            { "Pacific/Truk", CHUT },
            { "Pacific/Wake", new String[] { "Wake Zeit", "WAKT", "Wake Sommerzeit", "WAKST" } }, { "Pacific/Wallis",
            new String[] { "Wallis u. Futuna Zeit", "WFT", "Wallis u. Futuna Sommerzeit", "WFST" } },
