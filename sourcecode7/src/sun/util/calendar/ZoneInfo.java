...
public class ZoneInfo extends TimeZone {
    ...
    static {
        String oldmapping = AccessController
            .doPrivileged(new sun.security.action.GetPropertyAction("sun.timezone.ids.oldmapping", "false"))
     ...
     */
    ZoneInfo(String ID, int rawOffset, int dstSavings, int checksum, long[] transitions, int[] offsets,
        int[] simpleTimeZoneParams, boolean willGMTOffsetChange) {
        setID(ID);
    ...
    public int getOffset(int era, int year, int month, int day, int dayOfWeek, int milliseconds) {
        ...
        if (dayOfWeek < java.util.GregorianCalendar.SUNDAY || dayOfWeek > java.util.GregorianCalendar.SATURDAY) {
            throw new IllegalArgumentException();
        }
    ...
    public String toString() {
        return getClass().getName() + "[id=\"" + getID() + "\"" + ",offset=" + getLastRawOffset() + ",dstSavings=" +
            dstSavings + ",useDaylight=" + useDaylightTime() + ",transitions=" +
            ((transitions != null) ? transitions.length : 0) + ",lastRule=" +
            (lastRule == null ? getLastRuleInstance() : lastRule) + "]";
    }
    ...
    public SimpleTimeZone getLastRuleInstance() {
        ...
        if (simpleTimeZoneParams.length == 10) {
            return new SimpleTimeZone(getLastRawOffset(), getID(), simpleTimeZoneParams[0], simpleTimeZoneParams[1],
                simpleTimeZoneParams[2], simpleTimeZoneParams[3], simpleTimeZoneParams[4], simpleTimeZoneParams[5],
                simpleTimeZoneParams[6], simpleTimeZoneParams[7], simpleTimeZoneParams[8], simpleTimeZoneParams[9],
                dstSavings);
        }
        return new SimpleTimeZone(getLastRawOffset(), getID(), simpleTimeZoneParams[0], simpleTimeZoneParams[1],
            simpleTimeZoneParams[2], simpleTimeZoneParams[3], simpleTimeZoneParams[4], simpleTimeZoneParams[5],
            simpleTimeZoneParams[6], simpleTimeZoneParams[7], dstSavings);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (getID().equals(that.getID()) && (getLastRawOffset() == that.getLastRawOffset()) &&
    ...
    public boolean hasSameRules(TimeZone other) {
        ...
        if (!(other instanceof ZoneInfo)) {
            ...
            if ((transitions == null) && (useDaylightTime() == false) && (other.useDaylightTime() == false)) {
                return true;
            }
            return false;
        }
