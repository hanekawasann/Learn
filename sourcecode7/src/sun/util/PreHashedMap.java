...
public abstract class PreHashedMap<V> extends AbstractMap<String, V> {
     ...
     *
     * @param rows The row array to be initialized
     */
    ...
    public V get(Object k) {
        ...
        for (; ; ) {
            if (a[0].equals(k)) { return toV(a[1]); }
    ...
    public V put(String k, V v) {
        int h = (k.hashCode() >> shift) & mask;
        Object[] a = (Object[]) ht[h];
        if (a == null) { throw new UnsupportedOperationException(k); }
        for (; ; ) {
            if (a[0].equals(k)) {
                V ov = toV(a[1]);
                a[1] = v;
            ...
            if (a.length < 3) { throw new UnsupportedOperationException(k); }
            a = (Object[]) a[2];
        }
    }
                    ...
                    public Map.Entry<String, V> next() {
                        return new Map.Entry<String, V>() {
                            ...
                            public boolean equals(Object ob) {
                                ...
                                if (!(ob instanceof Map.Entry)) { return false; }
                                Map.Entry<String, V> that = (Map.Entry<String, V>) ob;
                                return ((this.getKey() == null ? that.getKey() == null
