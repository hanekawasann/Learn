...
public final class TimeZoneNameUtility {
    ...
    private static final String[] retrieveDisplayNames(OpenListResourceBundle rb, String id, Locale locale) {
        ...
        if (pool.hasProviders()) {
            names = pool.getLocalizedObject(TimeZoneNameGetter.INSTANCE, locale, rb, id);
        }
    ...
    private static class TimeZoneNameGetter
            ...
            if (queryID.equals("GMT")) {
                ...
                if (aliases != null) {
                    ...
                    if (names == null) {
                        ...
                        names = examineAliases(timeZoneNameProvider, locale, queryID, aliases, aliases.entrySet());
                    }
                }
            }
        ...
        private static String[] examineAliases(TimeZoneNameProvider tznp, Locale locale, String id,
            Map<String, String> aliases, Set<Map.Entry<String, String>> aliasesSet) {
