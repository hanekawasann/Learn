...
public class PeekGraphics extends Graphics2D implements PrinterGraphics, ImageObserver, Cloneable {
    ...
    public boolean drawImage(Image img, int dx1, int dy1, int dx2, int dy2, int sx1, int sy1, int sx2, int sy2,
        ...
        return mGraphics.drawImage(img, dx1, dy1, dx2, dy2, sx1, sy1, sx2, sy2, observer);
    ...
    public boolean drawImage(Image img, int dx1, int dy1, int dx2, int dy2, int sx1, int sy1, int sx2, int sy2,
        ...
        return mGraphics.drawImage(img, dx1, dy1, dx2, dy2, sx1, sy1, sx2, sy2, bgcolor, observer);
    ...
    public boolean hitsDrawingArea(Rectangle rect) {
        ...
        return mDrawingArea.intersects((float) rect.getMinY(), (float) rect.getMaxY());
    }
    ...
    private void addDrawingRect(Rectangle2D rect, float x, float y) {
        ...
        addDrawingRect((float) (rect.getX() + x), (float) (rect.getY() + y), (float) rect.getWidth(),
    ...
    private void addDrawingRect(Rectangle2D rect) {
        ...
        */
        ...
        mDrawingArea.add((float) transRect.getMinY(), (float) transRect.getMaxY());
    ...
    protected class ImageWaiter implements ImageObserver {
        ...
        synchronized public boolean imageUpdate(Image image, int flags, int x, int y, int w, int h) {
