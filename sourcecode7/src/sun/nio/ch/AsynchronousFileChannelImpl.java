...
abstract class AsynchronousFileChannelImpl extends AsynchronousFileChannel {
    ...
    protected AsynchronousFileChannelImpl(FileDescriptor fdObj, boolean reading, boolean writing,
    ...
    protected final void end(boolean completed) throws IOException {
        ...
        if (!completed && !isOpen()) { throw new AsynchronousCloseException(); }
    }

    // -- file locking --

    abstract <A> Future<FileLock> implLock(long position, long size, boolean shared, A attachment,
    ...
    @Override
    public final <A> void lock(long position, long size, boolean shared, A attachment,
        CompletionHandler<FileLock, ? super A> handler) {
    ...
    abstract <A> Future<Integer> implRead(ByteBuffer dst, long position, A attachment,
    ...
    abstract <A> Future<Integer> implWrite(ByteBuffer src, long position, A attachment,
        CompletionHandler<Integer, ? super A> handler);
    ...
    @Override
    public final <A> void write(ByteBuffer src, long position, A attachment,
        CompletionHandler<Integer, ? super A> handler) {
        if (handler == null) { throw new NullPointerException("'handler' is null"); }
