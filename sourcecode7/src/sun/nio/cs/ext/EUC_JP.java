...
public class EUC_JP extends Charset implements HistoricallyNamedCharset {
    ...
    static class Decoder extends JIS_X_0208_Decoder implements DelegatableDecoder {
        ...
        protected char decodeDouble(int byte1, int byte2) {
            ...
            if (((byte1 < 0) || (byte1 > getIndex1().length)) || ((byte2 < start) || (byte2 > end))) {
                return REPLACE_CHAR;
            }

            int n = (j0208Index1[byte1 - 0x80] & 0xf) * (end - start + 1) + (byte2 - start);
    ...
    static class Encoder extends JIS_X_0208_Encoder {
        ...
        public boolean canEncode(char c) {
            ...
            if (encodeSingle(c, encodedBytes) == 0) { //doublebyte
                if (encodeDouble(c) == 0) { return false; }
            }
            return true;
        }
        ...
        protected int encodeSingle(char inputChar, byte[] outputByte) {
            ...
            if ((b = encoderJ0201.encode(inputChar)) == 0) { return 0; }
