...
abstract class ISO2022 extends Charset {
                    ...
                    switch (b1) {
                        ...
                        case ISO_ESC:
                            ...
                            switch (b1) {
                                case ISO_SS2_7:
                                    ...
                                    da[dp] = decode((byte) b2, (byte) b3, SS2Flag);
                                    dp++;
                                    inputSize = 4;
                                    break;
                                case ISO_SS3_7:
                                    ...
                                    b3 = sa[sp + 3];
                                    if (dl - dp < 1) { return CoderResult.OVERFLOW; }
                                    da[dp] = decode((byte) b2, (byte) b3, SS3Flag);
                                    dp++;
                                    inputSize = 4;
                                    break;
                                default:
                        ...
                        default:
                            ...
                            if (!shiftout) {
                                ...
                                if (sl - sp < 2) { return CoderResult.UNDERFLOW; }
                                b2 = sa[sp + 1] & 0xff;
                                da[dp++] = decode((byte) b1, (byte) b2, SOFlag);
                                inputSize = 2;
                            }
                            break;
                    }
                    ...
                    switch (b1) {
                        ...
                        case ISO_ESC:
                            ...
                            switch (b1) {
                                case ISO_SS2_7:
                                    ...
                                    dst.put(decode((byte) b2, (byte) b3, SS2Flag));
                                    inputSize = 4;
                                    break;
                                case ISO_SS3_7:
                                    if (src.remaining() < 2) { return CoderResult.UNDERFLOW; }
                                    ...
                                    b3 = src.get();
                                    if (dst.remaining() < 1) { return CoderResult.OVERFLOW; }
                                    dst.put(decode((byte) b2, (byte) b3, SS3Flag));
                                    inputSize = 4;
                                    break;
                                default:
                                    return CoderResult.malformedForLength(2);
                        ...
                        default:
                            ...
                            if (!shiftout) {
                                ...
                                if (src.remaining() < 1) { return CoderResult.UNDERFLOW; }
                                b2 = src.get() & 0xff;
                                dst.put(decode((byte) b1, (byte) b2, SOFlag));
                                inputSize = 2;
                            }
                            break;
                    }
    ...
    protected static class Encoder extends CharsetEncoder {
        ...
        protected String SODesig, SS2Desig = null, SS3Desig = null;
        ...
        private CoderResult encodeArrayLoop(CharBuffer src, ByteBuffer dst) {
            ...
            try {
                while (sp < sl) {
                    ...
                    for (int i = 0; i < outputSize; i++) { da[dp++] = outputByte[i]; }
                    sp++;
        ...
        private CoderResult encodeBufferLoop(CharBuffer src, ByteBuffer dst) {
            ...
            try {
                while (src.hasRemaining()) {
                    ...
                    for (int i = 0; i < outputSize; i++) { dst.put(outputByte[i]); }
                    mark++;
                    shiftout = newshiftout;
                    SODesDefined = newSODesDefined;
                    SS2DesDefined = newSS2DesDefined;
