...
public class IBM834 extends Charset {
    ...
    public CharsetDecoder newDecoder() {
        IBM933.initb2c();
        return new DoubleByte.Decoder_EBCDIC_DBCSONLY(this, IBM933.b2c, 0x40, 0xfe);  // hardcode the b2min/max
    }
    ...
    protected static class Encoder extends DoubleByte.Encoder_EBCDIC_DBCSONLY {
        public Encoder(Charset cs) {
            super(cs, new byte[] { (byte) 0xfe, (byte) 0xfe }, IBM933.c2b, IBM933.c2bIndex);
        }
        ...
        public boolean isLegalReplacement(byte[] repl) {
            if (repl.length == 2 && repl[0] == (byte) 0xfe && repl[1] == (byte) 0xfe) { return true; }
