...
public class SJIS extends Charset implements HistoricallyNamedCharset {
    ...
    public boolean contains(Charset cs) {
        return ((cs.name().equals("US-ASCII")) || (cs instanceof JIS_X_0201) || (cs instanceof SJIS) ||
    ...
    static class Encoder extends JIS_X_0208_Encoder {
        ...
        protected int encodeSingle(char inputChar) {
            ...
            if ((inputChar & 0xFF80) == 0) { return (byte) inputChar; }

            if ((b = jis0201.encode(inputChar)) == 0) { return -1; } else { return b; }
        }
