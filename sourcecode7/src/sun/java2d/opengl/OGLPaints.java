...
abstract class OGLPaints {
    ...
    private static class Texture extends OGLPaints {
        ...
        boolean isPaintValid(SunGraphics2D sg2d) {
            ...
            if (!(srcData instanceof OGLSurfaceData)) {
                ...
                //         OpenGL texture...
                srcData = dstData.getSourceSurfaceData(bi, sg2d.TRANSFORM_ISIDENT, CompositeType.SrcOver, null);
                if (!(srcData instanceof OGLSurfaceData)) {
                    return false;
                }
            }
    ...
    private static class LinearGradient extends MultiGradient {
        ...
        boolean isPaintValid(SunGraphics2D sg2d) {
            ...
            if (paint.getFractions().length == 2 && paint.getCycleMethod() != CycleMethod.REPEAT &&
