...
public abstract class OGLSurfaceData extends SurfaceData implements AccelSurface {
    ...
    public void validatePipe(SunGraphics2D sg2d) {
        ...
        if (/* CompositeType.SrcNoEa (any color) */
            (sg2d.compositeState <= sg2d.COMP_ISCOPY && sg2d.paintState <= sg2d.PAINT_ALPHACOLOR) ||
                ...
                (sg2d.compositeState == sg2d.COMP_ALPHA && sg2d.paintState <= sg2d.PAINT_ALPHACOLOR &&
    ...
    public boolean copyArea(SunGraphics2D sg2d, int x, int y, int w, int h, int dx, int dy) {
        if (sg2d.transformState < sg2d.TRANSFORM_TRANSLATESCALE && sg2d.compositeState < sg2d.COMP_XOR) {
            x += sg2d.transX;
            y += sg2d.transY;
