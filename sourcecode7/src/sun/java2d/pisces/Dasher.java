...
final class Dasher implements sun.awt.geom.PathConsumer2D {
    ...
    private void somethingTo(int type) {
        ...
        while ((t = li.next(leftInThisDashSegment)) < 1) {
            if (t != 0) {
                Helpers.subdivideAt((t - lastSplitT) / (1 - lastSplitT), curCurvepts, curCurveoff, curCurvepts, 0,
    ...
    private static class LengthIterator {
        ...
        private void goLeft() {
            ...
            if (len >= 0) {
                ...
                Helpers
                    .subdivide(recCurveStack[recLevel], 0, recCurveStack[recLevel + 1], 0, recCurveStack[recLevel], 0,
                        curveType);
