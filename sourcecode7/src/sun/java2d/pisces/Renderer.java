...
final class Renderer implements PathConsumer2D {
    ...
    public Renderer(int subpixelLgPositionsX, int subpixelLgPositionsY, int pix_boundsX, int pix_boundsY,
    ...
    public void endRendering() {
        ...
        if (pminX > pmaxX || pminY > pmaxY) {
            this.cache = new PiscesCache(boundsMinX >> SUBPIXEL_LG_POSITIONS_X, boundsMinY >> SUBPIXEL_LG_POSITIONS_Y,
