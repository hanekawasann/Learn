...
public class FillParallelogram extends GraphicsPrimitive {
     ...
     */
    public native void FillParallelogram(SunGraphics2D sg2d, SurfaceData dest, double x0, double y0, double dx1,
    ...
    public GraphicsPrimitive makePrimitive(SurfaceType srctype, CompositeType comptype, SurfaceType dsttype) {
        ...
        throw new InternalError("FillParallelogram not implemented for " + srctype + " with " + comptype);
    }
    ...
    private static class TraceFillParallelogram extends FillParallelogram {
        ...
        public void FillParallelogram(SunGraphics2D sg2d, SurfaceData dest, double x0, double y0, double dx1,
            double dy1, double dx2, double dy2) {
