...
public class JvmMemManagerEntryImpl implements JvmMemManagerEntryMBean {
    ...
    public EnumJvmMemManagerState getJvmMemManagerState() throws SnmpStatusException {
        if (manager.isValid()) { return JvmMemManagerStateValid; } else { return JvmMemManagerStateInvalid; }
    }

    private final static EnumJvmMemManagerState JvmMemManagerStateValid = new EnumJvmMemManagerState("valid");
    private final static EnumJvmMemManagerState JvmMemManagerStateInvalid = new EnumJvmMemManagerState("invalid");
