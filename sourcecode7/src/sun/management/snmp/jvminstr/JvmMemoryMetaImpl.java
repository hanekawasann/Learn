...
public class JvmMemoryMetaImpl extends JvmMemoryMeta {
     ...
     **/
    protected JvmMemManagerTableMeta createJvmMemManagerTableMetaNode(String tableName, String groupName, SnmpMib mib,
        MBeanServer server) {
     ...
     **/
    protected JvmMemGCTableMeta createJvmMemGCTableMetaNode(String tableName, String groupName, SnmpMib mib,
        MBeanServer server) {
     ...
     **/
    protected JvmMemPoolTableMeta createJvmMemPoolTableMetaNode(String tableName, String groupName, SnmpMib mib,
        MBeanServer server) {
     ...
     **/
    protected JvmMemMgrPoolRelTableMeta createJvmMemMgrPoolRelTableMetaNode(String tableName, String groupName,
