...
public class JVM_MANAGEMENT_MIB_IMPL extends JVM_MANAGEMENT_MIB {
    ...
    private class NotificationHandler implements NotificationListener {
        public void handleNotification(Notification notification, Object handback) {
            ...
            if (type.equals(MemoryNotificationInfo.MEMORY_THRESHOLD_EXCEEDED) || type.equals(MemoryNotificationInfo.
                ...
                if (entryIndex == null) {
                    log.error("handleNotification",
                        "Error: Can't find entry index for Memory Pool: " + minfo.getPoolName() + ": " +
                ...
                try {
                    ...
                    if (type.equals(MemoryNotificationInfo.
                        ...
                        usedOid = new SnmpOid(mibTable.
                            resolveVarName("jvmMemPoolUsed").getOid() + "." + entryIndex);
                        countOid = new SnmpOid(mibTable.
                            resolveVarName("jvmMemPoolThreshdCount").getOid() + "." + entryIndex);
                        ...
                        trap = new SnmpOid(mibTable.
                            ...
                            getOid());
                        usedOid = new SnmpOid(mibTable.
                            resolveVarName("jvmMemPoolCollectUsed").getOid() + "." + entryIndex);
                        countOid = new SnmpOid(mibTable.
                    ...
                    SnmpOid poolNameOid = new SnmpOid(mibTable.
                        resolveVarName("jvmMemPoolName").getOid() + "." + entryIndex);
     ...
     */
    private ArrayList<NotificationTarget> notificationTargets = new ArrayList<NotificationTarget>();
    ...
    private synchronized void sendTrap(SnmpOid trap, SnmpVarBindList list) {
        ...
        while (iterator.hasNext()) {
            ...
            try {
                ...
                log.error("sendTrap", "Exception occured while sending trap to [" + target + "]. Exception : " + e);
    ...
    public synchronized void addTargets(List<NotificationTarget> targets) throws IllegalArgumentException {
        if (targets == null) { throw new IllegalArgumentException("Target list is null"); }
     ...
     * interface.
     **/
    protected Object createJvmMemoryMBean(String groupName, String groupOid, ObjectName groupObjname,
        MBeanServer server) {
        ...
        // interface.
        //
        if (server != null) { return new JvmMemoryImpl(this, server); } else { return new JvmMemoryImpl(this); }
    }
     ...
     **/
    protected JvmMemoryMeta createJvmMemoryMetaNode(String groupName, String groupOid, ObjectName groupObjname,
        MBeanServer server) {
     ...
     **/
    protected JvmThreadingMeta createJvmThreadingMetaNode(String groupName, String groupOid, ObjectName groupObjname,
        MBeanServer server) {
     ...
     * interface.
     **/
    protected Object createJvmThreadingMBean(String groupName, String groupOid, ObjectName groupObjname,
        MBeanServer server) {
        ...
        // interface.
        //
        if (server != null) { return new JvmThreadingImpl(this, server); } else { return new JvmThreadingImpl(this); }
    }
     ...
     **/
    protected JvmRuntimeMeta createJvmRuntimeMetaNode(String groupName, String groupOid, ObjectName groupObjname,
        MBeanServer server) {
     ...
     * interface.
     **/
    protected Object createJvmRuntimeMBean(String groupName, String groupOid, ObjectName groupObjname,
        MBeanServer server) {
        ...
        // interface.
        //
        if (server != null) { return new JvmRuntimeImpl(this, server); } else { return new JvmRuntimeImpl(this); }
    }
     ...
     **/
    protected JvmCompilationMeta createJvmCompilationMetaNode(String groupName, String groupOid,
     ...
     * interface.
     **/
    protected Object createJvmCompilationMBean(String groupName, String groupOid, ObjectName groupObjname,
        MBeanServer server) {
        ...
        // interface.
        //
        if (server != null) { return new JvmCompilationImpl(this, server); } else {
    ...
    protected Object createJvmOSMBean(String groupName, String groupOid, ObjectName groupObjname, MBeanServer server) {
        ...
        // interface.
        //
        if (server != null) { return new JvmOSImpl(this, server); } else { return new JvmOSImpl(this); }
    }
     ...
     * interface.
     **/
    protected Object createJvmClassLoadingMBean(String groupName, String groupOid, ObjectName groupObjname,
        MBeanServer server) {
        ...
        // interface.
        //
        if (server != null) { return new JvmClassLoadingImpl(this, server); } else {
    ...
    private SnmpOid getJvmMemPoolEntryIndex(String poolName) {
        return getJvmMemPoolEntryIndex(getJvmMemPoolTableHandler(null), poolName);
    }
