...
public class JvmMemPoolEntryImpl implements JvmMemPoolEntryMBean {
    ...
    final static String collectMemoryTag = "jvmMemPoolEntry.getCollectionUsage";
    ...
    MemoryUsage getMemoryUsage() {
        try {
            ...
            if (m != null) {
                final MemoryUsage cached = (MemoryUsage) m.get(entryMemoryTag);
                if (cached != null) {
    ...
    MemoryUsage getPeakMemoryUsage() {
        try {
            ...
            if (m != null) {
                ...
                if (cached != null) {
                    if (log.isDebugOn()) { log.debug("getPeakMemoryUsage", entryPeakMemoryTag + " found in cache."); }
                    return cached;
                }
    ...
    public Long getJvmMemPoolMaxSize() throws SnmpStatusException {
        ...
        if (val > -1) { return new Long(val); } else { return JvmMemoryImpl.Long0; }
    }
    ...
    public Long getJvmMemPoolThreshold() throws SnmpStatusException {
        if (!pool.isUsageThresholdSupported()) { return JvmMemoryImpl.Long0; }
    ...
    public EnumJvmMemPoolThreshdSupport getJvmMemPoolThreshdSupport() throws SnmpStatusException {
        if (pool.isUsageThresholdSupported()) { return EnumJvmMemPoolThreshdSupported; } else {
    ...
    public EnumJvmMemPoolCollectThreshdSupport getJvmMemPoolCollectThreshdSupport() throws SnmpStatusException {
        if (pool.isCollectionUsageThresholdSupported()) { return EnumJvmMemPoolCollectThreshdSupported; } else {
    ...
    public static EnumJvmMemPoolType jvmMemPoolType(MemoryType type) throws SnmpStatusException {
        if (type.equals(MemoryType.HEAP)) { return EnumJvmMemPoolTypeHeap; } else if (type
            .equals(MemoryType.NON_HEAP)) { return EnumJvmMemPoolTypeNonHeap; }
    ...
    public EnumJvmMemPoolState getJvmMemPoolState() throws SnmpStatusException {
        if (pool.isValid()) { return JvmMemPoolStateValid; } else { return JvmMemPoolStateInvalid; }
    }
    ...
    private final static EnumJvmMemPoolState JvmMemPoolStateValid = new EnumJvmMemPoolState("valid");
    private final static EnumJvmMemPoolState JvmMemPoolStateInvalid = new EnumJvmMemPoolState("invalid");
    ...
    private static final EnumJvmMemPoolThreshdSupport EnumJvmMemPoolThreshdSupported = new EnumJvmMemPoolThreshdSupport(
        "supported");
    private static final EnumJvmMemPoolThreshdSupport EnumJvmMemPoolThreshdUnsupported
        = new EnumJvmMemPoolThreshdSupport("unsupported");

    private static final EnumJvmMemPoolCollectThreshdSupport EnumJvmMemPoolCollectThreshdSupported
        = new EnumJvmMemPoolCollectThreshdSupport("supported");
    private static final EnumJvmMemPoolCollectThreshdSupport EnumJvmMemPoolCollectThreshdUnsupported
