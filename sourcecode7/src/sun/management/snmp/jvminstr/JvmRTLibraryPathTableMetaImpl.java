...
public class JvmRTLibraryPathTableMetaImpl extends JvmRTLibraryPathTableMeta {
    ...
    public Object getEntry(SnmpOid oid) throws SnmpStatusException {
        ...
        //          in some interface.
        //
        final String entryTag = ((m == null) ? null : ("JvmRTLibraryPathTable.entry." + oid.toString()));
        ...
        final Object entry = new JvmRTLibraryPathEntryImpl((String) data, (int) oid.getOidArc(0));
    ...
    protected SnmpTableHandler getHandler(Object userData) {
        ...
        if (m != null) {
            final SnmpTableHandler handler = (SnmpTableHandler) m.get("JvmRTLibraryPathTable.handler");
        ...
        if (m != null && handler != null) { m.put("JvmRTLibraryPathTable.handler", handler); }
