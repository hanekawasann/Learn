...
public class JvmMemoryImpl implements JvmMemoryMBean {
     ...
     * "
     */
    final static EnumJvmMemoryGCCall JvmMemoryGCCallSupported = new EnumJvmMemoryGCCall("supported");
    final static EnumJvmMemoryGCCall JvmMemoryGCCallStart = new EnumJvmMemoryGCCall("start");
    final static EnumJvmMemoryGCCall JvmMemoryGCCallFailed = new EnumJvmMemoryGCCall("failed");
    final static EnumJvmMemoryGCCall JvmMemoryGCCallStarted = new EnumJvmMemoryGCCall("started");
     ...
     * "
     */
    final static EnumJvmMemoryGCVerboseLevel JvmMemoryGCVerboseLevelVerbose = new EnumJvmMemoryGCVerboseLevel(
        "verbose");
    final static EnumJvmMemoryGCVerboseLevel JvmMemoryGCVerboseLevelSilent = new EnumJvmMemoryGCVerboseLevel("silent");
    ...
    public Long getJvmMemoryNonHeapMaxSize() throws SnmpStatusException {
        ...
        if (val > -1) { return new Long(val); } else { return Long0; }
    }
    ...
    public EnumJvmMemoryGCCall getJvmMemoryGCCall() throws SnmpStatusException {
        ...
        if (m != null) {
            final EnumJvmMemoryGCCall cached = (EnumJvmMemoryGCCall) m.get("jvmMemory.getJvmMemoryGCCall");
    ...
    public void setJvmMemoryGCCall(EnumJvmMemoryGCCall x) throws SnmpStatusException {
        if (x.intValue() == JvmMemoryGCCallStart.intValue()) {
            ...
            try {
                ...
                if (m != null) { m.put("jvmMemory.getJvmMemoryGCCall", JvmMemoryGCCallStarted); }
            } catch (Exception ex) {
                if (m != null) { m.put("jvmMemory.getJvmMemoryGCCall", JvmMemoryGCCallFailed); }
            }
            return;
        }
    ...
    public EnumJvmMemoryGCVerboseLevel getJvmMemoryGCVerboseLevel() throws SnmpStatusException {
        if (ManagementFactory.getMemoryMXBean().isVerbose()) { return JvmMemoryGCVerboseLevelVerbose; } else {
    ...
    public void setJvmMemoryGCVerboseLevel(EnumJvmMemoryGCVerboseLevel x) throws SnmpStatusException {
        ...
        } else { ManagementFactory.getMemoryMXBean().setVerbose(false); }
    }
