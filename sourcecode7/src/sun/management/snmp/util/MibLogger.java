...
public class MibLogger {
    ...
    static String getClassName(Class clazz) {
        ...
        if (clazz.isArray()) { return getClassName(clazz.getComponentType()) + "[]"; }
        final String fullname = clazz.getName();
        final int lastpoint = fullname.lastIndexOf('.');
        final int len = fullname.length();
        if ((lastpoint < 0) || (lastpoint >= len)) { return fullname; } else {
    ...
    static String getLoggerName(Class clazz) {
        ...
        if (pname == null) { return "sun.management.snmp.jvminstr"; } else { return pname; }
    }
    ...
    public void config(String func, String msg) {
        final Logger l = getLogger();
        if (l != null) { l.logp(Level.CONFIG, className, func, msg); }
    }

    public void config(String func, Throwable t) {
        final Logger l = getLogger();
        if (l != null) { l.logp(Level.CONFIG, className, func, t.toString(), t); }
    }

    public void config(String func, String msg, Throwable t) {
        final Logger l = getLogger();
        if (l != null) { l.logp(Level.CONFIG, className, func, msg, t); }
    }

    public void error(String func, String msg) {
        final Logger l = getLogger();
        if (l != null) { l.logp(Level.SEVERE, className, func, msg); }
    }

    public void info(String func, String msg) {
        final Logger l = getLogger();
        if (l != null) { l.logp(Level.INFO, className, func, msg); }
    }

    public void info(String func, Throwable t) {
        final Logger l = getLogger();
        if (l != null) { l.logp(Level.INFO, className, func, t.toString(), t); }
    }

    public void info(String func, String msg, Throwable t) {
        final Logger l = getLogger();
        if (l != null) { l.logp(Level.INFO, className, func, msg, t); }
    }

    public void warning(String func, String msg) {
        final Logger l = getLogger();
        if (l != null) { l.logp(Level.WARNING, className, func, msg); }
    }

    public void warning(String func, Throwable t) {
        final Logger l = getLogger();
        if (l != null) { l.logp(Level.WARNING, className, func, t.toString(), t); }
    }

    public void warning(String func, String msg, Throwable t) {
        final Logger l = getLogger();
        if (l != null) { l.logp(Level.WARNING, className, func, msg, t); }
    }

    public void trace(String func, String msg) {
        final Logger l = getLogger();
        if (l != null) { l.logp(Level.FINE, className, func, msg); }
    }

    public void trace(String func, Throwable t) {
        final Logger l = getLogger();
        if (l != null) { l.logp(Level.FINE, className, func, t.toString(), t); }
    }

    public void trace(String func, String msg, Throwable t) {
        final Logger l = getLogger();
        if (l != null) { l.logp(Level.FINE, className, func, msg, t); }
    }

    public void debug(String func, String msg) {
        final Logger l = getLogger();
        if (l != null) { l.logp(Level.FINEST, className, func, msg); }
    }

    public void debug(String func, Throwable t) {
        final Logger l = getLogger();
        if (l != null) { l.logp(Level.FINEST, className, func, t.toString(), t); }
    }

    public void debug(String func, String msg, Throwable t) {
        final Logger l = getLogger();
        if (l != null) { l.logp(Level.FINEST, className, func, msg, t); }
    }
}
