...
public abstract class SnmpNamedListTableCache extends SnmpListTableCache {
    ...
    protected SnmpCachedData updateCachedDatas(Object context, List rawDatas) {
        ...
        final SnmpCachedData result = super.updateCachedDatas(context, rawDatas);
        names = ctxt;
        return result;
    }
    ...
    protected List getRawDatas(Map<Object, Object> userData, String key) {
        ...
        if (userData != null) { rawDatas = (List) userData.get(key); }
        ...
        if (rawDatas == null) {
            ...
            // Put list in cache...
            if (rawDatas != null && userData != null) { userData.put(key, rawDatas); }
        }
    ...
    protected SnmpCachedData updateCachedDatas(Object context) {
        ...
        final Map<Object, Object> userData = (context instanceof Map) ? Util.<Map<Object, Object>>cast(context) : null;
        ...
        TreeMap ctxt = new TreeMap();
        final SnmpCachedData result = super.updateCachedDatas(ctxt, rawDatas);
        names = ctxt;
        return result;
    }
