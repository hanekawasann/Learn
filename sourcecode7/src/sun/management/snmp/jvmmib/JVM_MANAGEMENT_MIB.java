...
public abstract class JVM_MANAGEMENT_MIB extends SnmpMib implements Serializable {
     ...
     **/
    protected JvmOSMeta createJvmOSMetaNode(String groupName, String groupOid, ObjectName groupObjname,
        MBeanServer server) {
     ...
     * interface.
     **/
    protected abstract Object createJvmOSMBean(String groupName, String groupOid, ObjectName groupObjname,
        MBeanServer server);
    ...
    protected void initJvmCompilation(MBeanServer server) throws Exception {
        ...
        ObjectName objname = null;
        if (server != null) {
            objname = getGroupObjectName("JvmCompilation", oid,
                mibName + ":name=sun.management.snmp.jvmmib.JvmCompilation");
        }
        ...
        if (meta != null) {
            ...
            // interface.
            //
            final JvmCompilationMBean group = (JvmCompilationMBean) createJvmCompilationMBean("JvmCompilation", oid,
                objname, server);
            meta.setInstance(group);
     ...
     * interface.
     **/
    protected abstract Object createJvmCompilationMBean(String groupName, String groupOid, ObjectName groupObjname,
        MBeanServer server);
     ...
     * interface.
     **/
    protected abstract Object createJvmRuntimeMBean(String groupName, String groupOid, ObjectName groupObjname,
        MBeanServer server);
    ...
    protected void initJvmThreading(MBeanServer server) throws Exception {
        ...
        ObjectName objname = null;
        if (server != null) {
            objname = getGroupObjectName("JvmThreading", oid,
                mibName + ":name=sun.management.snmp.jvmmib.JvmThreading");
        }
        ...
        if (meta != null) {
            ...
            // interface.
            //
            final JvmThreadingMBean group = (JvmThreadingMBean) createJvmThreadingMBean("JvmThreading", oid, objname,
                server);
            meta.setInstance(group);
     ...
     * interface.
     **/
    protected abstract Object createJvmThreadingMBean(String groupName, String groupOid, ObjectName groupObjname,
        MBeanServer server);
     ...
     * interface.
     **/
    protected abstract Object createJvmMemoryMBean(String groupName, String groupOid, ObjectName groupObjname,
        MBeanServer server);
    ...
    protected void initJvmClassLoading(MBeanServer server) throws Exception {
        ...
        ObjectName objname = null;
        if (server != null) {
            objname = getGroupObjectName("JvmClassLoading", oid,
                mibName + ":name=sun.management.snmp.jvmmib.JvmClassLoading");
        }
        ...
        if (meta != null) {
            ...
            // interface.
            //
            final JvmClassLoadingMBean group = (JvmClassLoadingMBean) createJvmClassLoadingMBean("JvmClassLoading", oid,
                objname, server);
            meta.setInstance(group);
     ...
     **/
    protected JvmClassLoadingMeta createJvmClassLoadingMetaNode(String groupName, String groupOid,
        ObjectName groupObjname, MBeanServer server) {
     ...
     * interface.
     **/
    protected abstract Object createJvmClassLoadingMBean(String groupName, String groupOid, ObjectName groupObjname,
        MBeanServer server);
