...
public class JvmMemGCTableMeta extends SnmpMibTable implements Serializable {
     ...
     **/
    protected JvmMemGCEntryMeta createJvmMemGCEntryMetaNode(String snmpEntryName, String tableName, SnmpMib mib,
        MBeanServer server) {
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname, Object entry) throws SnmpStatusException {
        if (!(entry instanceof JvmMemGCEntryMBean)) {
            throw new ClassCastException(
                "Entries for Table \"" + "JvmMemGCTable" + "\" must implement the \"" + "JvmMemGCEntryMBean" +
                    "\" interface.");
        }
