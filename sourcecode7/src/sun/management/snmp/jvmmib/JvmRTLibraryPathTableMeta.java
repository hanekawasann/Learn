...
public class JvmRTLibraryPathTableMeta extends SnmpMibTable implements Serializable {
     ...
     **/
    protected JvmRTLibraryPathEntryMeta createJvmRTLibraryPathEntryMetaNode(String snmpEntryName, String tableName,
    ...
    public void createNewEntry(SnmpMibSubRequest req, SnmpOid rowOid, int depth) throws SnmpStatusException {
        if (factory != null) { factory.createNewEntry(req, rowOid, depth, this); } else {
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname, Object entry) throws SnmpStatusException {
        if (!(entry instanceof JvmRTLibraryPathEntryMBean)) {
            throw new ClassCastException("Entries for Table \"" + "JvmRTLibraryPathTable" + "\" must implement the \"" +
