...
public class JvmRTInputArgsTableMeta extends SnmpMibTable implements Serializable {
     ...
     **/
    protected JvmRTInputArgsEntryMeta createJvmRTInputArgsEntryMetaNode(String snmpEntryName, String tableName,
    ...
    public synchronized void addEntry(SnmpOid rowOid, ObjectName objname, Object entry) throws SnmpStatusException {
        if (!(entry instanceof JvmRTInputArgsEntryMBean)) {
            throw new ClassCastException("Entries for Table \"" + "JvmRTInputArgsTable" + "\" must implement the \"" +
