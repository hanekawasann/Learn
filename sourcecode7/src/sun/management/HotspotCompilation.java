...
class HotspotCompilation implements HotspotCompilationMBean {
    ...
    private static final String CI_COUNTER_NAME_PATTERN = JAVA_CI + "|" + COM_SUN_CI + "|" + SUN_CI;
    ...
    private class CompilerThreadInfo {
        ...
        CompilerThreadStat getCompilerThreadStat() {
            MethodInfo minfo = new MethodInfo(method.stringValue(), (int) type.longValue(), -1);
            return new CompilerThreadStat(name, compiles.longValue(), time.longValue(), minfo);
        }
    }
