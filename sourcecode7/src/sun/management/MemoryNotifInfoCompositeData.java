...
public class MemoryNotifInfoCompositeData extends LazyCompositeData {
    ...
    protected CompositeData getCompositeData() {
        ...
        final Object[] memoryNotifInfoItemValues = { memoryNotifInfo.getPoolName(),
            MemoryUsageCompositeData.toCompositeData(memoryNotifInfo.getUsage()),
            new Long(memoryNotifInfo.getCount()), };

        try {
            return new CompositeDataSupport(memoryNotifInfoCompositeType, memoryNotifInfoItemNames,
    ...
    private static final String[] memoryNotifInfoItemNames = { POOL_NAME, USAGE, COUNT, };
    ...
    public static String getPoolName(CompositeData cd) {
        ...
        if (poolname == null) {
            throw new IllegalArgumentException(
                "Invalid composite data: " + "Attribute " + POOL_NAME + " has null value");
        }
        return poolname;
    }
