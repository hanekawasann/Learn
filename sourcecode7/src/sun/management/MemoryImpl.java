...
class MemoryImpl extends NotificationEmitterSupport implements MemoryMXBean {
    ...
    private final static String[] notifTypes = { MemoryNotificationInfo.MEMORY_THRESHOLD_EXCEEDED,
        MemoryNotificationInfo.MEMORY_COLLECTION_THRESHOLD_EXCEEDED };
    private final static String[] notifMsgs = { "Memory usage exceeds usage threshold",
    ...
    public MBeanNotificationInfo[] getNotificationInfo() {
        synchronized (this) {
            if (notifInfo == null) {
                ...
                notifInfo[0] = new MBeanNotificationInfo(notifTypes, notifName, "Memory Notification");
            }
        }
        return notifInfo;
    }
