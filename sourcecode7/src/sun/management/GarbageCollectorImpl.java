...
class GarbageCollectorImpl extends MemoryManagerImpl implements GarbageCollectorMXBean {
    ...
    synchronized String[] getAllPoolNames() {
        if (poolNames == null) {
            ...
            int i = 0;
            for (ListIterator iter = pools.listIterator(); iter.hasNext(); i++) {
    ...
    private final static String[] gcNotifTypes = { GarbageCollectionNotificationInfo.GARBAGE_COLLECTION_NOTIFICATION };
    ...
    public MBeanNotificationInfo[] getNotificationInfo() {
        synchronized (this) {
            if (notifInfo == null) {
                ...
                notifInfo[0] = new MBeanNotificationInfo(gcNotifTypes, notifName, "GC Notification");
            }
        }
        return notifInfo;
    }
    ...
    void createGCNotification(long timestamp, String gcName, String gcAction, String gcCause, GcInfo gcInfo) {
        ...
        Notification notif = new Notification(GarbageCollectionNotificationInfo.GARBAGE_COLLECTION_NOTIFICATION,
            getObjectName(), getNextSeqNumber(), timestamp, gcName);
        GarbageCollectionNotificationInfo info = new GarbageCollectionNotificationInfo(gcName, gcAction, gcCause,
            gcInfo);
    ...
    native void setNotificationEnabled(GarbageCollectorMXBean gc, boolean enabled);
