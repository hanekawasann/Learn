...
public class MethodTypeSignature implements Signature {
    ...
    private MethodTypeSignature(FormalTypeParameter[] ftps, TypeSignature[] pts, ReturnType rt,
    ...
    public static MethodTypeSignature make(FormalTypeParameter[] ftps, TypeSignature[] pts, ReturnType rt,
        FieldTypeSignature[] ets) {
