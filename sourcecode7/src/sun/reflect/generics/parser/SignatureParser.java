...
public class SignatureParser {
    ...
    private ClassSignature parseClassSignature() {
        ...
        return ClassSignature
            .make(parseZeroOrMoreFormalTypeParameters(), parseClassTypeSignature(), parseSuperInterfaces());
    }

    private FormalTypeParameter[] parseZeroOrMoreFormalTypeParameters() {
        if (current() == '<') { return parseFormalTypeParameters();} else {return new FormalTypeParameter[0];}
    }


    private FormalTypeParameter[] parseFormalTypeParameters() {
        Collection<FormalTypeParameter> ftps = new ArrayList<FormalTypeParameter>(3);
    ...
    private ClassTypeSignature parseClassTypeSignature() {
        ...
        advance();
        List<SimpleClassTypeSignature> scts = new ArrayList<SimpleClassTypeSignature>(5);
    ...
    private TypeArgument[] parseTypeArgumentsOpt() {
        if (current() == '<') {return parseTypeArguments();} else {return new TypeArgument[0];}
    }
    ...
    private FieldTypeSignature[] parseZeroOrMoreBounds() {
        Collection<FieldTypeSignature> fts = new ArrayList<FieldTypeSignature>(3);
    ...
    private ClassTypeSignature[] parseSuperInterfaces() {
        Collection<ClassTypeSignature> cts = new ArrayList<ClassTypeSignature>(5);
        while (current() == 'L') {
    ...
    private MethodTypeSignature parseMethodTypeSignature() {
        ...
        return MethodTypeSignature
            .make(parseZeroOrMoreFormalTypeParameters(), parseFormalParameters(), parseReturnType(),
    ...
    private FieldTypeSignature[] parseZeroOrMoreThrowsSignatures() {
        Collection<FieldTypeSignature> ets = new ArrayList<FieldTypeSignature>(3);
        while (current() == '^') {
