...
class Activation {
    ...
    Activation(String moduleName, DTraceProvider[] providers) {
        ...
        resource = new SystemResource(this, JVM.activate(moduleName, providers));
    }
...
class SystemResource extends WeakReference<Activation> {
    ...
    private static ReferenceQueue<Activation> referenceQueue = referenceQueue = new ReferenceQueue<Activation>();
