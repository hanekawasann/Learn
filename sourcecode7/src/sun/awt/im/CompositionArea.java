...
public final class CompositionArea extends JPanel implements InputMethodListener {
    ...
    CompositionArea() {
        ...
        compositionWindow
            .setLocation(screenSize.width - windowSize.width - 20, screenSize.height - windowSize.height - 100);
    ...
    private Rectangle getCaretRectangle(TextHitInfo caret) {
        ...
        return new Rectangle(TEXT_ORIGIN_X + caretLocation, TEXT_ORIGIN_Y - metrics.getAscent(), 0,
