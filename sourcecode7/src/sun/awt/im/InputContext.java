...
public class InputContext extends java.awt.im.InputContext implements ComponentListener, WindowListener {
    ...
    public void dispatchEvent(AWTEvent event) {
        ...
        if (event instanceof FocusEvent) {
            ...
            if ((opposite != null) && (getComponentWindow(opposite) instanceof InputMethodWindow) &&
    ...
    private void logCreationFailed(Throwable throwable) {
        String errorTextFormat = Toolkit
            .getProperty("AWT.InputMethodCreationFailed", "Could not create {0}. Reason: {1}");
        Object[] args = { inputMethodLocator.getDescriptor().getInputMethodDisplayName(null, Locale.getDefault()),
