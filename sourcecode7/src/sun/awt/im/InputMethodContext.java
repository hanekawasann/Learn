...
public class InputMethodContext extends sun.awt.im.InputContext implements java.awt.im.spi.InputMethodContext {
    ...
    static {
        ...
        String inputStyle = (String) AccessController.doPrivileged(new GetPropertyAction("java.awt.im.style", null));
    ...
    public void dispatchInputMethodEvent(int id, AttributedCharacterIterator text, int committedCharacterCount,
        ...
        if (source != null) {
            InputMethodEvent event = new InputMethodEvent(source, id, text, committedCharacterCount, caret,
                visiblePosition);
     ...
     */
    synchronized void dispatchCommittedText(Component client, AttributedCharacterIterator text,
        ...
        try {
            ...
            if (req != null) {
                ...
                AttributedCharacterIterator toBeCommitted = (new AttributedString(text, beginIndex,
                    beginIndex + committedCharacterCount)).getIterator();

                InputMethodEvent inputEvent = new InputMethodEvent(client, InputMethodEvent.INPUT_METHOD_TEXT_CHANGED,
                    toBeCommitted, committedCharacterCount, null, null);
                ...
                while (committedCharacterCount-- > 0 && keyChar != CharacterIterator.DONE) {
                    KeyEvent keyEvent = new KeyEvent(client, KeyEvent.KEY_TYPED, time, 0, KeyEvent.VK_UNDEFINED,
                        keyChar);
