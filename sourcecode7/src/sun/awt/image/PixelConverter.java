...
public class PixelConverter {
    ...
    public static class Ushort565Rgb extends PixelConverter {
        ...
        public int rgbToPixel(int rgb, ColorModel cm) {
            return (((rgb >> (16 + 3 - 11)) & 0xf800) | ((rgb >> (8 + 2 - 5)) & 0x07e0) |
                ((rgb >> (0 + 3 - 0)) & 0x001f));
        }
    ...
    public static class Ushort555Rgbx extends PixelConverter {
        ...
        public int rgbToPixel(int rgb, ColorModel cm) {
            return (((rgb >> (16 + 3 - 11)) & 0xf800) | ((rgb >> (8 + 3 - 6)) & 0x07c0) |
                ((rgb >> (0 + 3 - 1)) & 0x003e));
        }
    ...
    public static class Ushort555Rgb extends PixelConverter {
        ...
        public int rgbToPixel(int rgb, ColorModel cm) {
            return (((rgb >> (16 + 3 - 10)) & 0x7c00) | ((rgb >> (8 + 3 - 5)) & 0x03e0) |
                ((rgb >> (0 + 3 - 0)) & 0x001f));
        }
    ...
    public static class ByteGray extends PixelConverter {
        ...
        public int rgbToPixel(int rgb, ColorModel cm) {
            ...
            int grn = (rgb >> 8) & 0xff;
            int blu = (rgb) & 0xff;
            return (int) (red * RED_MULT + grn * GRN_MULT + blu * BLU_MULT + 0.5);
        }
    ...
    public static class UshortGray extends ByteGray {
        ...
        public int rgbToPixel(int rgb, ColorModel cm) {
            ...
            int grn = (rgb >> 8) & 0xff;
            int blu = (rgb) & 0xff;
            return (int) (red * USHORT_RED_MULT + grn * USHORT_GRN_MULT + blu * USHORT_BLU_MULT + 0.5);
        }
