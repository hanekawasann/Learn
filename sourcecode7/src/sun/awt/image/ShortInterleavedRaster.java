...
public class ShortInterleavedRaster extends ShortComponentRaster {
     ...
     */
    public ShortInterleavedRaster(SampleModel sampleModel, DataBuffer dataBuffer, Rectangle aRegion, Point origin,
        ...
        if ((sampleModel instanceof PixelInterleavedSampleModel) ||
            ...
            throw new RasterFormatException(
                "ShortInterleavedRasters must " + "have PixelInterleavedSampleModel, SinglePixelPackedSampleModel" +
                    " or 1 band ComponentSampleModel.  Sample model is " + sampleModel);
        }
    ...
    public WritableRaster createWritableChild(int x, int y, int width, int height, int x0, int y0, int[] bandList) {
        ...
        return new ShortInterleavedRaster(sm, dataBuffer, new Rectangle(x0, y0, width, height),
    ...
    public String toString() {
        return new String("ShortInterleavedRaster: width = " + width + " height = " + height + " #numDataElements " +
            numDataElements);
