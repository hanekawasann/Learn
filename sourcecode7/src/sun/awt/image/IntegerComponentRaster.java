...
public class IntegerComponentRaster extends SunWritableRaster {
     ...
     */
    public IntegerComponentRaster(SampleModel sampleModel, DataBuffer dataBuffer, Rectangle aRegion, Point origin,
    ...
    private void setDataElements(int dstX, int dstY, int width, int height, Raster inRaster) {
        ...
        if (inRaster instanceof IntegerComponentRaster && (pixelStride == 1) && (numDataElements == 1)) {
    ...
    public WritableRaster createWritableChild(int x, int y, int width, int height, int x0, int y0, int bandList[]) {
        ...
        return new IntegerComponentRaster(sm, dataBuffer, new Rectangle(x0, y0, width, height),
    ...
    private void verify(boolean strictCheck) {
        ...
        if (data.length < maxSize) {
            throw new RasterFormatException(
                "Data array too small (should be " + maxSize + " but is " + data.length + " )");
        }
    }

    public String toString() {
        return new String("IntegerComponentRaster: width = " + width + " height = " + height + " #Bands = " + numBands +
            " #DataElements " + numDataElements + " xOff = " + sampleModelTranslateX + " yOff = " +
            sampleModelTranslateY + " dataOffset[0] " + dataOffsets[0]);
    }
