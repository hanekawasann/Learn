...
public class JPEGImageDecoder extends ImageDecoder {
    ...
    static {
        java.security.AccessController.doPrivileged(new sun.security.action.LoadLibraryAction("jpeg"));
    ...
    private native void readImage(InputStream is, byte buf[]) throws ImageFormatException, IOException;
     ...
     */
    private static final int hintflags = ImageConsumer.TOPDOWNLEFTRIGHT | ImageConsumer.COMPLETESCANLINES |
