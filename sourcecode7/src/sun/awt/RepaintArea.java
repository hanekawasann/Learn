...
public class RepaintArea {
    ...
    public void paint(Object target, boolean shouldClearRectBeforePaint) {
        ...
        if (ra.paintRects[HORIZONTAL] != null && ra.paintRects[VERTICAL] != null) {
            ...
            int benefit = square - ra.paintRects[HORIZONTAL].width * ra.paintRects[HORIZONTAL].height -
                ra.paintRects[VERTICAL].width * ra.paintRects[VERTICAL].height;
                    ...
                    try {
                        ...
                        if (i == UPDATE) {
                            ...
                            if (shouldClearRectBeforePaint) {
                                g.clearRect(ra.paintRects[i].x, ra.paintRects[i].y, ra.paintRects[i].width,
    ...
    public String toString() {
        return super.toString() + "[ horizontal=" + paintRects[0] + " vertical=" + paintRects[1] + " update=" +
            paintRects[2] + "]";
    }
}
