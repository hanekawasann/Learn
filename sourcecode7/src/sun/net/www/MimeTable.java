...
public class MimeTable implements FileNameMap {
    ...
    static {
        java.security.AccessController.doPrivileged(new java.security.PrivilegedAction<Void>() {
            public Void run() {
                ...
                mailcapLocations = new String[] { System.getProperty("user.mailcap"),
                    System.getProperty("user.home") + "/.mailcap", "/etc/mailcap", "/usr/etc/mailcap",
        ...
        try {
            ...
            if (userTablePath != null) {
                ...
                if (!file.exists()) {
                    ...
                    file = new File(System.getProperty("java.home") + File.separator + "lib" + File.separator +
    ...
    public synchronized boolean save(String filename) {
        if (filename == null) {
            filename = System
                .getProperty("user.home" + File.separator + "lib" + File.separator + "content-types.properties");
        }
