...
abstract public class URLConnection extends java.net.URLConnection {
    ...
    public void setRequestProperty(String key, String value) {
        if (connected) { throw new IllegalAccessError("Already connected"); }
    ...
    public String getContentType() {
        if (contentType == null) { contentType = getHeaderField("content-type"); }
        if (contentType == null) {
            String ct = null;
            try {
            ...
            if (ct == null) {
                ...
                if (ct == null) {
                    if (url.getFile().endsWith("/")) { ct = "text/html"; } else {
            ...
            if (ct == null || ce != null &&
                !(ce.equalsIgnoreCase("7bit") || ce.equalsIgnoreCase("8bit") || ce.equalsIgnoreCase("binary"))) {
                ct = "content/unknown";
            }
            setContentType(ct);
        }
