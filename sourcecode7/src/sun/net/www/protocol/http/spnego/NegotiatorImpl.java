...
public class NegotiatorImpl extends Negotiator {
    ...
    private static final boolean DEBUG = java.security.AccessController
    ...
    public NegotiatorImpl(HttpCallerInfo hci) throws IOException {
        try {
            ...
            if (DEBUG) {
                System.out
                    .println("Negotiate support not initiated, will " + "fallback to other scheme if allowed. Reason:");
                e.printStackTrace();
            }
