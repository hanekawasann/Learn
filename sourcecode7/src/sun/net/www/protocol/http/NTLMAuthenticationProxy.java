...
class NTLMAuthenticationProxy {
    ...
    private static NTLMAuthenticationProxy tryLoadNTLMAuthentication() {
        ...
        try {
            ...
            if (cl != null) {
                threeArg = cl.getConstructor(boolean.class, URL.class, PasswordAuthentication.class);
                fiveArg = cl.getConstructor(boolean.class, String.class, int.class, PasswordAuthentication.class);
