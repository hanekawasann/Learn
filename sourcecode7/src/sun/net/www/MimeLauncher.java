...
class MimeLauncher extends Thread {
    ...
    MimeLauncher(MimeEntry M, java.net.URLConnection uc, InputStream is, String tempFileTemplate, String threadName)
    ...
    private boolean findExecutablePath(String str) {
        ...
        String execPathList;
        execPathList = java.security.AccessController
            .doPrivileged(new sun.security.action.GetPropertyAction("exec.path"));
