...
public class FilePane extends JPanel implements PropertyChangeListener {
    ...
    private final KeyListener detailsKeyListener = new KeyAdapter() {
        ...
        public void keyTyped(KeyEvent e) {
            ...
            if (index >= 0) {
                ...
                Rectangle cellRect = detailsTable
                    .getCellRect(index, detailsTable.convertColumnIndexToView(COLUMN_FILENAME), false);
     ...
     */
    private class SortableListModel extends AbstractListModel implements TableModelListener, RowSorterListener {
                    ...
                    if (!newDisplayName.equals(oldDisplayName)) {
                        ...
                        if (f2.exists()) {
                            ...
                            if (FilePane.this.getModel().renameFile(f, f2)) {
                                ...
                                JOptionPane
                                    .showMessageDialog(chooser, MessageFormat.format(renameErrorText, oldFileName),
    ...
    class DetailsTableCellRenderer extends DefaultTableCellRenderer {
        ...
        public void setBounds(int x, int y, int width, int height) {
            if (getHorizontalAlignment() == SwingConstants.LEADING && !fullRowSelection) {
    ...
    private class Handler implements MouseListener {
        ...
        public void mouseClicked(MouseEvent evt) {
            ...
            if (source instanceof JList) {
                ...
                boolean pointOutsidePrefSize = SwingUtilities2
                    .pointOutsidePrefSize(table, index, table.columnAtPoint(p), p);
                ...
                if (index >= 0 && list != null && listSelectionModel.isSelectedIndex(index)) {
                    ...
                    evt = new MouseEvent(list, evt.getID(), evt.getWhen(), evt.getModifiers(), r.x + 1,
                        r.y + r.height / 2, evt.getXOnScreen(), evt.getYOnScreen(), evt.getClickCount(),
            ...
            if (index >= 0 && SwingUtilities.isLeftMouseButton(evt)) {
                ...
                if (evt.getClickCount() == 1 && source instanceof JList) {
                    if ((!fc.isMultiSelectionEnabled() || fc.getSelectedFiles().length <= 1) && index >= 0 &&
