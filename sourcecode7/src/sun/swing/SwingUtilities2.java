...
public class SwingUtilities2 {
    ...
    public static class AATextInfo {
        ...
        private static AATextInfo getAATextInfoFromMap(Map hints) {
            ...
            if (aaHint == null || aaHint == VALUE_TEXT_ANTIALIAS_OFF || aaHint == VALUE_TEXT_ANTIALIAS_DEFAULT) {
                return null;
            } else {
        ...
        public AATextInfo(Object aaHint, Integer lcdContrastHint) {
            ...
            if (aaHint == VALUE_TEXT_ANTIALIAS_OFF || aaHint == VALUE_TEXT_ANTIALIAS_DEFAULT) {
                throw new InternalError("AA must be on");
            }
            this.aaHint = aaHint;
            this.lcdContrastHint = lcdContrastHint;
            this.frc = new FontRenderContext(null, aaHint, VALUE_FRACTIONALMETRICS_DEFAULT);
        }
    }
        ...
        if (isPrinting(g)) {
            ...
            if (g2d != null) {
                ...
                if (frc != null && !isFontRenderContextPrintCompatible(deviceFontRenderContext, frc)) {
                    TextLayout layout = createTextLayout(c, new String(data, offset, length), g2d.getFont(),
        ...
        public int getLeftSideBearing(char aChar) {
            ...
            if (lsb == UNSET) {
                ...
                if (lsb < 0) {
                    ...
                    if (aaHint == VALUE_TEXT_ANTIALIAS_LCD_HRGB || aaHint == VALUE_TEXT_ANTIALIAS_LCD_HBGR) {
                        lsb++;
                    }
                }
                lsbCache[index] = lsb;
    ...
    private static boolean isTrustedContext() {
        return (System.getSecurityManager() == null) || (AppContext.getAppContext().
