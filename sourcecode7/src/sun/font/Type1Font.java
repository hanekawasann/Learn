...
public class Type1Font extends FileFont {
    ...
    static {
        ...
        String nm[] = { "Black", "Bold", "Book", "Demi", "Heavy", "Light", "Meduium", "Nord", "Poster", "Regular",
            "Super", "Thin", "Compressed", "Condensed", "Compact", "Extended", "Narrow", "Inclined", "Italic", "Kursiv",
            "Oblique", "Upright", "Sloped", "Semi", "Ultra", "Extra", "Alternate", "Alternate", "Deutsche Fraktur",
            "Expert", "Inline", "Ornaments", "Outline", "Roman", "Rounded", "Script", "Shaded", "Swash", "Titling",
            "Typewriter" };
        String abbrv[] = { "Blk", "Bd", "Bk", "Dm", "Hv", "Lt", "Md", "Nd", "Po", "Rg", "Su", "Th", "Cm", "Cn", "Ct",
            "Ex", "Nr", "Ic", "It", "Ks", "Obl", "Up", "Sl", "Sm", "Ult", "X", "A", "Alt", "Dfr", "Exp", "In", "Or",
       ...
       /* This is only subset of names from nm[] because we want to distinguish things
        ...
        String styleTokens[] = { "Black", "Bold", "Book", "Demi", "Heavy", "Light", "Medium", "Nord", "Poster",
            "Regular", "Super", "Thin", "Compressed", "Condensed", "Compact", "Extended", "Narrow", "Inclined",
            "Italic", "Kursiv", "Oblique", "Upright", "Sloped", "Slanted", "Semi", "Ultra", "Extra" };
    ...
    private String fullName2FamilyName(String name) {
        ...
        while (end > 0) {
            start = end - 1;
            while (start > 0 && name.charAt(start) != ' ') { start--; }
    ...
    private String expandAbbreviation(String abbr) {
        if (styleAbbreviationsMapping.containsKey(abbr)) { return (String) styleAbbreviationsMapping.get(abbr); }
        return abbr;
    }
    ...
    private int nextCapitalLetter(String s, int off) {
        for (; (off >= 0) && off < s.length(); off++) {
            if (s.charAt(off) >= 'A' && s.charAt(off) <= 'Z') { return off; }
        }
        return -1;
    }
    ...
    public String toString() {
        return "** Type1 Font: Family=" + familyName + " Name=" + fullName + " style=" + style + " fileName=" +
            getPublicFileName();
    }
}
