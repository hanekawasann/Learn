...
public abstract class FontStrike {
    ...
    abstract void getGlyphImageBounds(int glyphcode, Point2D.Float pt, Rectangle result);
    ...
    abstract GeneralPath getGlyphVectorOutline(int[] glyphs, float x, float y);
