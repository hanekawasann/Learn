...
public class FontStrikeDesc {
    ...
    public boolean equals(Object obj) {
        try {
            ...
            return (desc.valuemask == this.valuemask && desc.glyphTx.equals(this.glyphTx) &&
    ...
    public static int getAAHintIntVal(Object aa, Font2D font2D, int ptSize) {
        if (aa == VALUE_TEXT_ANTIALIAS_OFF || aa == VALUE_TEXT_ANTIALIAS_DEFAULT) {
        ...
        } else if (aa == VALUE_TEXT_ANTIALIAS_LCD_HRGB || aa == VALUE_TEXT_ANTIALIAS_LCD_HBGR) {
            return INTVAL_TEXT_ANTIALIAS_LCD_HRGB;
        } else if (aa == VALUE_TEXT_ANTIALIAS_LCD_VRGB || aa == VALUE_TEXT_ANTIALIAS_LCD_VBGR) {
    ...
    public static int getFMHintIntVal(Object fm) {
        if (fm == VALUE_FRACTIONALMETRICS_OFF || fm == VALUE_FRACTIONALMETRICS_DEFAULT) {
    ...
    public String toString() {
        return "FontStrikeDesc: Style=" + style + " AA=" + aaHint + " FM=" + fmHint + " devTx=" + devTx +
            " devTx.FontTx.ptSize=" + glyphTx;
    }
}
