...
public final class CGIHandler {
    ...
    private static CGICommandHandler commands[] = { new CGIForwardCommand(), new CGIGethostnameCommand(),
    ...
    public static void main(String args[]) {
        try {
            ...
            } else { returnClientError("invalid command: " + command); }
        } catch (Exception e) {
...
final class CGIForwardCommand implements CGICommandHandler {
    ...
    public void execute(String param) throws CGIClientException, CGIServerException {
        ...
        if (port <= 0 || port > 0xFFFF) { throw new CGIClientException("invalid port: " + port); }
        if (port < 1024) { throw new CGIClientException("permission denied for port: " + port); }
        ...
        do {
            ...
            if (line == null) { throw new CGIServerException("unexpected EOF reading server response"); }
