...
public class RMIMasterSocketFactory extends RMISocketFactory {
    ...
    public RMIMasterSocketFactory() {
        ...
        try {
            String proxyHost;
            proxyHost = java.security.AccessController
                .doPrivileged(new sun.security.action.GetPropertyAction("http.proxyHost"));

            if (proxyHost == null) {
                proxyHost = java.security.AccessController
                    .doPrivileged(new sun.security.action.GetPropertyAction("proxyHost"));
            }

            Boolean tmp = java.security.AccessController
                .doPrivileged(new sun.security.action.GetBooleanAction("java.rmi.server.disableHttp"));
