...
final class ConnectionMultiplexer {
    ...
    private static String getLogLevel() {
        return java.security.AccessController
            .doPrivileged(new sun.security.action.GetPropertyAction("sun.rmi.transport.tcp.multiplex.logLevel"));
    }

    /* multiplex system log */
    static final Log multiplexLog = Log
        .getLog("sun.rmi.transport.tcp.multiplex", "multiplex", ConnectionMultiplexer.logLevel);
            ...
            while (true) {
                ...
                switch (op) {
                    ...
                    case OPEN:
                        ...
                        info = (MultiplexConnectionInfo) connectionTable.get(idObj);
    ...
    public synchronized TCPConnection openConnection() throws IOException {
        ...
        synchronized (connectionTable) {
            ...
            if (numConnections >= maxConnections) {
                throw new IOException("Cannot exceed " + maxConnections + " simultaneous multiplexed connections");
            }
            connectionTable.put(idObj, info);
            ++numConnections;
        }
    ...
    public void shutDown() {
        ...
        synchronized (connectionTable) {
            ...
            while (enum_.hasMoreElements()) {
                MultiplexConnectionInfo info = (MultiplexConnectionInfo) enum_.nextElement();
                info.in.disconnect();
                info.out.disconnect();
            }
