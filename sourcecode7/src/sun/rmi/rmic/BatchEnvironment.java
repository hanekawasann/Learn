...
public class BatchEnvironment extends sun.tools.javac.BatchEnvironment {
    ...
    public String errorString(String err, Object arg0, Object arg1, Object arg2) {
        if (err.startsWith("rmic.") || err.startsWith("warn.rmic.")) {
            String result = Main
                .getText(err, (arg0 != null ? arg0.toString() : null), (arg1 != null ? arg1.toString() : null),
    ...
    private static class Path extends LinkedHashSet<String> {
            ...
            public Iterator<String> iterator() {
                return new Iterator<String>() {
                    ...
                    public String next() {
                        ...
                        if (beg == end && emptyPathDefault != null) { return emptyPathDefault; } else {
        ...
        public Path addDirectories(String dirs, boolean warn) {
            if (dirs != null) { for (String dir : new PathIterator(dirs)) { addDirectory(dir, warn); } }
            return this;
        }
        ...
        public Path addFiles(String files, boolean warn) {
            if (files != null) {
                for (String file : new PathIterator(files, emptyPathDefault)) { addFile(file, warn); }
            }
            return this;
        }
            ...
            try {
                ...
                try {
                    ...
                    for (StringTokenizer st = new StringTokenizer(path); st.hasMoreTokens(); ) {
                        ...
                        if (jarParent != null) { elt = new File(jarParent, elt).getCanonicalPath(); }
                        addFile(elt, warn);
                    }
                } finally {
                    jar.close();
