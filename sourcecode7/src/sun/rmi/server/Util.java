...
public final class Util {
    ...
    static final int logLevel = LogStream
        .parseLevel(AccessController.doPrivileged(new GetPropertyAction("sun.rmi.server.logLevel")));
    ...
    private static final boolean ignoreStubClasses = AccessController
        .doPrivileged(new GetBooleanAction("java.rmi.server.ignoreStubClasses")).
            booleanValue();

    /** cache of  impl classes that have no corresponding stub class */
    private static final Map<Class<?>, Void> withoutStubs = Collections
        .synchronizedMap(new WeakHashMap<Class<?>, Void>(11));
    ...
    static Skeleton createSkeleton(Remote object) throws SkeletonNotFoundException {
        ...
        try {
            ...
            throw new SkeletonNotFoundException(
                "object does not implement a remote interface: " + object.getClass().getName());
        }
