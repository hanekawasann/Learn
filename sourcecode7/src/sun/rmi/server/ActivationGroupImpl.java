...
public class ActivationGroupImpl extends ActivationGroup {
     ...
     */
    public MarshalledObject<? extends Remote> newInstance(final ActivationID id, final ActivationDesc desc)
        ...
        try {
            ...
            final Class<? extends Remote> cl = RMIClassLoader.loadClass(desc.getLocation(), className)
            ...
            try {
                ...
                impl = AccessController.doPrivileged(new PrivilegedExceptionAction<Remote>() {
                    public Remote run() throws InstantiationException, NoSuchMethodException, IllegalAccessException,
                        InvocationTargetException {
                        Constructor<? extends Remote> constructor = cl
                            .getDeclaredConstructor(ActivationID.class, MarshalledObject.class);
