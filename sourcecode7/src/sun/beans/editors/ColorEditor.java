...
public class ColorEditor extends Panel implements PropertyEditor {
    ...
    private String colorNames[] = { " ", "white", "lightGray", "gray", "darkGray", "black", "red", "pink", "orange",
        "yellow", "green", "magenta", "cyan", "blue" };
    private Color colors[] = { null, Color.white, Color.lightGray, Color.gray, Color.darkGray, Color.black, Color.red,
