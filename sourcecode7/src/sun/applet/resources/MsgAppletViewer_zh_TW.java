...
public class MsgAppletViewer_zh_TW extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        Object[][] temp = new Object[][] { { "textframe.button.dismiss", "\u95DC\u9589" },
            { "appletviewer.tool.title", "Applet \u6AA2\u8996\u5668: {0}" }, { "appletviewer.menu.applet", "Applet" },
            { "appletviewer.menuitem.restart", "\u91CD\u65B0\u555F\u52D5" },
            { "appletviewer.menuitem.reload", "\u91CD\u65B0\u8F09\u5165" },
            { "appletviewer.menuitem.stop", "\u505C\u6B62" }, { "appletviewer.menuitem.save", "\u5132\u5B58..." },
            { "appletviewer.menuitem.start", "\u555F\u52D5" }, { "appletviewer.menuitem.clone", "\u8907\u88FD..." },
            { "appletviewer.menuitem.tag", "\u6A19\u8A18..." }, { "appletviewer.menuitem.info", "\u8CC7\u8A0A..." },
            { "appletviewer.menuitem.edit", "\u7DE8\u8F2F" },
            { "appletviewer.menuitem.encoding", "\u5B57\u5143\u7DE8\u78BC" },
            { "appletviewer.menuitem.print", "\u5217\u5370..." }, { "appletviewer.menuitem.props", "\u5C6C\u6027..." },
            { "appletviewer.menuitem.close", "\u95DC\u9589" }, { "appletviewer.menuitem.quit", "\u7D50\u675F" },
            ...
            { "appletviewer.main.warning",
                "\u8B66\u544A: \u672A\u555F\u52D5 Applet\u3002\u8ACB\u78BA\u8A8D\u8F38\u5165\u5305\u542B <applet> \u6A19\u8A18\u3002" },
            { "appletviewer.main.warn.prop.overwrite",
                "\u8B66\u544A: \u4F9D\u7167\u4F7F\u7528\u8005\u8981\u6C42\uFF0C\u66AB\u6642\u8986\u5BEB\u7CFB\u7D71\u5C6C\u6027: \u7D22\u5F15\u9375: {0} \u820A\u503C: {1} \u65B0\u503C: {2}" },
            { "appletviewer.main.warn.cantreadprops",
                "\u8B66\u544A: \u7121\u6CD5\u8B80\u53D6 AppletViewer \u5C6C\u6027\u6A94\u6848: {0} \u4F7F\u7528\u9810\u8A2D\u503C\u3002" },
            ...
            { "appletclassloader.getresource.verbose.forname",
                "AppletClassLoader.getResource \u7684\u540D\u7A31: {0}" },
            ...
            { "appletpanel.nocreate", "\u8F09\u5165: \u7121\u6CD5\u5EFA\u7ACB {0}\u3002" }, { "appletpanel.noconstruct",
            "\u8F09\u5165: {0} \u975E\u516C\u7528\u6216\u6C92\u6709\u516C\u7528\u5EFA\u69CB\u5B50\u3002" },
            ...
            { "appletpanel.badattribute.exception",
                "HTML \u5256\u6790: \u5BEC\u5EA6/\u9AD8\u5EA6\u5C6C\u6027\u7684\u503C\u4E0D\u6B63\u78BA" },
            { "appletillegalargumentexception.objectinputstream",
                "AppletObjectInputStream \u9700\u8981\u975E\u7A7A\u503C\u8F09\u5165\u5668" },
            ...
            { "appletprops.choice.unsignedapplet.no", "\u5426" }, { "appletprops.choice.unsignedapplet.yes", "\u662F" },
            { "appletprops.button.apply", "\u5957\u7528" }, { "appletprops.button.cancel", "\u53D6\u6D88" },
            { "appletprops.button.reset", "\u91CD\u8A2D" },
            { "appletprops.apply.exception", "\u7121\u6CD5\u5132\u5B58\u5C6C\u6027: {0}" },
            /* 4066432 */
            { "appletprops.title.invalidproxy", "\u7121\u6548\u7684\u9805\u76EE" }, { "appletprops.label.invalidproxy",
            "\u4EE3\u7406\u4E3B\u6A5F\u9023\u63A5\u57E0\u5FC5\u9808\u662F\u6B63\u6574\u6578\u503C\u3002" },
