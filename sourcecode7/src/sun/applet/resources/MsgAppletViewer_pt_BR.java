...
public class MsgAppletViewer_pt_BR extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        Object[][] temp = new Object[][] { { "textframe.button.dismiss", "Rejeitar" },
            { "appletviewer.tool.title", "Visualizador do Applet: {0}" }, { "appletviewer.menu.applet", "Applet" },
            { "appletviewer.menuitem.restart", "Reiniciar" }, { "appletviewer.menuitem.reload", "Recarregar" },
            { "appletviewer.menuitem.stop", "Interromper" }, { "appletviewer.menuitem.save", "Salvar" },
            { "appletviewer.menuitem.start", "Iniciar" }, { "appletviewer.menuitem.clone", "Clonar..." },
            { "appletviewer.menuitem.tag", "Tag..." }, { "appletviewer.menuitem.info", "Informa\u00E7\u00F5es..." },
            { "appletviewer.menuitem.edit", "Editar" },
            { "appletviewer.menuitem.encoding", "Codifica\u00E7\u00E3o do Caractere" },
            { "appletviewer.menuitem.print", "Imprimir..." }, { "appletviewer.menuitem.props", "Propriedades..." },
            { "appletviewer.menuitem.close", "Fechar" }, { "appletviewer.menuitem.quit", "Sair" },
            { "appletviewer.label.hello", "Ol\u00E1..." }, { "appletviewer.status.start", "iniciando o applet..." },
            ...
            { "appletviewer.appletsave.err2", "no appletSave: {0}" }, { "appletviewer.applettag", "Tag mostrada" },
            ...
            { "appletviewer.parse.warning.requiresname",
                "Advert\u00EAncia: a tag <param name=... value=...> requer um atributo de nome." },
            { "appletviewer.parse.warning.paramoutside",
                "Advert\u00EAncia: a tag <param> externa <applet> ... </applet>." },
            ...
            { "appletviewer.main.err.prop.cantread",
                "N\u00E3o \u00E9 poss\u00EDvel ler o arquivo de propriedades do usu\u00E1rio: {0}" },
            { "appletviewer.main.err.prop.cantsave",
                "N\u00E3o \u00E9 poss\u00EDvel salvar o arquivo de propriedades do usu\u00E1rio: {0}" },
            ...
            { "appletviewer.main.debug.cantfindmain",
                "N\u00E3o \u00E9 poss\u00EDvel localizar o m\u00E9todo principal no depurador!" },
            ...
            { "appletviewer.main.warning",
                "Advert\u00EAncia: Nenhum applet iniciado. Certifique-se de que a entrada contenha uma tag <applet>." },
            { "appletviewer.main.warn.prop.overwrite",
                "Advert\u00EAncia: Substituindo a propriedade do sistema temporariamente a pedido do usu\u00E1rio: chave: {0} valor antigo: {1} valor novo: {2}" },
            { "appletviewer.main.warn.cantreadprops",
                "Advert\u00EAncia: N\u00E3o \u00E9 poss\u00EDvel ler o arquivo de propriedades AppletViewer: {0} Usando defaults." },
            ...
            { "appletpanel.destroyed", "Applet destru\u00EDdo." }, { "appletpanel.loaded", "Applet carregado." },
            { "appletpanel.started", "Applet iniciado." }, { "appletpanel.inited", "Applet inicializado." },
            { "appletpanel.stopped", "Applet interrompido." }, { "appletpanel.disposed", "Applet descartado." },
            { "appletpanel.nocode", "A tag APPLET n\u00E3o encontrou o par\u00E2metro CODE." },
            { "appletpanel.notfound", "carga: classe {0} n\u00E3o encontrada." },
            { "appletpanel.nocreate", "carga: {0} n\u00E3o pode ser instanciada." }, { "appletpanel.noconstruct",
            "carga: {0} n\u00E3o \u00E9 p\u00FAblica ou n\u00E3o tem construtor p\u00FAblico." },
            { "appletpanel.death", "eliminado" }, { "appletpanel.exception", "exce\u00E7\u00E3o: {0}." },
            { "appletpanel.exception2", "exce\u00E7\u00E3o: {0}: {1}." }, { "appletpanel.error", "erro: {0}." },
            ...
            { "appletillegalargumentexception.objectinputstream",
                "AppletObjectInputStream requer um carregador n\u00E3o nulo" },
            { "appletprops.title", "Propriedades do AppletViewer" },
            { "appletprops.label.http.server", "Servidor proxy Http:" },
            { "appletprops.label.http.proxy", "Porta proxy Http:" }, { "appletprops.label.network", "Acesso de rede:" },
            ...
            { "appletprops.choice.unsignedapplet.no", "N\u00E3o" }, { "appletprops.choice.unsignedapplet.yes", "Sim" },
            ...
            { "appletsecurityexception.checkpropsaccess.key",
                "Exce\u00E7\u00E3o de Seguran\u00E7a: acesso \u00E0s propriedades {0}" },
            ...
            { "appletsecurityexception.checkconnect.networknone",
                "Exce\u00E7\u00E3o de Seguran\u00E7a: socket.connect: {0}->{1}" },
            { "appletsecurityexception.checkconnect.networkhost1",
                "Exce\u00E7\u00E3o de Seguran\u00E7a: N\u00E3o foi poss\u00EDvel estabelecer conex\u00E3o com {0} com a origem de {1}." },
            { "appletsecurityexception.checkconnect.networkhost2",
                "Exce\u00E7\u00E3o de Seguran\u00E7a: N\u00E3o foi poss\u00EDvel resolver o IP para o host {0} ou para {1}. " },
            { "appletsecurityexception.checkconnect.networkhost3",
                "Exce\u00E7\u00E3o de Seguran\u00E7a: N\u00E3o foi poss\u00EDvel resolver o IP para o host {0}. Consulte a propriedade trustProxy." },
            { "appletsecurityexception.checkconnect", "Exce\u00E7\u00E3o de Seguran\u00E7a: conectar: {0}->{1}" },
            { "appletsecurityexception.checkpackageaccess",
                "Exce\u00E7\u00E3o de Seguran\u00E7a: n\u00E3o \u00E9 poss\u00EDvel acessar o pacote: {0}" },
            { "appletsecurityexception.checkpackagedefinition",
                "Exce\u00E7\u00E3o de Seguran\u00E7a: n\u00E3o \u00E9 poss\u00EDvel definir o pacote: {0}" },
            { "appletsecurityexception.cannotsetfactory",
                "Exce\u00E7\u00E3o de Seguran\u00E7a: n\u00E3o \u00E9 poss\u00EDvel definir o factory" },
            { "appletsecurityexception.checkmemberaccess",
                "Exce\u00E7\u00E3o de Seguran\u00E7a: verificar acesso do membro" },
            ...
            { "appletsecurityexception.checksystemclipboardaccess",
                "Exce\u00E7\u00E3o de Seguran\u00E7a: getSystemClipboard" },
            { "appletsecurityexception.checkawteventqueueaccess",
                "Exce\u00E7\u00E3o de Seguran\u00E7a: getEventQueue" }, { "appletsecurityexception.checksecurityaccess",
            "Exce\u00E7\u00E3o de Seguran\u00E7a: opera\u00E7\u00E3o de seguran\u00E7a: {0}" },
            { "appletsecurityexception.getsecuritycontext.unknown",
                "tipo de carregador de classe desconhecido. n\u00E3o \u00E9 poss\u00EDvel verificar getContext" },
            { "appletsecurityexception.checkread.unknown",
                "tipo de carregador de classe desconhecido. n\u00E3o \u00E9 poss\u00EDvel verificar a leitura {0}" },
            { "appletsecurityexception.checkconnect.unknown",
                "tipo de carregador de classe desconhecido. n\u00E3o \u00E9 poss\u00EDvel verificar a conex\u00E3o" }, };
