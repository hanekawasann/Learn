...
abstract public class CallSite {
    ...
    /*package-private*/ MethodHandle target;    // Note: This field is known to the JVM.  Do not change.
    ...
    void checkTargetChange(MethodHandle oldTarget, MethodHandle newTarget) {
        ...
        if (!newType.equals(oldType)) { throw wrongTargetType(newTarget, oldType); }
    }

    private static WrongMethodTypeException wrongTargetType(MethodHandle target, MethodType type) {
        return new WrongMethodTypeException(target + " should be of type " + type);
    }
    ...
    static CallSite makeSite(MethodHandle bootstrapMethod,
        ...
        try {
            ...
            if (info == null) {
                ...
                switch (argv.length) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        binding = bootstrapMethod
                            .invoke(caller, name, type, argv[0], argv[1], argv[2], argv[3], argv[4]);
                        break;
                    case 6:
                        binding = bootstrapMethod
                            .invoke(caller, name, type, argv[0], argv[1], argv[2], argv[3], argv[4], argv[5]);
                        break;
                    default:
            ...
            if (ex instanceof BootstrapMethodError) { bex = (BootstrapMethodError) ex; } else {
