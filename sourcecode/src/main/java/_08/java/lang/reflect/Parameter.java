...
public final class Parameter implements AnnotatedElement {
    ...
    public String toString() {
        ...
        if (0 != modifiers) { sb.append(' '); }

        if (isVarArgs()) { sb.append(typename.replaceFirst("\\[\\]$", "...")); } else { sb.append(typename); }
    ...
    public String getName() {
        ...
        if (name == null || name.equals("")) { return "arg" + index; } else { return name; }
    }
