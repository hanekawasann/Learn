...
public class RMIClassLoader {
    ...
    /** provider instance */
    private static final RMIClassLoaderSpi provider = AccessController
        .doPrivileged(new PrivilegedAction<RMIClassLoaderSpi>() {
    ...
    private static RMIClassLoaderSpi initializeProvider() {
        ...
        if (providerClassName != null) {
            ...
            try {
                ...
                Error error = new LinkageError("provider class not assignable to RMIClassLoaderSpi", e);
                throw error;
            }
        }
