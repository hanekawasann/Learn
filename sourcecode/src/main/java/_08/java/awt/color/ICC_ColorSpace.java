...
public class ICC_ColorSpace extends ColorSpace {
    ...
    public ICC_ColorSpace(ICC_Profile profile) {
        ...
        if ((profileClass != ICC_Profile.CLASS_INPUT) && (profileClass != ICC_Profile.CLASS_DISPLAY) &&
            (profileClass != ICC_Profile.CLASS_OUTPUT) && (profileClass != ICC_Profile.CLASS_COLORSPACECONVERSION) &&
    ...
    public float[] toCIEXYZ(float[] colorvalue) {
        ...
        if (this2xyz == null) {
            ...
            try {
                transformList[0] = mdl
                    .createTransform(thisProfile, ICC_Profile.icRelativeColorimetric, ColorTransform.In);
    ...
    public float[] fromCIEXYZ(float[] colorvalue) {
        ...
        if (xyz2this == null) {
            ...
            try {
                transformList[1] = mdl
                    .createTransform(thisProfile, ICC_Profile.icRelativeColorimetric, ColorTransform.Out);
            } catch (CMMException e) {
                transformList[1] = CMSManager.getModule()
                    .createTransform(thisProfile, ColorTransform.Any, ColorTransform.Out);
            }
