...
public class LogManager {
    ...
    final void ensureLogManagerInitialized() {
        ...
        synchronized (this) {
            ...
            assert initializedCalled ||
                !initializationDone : "Initialization can't be done if initialized has not been called!";
     ...
     * @throws NullPointerException if the PropertyChangeListener is null.
    ...
    public void readConfiguration(InputStream ins) throws IOException, SecurityException {
        ...
        synchronized (listenerMap) {
            if (!listenerMap.isEmpty()) { listeners = new HashMap<>(listenerMap); }
        }
        if (listeners != null) {
    ...
    private static class Beans {
        ...
        private static final Method propertyChangeMethod = getMethod(propertyChangeListenerClass, "propertyChange",
            propertyChangeEventClass);

        private static final Constructor<?> propertyEventCtor = getConstructor(propertyChangeEventClass, Object.class,
