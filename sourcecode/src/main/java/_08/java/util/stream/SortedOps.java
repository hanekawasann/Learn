...
final class SortedOps {
    ...
    private static final class OfRef<T> extends ReferencePipeline.StatefulOp<T, T> {
        ...
        public Sink<T> opWrapSink(int flags, Sink<T> sink) {
            ...
            if (StreamOpFlag.SORTED.isKnown(flags) && isNaturalSort) { return sink; } else if (StreamOpFlag.SIZED
                .isKnown(flags)) { return new SizedRefSortingSink<>(sink, comparator); } else {
    ...
    private static final class OfInt extends IntPipeline.StatefulOp<Integer> {
        ...
        public Sink<Integer> opWrapSink(int flags, Sink sink) {
            ...
            if (StreamOpFlag.SORTED.isKnown(flags)) { return sink; } else if (StreamOpFlag.SIZED.isKnown(flags)) {
        ...
        @Override
        public <P_IN> Node<Integer> opEvaluateParallel(PipelineHelper<Integer> helper, Spliterator<P_IN> spliterator,
    ...
    private static final class OfLong extends LongPipeline.StatefulOp<Long> {
        ...
        @Override
        public <P_IN> Node<Long> opEvaluateParallel(PipelineHelper<Long> helper, Spliterator<P_IN> spliterator,
    ...
    private static final class OfDouble extends DoublePipeline.StatefulOp<Double> {
        ...
        @Override
        public <P_IN> Node<Double> opEvaluateParallel(PipelineHelper<Double> helper, Spliterator<P_IN> spliterator,
