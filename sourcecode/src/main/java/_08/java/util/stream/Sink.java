...
interface Sink<T> extends Consumer<T> {
    ...
    interface OfInt extends Sink<Integer>, IntConsumer {
        ...
        default void accept(Integer i) {
            if (Tripwire.ENABLED) { Tripwire.trip(getClass(), "{0} calling Sink.OfInt.accept(Integer)"); }
            accept(i.intValue());
        }
    }
    ...
    interface OfLong extends Sink<Long>, LongConsumer {
        ...
        default void accept(Long i) {
            if (Tripwire.ENABLED) { Tripwire.trip(getClass(), "{0} calling Sink.OfLong.accept(Long)"); }
            accept(i.longValue());
        }
    }
    ...
    interface OfDouble extends Sink<Double>, DoubleConsumer {
        ...
        default void accept(Double i) {
            if (Tripwire.ENABLED) { Tripwire.trip(getClass(), "{0} calling Sink.OfDouble.accept(Double)"); }
