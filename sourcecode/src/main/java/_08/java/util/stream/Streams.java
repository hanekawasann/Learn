...
final class Streams {
    ...
    static final class IntStreamBuilderImpl extends AbstractStreamBuilderImpl<Integer, Spliterator.OfInt>
        ...
        public IntStream build() {
            ...
            if (c >= 0) {
                ...
                // Use this spliterator if 0 or 1 elements, otherwise use
                // the spliterator of the spined buffer
                return (c < 2) ? StreamSupport.intStream(this, false)
                    : StreamSupport.intStream(buffer.spliterator(), false);
            }
    ...
    static final class LongStreamBuilderImpl extends AbstractStreamBuilderImpl<Long, Spliterator.OfLong>
        ...
        public LongStream build() {
            ...
            if (c >= 0) {
                ...
                // Use this spliterator if 0 or 1 elements, otherwise use
                // the spliterator of the spined buffer
                return (c < 2) ? StreamSupport.longStream(this, false)
                    : StreamSupport.longStream(buffer.spliterator(), false);
            }
    ...
    abstract static class ConcatSpliterator<T, T_SPLITR extends Spliterator<T>> implements Spliterator<T> {
        ...
        public boolean tryAdvance(Consumer<? super T> consumer) {
            ...
            } else { hasNext = bSpliterator.tryAdvance(consumer); }
            return hasNext;
        }
        ...
        public Comparator<? super T> getComparator() {
            if (beforeSplit) { throw new IllegalStateException(); }
        ...
        private static abstract class OfPrimitive<T, T_CONS, T_SPLITR extends Spliterator.OfPrimitive<T, T_CONS, T_SPLITR>>
            ...
            public boolean tryAdvance(T_CONS action) {
                ...
                } else { hasNext = bSpliterator.tryAdvance(action); }
                return hasNext;
            }

            @Override
            public void forEachRemaining(T_CONS action) {
                if (beforeSplit) { aSpliterator.forEachRemaining(action); }
