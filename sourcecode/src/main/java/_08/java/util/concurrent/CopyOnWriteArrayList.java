...
public class CopyOnWriteArrayList<E> implements List<E>, RandomAccess, Cloneable, java.io.Serializable {
    ...
    public <T> T[] toArray(T[] a) {
        ...
        if (a.length < len) { return (T[]) Arrays.copyOf(elements, len, a.getClass()); } else {
    ...
    public void add(int index, E element) {
        ...
        try {
            ...
            if (numMoved == 0) { newElements = Arrays.copyOf(elements, len + 1); } else {
    ...
    public E remove(int index) {
        ...
        try {
            ...
            if (numMoved == 0) { setArray(Arrays.copyOf(elements, len - 1)); } else {
    ...
    public boolean equals(Object o) {
        ...
        Object[] elements = getArray();
        int len = elements.length;
        for (int i = 0; i < len; ++i) { if (!it.hasNext() || !eq(elements[i], it.next())) { return false; } }
        return !it.hasNext();
    }
    ...
    private static class COWSubList<E> extends AbstractList<E> implements RandomAccess {
        ...
        private void checkForComodification() {
            if (l.getArray() != expectedArray) { throw new ConcurrentModificationException(); }
        }
        ...
        public void forEach(Consumer<? super E> action) {
            ...
            if (l.getArray() != a) { throw new ConcurrentModificationException(); }
            if (lo < 0 || hi > a.length) { throw new IndexOutOfBoundsException(); }
            for (int i = lo; i < hi; ++i) {
                @SuppressWarnings("unchecked")
                E e = (E) a[i];
                action.accept(e);
        ...
        public void replaceAll(UnaryOperator<E> operator) {
            ...
            try {
                ...
                if (l.getArray() != elements) { throw new ConcurrentModificationException(); }
                int len = elements.length;
                if (lo < 0 || hi > len) { throw new IndexOutOfBoundsException(); }
                Object[] newElements = Arrays.copyOf(elements, len);
                for (int i = lo; i < hi; ++i) {
                    @SuppressWarnings("unchecked")
                    E e = (E) elements[i];
        ...
        public boolean removeAll(Collection<?> c) {
            ...
            try {
                ...
                if (n > 0) {
                    ...
                    for (int i = lo; i < hi; ++i) {
                        Object element = elements[i];
                        if (!c.contains(element)) { temp[newSize++] = element; }
                    }
                    if (newSize != n) {
            ...
            try {
                ...
                if (n > 0) {
                    ...
                    for (int i = lo; i < hi; ++i) {
                        @SuppressWarnings("unchecked")
                        E e = (E) elements[i];
                        if (!filter.test(e)) { temp[newSize++] = e; }
                    }
                    if (newSize != n) {
                        Object[] newElements = new Object[len - n + newSize];
                        System.arraycopy(elements, 0, newElements, 0, lo);
    ...
    private static class COWSubListIterator<E> implements ListIterator<E> {
        ...
        public E next() {
            if (hasNext()) { return it.next(); } else { throw new NoSuchElementException(); }
        }
        ...
        public E previous() {
            if (hasPrevious()) { return it.previous(); } else { throw new NoSuchElementException(); }
        }
