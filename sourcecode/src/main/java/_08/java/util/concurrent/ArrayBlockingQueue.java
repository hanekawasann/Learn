...
public class ArrayBlockingQueue<E> extends AbstractQueue<E> implements BlockingQueue<E>, java.io.Serializable {
    ...
    public Object[] toArray() {
        ...
        try {
            ...
            if (count <= n) { System.arraycopy(items, takeIndex, a, 0, count); } else {
    ...
    public String toString() {
        ...
        try {
            ...
            for (int i = takeIndex; ; ) {
                ...
                if (--k == 0) { return sb.append(']').toString(); }
                sb.append(',').append(' ');
                if (++i == items.length) { i = 0; }
            }
        } finally {
        ...
        try {
            ...
            try {
                ...
                if (i > 0) {
                    ...
                    takeIndex = take;
                    if (itrs != null) {
                        if (count == 0) { itrs.queueIsEmpty(); } else if (i > take) { itrs.takeIndexWrapped(); }
                    }
    ...
    class Itrs {
        ...
        void takeIndexWrapped() {
            ...
            for (Node o = null, p = head; p != null; ) {
                ...
                if (it == null || it.takeIndexWrapped()) {
                    ...
                    p.clear();
                    p.next = null;
                    if (o == null) { head = next; } else { o.next = next; }
                } else {
                    o = p;
                }
                p = next;
        ...
        void elementDequeued() {
            // assert lock.getHoldCount() == 1;
            if (count == 0) { queueIsEmpty(); } else if (takeIndex == 0) { takeIndexWrapped(); }
        }
    }
    ...
    private class Itr implements Iterator<E> {
        ...
        private void incorporateDequeues() {
            ...
            if (cycles != prevCycles || takeIndex != prevTakeIndex) {
                ...
                if (cursor < 0 && nextIndex < 0 && lastRet < 0) { detach(); } else {
        ...
        public void remove() {
            ...
            try {
                ...
                this.lastRet = NONE;
                if (lastRet >= 0) {
                    if (!isDetached()) { removeAt(lastRet); } else {
        ...
        boolean removedAt(int removedIndex) {
            ...
            if (lastRet >= 0) {
                ...
                if (x == removedDistance) { this.lastRet = lastRet = REMOVED; } else if (x > removedDistance) {
            ...
            if (nextIndex >= 0) {
                ...
                if (x == removedDistance) { this.nextIndex = nextIndex = REMOVED; } else if (x > removedDistance) {
