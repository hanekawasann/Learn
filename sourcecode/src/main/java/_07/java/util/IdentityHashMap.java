...
public class IdentityHashMap<K, V> extends AbstractMap<K, V> implements Map<K, V>, java.io.Serializable, Cloneable {
    ...
    private class EntryIterator extends IdentityHashMapIterator<Map.Entry<K, V>> {
        ...
        private class Entry implements Map.Entry<K, V> {
            ...
            public V setValue(V value) {
                ...
                if (traversalTable != IdentityHashMap.this.table) { put((K) traversalTable[index], value); }
                return oldValue;
            }
    ...
    public Collection<V> values() {
        ...
        if (vs != null) { return vs; } else { return values = new Values(); }
    }
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        ...
        if (es != null) { return es; } else { return entrySet = new EntrySet(); }
    }
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public Object[] toArray() {
            ...
            for (int i = 0; i < size; i++) { result[i] = new AbstractMap.SimpleEntry<>(it.next()); }
            return result;
        }
        ...
        public <T> T[] toArray(T[] a) {
            ...
            Iterator<Map.Entry<K, V>> it = iterator();
            for (int i = 0; i < size; i++) { a[i] = (T) new AbstractMap.SimpleEntry<>(it.next()); }
