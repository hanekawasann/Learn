...
/*package*/ class ArraysParallelSortHelpers {
    ...
    static final class FJObject {
        ...
        static final class Merger<T> extends CountedCompleter<Void> {
            ...
            Merger(CountedCompleter<?> par, T[] a, T[] w, int lbase, int lsize, int rbase, int rsize, int wbase,
                int gran, Comparator<? super T> comparator) {
                super(par);
                this.a = a;
                this.w = w;
                this.lbase = lbase;
            ...
            public final void compute() {
                ...
                for (int lh, rh; ; ) {  // split larger, find point in smaller
                    if (ln >= rn) {
                        ...
                        for (int lo = 0; lo < rh; ) {
                            int rm = (lo + rh) >>> 1;
                            if (c.compare(split, a[rm + rb]) <= 0) { rh = rm; } else { lo = rm + 1; }
                        }
                    } else {
                        if (rn <= g) { break; }
                        lh = ln;
                        ...
                        for (int lo = 0; lo < lh; ) {
                            int lm = (lo + lh) >>> 1;
                            if (c.compare(split, a[lm + lb]) <= 0) { lh = lm; } else { lo = lm + 1; }
                        }
                    }
                ...
                if (rb < rf) { System.arraycopy(a, rb, w, k, rf - rb); } else if (lb < lf) {
    ...
    static final class FJByte {
        ...
        static final class Merger extends CountedCompleter<Void> {
            ...
            Merger(CountedCompleter<?> par, byte[] a, byte[] w, int lbase, int lsize, int rbase, int rsize, int wbase,
                int gran) {
                super(par);
                this.a = a;
                this.w = w;
            ...
            public final void compute() {
                ...
                for (int lh, rh; ; ) {  // split larger, find point in smaller
                    if (ln >= rn) {
                        ...
                        for (int lo = 0; lo < rh; ) {
                            int rm = (lo + rh) >>> 1;
                            if (split <= a[rm + rb]) { rh = rm; } else { lo = rm + 1; }
                        }
                    } else {
                        if (rn <= g) { break; }
                        lh = ln;
                        ...
                        for (int lo = 0; lo < lh; ) {
                            int lm = (lo + lh) >>> 1;
                            if (split <= a[lm + lb]) { lh = lm; } else { lo = lm + 1; }
                        }
                    }
    ...
    static final class FJChar {
        ...
        static final class Merger extends CountedCompleter<Void> {
            ...
            Merger(CountedCompleter<?> par, char[] a, char[] w, int lbase, int lsize, int rbase, int rsize, int wbase,
                int gran) {
                super(par);
                this.a = a;
                this.w = w;
    ...
    static final class FJShort {
        ...
        static final class Merger extends CountedCompleter<Void> {
            ...
            Merger(CountedCompleter<?> par, short[] a, short[] w, int lbase, int lsize, int rbase, int rsize, int wbase,
                int gran) {
                super(par);
                this.a = a;
                this.w = w;
    ...
    static final class FJInt {
        ...
        static final class Merger extends CountedCompleter<Void> {
            ...
            Merger(CountedCompleter<?> par, int[] a, int[] w, int lbase, int lsize, int rbase, int rsize, int wbase,
                int gran) {
                super(par);
                this.a = a;
                this.w = w;
    ...
    static final class FJLong {
        ...
        static final class Merger extends CountedCompleter<Void> {
            ...
            Merger(CountedCompleter<?> par, long[] a, long[] w, int lbase, int lsize, int rbase, int rsize, int wbase,
                int gran) {
                super(par);
                this.a = a;
                this.w = w;
    ...
    static final class FJFloat {
        ...
        static final class Merger extends CountedCompleter<Void> {
            ...
            Merger(CountedCompleter<?> par, float[] a, float[] w, int lbase, int lsize, int rbase, int rsize, int wbase,
                int gran) {
                super(par);
                this.a = a;
                this.w = w;
    ...
    static final class FJDouble {
        ...
        static final class Merger extends CountedCompleter<Void> {
            ...
            Merger(CountedCompleter<?> par, double[] a, double[] w, int lbase, int lsize, int rbase, int rsize,
                int wbase, int gran) {
                super(par);
                this.a = a;
                this.w = w;
