...
public class Arrays {
    ...
    public static <T extends Comparable<? super T>> void parallelSort(T[] a) {
        ...
        if (n <= MIN_ARRAY_SORT_GRAN || (p = ForkJoinPool.getCommonPoolParallelism()) == 1) {
            ...
            new ArraysParallelSortHelpers.FJObject.Sorter<T>(null, a,
                ...
                ((g = n / (p << 2)) <= MIN_ARRAY_SORT_GRAN) ? MIN_ARRAY_SORT_GRAN : g, NaturalOrder.INSTANCE).invoke();
        }
    }
    ...
    public static <T> void parallelSort(T[] a, Comparator<? super T> cmp) {
        if (cmp == null) { cmp = NaturalOrder.INSTANCE; }
        int n = a.length, p, g;
        if (n <= MIN_ARRAY_SORT_GRAN || (p = ForkJoinPool.getCommonPoolParallelism()) == 1) {
    ...
    public static void sort(Object[] a) {
        if (LegacyMergeSort.userRequested) { legacyMergeSort(a); } else {
    ...
    public static void sort(Object[] a, int fromIndex, int toIndex) {
        rangeCheck(a.length, fromIndex, toIndex);
        if (LegacyMergeSort.userRequested) { legacyMergeSort(a, fromIndex, toIndex); } else {
    ...
    private static void mergeSort(Object[] src, Object[] dest, int low, int high, int off) {
        ...
        for (int i = destLow, p = low, q = mid; i < destHigh; i++) {
            if (q >= high || p < mid && ((Comparable) src[p]).compareTo(src[q]) <= 0) { dest[i] = src[p++]; } else {
                dest[i] = src[q++];
            }
        }
    }
    ...
    public static <T> void sort(T[] a, Comparator<? super T> c) {
        if (c == null) { c = NaturalOrder.INSTANCE; }
        if (LegacyMergeSort.userRequested) { legacyMergeSort(a, c); } else {
    ...
    public static <T> void sort(T[] a, int fromIndex, int toIndex, Comparator<? super T> c) {
        if (c == null) { c = NaturalOrder.INSTANCE; }
        rangeCheck(a.length, fromIndex, toIndex);
        if (LegacyMergeSort.userRequested) { legacyMergeSort(a, fromIndex, toIndex, c); } else {
    ...
    private static <T> void legacyMergeSort(T[] a, int fromIndex, int toIndex, Comparator<? super T> c) {
        ...
        if (c == null) { mergeSort(aux, a, fromIndex, toIndex, -fromIndex); } else {
    ...
    private static void mergeSort(Object[] src, Object[] dest, int low, int high, int off, Comparator c) {
        ...
        // Merge sorted halves (now in src) into dest
        for (int i = destLow, p = low, q = mid; i < destHigh; i++) {
            if (q >= high || p < mid && c.compare(src[p], src[q]) <= 0) { dest[i] = src[p++]; } else {
                dest[i] = src[q++];
            }
        }
    }
    ...
    public static <T> void parallelPrefix(T[] array, BinaryOperator<T> op) {
        ...
        if (array.length > 0) { new ArrayPrefixHelpers.CumulateTask<>(null, op, array, 0, array.length).invoke(); }
    }
    ...
    public static void parallelPrefix(long[] array, LongBinaryOperator op) {
        Objects.requireNonNull(op);
        if (array.length > 0) { new ArrayPrefixHelpers.LongCumulateTask(null, op, array, 0, array.length).invoke(); }
    }
    ...
    public static void parallelPrefix(double[] array, DoubleBinaryOperator op) {
        Objects.requireNonNull(op);
        if (array.length > 0) { new ArrayPrefixHelpers.DoubleCumulateTask(null, op, array, 0, array.length).invoke(); }
    }
    ...
    public static void parallelPrefix(int[] array, IntBinaryOperator op) {
        Objects.requireNonNull(op);
        if (array.length > 0) { new ArrayPrefixHelpers.IntCumulateTask(null, op, array, 0, array.length).invoke(); }
    }
    ...
    public static int hashCode(int a[]) {
        ...
        int result = 1;
        for (int element : a) { result = 31 * result + element; }
    ...
    public static int hashCode(short a[]) {
        ...
        int result = 1;
        for (short element : a) { result = 31 * result + element; }
    ...
    public static int hashCode(char a[]) {
        ...
        int result = 1;
        for (char element : a) { result = 31 * result + element; }
    ...
    public static int deepHashCode(Object a[]) {
        ...
        for (Object element : a) {
            ...
            } else if (element instanceof boolean[]) { elementHash = hashCode((boolean[]) element); } else if (element !=
                null) { elementHash = element.hashCode(); }
    ...
    static boolean deepEquals0(Object e1, Object e2) {
        ...
        } else if (e1 instanceof byte[] && e2 instanceof byte[]) { eq = equals((byte[]) e1, (byte[]) e2); } else if (e1 instanceof short[] && e2 instanceof short[]) {
            eq = equals((short[]) e1, (short[]) e2);
        } else if (e1 instanceof int[] && e2 instanceof int[]) { eq = equals((int[]) e1, (int[]) e2); } else if (e1 instanceof long[] && e2 instanceof long[]) {
            eq = equals((long[]) e1, (long[]) e2);
        } else if (e1 instanceof char[] && e2 instanceof char[]) { eq = equals((char[]) e1, (char[]) e2); } else if (e1 instanceof float[] && e2 instanceof float[]) {
    ...
    private static void deepToString(Object[] a, StringBuilder buf, Set<Object[]> dejaVu) {
        ...
        for (int i = 0; ; i++) {
            ...
            if (element == null) {
                ...
                if (eClass.isArray()) {
                    if (eClass == byte[].class) { buf.append(toString((byte[]) element)); } else if (eClass ==
                        short[].class) { buf.append(toString((short[]) element)); } else if (eClass == int[].class) {
                        ...
                        if (dejaVu.contains(element)) { buf.append("[...]"); } else {
    ...
    public static void setAll(double[] array, IntToDoubleFunction generator) {
        Objects.requireNonNull(generator);
        for (int i = 0; i < array.length; i++) { array[i] = generator.applyAsDouble(i); }
    }
    ...
    public static <T> Spliterator<T> spliterator(T[] array, int startInclusive, int endExclusive) {
        return Spliterators
            .spliterator(array, startInclusive, endExclusive, Spliterator.ORDERED | Spliterator.IMMUTABLE);
    }
