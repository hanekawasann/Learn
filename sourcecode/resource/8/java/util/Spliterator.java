 ...
 * @apiNote <p>Spliterators, like {@code Iterators}s, are for traversing the elements of
    ...
    public interface OfLong extends OfPrimitive<Long, LongConsumer, OfLong> {
        ...
        default boolean tryAdvance(Consumer<? super Long> action) {
            if (action instanceof LongConsumer) {
                ...
                if (Tripwire.ENABLED) {
                    Tripwire
                        .trip(getClass(), "{0} calling Spliterator.OfLong.tryAdvance((LongConsumer) action::accept)");
                }
