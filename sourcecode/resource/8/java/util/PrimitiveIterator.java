...
public interface PrimitiveIterator<T, T_CONS> extends Iterator<T> {
    ...
    public static interface OfInt extends PrimitiveIterator<Integer, IntConsumer> {
        ...
        default void forEachRemaining(Consumer<? super Integer> action) {
            if (action instanceof IntConsumer) {
                ...
                if (Tripwire.ENABLED) {
                    Tripwire
                        .trip(getClass(), "{0} calling PrimitiveIterator.OfInt.forEachRemainingInt(action::accept)");
                }
    ...
    public static interface OfLong extends PrimitiveIterator<Long, LongConsumer> {
        ...
        @Override
        default Long next() {
            if (Tripwire.ENABLED) { Tripwire.trip(getClass(), "{0} calling PrimitiveIterator.OfLong.nextLong()"); }
            return nextLong();
        }
        ...
        default void forEachRemaining(Consumer<? super Long> action) {
            if (action instanceof LongConsumer) {
                ...
                if (Tripwire.ENABLED) {
                    Tripwire
                        .trip(getClass(), "{0} calling PrimitiveIterator.OfLong.forEachRemainingLong(action::accept)");
                }
    ...
    public static interface OfDouble extends PrimitiveIterator<Double, DoubleConsumer> {
        ...
        @Override
        default Double next() {
            if (Tripwire.ENABLED) { Tripwire.trip(getClass(), "{0} calling PrimitiveIterator.OfDouble.nextLong()"); }
            return nextDouble();
        }
