...
public interface LongStream extends BaseStream<Long, LongStream> {
    ...
    public static LongStream iterate(final long seed, final LongUnaryOperator f) {
        ...
        return StreamSupport.longStream(Spliterators
                .spliteratorUnknownSize(iterator, Spliterator.ORDERED | Spliterator.IMMUTABLE | Spliterator.NONNULL),
            false);
    }
    ...
    public static LongStream generate(LongSupplier s) {
        ...
        return StreamSupport
            .longStream(new StreamSpliterators.InfiniteSupplyingSpliterator.OfLong(Long.MAX_VALUE, s), false);
    }
    ...
    public static LongStream range(long startInclusive, final long endExclusive) {
        if (startInclusive >= endExclusive) {
            ...
            return StreamSupport
                .longStream(new Streams.RangeLongSpliterator(startInclusive, endExclusive, false), false);
        }
    }
    ...
    public static LongStream rangeClosed(long startInclusive, final long endInclusive) {
        if (startInclusive > endInclusive) {
            ...
            return StreamSupport
                .longStream(new Streams.RangeLongSpliterator(startInclusive, endInclusive, true), false);
        }
    }
