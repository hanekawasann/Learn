...
interface Node<T> {
    ...
    public interface OfPrimitive<T, T_CONS, T_ARR, T_SPLITR extends Spliterator.OfPrimitive<T, T_CONS, T_SPLITR>, T_NODE extends OfPrimitive<T, T_CONS, T_ARR, T_SPLITR, T_NODE>>
        extends Node<T> {
    ...
    interface OfInt extends OfPrimitive<Integer, IntConsumer, int[], Spliterator.OfInt, OfInt> {
        ...
        default void copyInto(Integer[] boxed, int offset) {
            if (Tripwire.ENABLED) { Tripwire.trip(getClass(), "{0} calling Node.OfInt.copyInto(Integer[], int)"); }
    ...
    interface OfLong extends OfPrimitive<Long, LongConsumer, long[], Spliterator.OfLong, OfLong> {
        ...
        default void copyInto(Long[] boxed, int offset) {
            if (Tripwire.ENABLED) { Tripwire.trip(getClass(), "{0} calling Node.OfInt.copyInto(Long[], int)"); }
    ...
    interface OfDouble extends OfPrimitive<Double, DoubleConsumer, double[], Spliterator.OfDouble, OfDouble> {
        ...
        default void copyInto(Double[] boxed, int offset) {
            if (Tripwire.ENABLED) { Tripwire.trip(getClass(), "{0} calling Node.OfDouble.copyInto(Double[], int)"); }
