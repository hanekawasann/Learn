...
class StreamSpliterators {
    ...
    private static abstract class AbstractWrappingSpliterator<P_IN, P_OUT, T_BUFFER extends AbstractSpinedBuffer>
         ...
         */
        AbstractWrappingSpliterator(PipelineHelper<P_OUT> ph, Supplier<Spliterator<P_IN>> spliteratorSupplier,
            boolean parallel) {
            this.ph = ph;
        ...
        public Comparator<? super P_OUT> getComparator() {
            if (!hasCharacteristics(SORTED)) { throw new IllegalStateException(); }
            return null;
        }
    ...
    static final class WrappingSpliterator<P_IN, P_OUT>
        ...
        public boolean tryAdvance(Consumer<? super P_OUT> consumer) {
            ...
            if (hasNext) { consumer.accept(buffer.get(nextToConsume)); }
            return hasNext;
        }
    ...
    static final class IntWrappingSpliterator<P_IN>
        extends AbstractWrappingSpliterator<P_IN, Integer, SpinedBuffer.OfInt> implements Spliterator.OfInt {
    ...
    static final class LongWrappingSpliterator<P_IN>
        extends AbstractWrappingSpliterator<P_IN, Long, SpinedBuffer.OfLong> implements Spliterator.OfLong {
    ...
    static final class DoubleWrappingSpliterator<P_IN>
        extends AbstractWrappingSpliterator<P_IN, Double, SpinedBuffer.OfDouble> implements Spliterator.OfDouble {
    ...
    static class DelegatingSpliterator<T, T_SPLITR extends Spliterator<T>> implements Spliterator<T> {
        ...
        static final class OfInt extends OfPrimitive<Integer, IntConsumer, Spliterator.OfInt>
        ...
        static final class OfLong extends OfPrimitive<Long, LongConsumer, Spliterator.OfLong>
        ...
        static final class OfDouble extends OfPrimitive<Double, DoubleConsumer, Spliterator.OfDouble>
    ...
    static abstract class SliceSpliterator<T, T_SPLITR extends Spliterator<T>> {
        ...
        protected abstract T_SPLITR makeSpliterator(T_SPLITR s, long sliceOrigin, long sliceFence, long origin,
            long fence);

        public T_SPLITR trySplit() {
            if (sliceOrigin >= fence) { return null; }

            if (index >= fence) { return null; }
        ...
        static final class OfRef<T> extends SliceSpliterator<T, Spliterator<T>> implements Spliterator<T> {
            ...
            @Override
            protected Spliterator<T> makeSpliterator(Spliterator<T> s, long sliceOrigin, long sliceFence, long origin,
                long fence) {
            ...
            public boolean tryAdvance(Consumer<? super T> action) {
                ...
                if (sliceOrigin >= fence) { return false; }
            ...
            public void forEachRemaining(Consumer<? super T> action) {
                ...
                if (sliceOrigin >= fence) { return; }

                if (index >= fence) { return; }
        ...
        static abstract class OfPrimitive<T, T_SPLITR extends Spliterator.OfPrimitive<T, T_CONS, T_SPLITR>, T_CONS>
            extends SliceSpliterator<T, T_SPLITR> implements Spliterator.OfPrimitive<T, T_CONS, T_SPLITR> {
        ...
        static final class OfInt extends OfPrimitive<Integer, Spliterator.OfInt, IntConsumer>
            ...
            @Override
            protected Spliterator.OfInt makeSpliterator(Spliterator.OfInt s, long sliceOrigin, long sliceFence,
        ...
        static final class OfLong extends OfPrimitive<Long, Spliterator.OfLong, LongConsumer>
            ...
            @Override
            protected Spliterator.OfLong makeSpliterator(Spliterator.OfLong s, long sliceOrigin, long sliceFence,
                long origin, long fence) {
        ...
        static final class OfDouble extends OfPrimitive<Double, Spliterator.OfDouble, DoubleConsumer>
            ...
            @Override
            protected Spliterator.OfDouble makeSpliterator(Spliterator.OfDouble s, long sliceOrigin, long sliceFence,
                long origin, long fence) {
    ...
    static abstract class UnorderedSliceSpliterator<T, T_SPLITR extends Spliterator<T>> {
        ...
        protected final long acquirePermits(long numElements) {
            ...
            do {
                ...
                if (remainingPermits == 0) { return unlimited ? numElements : 0; }
            ...
            if (unlimited) { return Math.max(numElements - grabbing, 0); } else if (remainingPermits > skipThreshold) {
        ...
        protected final PermitStatus permitStatus() {
            if (permits.get() > 0) { return PermitStatus.MAYBE_MORE; } else {
        ...
        static final class OfRef<T> extends UnorderedSliceSpliterator<T, Spliterator<T>>
            ...
            public boolean tryAdvance(Consumer<? super T> action) {
                ...
                while (permitStatus() != PermitStatus.NO_MORE) {
                    if (!s.tryAdvance(this)) { return false; } else if (acquirePermits(1) == 1) {
            ...
            public void forEachRemaining(Consumer<? super T> action) {
                ...
                while ((permitStatus = permitStatus()) != PermitStatus.NO_MORE) {
                    if (permitStatus == PermitStatus.MAYBE_MORE) {
                        ...
                        if (sb == null) { sb = new ArrayBuffer.OfRef<>(CHUNK_SIZE); } else { sb.reset(); }
        ...
        static abstract class OfPrimitive<T, T_CONS, T_BUFF extends ArrayBuffer.OfPrimitive<T_CONS>, T_SPLITR extends Spliterator.OfPrimitive<T, T_CONS, T_SPLITR>>
            extends UnorderedSliceSpliterator<T, T_SPLITR> implements Spliterator.OfPrimitive<T, T_CONS, T_SPLITR> {
            ...
            public boolean tryAdvance(T_CONS action) {
                ...
                while (permitStatus() != PermitStatus.NO_MORE) {
                    if (!s.tryAdvance((T_CONS) this)) { return false; } else if (acquirePermits(1) == 1) {
            ...
            public void forEachRemaining(T_CONS action) {
                ...
                while ((permitStatus = permitStatus()) != PermitStatus.NO_MORE) {
                    if (permitStatus == PermitStatus.MAYBE_MORE) {
                        // Optimistically traverse elements up to a threshold of CHUNK_SIZE
                        if (sb == null) { sb = bufferCreate(CHUNK_SIZE); } else { sb.reset(); }
        ...
        static final class OfInt extends OfPrimitive<Integer, IntConsumer, ArrayBuffer.OfInt, Spliterator.OfInt>
        ...
        static final class OfLong extends OfPrimitive<Long, LongConsumer, ArrayBuffer.OfLong, Spliterator.OfLong>
    ...
    static final class DistinctSpliterator<T> implements Spliterator<T>, Consumer<T> {
        ...
        public int characteristics() {
            return (s.characteristics() &
                ~(Spliterator.SIZED | Spliterator.SUBSIZED | Spliterator.SORTED | Spliterator.ORDERED)) |
