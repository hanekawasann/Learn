...
public class ForkJoinWorkerThread extends Thread {
    ...
    static final class InnocuousForkJoinWorkerThread extends ForkJoinWorkerThread {
        ...
        private static final AccessControlContext INNOCUOUS_ACC = new AccessControlContext(
        ...
        private static ThreadGroup createThreadGroup() {
            try {
                ...
                while (group != null) {
                    ...
                    if (parent == null) { return new ThreadGroup(group, "InnocuousForkJoinWorkerThreadGroup"); }
                    group = parent;
                }
            } catch (Exception e) {
                throw new Error(e);
