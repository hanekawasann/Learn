...
public final class Math {
    ...
    public static double nextUp(double d) {
        if (Double.isNaN(d) || d == Double.POSITIVE_INFINITY) { return d; } else {
            d += 0.0d;
    ...
    public static float nextUp(float f) {
        if (Float.isNaN(f) || f == FloatConsts.POSITIVE_INFINITY) { return f; } else {
            f += 0.0f;
    ...
    public static double nextDown(double d) {
        if (Double.isNaN(d) || d == Double.NEGATIVE_INFINITY) { return d; } else {
    ...
    public static float nextDown(float f) {
        if (Float.isNaN(f) || f == Float.NEGATIVE_INFINITY) { return f; } else {
