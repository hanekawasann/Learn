...
public final class SerializedLambda implements Serializable {
    ...
    private Object readResolve() throws ReflectiveOperationException {
        try {
            ...
            } else if (cause instanceof RuntimeException) { throw (RuntimeException) cause; } else {
    ...
    public String toString() {
        ...
        return String
            .format("SerializedLambda[%s=%s, %s=%s.%s:%s, " + "%s=%s %s.%s:%s, %s=%s, %s=%d]", "capturingClass",
                capturingClass, "functionalInterfaceMethod", functionalInterfaceClass, functionalInterfaceMethodName,
                functionalInterfaceMethodSignature, "implementation", implKind, implClass, implMethodName,
                implMethodSignature, "instantiatedMethodType", instantiatedMethodType, "numCaptured",
                capturedArgs.length);
    }
}
