...
public final class AclEntry {
    ...
    public static final class Builder {
        ...
        public AclEntry build() {
            if (type == null) { throw new IllegalStateException("Missing type component"); }
            if (who == null) { throw new IllegalStateException("Missing who component"); }
    ...
    public boolean equals(Object ob) {
        ...
        if (ob == null || !(ob instanceof AclEntry)) { return false; }
        AclEntry other = (AclEntry) ob;
        if (this.type != other.type) { return false; }
        if (!this.who.equals(other.who)) { return false; }
        if (!this.perms.equals(other.perms)) { return false; }
        if (!this.flags.equals(other.flags)) { return false; }
        return true;
    }
