...
public class InetSocketAddress extends SocketAddress {
    ...
    private static class InetSocketAddressHolder {
        ...
        private String getHostString() {
            if (hostname != null) { return hostname; }
            if (addr != null) {
                if (addr.holder().getHostName() != null) { return addr.holder().getHostName(); } else {
        ...
        public final boolean equals(Object obj) {
            if (obj == null || !(obj instanceof InetSocketAddressHolder)) { return false; }
            InetSocketAddressHolder that = (InetSocketAddressHolder) obj;
            boolean sameIP;
            if (addr != null) { sameIP = addr.equals(that.addr); } else if (hostname != null) {
                sameIP = (that.addr == null) && hostname.equalsIgnoreCase(that.hostname);
            } else { sameIP = (that.addr == null) && (that.hostname == null); }
        ...
        public final int hashCode() {
            ...
            if (hostname != null) { return hostname.toLowerCase().hashCode() + port; }
            return port;
        }
    }
    ...
    private static final ObjectStreamField[] serialPersistentFields = { new ObjectStreamField("hostname", String.class),
        new ObjectStreamField("addr", InetAddress.class), new ObjectStreamField("port", int.class) };
