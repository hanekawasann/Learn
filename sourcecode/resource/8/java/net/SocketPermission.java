...
public final class SocketPermission extends Permission implements java.io.Serializable {
    ...
    private static final int ephemeralLow = initEphemeralPorts("low", DEF_EPH_LOW);
    private static final int ephemeralHigh = initEphemeralPorts("high", PORT_MAX);
    ...
    private static int getMask(String action) {
        ...
        while (i != -1) {
            ...
            if (i >= 6 && (a[i - 6] == 'c' || a[i - 6] == 'C') && (a[i - 5] == 'o' || a[i - 5] == 'O') &&
                (a[i - 4] == 'n' || a[i - 4] == 'N') && (a[i - 3] == 'n' || a[i - 3] == 'N') &&
                (a[i - 2] == 'e' || a[i - 2] == 'E') && (a[i - 1] == 'c' || a[i - 1] == 'C') &&
                (a[i] == 't' || a[i] == 'T')) {
                matchlen = 7;
                mask |= CONNECT;

            } else if (i >= 6 && (a[i - 6] == 'r' || a[i - 6] == 'R') && (a[i - 5] == 'e' || a[i - 5] == 'E') &&
                (a[i - 4] == 's' || a[i - 4] == 'S') && (a[i - 3] == 'o' || a[i - 3] == 'O') &&
                (a[i - 2] == 'l' || a[i - 2] == 'L') && (a[i - 1] == 'v' || a[i - 1] == 'V') &&
                (a[i] == 'e' || a[i] == 'E')) {
                matchlen = 7;
                mask |= RESOLVE;

            } else if (i >= 5 && (a[i - 5] == 'l' || a[i - 5] == 'L') && (a[i - 4] == 'i' || a[i - 4] == 'I') &&
                (a[i - 3] == 's' || a[i - 3] == 'S') && (a[i - 2] == 't' || a[i - 2] == 'T') &&
                (a[i - 1] == 'e' || a[i - 1] == 'E') && (a[i] == 'n' || a[i] == 'N')) {
                matchlen = 6;
                mask |= LISTEN;

            } else if (i >= 5 && (a[i - 5] == 'a' || a[i - 5] == 'A') && (a[i - 4] == 'c' || a[i - 4] == 'C') &&
                (a[i - 3] == 'c' || a[i - 3] == 'C') && (a[i - 2] == 'e' || a[i - 2] == 'E') &&
                (a[i - 1] == 'p' || a[i - 1] == 'P') && (a[i] == 't' || a[i] == 'T')) {
                matchlen = 6;
                mask |= ACCEPT;
    ...
    private boolean authorized(String cname, byte[] addr) {
        if (addr.length == 4) { return authorizedIPv4(cname, addr); } else if (addr.length == 16) {
    ...
    private boolean authorizedIPv4(String cname, byte[] addr) {
        ...
        try {
            ...
            if (debug != null && Debug.isOn("failure")) {
                debug.println(
                    "socket access restriction: IP address of " + auth + " != " + InetAddress.getByAddress(addr));
            }
        } catch (UnknownHostException uhe) {
            Debug debug = getDebug();
            if (debug != null && Debug.isOn("failure")) {
