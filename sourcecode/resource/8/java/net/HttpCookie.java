...
public final class HttpCookie implements Cloneable {
    ...
    private final static String[] COOKIE_DATE_FORMATS = { "EEE',' dd-MMM-yyyy HH:mm:ss 'GMT'",
        "EEE',' dd MMM yyyy HH:mm:ss 'GMT'", "EEE MMM dd yyyy HH:mm:ss 'GMT'Z", "EEE',' dd-MMM-yy HH:mm:ss 'GMT'",
     ...
     * @throws IllegalArgumentException if header string violates the cookie specification's syntax or
    ...
    public boolean hasExpired() {
        ...
        if (deltaSecond > maxAge) { return true; } else { return false; }
    }
     ...
     *
     * @param purpose a {@code String} specifying the comment URL to display to the user
     * @see #getCommentURL
     */
    ...
    public void setDomain(String pattern) {
        if (pattern != null) { domain = pattern.toLowerCase(); } else { domain = pattern; }
    }
     ...
     *
     * @param httpOnly if {@code true} make the cookie HTTP only, i.e. only visible as
    ...
    public boolean equals(Object obj) {
        ...
        return equalsIgnoreCase(getName(), other.getName()) && equalsIgnoreCase(getDomain(), other.getDomain()) &&
    ...
    private static HttpCookie parseInternal(String header, boolean retainHeader) {
        ...
        try {
            ...
            if (index != -1) {
                ...
                if (retainHeader) { cookie = new HttpCookie(name, stripOffSurroundingQuote(value), header); } else {
