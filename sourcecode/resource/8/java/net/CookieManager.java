...
public class CookieManager extends CookieHandler {
    ...
    private boolean pathMatches(String path, String pathToMatchWith) {
        if (path == pathToMatchWith) { return true; }
        if (path == null || pathToMatchWith == null) { return false; }
        if (path.startsWith(pathToMatchWith)) { return true; }
    ...
    static class CookiePathComparator implements Comparator<HttpCookie> {
        public int compare(HttpCookie c1, HttpCookie c2) {
            ...
            if (c1.getPath().startsWith(c2.getPath())) { return -1; } else if (c2.getPath().startsWith(c1.getPath())) {
                return 1;
            } else { return 0; }
        }
    }
