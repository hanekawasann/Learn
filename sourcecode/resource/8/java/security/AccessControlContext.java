...
public final class AccessControlContext {
     ...
     */
    AccessControlContext(ProtectionDomain caller, DomainCombiner combiner, AccessControlContext parent,
    ...
    private boolean equalContext(AccessControlContext that) {
        if (!equalPDs(this.context, that.context)) { return false; }

        if (this.combiner == null && that.combiner != null) { return false; }

        if (this.combiner != null && !this.combiner.equals(that.combiner)) { return false; }
    ...
    private boolean equalPDs(ProtectionDomain[] a, ProtectionDomain[] b) {
        ...
        if (!(containsAllPDs(a, b) && containsAllPDs(b, a))) { return false; }
    ...
    private boolean equalLimitedContext(AccessControlContext that) {
         ...
         */
        if (!this.isLimited && !that.isLimited) { return true; }

        /*
         * If only one instance has limited privilege scope then we're done.
         */
        if (!(this.isLimited && that.isLimited)) { return false; }
        ...
        if (this.permissions == null && that.permissions != null) { return false; }

        if (this.permissions != null && that.permissions == null) { return false; }

        if (!(this.containsAllLimits(that) && that.containsAllLimits(this))) { return false; }
         ...
         */
        if (thisNextPC == null && thatNextPC != null && thatNextPC.isLimited) { return false; }

        if (thisNextPC != null && !thisNextPC.equalLimitedContext(thatNextPC)) { return false; }

        if (this.parent == null && that.parent != null) { return false; }

        if (this.parent != null && !this.parent.equals(that.parent)) { return false; }
    ...
    private boolean containsAllLimits(AccessControlContext that) {
        ...
        if (this.permissions == null && that.permissions == null) { return true; }
