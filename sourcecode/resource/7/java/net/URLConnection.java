...
public abstract class URLConnection {
    ...
    public Map<String, List<String>> getRequestProperties() {
        ...
        if (requests == null) { return Collections.EMPTY_MAP; }
    ...
    private String getContentHandlerPkgPrefixes() {
        String packagePrefixList = AccessController
            .doPrivileged(new sun.security.action.GetPropertyAction(contentPathProp, ""));
    ...
    static private boolean checkfpx(InputStream is) throws IOException {
        ...
        if (byteOrder == 0xFE && c[0] == 0x00 && c[2] == 0x61 && c[3] == 0x56 && c[4] == 0x54 && c[5] == 0xC1 &&
            c[6] == 0xCE && c[7] == 0x11 && c[8] == 0x85 && c[9] == 0x53 && c[10] == 0x00 && c[11] == 0xAA &&
        ...
        // non-intel byte order
            ...
            c[6] == 0x11 && c[8] == 0x85 && c[9] == 0x53 && c[10] == 0x00 && c[11] == 0xAA && c[12] == 0x00 &&
