...
class MethodHandleNatives {
    ...
    static class Constants {
        ...
        static final int // for getConstant
            GC_JVM_PUSH_LIMIT = 0, GC_JVM_STACK_MOVE_UNIT = 1, GC_CONV_OP_IMPLEMENTED_MASK = 2,
            GC_OP_ROT_ARGS_DOWN_LIMIT_BIAS = 3;
        static final int ETF_HANDLE_OR_METHOD_NAME = 0, // all available data (immediate MH or method)
         ...
         */
        static final int OP_RETYPE_ONLY = 0x0, // no argument changes; straight retype
         ...
         */
        static final int CONV_OP_MASK = 0xF00, // this nybble contains the conversion op field
        ...
        static final int DEFAULT_CONV_OP_IMPLEMENTED_MASK =
            ...
            ((1 << OP_RETYPE_ONLY) | (1 << OP_RETYPE_RAW) | (1 << OP_CHECK_CAST) | (1 << OP_PRIM_TO_PRIM) |
                (1 << OP_REF_TO_PRIM) | (1 << OP_SWAP_ARGS) | (1 << OP_ROT_ARGS) | (1 << OP_DUP_ARGS) |
                (1 << OP_DROP_ARGS)
                //|(1<<OP_SPREAD_ARGS)
            );
        ...
        static final int REF_getField = 1, REF_getStatic = 2, REF_putField = 3, REF_putStatic = 4, REF_invokeVirtual
            = 5, REF_invokeStatic = 6, REF_invokeSpecial = 7, REF_newInvokeSpecial = 8, REF_invokeInterface = 9;
    }
     ...
     */
    static CallSite makeDynamicCallSite(MethodHandle bootstrapMethod, String name, MethodType type, Object info,
    ...
    static void raiseException(int code, Object actual, Object required) {
        ...
        if (message == null) {
            ...
            if (actual != null) { message = "required " + required + " but encountered " + actual; } else {
