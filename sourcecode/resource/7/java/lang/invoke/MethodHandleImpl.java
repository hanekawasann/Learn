...
/*non-public*/ abstract class MethodHandleImpl {
     ...
     */
    static MethodHandle findMethod(MemberName method, boolean doDispatch, Class<?> lookupClass)
        ...
        if (!mh.isValid()) { throw method.makeAccessException("no direct method handle", lookupClass); }
        assert (mh.type() == mtype);
        if (!method.isVarargs()) { return mh; }
        int argc = mtype.parameterCount();
        if (argc != 0) {
            Class<?> arrayType = mtype.parameterType(argc - 1);
            if (arrayType.isArray()) { return AdapterMethodHandle.makeVarargsCollector(mh, arrayType); }
        }
    ...
    static MethodHandle makeAllocator(MethodHandle rawConstructor) {
        ...
        if (AdapterMethodHandle.canCollectArguments(rawConType, MethodType.methodType(allocateClass), 0, true)) {
            ...
            MethodHandle cookedConstructor = AdapterMethodHandle
                .makeCollectArguments(returner, rawConstructor, 1, false);
    ...
    static final class AllocateObject<C> extends BoundMethodHandle {
        ...
        private C invoke_L7(Object a0, Object a1, Object a2, Object a3, Object a4, Object a5, Object a6)
            throws Throwable {
            C obj = allocate();
        ...
        private C invoke_L8(Object a0, Object a1, Object a2, Object a3, Object a4, Object a5, Object a6, Object a7)
            throws Throwable {
            C obj = allocate();
        ...
        static {
            try {
                VARARGS_INVOKE = IMPL_LOOKUP
                    .findVirtual(AllocateObject.class, "invoke_V", MethodType.genericMethodType(0, true));
        ...
        static {
            for (int i = 0; i < INVOKES.length; i++) { CON_TYPES[i] = makeConType(INVOKES[i]); }
        }
    ...
    static MethodHandle accessArrayElement(Class<?> arrayClass, boolean isSetter) {
        if (!arrayClass.isArray()) { throw newIllegalArgumentException("not an array: " + arrayClass); }
        Class<?> elemClass = arrayClass.getComponentType();
        MethodHandle[] mhs = FieldAccessor.ARRAY_CACHE.get(elemClass);
        if (mhs == null) {
            if (!FieldAccessor.doCache(elemClass)) { return FieldAccessor.ahandle(arrayClass, isSetter); }
            mhs = new MethodHandle[] { FieldAccessor.ahandle(arrayClass, false),
    ...
    static final class FieldAccessor<C, V> extends BoundMethodHandle {
        ...
        static String fname(Class<?> vclass, boolean isSetter, boolean isStatic) {
            String stem;
            if (!isStatic) { stem = (!isSetter ? "getField" : "setField"); } else {
        ...
        static MethodType ftype(Class<?> cclass, Class<?> vclass, boolean isSetter, boolean isStatic) {
            MethodType type;
            if (!isStatic) {
                if (!isSetter) { return MethodType.methodType(vclass, cclass); } else {
                    return MethodType.methodType(void.class, cclass, vclass);
                }
            } else {
                if (!isSetter) { return MethodType.methodType(vclass); } else {
        ...
        static final HashMap<Class<?>, MethodHandle[]> ARRAY_CACHE = new HashMap<Class<?>, MethodHandle[]>();
        ...
        static MethodType atype(Class<?> aclass, boolean isSetter) {
            Class<?> vclass = aclass.getComponentType();
            if (!isSetter) { return MethodType.methodType(vclass, aclass, int.class); } else {
        ...
        static MethodHandle ahandle(Class<?> aclass, boolean isSetter) {
            ...
            if (caclass != null) { type = type.insertParameterTypes(0, Class.class); }
            MethodHandle mh;
            try {
    ...
    static MethodHandle permuteArguments(MethodHandle target, MethodType newType, MethodType oldType,
        ...
        for (int i = 0; i < outargs; i++) { callTypeArgs[i] = newType.parameterType(permutationOrNull[i]); }
        ...
        while (!state.equals(goal)) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (arg == thisRotArg + TOKEN) {
                    ...
                    if (arg != wantArg && arg >= wantArg - TOKEN * MAX_ARG_ROTATION &&
            ...
            if (bestRotLen >= 2) {
                ...
                for (int i = rotBeg; i <= rotEnd; i++) {
                    if ((int) state.get(i) != (int) goal.get(i)) { score += 1; }
                }
                ...
                if (score >= 2) {
                    ...
                    MethodHandle nextTarget = AdapterMethodHandle
                        .makeRotateArguments(rotType, target, rotBeg, rotSpan.size(), rotBy);
                    if (nextTarget != null) {
    ...
    static MethodHandle convertArguments(MethodHandle target, MethodType newType, int level) {
        ...
        if (retFilter != null) { res = MethodHandles.filterReturnValue(res, retFilter); }
        return res;
    }
    ...
    static MethodHandle convertArguments(MethodHandle target, MethodType newType, MethodType oldType, int level) {
        ...
        if (objTarget == null) { objTarget = FromGeneric.make(target); }
    ...
    static MethodHandle spreadArguments(MethodHandle target, MethodType newType, int spreadArgPos, Class<?> arrayType,
        int arrayLength) {
    ...
    static MethodHandle collectArguments(MethodHandle target, int collectArg, MethodHandle collector) {
        ...
        MethodType newType = type.dropParameterTypes(collectArg, collectArg + 1)
            .insertParameterTypes(collectArg, collector.type().parameterArray());
        return collectArguments(target, newType, collectArg, collector);
    }

    static MethodHandle collectArguments(MethodHandle target, MethodType newType, int collectArg,
    ...
    static MethodHandle filterArgument(MethodHandle target, int pos, MethodHandle filter) {
        ...
        if (result.type() != rtype) { result = result.asType(rtype); }
        return result;
    }
    ...
    private static class GuardWithTest extends BoundMethodHandle {
        ...
        private Object invoke_V(Object... av) throws Throwable {
            if ((boolean) test.invokeExact(av)) { return target.invokeExact(av); }
            return fallback.invokeExact(av);
        }

        private Object invoke_L0() throws Throwable {
            if ((boolean) test.invokeExact()) { return target.invokeExact(); }
            return fallback.invokeExact();
        }

        private Object invoke_L1(Object a0) throws Throwable {
            if ((boolean) test.invokeExact(a0)) { return target.invokeExact(a0); }
            return fallback.invokeExact(a0);
        }

        private Object invoke_L2(Object a0, Object a1) throws Throwable {
            if ((boolean) test.invokeExact(a0, a1)) { return target.invokeExact(a0, a1); }
            return fallback.invokeExact(a0, a1);
        }

        private Object invoke_L3(Object a0, Object a1, Object a2) throws Throwable {
            if ((boolean) test.invokeExact(a0, a1, a2)) { return target.invokeExact(a0, a1, a2); }
            return fallback.invokeExact(a0, a1, a2);
        }

        private Object invoke_L4(Object a0, Object a1, Object a2, Object a3) throws Throwable {
            if ((boolean) test.invokeExact(a0, a1, a2, a3)) { return target.invokeExact(a0, a1, a2, a3); }
            return fallback.invokeExact(a0, a1, a2, a3);
        }

        private Object invoke_L5(Object a0, Object a1, Object a2, Object a3, Object a4) throws Throwable {
            if ((boolean) test.invokeExact(a0, a1, a2, a3, a4)) { return target.invokeExact(a0, a1, a2, a3, a4); }
        ...
        private Object invoke_L7(Object a0, Object a1, Object a2, Object a3, Object a4, Object a5, Object a6)
            throws Throwable {
        ...
        private Object invoke_L8(Object a0, Object a1, Object a2, Object a3, Object a4, Object a5, Object a6, Object a7)
            throws Throwable {
        ...
        static {
            try {
                VARARGS_INVOKE = IMPL_LOOKUP
                    .findVirtual(GuardWithTest.class, "invoke_V", MethodType.genericMethodType(0, true));
            } catch (ReflectiveOperationException ex) {
                throw uncaughtException(ex);
            }
        }
    ...
    static MethodHandle selectAlternative() {
        ...
        try {
            SELECT_ALTERNATIVE = IMPL_LOOKUP.findStatic(MethodHandleImpl.class, "selectAlternative",
    ...
    private static class GuardWithCatch extends BoundMethodHandle {
        ...
        GuardWithCatch(MethodHandle invoker, MethodHandle target, Class<? extends Throwable> exType,
        ...
        static {
            try {
                VARARGS_INVOKE = IMPL_LOOKUP
                    .findVirtual(GuardWithCatch.class, "invoke_V", MethodType.genericMethodType(0, true));
            } catch (ReflectiveOperationException ex) {
                throw uncaughtException(ex);
            }
        }
    ...
    static MethodHandle makeGuardWithCatch(MethodHandle target, Class<? extends Throwable> exType,
        MethodHandle catcher) {
        MethodType type = target.type();
    ...
    static MethodHandle throwException() {
        ...
        try {
            THROW_EXCEPTION = IMPL_LOOKUP.findStatic(MethodHandleImpl.class, "throwException",
