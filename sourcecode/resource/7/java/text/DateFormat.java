...
public abstract class DateFormat extends Format {
    ...
    public boolean equals(Object obj) {
        ...
        return (// calendar.equivalentTo(other.calendar) // THIS API DOESN'T EXIST YET!
            calendar.getFirstDayOfWeek() == other.calendar.getFirstDayOfWeek() &&
                ...
                calendar.getTimeZone().equals(other.calendar.getTimeZone()) && numberFormat.equals(other.numberFormat));
    }
    ...
    private static DateFormat get(int timeStyle, int dateStyle, int flags, Locale loc) {
        ...
        try {
            ...
            if (pool.hasProviders()) {
                DateFormat providersInstance = pool
                    .getLocalizedObject(DateFormatGetter.INSTANCE, loc, timeStyle, dateStyle, flags);
    ...
    private static class DateFormatGetter
        ...
        public DateFormat getObject(DateFormatProvider dateFormatProvider, Locale locale, String key,
            Object... params) {
