...
public class MessageFormat extends Format {
    ...
    public AttributedCharacterIterator formatToCharacterIterator(Object arguments) {
        ...
        return createAttributedCharacterIterator(
            (AttributedCharacterIterator[]) iterators.toArray(new AttributedCharacterIterator[iterators.size()]));
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (maxOffset == other.maxOffset && pattern.equals(other.pattern) &&
            ((locale != null && locale.equals(other.locale)) || (locale == null && other.locale == null)) &&
            Arrays.equals(offsets, other.offsets) && Arrays.equals(argumentNumbers, other.argumentNumbers) &&
            ...
            if (false) { // if (argRecursion == 3){
                ...
                if (characterIterators != null) {
                    ...
                    if (subFormatter != null) {
                        ...
                        if (last != result.length()) {
                            characterIterators.add(createAttributedCharacterIterator(subIterator, Field.ARGUMENT,
                    ...
                    if (arg != null && arg.length() > 0) {
                        ...
                        characterIterators.add(
                            createAttributedCharacterIterator(arg, Field.ARGUMENT, Integer.valueOf(argumentNumber)));
                        last = result.length();
                    }
                } else {
                    if (subFormatter != null) {
    ...
    private static final int[] DATE_TIME_MODIFIERS = { DateFormat.DEFAULT, DateFormat.SHORT, DateFormat.MEDIUM,
