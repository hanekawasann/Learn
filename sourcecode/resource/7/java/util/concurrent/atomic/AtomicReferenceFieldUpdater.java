...
public abstract class AtomicReferenceFieldUpdater<T, V> {
    ...
    private static final class AtomicReferenceFieldUpdaterImpl<T, V> extends AtomicReferenceFieldUpdater<T, V> {
        ...
        AtomicReferenceFieldUpdaterImpl(Class<T> tclass, Class<V> vclass, String fieldName) {
            ...
            this.tclass = tclass;
            if (vclass == Object.class) { this.vclass = null; } else { this.vclass = vclass; }
        ...
        public boolean compareAndSet(T obj, V expect, V update) {
            if (obj == null || obj.getClass() != tclass || cclass != null ||
                (update != null && vclass != null && vclass != update.getClass())) { updateCheck(obj, update); }
        ...
        public void set(T obj, V newValue) {
            if (obj == null || obj.getClass() != tclass || cclass != null ||
                (newValue != null && vclass != null && vclass != newValue.getClass())) { updateCheck(obj, newValue); }
