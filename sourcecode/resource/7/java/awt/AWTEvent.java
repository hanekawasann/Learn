...
public abstract class AWTEvent extends EventObject {
    ...
    private static synchronized Field get_InputEvent_CanAccessSystemClipboard() {
        if (inputEvent_CanAccessSystemClipboard_Field == null) {
            inputEvent_CanAccessSystemClipboard_Field = (Field) java.security.AccessController
                    ...
                    public Object run() {
                        ...
                        try {
                            ...
                            if (log.isLoggable(PlatformLogger.FINE)) {
                                log.fine("AWTEvent.get_InputEvent_CanAccessSystemClipboard() got SecurityException ",
                                    e);
                            }
                        } catch (NoSuchFieldException e) {
                            if (log.isLoggable(PlatformLogger.FINE)) {
                                log.fine("AWTEvent.get_InputEvent_CanAccessSystemClipboard() got NoSuchFieldException ",
                                    e);
                            }
                        }
                        return null;
    ...
    Event convertToOld() {
        ...
        switch (id) {
            ...
            case KeyEvent.KEY_RELEASED:
                ...
                return new Event(src, ke.getWhen(), newid, 0, 0, Event.getOldEventKey(ke),
