...
class TempFileHelper {
    ...
    private static Path generatePath(String prefix, String suffix, Path dir) {
        ...
        Path name = dir.getFileSystem().getPath(prefix + n + suffix);
     ...
     */
    private static Path create(Path dir, String prefix, String suffix, boolean createDirectory, FileAttribute[] attrs)
        throws IOException {
        if (prefix == null) { prefix = ""; }
        if (suffix == null) { suffix = (createDirectory) ? "" : ".tmp"; }
        if (dir == null) { dir = tmpdir; }
        ...
        for (; ; ) {
            ...
            try {
                ...
                if (sm != null) { throw new IllegalArgumentException("Invalid prefix or suffix"); }
                throw e;
            }
            try {
                if (createDirectory) {
