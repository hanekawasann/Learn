...
public class EllipticCurve {
     ...
     * @throws NullPointerException     if <code>field</code>,
     *                                  <code>a</code>, or <code>b</code> is null.
     * @throws IllegalArgumentException if <code>a</code>
     ...
     */
    public byte[] getSeed() {
        if (seed == null) { return null; } else { return seed.clone(); }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EllipticCurve) {
            ...
            return (field.equals(curve.field)) && (a.equals(curve.a)) && (b.equals(curve.b));
        }
        return false;
    }
