...
public class DataFlavor implements Externalizable, Cloneable {
     ...
     */
    protected final static Class<?> tryToLoadClass(String className, ClassLoader fallback)
        throws ClassNotFoundException {
        ClassLoader systemClassLoader = (ClassLoader) java.security.AccessController
     ...
     *
     * @throws NullPointerException if either <code>primaryType</code>,
     *                              <code>subType</code> or <code>representationClass</code> is null
     */
    private DataFlavor(String primaryType, String subType, MimeTypeParameterList params, Class representationClass,
    ...
    private String paramString() {
        ...
        if (DataTransferer.isFlavorCharsetTextType(this) &&
            (isRepresentationClassInputStream() || isRepresentationClassByteBuffer() ||
    ...
    public static final DataFlavor selectBestTextFlavor(DataFlavor[] availableFlavors) {
        ...
        DataFlavor bestFlavor = Collections.max(Arrays.asList(availableFlavors), textFlavorComparator);
     ...
     * data
     * @throws IllegalArgumentException     if the representation class
     *                                      is not one of the seven listed above
     * @throws IllegalArgumentException     if the <code>Transferable</code>
     *                                      has <code>null</code> data
     * @throws NullPointerException         if the <code>Transferable</code> is
     *                                      <code>null</code>
     * @throws UnsupportedEncodingException if this flavor's representation
     *                                      is <code>java.io.InputStream</code>,
     *                                      <code>java.nio.ByteBuffer</code>, or <code>[B</code> and
     *                                      this flavor's encoding is not supported by this
     *                                      implementation of the Java platform
     * @throws UnsupportedFlavorException   if the <code>Transferable</code>
     *                                      does not support this flavor
     * @throws IOException                  if the data cannot be read because of an
     *                                      I/O error
     * @see #selectBestTextFlavor
     * @since 1.3
     */
    ...
    public boolean equals(DataFlavor that) {
        ...
        if (mimeType == null) {
            return that.mimeType == null;
        } else {
            if (!mimeType.match(that.mimeType)) {
                return false;
            }

            if ("text".equals(getPrimaryType()) && DataTransferer.doesSubtypeSupportCharset(this) &&
                representationClass != null &&
                !(isRepresentationClassReader() || String.class.equals(representationClass) ||
                    isRepresentationClassCharBuffer() || DataTransferer.charArrayClass.equals(representationClass))) {
    ...
    public int hashCode() {
        ...
        if (mimeType != null) {
            ...
            if ("text".equals(primaryType) && DataTransferer.doesSubtypeSupportCharset(this) &&
                representationClass != null &&
                !(isRepresentationClassReader() || String.class.equals(representationClass) ||
                    isRepresentationClassCharBuffer() || DataTransferer.charArrayClass.equals(representationClass))) {
    ...
    public boolean isFlavorRemoteObjectType() {
        return isRepresentationClassRemote() && isRepresentationClassSerializable() &&
