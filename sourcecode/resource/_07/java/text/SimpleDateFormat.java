        ...
        switch (patternCharIndex) {
            ...
            case PATTERN_YEAR:      // 'y'
                if (calendar instanceof GregorianCalendar) {
                    if (count != 2) { zeroPaddingNumber(value, count, maxIntCount, buffer); } else // count == 2
                    {
            ...
            case PATTERN_HOUR_OF_DAY1: // 'k' 1-based.  eg, 23:59 + 1 hour =>> 24:59
                if (current == null) {
                    ...
                    } else { zeroPaddingNumber(value, count, maxIntCount, buffer); }
                }
                break;
    ...
    private int subParseZoneString(String text, int start, CalendarBuilder calb) {
        ...
        if (tz != null) { // Matched any ?
            ...
            if (!(useSameName || (nameIndex >= 3 && dstAmount == 0))) {
                calb.set(Calendar.ZONE_OFFSET, tz.getRawOffset()).set(Calendar.DST_OFFSET, dstAmount);
            }
