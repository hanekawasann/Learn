...
public class ConcurrentSkipListMap<K, V> extends AbstractMap<K, V>
    ...
    public V computeIfPresent(K key, BiFunction<? super K, ? super V, ? extends V> remappingFunction) {
        ...
        while ((n = findNode(key)) != null) {
            if ((v = n.value) != null) {
                ...
                if (r != null) {
                    if (n.casValue(vv, r)) { return r; }
                } else if (doRemove(key, vv) != null) { break; }
            }
        }
        return null;
    }
    ...
    public V compute(K key, BiFunction<? super K, ? super V, ? extends V> remappingFunction) {
        ...
        for (; ; ) {
            ...
            if ((n = findNode(key)) == null) {
                if ((r = remappingFunction.apply(key, null)) == null) { break; }
        ...
        for (; ; ) {
            ...
            if ((n = findNode(key)) == null) {
                ...
                if ((r = remappingFunction.apply(vv, value)) != null) {
                    if (n.casValue(vv, r)) { return r; }
                } else if (doRemove(key, vv) != null) { return null; }
            }
        }
    }
    ...
    static final class Values<E> extends AbstractCollection<E> {
        ...
        @SuppressWarnings("unchecked")
        public Iterator<E> iterator() {
            if (m instanceof ConcurrentSkipListMap) { return ((ConcurrentSkipListMap<?, E>) m).valueIterator(); } else {
        ...
        public Spliterator<E> spliterator() {
            ...
            } else { return (Spliterator<E>) ((SubMap<?, E>) m).valueIterator(); }
        }
    }
    ...
    static final class EntrySet<K1, V1> extends AbstractSet<Map.Entry<K1, V1>> {
        ...
        public Spliterator<Map.Entry<K1, V1>> spliterator() {
            ...
            } else { return (Spliterator<Map.Entry<K1, V1>>) ((SubMap<K1, V1>) m).entryIterator(); }
        }
    }
    ...
    static final class SubMap<K, V> extends AbstractMap<K, V>
        ...
        ConcurrentSkipListMap.Node<K, V> loNode(Comparator<? super K> cmp) {
            ...
            } else { return m.findNear(lo, GT, cmp); }
        }
        ...
        K lowestKey() {
            ...
            if (isBeforeEnd(n, cmp)) { return n.key; } else { throw new NoSuchElementException(); }
        }
        ...
        Map.Entry<K, V> lowestEntry() {
            ...
            for (; ; ) {
                ConcurrentSkipListMap.Node<K, V> n = loNode(cmp);
                if (!isBeforeEnd(n, cmp)) { return null; }
        ...
        Map.Entry<K, V> getNearEntry(K key, int rel) {
            ...
            if (isDescending) { // adjust relation for direction
                if ((rel & LT) == 0) { rel |= LT; } else { rel &= ~LT; }
            }
        ...
        abstract class SubMapIter<T> implements Iterator<T>, Spliterator<T> {
            ...
            SubMapIter() {
                ...
                for (; ; ) {
                    ...
                    Object x = next.value;
                    if (x != null && x != next) {
                        if (!inBounds(next.key, cmp)) { next = null; } else {
                            @SuppressWarnings("unchecked")
                            V vv = (V) x;
                            nextValue = vv;
                        }
            ...
            private void ascend() {
                ...
                for (; ; ) {
                    ...
                    Object x = next.value;
                    if (x != null && x != next) {
                        if (tooHigh(next.key, cmp)) { next = null; } else {
                            @SuppressWarnings("unchecked")
                            V vv = (V) x;
                            nextValue = vv;
                        }
            ...
            private void descend() {
                ...
                for (; ; ) {
                    ...
                    Object x = next.value;
                    if (x != null && x != next) {
                        if (tooLow(next.key, cmp)) { next = null; } else {
                            @SuppressWarnings("unchecked")
                            V vv = (V) x;
                            nextValue = vv;
                        }
    ...
    public void forEach(BiConsumer<? super K, ? super V> action) {
        ...
        V v;
        for (Node<K, V> n = findFirst(); n != null; n = n.next) {
            if ((v = n.getValidValue()) != null) { action.accept(n.key, v); }
        }
    }
    ...
    static final class KeySpliterator<K, V> extends CSLMSpliterator<K, V> implements Spliterator<K> {
        ...
        public Spliterator<K> trySplit() {
            ...
            if ((e = current) != null && (ek = e.key) != null) {
                for (Index<K, V> q = row; q != null; q = row = q.down) {
                    ...
                    Node<K, V> b, n;
                    K sk;
                    if ((s = q.right) != null && (b = s.node) != null && (n = b.next) != null && n.value != null &&
                        (sk = n.key) != null && cpr(cmp, sk, ek) > 0 && (f == null || cpr(cmp, sk, f) < 0)) {
                        current = n;
                        Index<K, V> r = q.down;
        ...
        public void forEachRemaining(Consumer<? super K> action) {
            ...
            for (; e != null; e = e.next) {
                ...
                if ((v = e.value) != null && v != e) { action.accept(k); }
            }
        }
        ...
        public int characteristics() {
            return Spliterator.DISTINCT | Spliterator.SORTED | Spliterator.ORDERED | Spliterator.CONCURRENT |
                Spliterator.NONNULL;
        }
