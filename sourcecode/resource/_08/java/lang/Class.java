...
public final class Class<T> implements java.io.Serializable, GenericDeclaration, Type, AnnotatedElement {
    ...
    public String toGenericString() {
        if (isPrimitive()) {
            ...
            if (isInterface()) { // Note: all annotation types are interfaces
                ...
                if (isEnum()) { sb.append("enum"); } else { sb.append("class"); }
            }
            sb.append(' ');
            sb.append(getName());
    ...
    public TypeVariable<Class<T>>[] getTypeParameters() {
        ...
        if (info != null) { return (TypeVariable<Class<T>>[]) info.getTypeParameters(); } else {
    ...
    public Class<?> getEnclosingClass() throws SecurityException {
        ...
        if (enclosingInfo == null) {
            ...
            } else { enclosingCandidate = enclosingClass; }
        }
    ...
    private Method getMethod0(String name, Class<?>[] parameterTypes, boolean includeStaticMethods) {
        ...
        if ((res = searchMethods(privateGetDeclaredMethods(true), name, parameterTypes)) != null) {
            if (includeStaticMethods || !Modifier.isStatic(res.getModifiers())) { return res; }
        }
        ...
        Class<?>[] interfaces = getInterfaces();
        for (Class<?> c : interfaces) { if ((res = c.getMethod0(name, parameterTypes, false)) != null) { return res; } }
        // Not found
        return null;
    }
    ...
    public <U> Class<? extends U> asSubclass(Class<U> clazz) {
        if (clazz.isAssignableFrom(this)) { return (Class<? extends U>) this; } else {
